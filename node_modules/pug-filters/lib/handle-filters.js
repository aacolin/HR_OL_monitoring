...
module.e***REMOVED***ports = handleFilters;
  ...
  walk(
    ...
    function(node) {
      ...
      if (node.type === 'Filter') {
        ...
        var te***REMOVED***t = getBodyAsTe***REMOVED***t(node);
        var attrs = getAttributes(node, options);
        attrs.filename = node.filename;
        node.type = 'Te***REMOVED***t';
        node.val = filterWithFallback(node, te***REMOVED***t, attrs);
      ...
      function filterWithFallback(filter, te***REMOVED***t, attrs, funcName) {
        try {
          var filterName = getFilterName(filter);
          if (filters && filters[filterName]) {
            return filters[filterName](te***REMOVED***t, attrs);
          } else {
            return runFilter(filterName, te***REMOVED***t, attrs, dir, funcName);
          }
        } catch (e***REMOVED***) {
          if (e***REMOVED***.code === 'UNKNOWN_FILTER') {
            throw error(e***REMOVED***.code, e***REMOVED***.message, filter);
          }
          throw e***REMOVED***;
        }
      }
...
function getBodyAsTe***REMOVED***t(node) {
...
function getAttributes(node, options) {
  ...
  node.attrs.forEach(function(attr) {
    try {
      ...
      if (/not constant/.test(e***REMOVED***.message)) {
        throw error(
