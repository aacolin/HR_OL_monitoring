...
opts = { host: 'my-bucket.s3.amazonaws.com', path: '/?X-Amz-E***REMOVED***pires=12345', signQuery: true }
...
request(opts)
/*
<?***REMOVED***ml version="1.0"?>
<ListQueuesResponse ***REMOVED***mlns="https://queue.amazonaws.com/doc/2012-11-05/">
...
*/

// aws4 can infer the HTTP method if a body is passed in
// method will be POST and Content-Type: 'application/***REMOVED***-www-form-urlencoded; charset=utf-8'
request(aws4.sign({ service: 'iam', body: 'Action=ListGroups&Version=2010-05-08' }))
/*
<ListGroupsResponse ***REMOVED***mlns="https://iam.amazonaws.com/doc/2010-05-08/">
...
*/
...
request(aws4.sign({
  ...
  path: '/',
  headers: {
    'Content-Type': 'application/***REMOVED***-amz-json-1.0',
...
// you can also specify e***REMOVED***tra headers to ignore during signing
request(aws4.sign({
  host: '07tjusf2h91cunochc.us-east-1.aoss.amazonaws.com',
  method: 'PUT',
  path: '/my-inde***REMOVED***',
  body: '{"mappings":{}}',
  headers: {
    'Content-Type': 'application/json',
    'X-Amz-Content-Sha256': 'UNSIGNED-PAYLOAD'
  },
  e***REMOVED***traHeadersToIgnore: {
    'content-length': true
  }
}))
...
// see e***REMOVED***ample.js for e***REMOVED***amples with other services
```
...
populated if they don't already e***REMOVED***ist:
...
- `e***REMOVED***traHeadersToIgnore` (an object with lowercase header keys to ignore when signing, eg `{ 'content-length': true }`)
- `e***REMOVED***traHeadersToInclude` (an object with lowercase header keys to include when signing, overriding any ignores)
- `headers['Host']` (will use `hostname` or `host` or be calculated if not given)
- `headers['Content-Type']` (will use `'application/***REMOVED***-www-form-urlencoded; charset=utf-8'`
...
```
e***REMOVED***port AWS_ACCESS_KEY_ID="<your-access-key-id>"
e***REMOVED***port AWS_SECRET_ACCESS_KEY="<your-secret-access-key>"
e***REMOVED***port AWS_SESSION_TOKEN="<your-session-token>"
```
...
committed and subsequently e***REMOVED***tracted this code.
