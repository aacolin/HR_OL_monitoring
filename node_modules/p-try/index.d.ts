declare const pTry: {
	...
	```
	*/
	<ValueType, ArgumentsType e***REMOVED***tends unknown[]>(
		fn: (...arguments: ArgumentsType) => PromiseLike<ValueType> | ValueType,
		...arguments: ArgumentsType
	): Promise<ValueType>;

	// TODO: remove this in the ne***REMOVED***t major version, refactor the whole definition to:
	// declare function pTry<ValueType, ArgumentsType e***REMOVED***tends unknown[]>(
	//	fn: (...arguments: ArgumentsType) => PromiseLike<ValueType> | ValueType,
	//	...arguments: ArgumentsType
	// ): Promise<ValueType>;
	// e***REMOVED***port = pTry;
