...
* fi***REMOVED*** [#284](https://github.com/uuidjs/uuid/issues/284) by setting function name in try-catch ([f2a60f2](https://github.com/uuidjs/uuid/commit/f2a60f2))
...
* fi***REMOVED*** [#229](https://github.com/uuidjs/uuid/issues/229) ([c9684d4](https://github.com/uuidjs/uuid/commit/c9684d4))
...
* use msCrypto if available. Fi***REMOVED***es [#241](https://github.com/uuidjs/uuid/issues/241) ([#247](https://github.com/uuidjs/uuid/issues/247)) ([1fef18b](https://github.com/uuidjs/uuid/commit/1fef18b))
...
* (fi***REMOVED***) Add .npmignore file to e***REMOVED***clude test/ and other non-essential files from packing. (#183)
* Fi***REMOVED*** typo (#178)
* Simple typo fi***REMOVED*** (#165)
...
* Improved module conte***REMOVED***t detection
...
* E***REMOVED***pose RNG option to allow for perf testing with different generators
