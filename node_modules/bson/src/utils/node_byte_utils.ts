...
type NodeJsEncoding = 'base64' | 'he***REMOVED***' | 'utf8' | 'binary';
...
// This can be nullish, but we gate the nodejs functions on being e***REMOVED***ported whether or not this e***REMOVED***ists
// Node.js global
declare const Buffer: NodeJsBufferConstructor;
declare const require: (mod: 'crypto') => { randomBytes: (byteLength: number) => Uint8Array };

/** @internal */
e***REMOVED***port function nodejsMathRandomBytes(byteLength: number) {
 ...
 * In order to make our es module bundle work as e***REMOVED***pected on Node.js we need to change this `require()` to a dynamic import, and the dynamic
...
/** @internal */
e***REMOVED***port const nodeJsByteUtils = {
  ...
  fromHe***REMOVED***(he***REMOVED***: string): NodeJsBuffer {
