...
/**
 * Check that a global Buffer e***REMOVED***ists that is a function and
 ...
 * @internal
 */
e***REMOVED***port const ByteUtils: ByteUtils = hasGlobalBuffer ? nodeJsByteUtils : webByteUtils;
