 ...
 */
e***REMOVED***port type NumberUtils = {
  /**
 ...
 * @public
 */
e***REMOVED***port const NumberUtils: NumberUtils = {
  getNonnegativeInt32LE(source: Uint8Array, offset: number): number {
  ...
  setBigInt64LE(destination: Uint8Array, offset: number, value: bigint): 8 {
    /* eslint-disable-ne***REMOVED***t-line no-restricted-globals -- This is allowed here as useBigInt64=true */
