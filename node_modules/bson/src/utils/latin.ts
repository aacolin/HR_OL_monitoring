 ...
 * - If any byte e***REMOVED***ceeds 128 this function returns null
 *
 * @param uint8array - A sequence of bytes that may contain basic latin characters
 * @param start - The start inde***REMOVED*** from which to search the uint8array
 * @param end - The inde***REMOVED*** to stop searching the uint8array
 * @returns string if all bytes are within the basic latin range, otherwise null
 */
e***REMOVED***port function tryReadBasicLatin(
 ...
 * - If any code unit e***REMOVED***ceeds 128 this function returns null
 *
 ...
 */
e***REMOVED***port function tryWriteBasicLatin(
