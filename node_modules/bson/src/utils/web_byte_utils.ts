...
type Te***REMOVED***tEncoder = {
  readonly encoding: string;
  encode(input?: string): Uint8Array;
};
type Te***REMOVED***tEncoderConstructor = {
  new (): Te***REMOVED***tEncoder;
};

// Web global
declare const Te***REMOVED***tDecoder: Te***REMOVED***tDecoderConstructor;
declare const Te***REMOVED***tEncoder: Te***REMOVED***tEncoderConstructor;
...
/** @internal */
e***REMOVED***port function webMathRandomBytes(byteLength: number) {
  if (byteLength < 0) {
...
const webRandomBytes: (byteLength: number) => Uint8Array = (() => {
  ...
  if (crypto != null && typeof crypto.getRandomValues === 'function') {
    return (byteLength: number) => {
      // @ts-e***REMOVED***pect-error: crypto.getRandomValues cannot actually be null here
...
/** @internal */
e***REMOVED***port const webByteUtils = {
  toLocalBufferType(
  ...
  toHe***REMOVED***(uint8array: Uint8Array): string {
