 ...
 */
e***REMOVED***port class BSONError e***REMOVED***tends Error {
  /**
   * @internal
  ...
  public static isBSONError(value: unknown): value is BSONError {
    return (
      ...
      // Do not access the following properties, just check e***REMOVED***istence
      'name' in value &&
      'message' in value &&
      'stack' in value
    );
 ...
 * @category Error
 */
e***REMOVED***port class BSONVersionError e***REMOVED***tends BSONError {
 ...
 *
 */
e***REMOVED***port class BSONRuntimeError e***REMOVED***tends BSONError {
 ...
 */
e***REMOVED***port class BSONOffsetError e***REMOVED***tends BSONError {
