...
|               | `bson@1.***REMOVED***` | `bson@4.***REMOVED***` | `bson@5.***REMOVED***` | `bson@6.***REMOVED***` |
| ------------- | ---------- | ---------- | ---------- | ---------- |
| `mongodb@6.***REMOVED***` | N/A        | N/A        | N/A        | ✓          |
| `mongodb@5.***REMOVED***` | N/A        | N/A        | ✓          | N/A        |
| `mongodb@4.***REMOVED***` | N/A        | ✓          | N/A        | N/A        |
| `mongodb@3.***REMOVED***` | ✓          | N/A        | N/A        | N/A        |

## Documentation

### BSON

[API documentation](https://mongodb.github.io/node-mongodb-native/Ne***REMOVED***t/modules/BSON.html)
...
- [EJSON](#EJSON)
  ...
  - [.parse(te***REMOVED***t, [options])](#EJSON.parse)
...
#### _EJSON_.parse(te***REMOVED***t, [options])

| Param             | Type                 | Default           | Description                                                                        |
| ----------------- | -------------------- | ----------------- | ---------------------------------------------------------------------------------- |
| te***REMOVED***t              | <code>string</code>  |                   |                                                                                    |
| [options]         | <code>object</code>  |                   | Optional settings                                                                  |
| [options.rela***REMOVED***ed] | <code>boolean</code> | <code>true</code> | Attempt to return native JS types where possible, rather than BSON types (if true) |
...
| Param             | Type                                        | Default           | Description                                                                                                                                                                                                                                                                                                                                        |
| ----------------- | ------------------------------------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| value             | <code>object</code>                         |                   | The value to convert to e***REMOVED***tended JSON                                                                                                                                                                                                                                                                                                              |
...
| [options]         | <code>object</code>                         |                   | Optional settings                                                                                                                                                                                                                                                                                                                                  |
| [options.rela***REMOVED***ed] | <code>boolean</code>                        | <code>true</code> | Enabled E***REMOVED***tended JSON's `rela***REMOVED***ed` mode                                                                                                                                                                                                                                                                                                             |
| [options.legacy]  | <code>boolean</code>                        | <code>true</code> | Output in E***REMOVED***tended JSON v1                                                                                                                                                                                                                                                                                                                         |
...
| Param     | Type                | Description                                  |
| --------- | ------------------- | -------------------------------------------- |
| ejson     | <code>object</code> | The E***REMOVED***tended JSON object to deserialize      |
...
Any new errors we add to the driver will directly e***REMOVED***tend an e***REMOVED***isting error class and no e***REMOVED***isting error will be moved to a different parent class outside of a major release.
This means `BSONError.isBSONError()` will always be able to accurately capture the errors that our BSON library throws.

Hypothetical e***REMOVED***ample: A collection in our Db has an issue with UTF-8 data:
...
BSON vendors the required polyfills for `Te***REMOVED***tEncoder`, `Te***REMOVED***tDecoder`, `atob`, `btoa` imported from React Native and therefore doesn't e***REMOVED***pect users to polyfill these. One additional polyfill, `crypto.getRandomValues` is recommended and can be installed with the following command:

```sh
npm install --save react-native-get-random-values
```

The following snippet should be placed at the top of the entrypoint (by default this is the root `inde***REMOVED***.js` file) for React Native projects using the BSON library. These lines must be placed for any code that imports `BSON`.
...
This will cause React Native to import the `node_modules/bson/lib/bson.rn.cjs` bundle (see the `"react-native"` setting we have in the `"e***REMOVED***ports"` section of our [package.json](./package.json).)

### Technical Note about React Native module import

The `"e***REMOVED***ports"` definition in our `package.json` will result in BSON's CommonJS bundle being imported in a React Native project instead of the ES module bundle. Importing the CommonJS bundle is necessary because BSON's ES module bundle of BSON uses top-level await, which is not supported synta***REMOVED*** in [React Native's runtime hermes](https://hermesengine.dev/).

## FAQ

#### Why does `undefined` get converted to `null`?

The `undefined` BSON type has been [deprecated for many years](http://bsonspec.org/spec.html), so this library has dropped support for it. Use the `ignoreUndefined` option (for e***REMOVED***ample, from the [driver](http://mongodb.github.io/node-mongodb-native/2.2/api/MongoClient.html#connect) ) to instead remove `undefined` keys.
