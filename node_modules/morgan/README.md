...
var morgan = require('morgan')
var path = require('path')
var rfs = require('rotating-file-stream') // version 2.***REMOVED***
...
[coveralls-image]: https://badgen.net/coveralls/c/github/e***REMOVED***pressjs/morgan/master
...
[travis-image]: https://badgen.net/travis/e***REMOVED***pressjs/morgan/master
