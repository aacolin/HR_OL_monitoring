...
- `INVALID_BASEDIR`: the specified `opts.basedir` doesn't e***REMOVED***ist, or is not a directory
...
* opts.e***REMOVED***tensions - array of file e***REMOVED***tensions to search in order

* opts.includeCoreModules - set to `false` to e***REMOVED***clude node core modules (e.g. `fs`) from the search

* opts.readFile - how to read files asynchronously

* opts.isFile - function to asynchronously test whether a file e***REMOVED***ists

* opts.isDirectory - function to asynchronously test whether a file e***REMOVED***ists and is a directory
...
This is the way Node resolves dependencies when e***REMOVED***ecuted with the [--preserve-symlinks](https://nodejs.org/api/all.html#cli_preserve_symlinks) flag.
**Note:** this property is currently `true` by default but it will be changed to
`false` in the ne***REMOVED***t major version because *Node's resolution algorithm does not preserve symlinks by default*.
...
* opts.isFile - function to synchronously test whether a file e***REMOVED***ists

* opts.isDirectory - function to synchronously test whether a file e***REMOVED***ists and is a directory
