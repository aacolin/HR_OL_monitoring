...
// broken in node v8.9.***REMOVED***, v9.0, v9.1, v9.2.***REMOVED***. see https://github.com/nodejs/node/pull/17113
...
test('bar', function (t) {
    ...
    t.equal(
        ...
        path.join(dir, 'bar/node_modules/foo/inde***REMOVED***.js'),
        'foo in bar'
    );
...
test('baz', function (t) {
    ...
    t.equal(
        ...
        path.join(dir, 'baz/quu***REMOVED***.js'),
        './baz'
    );
    if (requireResolveSupportsPaths) {
        t.equal(
...
test('biz', function (t) {
    ...
    t.equal(
        resolve.sync('./gru***REMOVED***', { basedir: dir }),
        path.join(dir, 'gru***REMOVED***/inde***REMOVED***.js')
    );
    if (requireResolveSupportsPaths) {
        t.equal(
            resolve.sync('./gru***REMOVED***', { basedir: dir }),
            require.resolve('./gru***REMOVED***', { paths: [dir] }),
            './gru***REMOVED***: resolve.sync === require.resolve'
        );
    }

    var tivDir = path.join(dir, 'gru***REMOVED***');
    t.equal(
        resolve.sync('tiv', { basedir: tivDir }),
        path.join(dir, 'tiv/inde***REMOVED***.js')
    );
    if (!requireResolveDefaultPathsBroken && requireResolveSupportsPaths) {
        t.equal(
            resolve.sync('tiv', { basedir: tivDir }),
    ...
    var gru***REMOVED***Dir = path.join(dir, 'tiv');
    t.equal(
        resolve.sync('gru***REMOVED***', { basedir: gru***REMOVED***Dir }),
        path.join(dir, 'gru***REMOVED***/inde***REMOVED***.js')
    );
    if (!requireResolveDefaultPathsBroken && requireResolveSupportsPaths) {
        t.equal(
            resolve.sync('gru***REMOVED***', { basedir: gru***REMOVED***Dir }),
            require.resolve('gru***REMOVED***', { paths: [gru***REMOVED***Dir] }),
            'gru***REMOVED***: resolve.sync === require.resolve'
        );
    }
...
test('cup', function (t) {
    ...
    t.throws(function () {
        resolve.sync('./cup', {
            basedir: dir,
            e***REMOVED***tensions: ['.js']
        });
    });

    if (requireResolveSupportsPaths) {
        t.equal(
            resolve.sync('./cup.coffee', { basedir: dir, e***REMOVED***tensions: ['.js', '.coffee'] }),
...
test('path iterator', function (t) {
    ...
    t.equal(
        resolve.sync('baz', { packageIterator: e***REMOVED***actIterator }),
        path.join(resolverDir, 'baz/quu***REMOVED***.js')
    );
...
test('missing inde***REMOVED***', function (t) {
    ...
    var resolverDir = path.join(__dirname, 'resolver');
    try {
        resolve.sync('./missing_inde***REMOVED***', { basedir: resolverDir });
        t.fail('did not fail');
    } catch (err) {
    ...
    if (requireResolveSupportsPaths) {
        try {
            require.resolve('./missing_inde***REMOVED***', { basedir: resolverDir });
...
test('#52 - incorrectly resolves module-paths like "./someFolder/" when there is a file of the same name', function (t) {
    ...
    t.equal(
        resolve.sync('./foo/', { basedir: basedir }),
        path.join(dir, 'same_names/foo/inde***REMOVED***.js')
    );
    if (requireResolveSupportsPaths) {
        t.equal(
            resolve.sync('./foo/', { basedir: basedir }),
...
test('sync: #121 - treating an e***REMOVED***isting file as a dir when no basedir', function (t) {
...
test('sync dot main', function (t) {
    ...
    t.equal(
        ...
        path.join(__dirname, 'resolver/dot_main/inde***REMOVED***.js'),
        './resolver/dot_main'
    );
    t.equal(
        resolve.sync('./resolver/dot_main'),
...
test('sync dot slash main', function (t) {
    ...
    t.equal(
        ...
        path.join(__dirname, 'resolver/dot_slash_main/inde***REMOVED***.js')
    );
    t.equal(
        resolve.sync('./resolver/dot_slash_main'),
...
test('non-string "main" field in package.json', function (t) {
    ...
    try {
        ...
        t.equal(result, undefined, 'result should not e***REMOVED***ist');
...
test('absolute paths', function (t) {
    ...
    t.equal(
        resolve.sync(e***REMOVED***tensionless),
        __filename,
    ...
    t.equal(
        resolve.sync(e***REMOVED***tensionless, { basedir: process.cwd() }),
        __filename,
    ...
    if (requireResolveSupportsPaths) {
        t.equal(
            resolve.sync(e***REMOVED***tensionless, { basedir: process.cwd() }),
            require.resolve(e***REMOVED***tensionless, { paths: [process.cwd()] }),
            'e***REMOVED***tensionless absolute path to this file + basedir: resolve.sync === require.resolve'
        );
    }
...
test('malformed package.json', { skip: !fs.e***REMOVED***istsSync(malformedDir) }, function (t) {
    ...
    t.equal(
        resolve.sync('./inde***REMOVED***.js', { basedir: basedir }),
        e***REMOVED***pected,
    ...
    if (requireResolveSupportsPaths) {
        t.equal(
            resolve.sync('./inde***REMOVED***.js', { basedir: basedir }),
            require.resolve('./inde***REMOVED***.js', { paths: [basedir] }),
        ...
        './inde***REMOVED***.js',
        {
            ...
            readPackageSync: function (readFileSync, pkgfile) {
                ...
                try {
                    ...
                    t.ok(e instanceof Synta***REMOVED***Error, 'readPackageSync: malformed package.json parses as a synta***REMOVED*** error');
                }
            }
        }
    );
