...
test('packageFilter', function (t) {
    function relative(***REMOVED***) {
        return path.relative(__dirname, ***REMOVED***);
    }

    function testPackageFilter(preserveSymlinks) {
        return function (st) {
            st.plan('is 1.***REMOVED***' ? 3 : 5); // eslint-disable-line no-constant-condition

            var destMain = 'symlinks/dest/node_modules/mod-a/inde***REMOVED***.js';
            var destPkg = 'symlinks/dest/node_modules/mod-a/package.json';
            var sourceMain = 'symlinks/source/node_modules/mod-a/inde***REMOVED***.js';
            var sourcePkg = 'symlinks/source/node_modules/mod-a/package.json';
            var destDir = path.join(__dirname, 'symlinks', 'dest');

            /* eslint multiline-comment-style: 0 */
            /* v2.***REMOVED*** will restore these tests
