...
test('homedir module paths', function (t) {
    ...
    makeTempDir(t, hnm, function (err) {
        ...
        var bazPkg = { name: 'baz', main: 'quu***REMOVED***.js' };
        var dotMainPkg = { main: 'inde***REMOVED***' };

        var bazHNMmain = path.join(bazHNMDir, 'quu***REMOVED***.js');
        t.equal(require.resolve('baz'), bazHNMmain, 'sanity check: require.resolve finds HNM `baz`');
        var dotMainMain = path.join(dotMainDir, 'inde***REMOVED***.js');
        ...
        makeTempDir(t, hnl, function (err) {
            ...
            var dotSlashMainMain = path.join(dotSlashMainDir, 'inde***REMOVED***.js');
            var dotSlashMainPkg = { main: 'inde***REMOVED***' };
