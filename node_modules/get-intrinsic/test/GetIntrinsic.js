...
test('e***REMOVED***port', function (t) {
...
test('throws', function (t) {
	t['throws'](
		...
		Synta***REMOVED***Error,
		'none***REMOVED***istent intrinsic throws a synta***REMOVED*** error'
	);
	...
	t['throws'](
		function () { GetIntrinsic('.'); },
		Synta***REMOVED***Error,
		'"just a dot" intrinsic throws a synta***REMOVED*** error'
	);

	t['throws'](
		function () { GetIntrinsic('%String'); },
		Synta***REMOVED***Error,
		'Leading % without trailing % throws a synta***REMOVED*** error'
	);

	t['throws'](
		function () { GetIntrinsic('String%'); },
		Synta***REMOVED***Error,
		'Trailing % without leading % throws a synta***REMOVED*** error'
	);
	...
	t['throws'](
		function () { GetIntrinsic('%Pro***REMOVED***y.prototype.undefined%'); },
		TypeError,
		"Throws when middle part doesn't e***REMOVED***ist (%Pro***REMOVED***y.prototype.undefined%)"
	);

	t['throws'](
		function () { GetIntrinsic('%Array.prototype%garbage%'); },
		Synta***REMOVED***Error,
		'Throws with e***REMOVED***tra percent signs'
	);

	t['throws'](
		function () { GetIntrinsic('%Array.prototype%push%'); },
		Synta***REMOVED***Error,
		'Throws with e***REMOVED***tra percent signs, even on an e***REMOVED***isting intrinsic'
	);
...
test('dotted paths', function (t) {
	...
	test('dotted path reports correct error', function (st) {
		st['throws'](function () {
			GetIntrinsic('%NonE***REMOVED***istentIntrinsic.prototype.property%');
		}, /%NonE***REMOVED***istentIntrinsic%/, 'The base intrinsic of %NonE***REMOVED***istentIntrinsic.prototype.property% is %NonE***REMOVED***istentIntrinsic%');

		st['throws'](function () {
			GetIntrinsic('%NonE***REMOVED***istentIntrinsicPrototype.property%');
		}, /%NonE***REMOVED***istentIntrinsicPrototype%/, 'The base intrinsic of %NonE***REMOVED***istentIntrinsicPrototype.property% is %NonE***REMOVED***istentIntrinsicPrototype%');
