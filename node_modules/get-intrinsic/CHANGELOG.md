...
- [meta] simplify `e***REMOVED***ports` [`faa0cc6`](https://github.com/ljharb/get-intrinsic/commit/faa0cc618e2830ffb51a8202490b0c215d965cbc)
...
- [Fi***REMOVED***] avoid a crash in envs without `__proto__` [`7bad8d0`](https://github.com/ljharb/get-intrinsic/commit/7bad8d061bf8721733b58b73a2565af2b6756b64)
...
- [Fi***REMOVED***] ensure `Error.prototype` is undeniable [`c511e97`](https://github.com/ljharb/get-intrinsic/commit/c511e97ae99c764c4524b540dee7a70757af8da3)
...
- [Dev Deps] update `es-abstract`, `es-value-fi***REMOVED***tures`, `tape` [`07ff291`](https://github.com/ljharb/get-intrinsic/commit/07ff291816406ebe5a12d7f16965bde0942dd688)
- [Fi***REMOVED***] properly check for % signs [`50ac176`](https://github.com/ljharb/get-intrinsic/commit/50ac1760fe99c227e64eabde76e9c0e44cd881b5)

## [v1.1.2](https://github.com/ljharb/get-intrinsic/compare/v1.1.1...v1.1.2) - 2022-06-08

### Fi***REMOVED***ed

- [Fi***REMOVED***] properly validate against e***REMOVED***tra % signs [`#16`](https://github.com/ljharb/get-intrinsic/issues/16)
...
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `aud`, `es-abstract`, `es-value-fi***REMOVED***tures`, `object-inspect`, `tape` [`29e3c09`](https://github.com/ljharb/get-intrinsic/commit/29e3c091c2bf3e17099969847e8729d0e46896de)
...
- [Dev Deps] update `@ljharb/eslint-config`, `es-abstract`, `es-value-fi***REMOVED***tures`, `object-inspect`, `tape` [`10b6f5c`](https://github.com/ljharb/get-intrinsic/commit/10b6f5c02593fb3680c581d696ac124e30652932)
...
- [readme] fi***REMOVED*** repo URLs [`1c8305b`](https://github.com/ljharb/get-intrinsic/commit/1c8305b5365827c9b6fc785434aac0e1328ff2f5)
...
- [meta] e***REMOVED***port `./package.json` [`#9`](https://github.com/ljharb/get-intrinsic/issues/9)
...
- [Refactor] delay `Function` eval until synta***REMOVED***-derived values are requested [`#3`](https://github.com/ljharb/get-intrinsic/issues/3)
...
- [Fi***REMOVED***] Throw for non‑e***REMOVED***istent intrinsics [`68f873b`](https://github.com/ljharb/get-intrinsic/commit/68f873b013c732a05ad6f5fc54f697e55515461b)
- [Fi***REMOVED***] Throw for non‑e***REMOVED***istent segments in the intrinsic path [`8325dee`](https://github.com/ljharb/get-intrinsic/commit/8325deee43128f3654d3399aa9591741ebe17b21)
...
- [Fi***REMOVED***] add missing dependencies [`5031771`](https://github.com/ljharb/get-intrinsic/commit/5031771bb1095b38be88ce7c41d5de88718e432e)
- [Tests] use `es-value-fi***REMOVED***tures` [`af48765`](https://github.com/ljharb/get-intrinsic/commit/af48765a23c5323fb0b6b38dbf00eb5099c7bebc)
