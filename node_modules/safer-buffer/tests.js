...
test('Default is Safer', function (t) {
  t.equal(inde***REMOVED***, safer)
  t.notEqual(safer, dangerous)
  t.notEqual(inde***REMOVED***, dangerous)
  t.end()
})

test('Is not a function', function (t) {
  [inde***REMOVED***, safer, dangerous].forEach(function (impl) {
...
test('Safe methods e***REMOVED***ist', function (t) {
  [inde***REMOVED***, safer, dangerous].forEach(function (impl) {
...
test('Unsafe methods e***REMOVED***ist only in Dangerous', function (t) {
  [inde***REMOVED***, safer].forEach(function (impl) {
...
test('All Safer methods are present in Dangerous', function (t) {
  Object.keys(safer).forEach(function (method) {
    ...
    [inde***REMOVED***, safer, dangerous].forEach(function (impl) {
      ...
      if (method !== 'kStringMa***REMOVED***Length') {
        t.notEqual(typeof impl[method], 'undefined', method)
      }
    })
  })
...
test('Methods return Buffers', function (t) {
  [inde***REMOVED***, safer, dangerous].forEach(function (impl) {
    ...
    t.ok(buffer.Buffer.isBuffer(impl.Buffer.alloc(10, '***REMOVED***')))
...
test('Constructor is buffer.Buffer', function (t) {
  [inde***REMOVED***, safer, dangerous].forEach(function (impl) {
    ...
    t.equal(impl.Buffer.alloc(10, '***REMOVED***').constructor, buffer.Buffer)
...
test('Buffers have appropriate lengths (2)', function (t) {
  t.equal(inde***REMOVED***.Buffer.alloc, safer.Buffer.alloc)
  t.equal(inde***REMOVED***.Buffer.alloc, dangerous.Buffer.alloc)
  var ok = true;
  [ safer.Buffer.alloc,
...
test('.alloc(size) is zero-filled and has correct length', function (t) {
  ...
  for (var i = 0; i < 1e2; i++) {
    ...
    var buf = inde***REMOVED***.Buffer.alloc(length)
    if (!buffer.Buffer.isBuffer(buf)) ok = false
    if (buf.length !== length) ok = false
    var j
    for (j = 0; j < length; j++) {
...
test('.alloc(size, fill) is `fill`-filled', function (t) {
  ...
  for (var i = 0; i < 1e2; i++) {
    ...
    var buf = inde***REMOVED***.Buffer.alloc(length, fill)
    if (!buffer.Buffer.isBuffer(buf)) ok = false
    if (buf.length !== length) ok = false
...
test('.alloc(size, fill) is `fill`-filled', function (t) {
  ...
  t.ok(ok)
  t.deepEqual(inde***REMOVED***.Buffer.alloc(9, 'a'), inde***REMOVED***.Buffer.alloc(9, 97))
  t.notDeepEqual(inde***REMOVED***.Buffer.alloc(9, 'a'), inde***REMOVED***.Buffer.alloc(9, 98))

  var tmp = new buffer.Buffer(2)
  tmp.fill('ok')
  if (tmp[1] === tmp[0]) {
    // Outdated Node.js
    t.deepEqual(inde***REMOVED***.Buffer.alloc(5, 'ok'), inde***REMOVED***.Buffer.from('ooooo'))
  } else {
    t.deepEqual(inde***REMOVED***.Buffer.alloc(5, 'ok'), inde***REMOVED***.Buffer.from('okoko'))
  }
  t.notDeepEqual(inde***REMOVED***.Buffer.alloc(5, 'ok'), inde***REMOVED***.Buffer.from('kokok'))
