...
- 🐞 fi***REMOVED*** recent regression when using `path` option. return to historical behavior: do not attempt to auto find `.env` if `path` set. (regression was introduced in `16.4.3`) [#814](https://github.com/motdotla/dotenv/pull/814)

## [16.4.4](https://github.com/motdotla/dotenv/compare/v16.4.3...v16.4.4) (2024-02-13)

### Changed

- 🐞 Replaced chaining operator `?.` with old school `&&` (fi***REMOVED***ing node 12 failures) [#812](https://github.com/motdotla/dotenv/pull/812)

## [16.4.3](https://github.com/motdotla/dotenv/compare/v16.4.2...v16.4.3) (2024-02-12)

### Changed

- Fi***REMOVED***ed processing of multiple files in `options.path` [#805](https://github.com/motdotla/dotenv/pull/805)

## [16.4.2](https://github.com/motdotla/dotenv/compare/v16.4.1...v16.4.2) (2024-02-10)

### Changed

- Changed funding link in package.json to [`dotenv***REMOVED***.com`](https://dotenv***REMOVED***.com)
...
- Fi***REMOVED*** output typing for `populate` [#792](https://github.com/motdotla/dotenv/pull/792)
...
- E***REMOVED***posed private function `_configDotenv` as `configDotenv`. [#744](https://github.com/motdotla/dotenv/pull/744)
...
- Fi***REMOVED***ed `{crypto: false}` in `packageJson.browser`
...
ℹ️ `.env.vault` e***REMOVED***tends the `.env` file format standard with a localized encrypted vault file. Package it securely with your production code deploys. It's cloud agnostic so that you can deploy your secrets anywhere – without [risky third-party integrations](https://techcrunch.com/2023/01/05/circleci-breach/). [read more](https://github.com/motdotla/dotenv#-deploying)

### Changed

- Fi***REMOVED***ed "cannot resolve 'fs'" error on tools like Replit [#693](https://github.com/motdotla/dotenv/pull/693)
...
- E***REMOVED***port `env-options.js` and `cli-options.js` in package.json for use with downstream [dotenv-e***REMOVED***pand](https://github.com/motdotla/dotenv-e***REMOVED***pand) module
...
- _Breaking:_ `#` marks the beginning of a comment (UNLESS the value is wrapped in quotes. Please update your `.env` files to wrap in quotes any values containing `#`. For e***REMOVED***ample: `SECRET_HASH="something-with-a-#-hash"`).
...
- _Breaking:_ Remove multiline option (just works out of the bo***REMOVED*** now. no need for the flag.)
...
- Preserve backwards compatibility on e***REMOVED***ports by re-introducing the prior in-place e***REMOVED***ports 🐞 ([#606](https://github.com/motdotla/dotenv/pull/606))
...
- Move types/inde***REMOVED***.d.ts to lib/main.d.ts ([#585](https://github.com/motdotla/dotenv/pull/585))
- Typescript cleanup ([#587](https://github.com/motdotla/dotenv/pull/587))
- E***REMOVED***plicit typescript inclusion in package.json ([#566](https://github.com/motdotla/dotenv/pull/566))
...
- define package.json in e***REMOVED***ports
...
- point to e***REMOVED***act types file to work with VS Code
...
- Fi***REMOVED*** removing unbalanced quotes ([#376](https://github.com/motdotla/dotenv/pull/376))
...
- LICENSE to be more e***REMOVED***plicit about what was defined in `package.json`. Linked to from README
- Testing nodejs v4 on travis-ci
- added e***REMOVED***amples of how to use dotenv in different ways
...
- Variable e***REMOVED***pansion and escaping so environment variables are encouraged to be fully orthogonal
