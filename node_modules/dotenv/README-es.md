...
<a href="https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=dotenv_p_20220831">
  ...
  <div>
    <sup>Haga más en la CLI con edición de te***REMOVED***to real, resultado básado en bloques, y busqueda de comandos de IA.</sup>
  </div>
</a>
<br>
<a href="https://retool.com/?utm_source=sponsor&utm_campaign=dotenv">
  ...
  <div>
    <sup>Construya Interfaces de Usuario de forma visual con componentes fle***REMOVED***ibles, conéctese a cualquier fuente de datos, y escriba lógica de negocio en JavaScript.</sup>
  </div>
</a>
<br>
...
Los comentarios comienzan donde e***REMOVED***iste un `#`, entonces, si su valor contiene un `#`, enciérrelo entre comillas. Este es un cambio importante desde la versión `>= v15.0.0` en adelante.
...
### E***REMOVED***pansión Variable

Necesitaras agregar el valor de otro variable en una de sus variables? Usa [dotenv-e***REMOVED***pand](https://github.com/motdotla/dotenv-e***REMOVED***pand).
...
Vea [ejemplos](https://github.com/dotenv-org/e***REMOVED***amples) sobre el uso de dotenv con varios frameworks, lenguajes y configuraciones.

* [nodejs](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-nodejs)
* [nodejs (depurar en)](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-nodejs-debug)
* [nodejs (anular en)](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-nodejs-override)
* [esm](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-esm)
* [esm (precarga)](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-esm-preload)
* [typescript](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-typescript)
* [typescript parse](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-typescript-parse)
* [typescript config](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-typescript-config)
* [webpack](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-webpack)
* [webpack (plugin)](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-webpack2)
* [react](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-react)
* [react (typescript)](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-react-typescript)
* [e***REMOVED***press](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-e***REMOVED***press)
* [nestjs](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-nestjs)

## Documentación

Dotenv e***REMOVED***pone dos funciones:
...
- los espacios en blanco se eliminan de ambos e***REMOVED***tremos de los valores no citanos (aprende más en [`trim`](https://developer.mozilla.org/es/docs/Web/JavaScript/Reference/Global_Objects/String/Trim)) (`FOO=  algo ` se convierte en `{FOO: 'algo'}`)
- los valores entre comillas simples y dobles se escapan (`CITA_SIMPLE='citado'` se convierte en `{CITA_SIMPLE: "citado"}`)
- los valores entre comillas simples y dobles mantienen los espacios en blanco en ambos e***REMOVED***tremos  (`FOO="  algo  "` se convierte en `{FOO: '  algo  '}`)
- los valores entre comillas dobles e***REMOVED***panden nuevas líneas (`MULTILINEA="nueva\nlínea"` se convierte en
...
Por defecto, nunca modificaremos ninguna variable de entorno que ya haya sido establecida. En particular, si hay una variable en su archivo `.env` que colisiona con una que ya e***REMOVED***iste en su entorno, entonces esa variable se omitirá.
...
Si estás utilizando otros frameworks (por ejemplo, Ne***REMOVED***t.js, Gatsby...), debes consultar su documentación para saber cómo injectar variables de entorno en el cliente.
...
variableE***REMOVED***pansion(miEnv)
```
...
e***REMOVED***port default new Client(process.env.CLAVE_API)
...
¿Esto tiene algo de sentido? Esto es poco poco intuitivo, pero es como funciona la importación de módulos en ES6. Aquí hay un ejemplo [ejemplo práctico de esta trampa](https://github.com/dotenv-org/e***REMOVED***amples/tree/master/dotenv-es6-import-pitfall).

E***REMOVED***isten dos arternativas a este planteamiento:

1. Precarga dotenv: `node --require dotenv/config inde***REMOVED***.js` (_Nota: no es necesario usar `import` dotenv con este método_)
...
### ¿Qué pasa con la e***REMOVED***pansión de variable?

Prueba [dotenv-e***REMOVED***pand](https://github.com/motdotla/dotenv-e***REMOVED***pand)
