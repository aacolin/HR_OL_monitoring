interface Thenable<T> {
   ...
   * @param onfulfilled The callback to e***REMOVED***ecute when the ThenPromise is resolved.
   * @param onrejected The callback to e***REMOVED***ecute when the ThenPromise is rejected.
   * @returns A ThenPromise for the completion of which ever callback is e***REMOVED***ecuted.
   */
...
interface ThenPromise<T> {
  ...
  // E***REMOVED***tensions specific to then/promise
...
interface ThenPromiseConstructor {
   ...
   * @param e***REMOVED***ecutor A callback used to initialize the promise. This callback is passed two arguments:
   * a resolve callback used resolve the promise with a value or the result of another promise,
   * and a reject callback used to reject the promise with a provided reason or error.
   */
  new <T>(e***REMOVED***ecutor: (resolve: (value?: T | Thenable<T>) => void, reject: (reason?: any) => void) => any): ThenPromise<T>;
