...
* fi***REMOVED*** file download methods `.downloadFile()`, `.downloadFirmwareBinary()`, and `.downloadProductFirmware()` [PR #112](https://github.com/particle-iot/particle-api-js/pull/112)
...
* Update to latest superagent to fi***REMOVED*** deprecation warnings in Node v12
...
## 7.2.2 - 23 Jul 2018
* Fi***REMOVED*** npm api key for publishing to registry
...
## 7.1.1 - 13 Feb 2018
* Fi***REMOVED*** country parameter for activate sim [PR #81](https://github.com/particle-iot/particle-api-js/pull/81)
...
* Fi***REMOVED*** event stream e***REMOVED***ception when it is an HTML response [PR #64](https://github.com/particle-iot/particle-api-js/pull/64). Thanks @spacetc62!
...
## 6.6.2 - 15 Sep 2017
* Fi***REMOVED*** nested directories bug
...
* Add support for sending additional conte***REMOVED***t with each call.
...
* Fi***REMOVED*** the login method content type
...
* Fi***REMOVED*** files parameter default name to be `file` and not `file1`.
...
* Handle `JSON.parse` e***REMOVED***ceptions when parsing event stream
...
* Fi***REMOVED*** named event streams by encoding event name.
...
* Fi***REMOVED*** event stream. [#8](https://github.com/particle-iot/particle-api-js/issues/8)
