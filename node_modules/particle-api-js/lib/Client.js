   ...
   */
		...
		value: function listBuildTargets() {
			return this.api.listBuildTargets({ onlyFeatured: true, auth: this.auth }).then(function (payload) {
				...
				try {
					for (var _iterator = (0, _getIterator3.default)(payload.body.targets), _step; !(_iteratorNormalCompletion = (_step = _iterator.ne***REMOVED***t()).done); _iteratorNormalCompletion = true) {
						...
						try {
							for (var _iterator2 = (0, _getIterator3.default)(target.platforms), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.ne***REMOVED***t()).done); _iteratorNormalCompletion2 = true) {
								var platform = _step2.value;

								targets.push({
									version: target.version,
									platform: platform,
									prerelease: target.prereleases.inde***REMOVED***Of(platform) > -1,
		...
		value: function trackingIdentity() {
			...
			return this.api.trackingIdentity({ full: full, conte***REMOVED***t: conte***REMOVED***t, auth: this.auth }).then(function (payload) {
				return payload.body;
			});
		}
	}]);
...
e***REMOVED***ports.default = Client;
