...
var EventStream = function (_EventEmitter) {
	...
	function EventStream(uri, token) {
		...
		_this.idleTimeoutE***REMOVED***pired = _this.idleTimeoutE***REMOVED***pired.bind(_this);
		return _this;
	}
	...
	(0, _createClass3.default)(EventStream, [{
		...
		value: function startIdleTimeout() {
			this.stopIdleTimeout();
			this.idleTimeout = setTimeout(this.idleTimeoutE***REMOVED***pired, this.timeout);
		}
	}, {
		key: 'stopIdleTimeout',
		...
		key: 'idleTimeoutE***REMOVED***pired',
		value: function idleTimeoutE***REMOVED***pired() {
			if (this.req) {
				this.req.abort();
				this.end();
			}
...
e***REMOVED***ports.default = EventStream;
