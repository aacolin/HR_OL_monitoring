...
This package e***REMOVED***ports a binary called `nodetouch` that works mostly
like the uni***REMOVED*** builtin `touch(1)`.
...
This package creates a `nodetouch` command line e***REMOVED***ecutable that works
very much like the uni***REMOVED*** builtin `touch(1)`
