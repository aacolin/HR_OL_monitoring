...
module.e***REMOVED***ports = (f, options, cb) => {
...
module.e***REMOVED***ports.sync = module.e***REMOVED***ports.touchSync = (f, options) =>
  (new TouchSync(validOpts(options, f, null)), undefined)

module.e***REMOVED***ports.ftouch = (fd, options, cb) => {
  if (typeof options === 'function')
    cb = options, options = {}
...
module.e***REMOVED***ports.ftouchSync = (fd, opt) =>
...
class Touch e***REMOVED***tends EE {
  constructor (options) {
    super(options)
    this.fd = options.fd
...
class TouchSync e***REMOVED***tends Touch {
  open () {
    try {
