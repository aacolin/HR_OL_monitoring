...
const declaresArguments = (node) => t.isFunction(node) && !t.isArrowFunctionE***REMOVED***pression(node);
...
function findGlobals(ast) {
    ...
    for (const node of globals) {
        const name = node.type === 'ThisE***REMOVED***pression' ? 'this' : node.name;
...
e***REMOVED***ports.default = findGlobals;
