...
4.0.3 / 2022-05-17
==================
 * fi***REMOVED***: allow using `comment` with `findOneAndUpdate()`, `count()`, `distinct()` and `hint` with `findOneAndUpdate()` Automattic/mongoose#11793

4.0.2 / 2022-01-23
==================
 * perf: replace rege***REMOVED***p-clone with native functionality #131 [Uzlopak](https://github.com/Uzlopak)
 ...
 * BREAKING CHANGE: upgrade to mongodb driver 4.***REMOVED***: drop support for `findAndModify()`, use native `findOneAndUpdate/Delete` #124
...
3.2.5 / 2021-03-29
==================
 * fi***REMOVED***(utils): make `mergeClone()` skip special properties like `__proto__` #121 [zpbrent](https://github.com/zpbrent)

3.2.4 / 2021-02-12
==================
 * fi***REMOVED***(utils): make clone() only copy own properties Automattic/mongoose#9876

3.2.3 / 2020-12-10
==================
 * fi***REMOVED***(utils): avoid copying special properties like `__proto__` when merging and cloning. Fi***REMOVED*** CVE-2020-35149

3.2.2 / 2019-09-22
==================
 * fi***REMOVED***: dont re-call setOptions() when pulling base class options Automattic/mongoose#8159
 ...
 * feat: add `ma***REMOVED***TimeMS()` as alias of `ma***REMOVED***Time()` #105 [Fonger](https://github.com/Fonger)
 * feat: add `collation()` helper #105 [Fonger](https://github.com/Fonger)

3.0.1 / 2018-07-02
==================
 * fi***REMOVED***: parse sort array options correctly #103 #102 [Fonger](https://github.com/Fonger)
...
2.3.3 / 2017-11-19
==================
 * fi***REMOVED***ed; catch sync errors in cursor.toArray() re: Automattic/mongoose#5812

2.3.2 / 2017-09-27
==================
 * fi***REMOVED***ed; bumped debug -> 2.6.9 re: #89

2.3.1 / 2017-05-22
==================
 * fi***REMOVED***ed; bumped debug -> 2.6.7 re: #86
...
2.2.3 / 2017-01-31
==================
 * fi***REMOVED***ed; throw correct error when passing incorrectly formatted array to sort()

2.2.2 / 2017-01-31
==================
 * fi***REMOVED***ed; allow passing maps to sort()

2.2.1 / 2017-01-29
==================
 * fi***REMOVED***ed; allow passing string to hint()
...
1.10.1 / 2016-04-26
===================
 * fi***REMOVED***ed; ensure conditions is an object before assigning #75
 ...
 * added; ability to use array synta***REMOVED*** for sort re: https://jira.mongodb.org/browse/NODE-578 #67

1.8.0 / 2016-03-01
==================
 * fi***REMOVED***ed; dont throw an error if count used with sort or select Automattic/mongoose#3914

1.7.0 / 2016-02-23
==================
 * fi***REMOVED***ed; don't treat objects with a length property as argument objects #70
 ...
 * fi***REMOVED***ed; support e***REMOVED***ec cb being called synchronously #66

1.6.1 / 2015-06-16
==================

 * fi***REMOVED***ed; do not treat $meta projection as inclusive [vkarpov15](https://github.com/vkarpov15)
 ...
 * fi***REMOVED***ed; debug output
 * fi***REMOVED***ed; allow hint usage with count #61 [trueinsider](https://github.com/trueinsider)
 ...
 * fi***REMOVED***ed; distinct assignment in toConstructor() #51 from [esco](https://github.com/esco)
 ...
 * added; support for ma***REMOVED***TimeMS #44 [yoitsro](https://github.com/yoitsro)
 * updated; devDependency (driver to 1.4.4)

0.7.0 / 2014-05-02
==================

 * fi***REMOVED***ed; pass $ma***REMOVED***Distance in $near object as described in docs #43 [vkarpov15](https://github.com/vkarpov15)
 * fi***REMOVED***ed; cloning buffers #42 [gjohnson](https://github.com/gjohnson)
 * tests; a little bit more `mongodb` agnostic #34 [refack](https://github.com/refack)

0.6.0 / 2014-04-01
==================

 * fi***REMOVED***ed; Allow $meta args in sort() so te***REMOVED***t search sorting works #37 [vkarpov15](https://github.com/vkarpov15)

0.5.3 / 2014-02-22
==================

 * fi***REMOVED***ed; cloning mongodb.Binary

0.5.2 / 2014-01-30
==================

 * fi***REMOVED***ed; cloning ObjectId constructors
 * fi***REMOVED***ed; cloning of ReadPreferences #30 [ashtuchkin](https://github.com/ashtuchkin)
 ...
 * fi***REMOVED***ed; cloning objects that have no constructor #21
 ...
 * fi***REMOVED***ed; inclusive/e***REMOVED***clusive logic
 ...
 * added; selectedE***REMOVED***clusively()

0.3.3 / 2013-11-14
==================

 * Fi***REMOVED*** Mongo DB Dependency #20 [rschmukler](https://github.com/rschmukler)
...
==================
  ...
  * fi***REMOVED***ed; update retains key order #19
...
==================
  ...
  * clone update doc before e***REMOVED***ecution
  * stricter env checks
...
==================
  ...
  * now e***REMOVED***posing mongodb e***REMOVED***port to allow for better testing [ebensing](https://github.com/ebensing)
...
==================
  ...
  * fi***REMOVED*** read preferences typo [ebensing](https://github.com/ebensing)
  * fi***REMOVED*** reference to old param name in e***REMOVED***ists() [ebensing](https://github.com/ebensing)

0.1.1 / 2013-06-24
==================

  * fi***REMOVED***ed; $intersects -> $geoIntersects #14 [ebensing](https://github.com/ebensing)
  * fi***REMOVED***ed; Retain key order when copying objects #15 [ebensing](https://github.com/ebensing)
...
==================
  ...
  * fi***REMOVED***ed; ma***REMOVED***Scan casing
  * use rege***REMOVED***p-clone
  * added; geometry/intersects support
  * support $and
  * near: do not use "radius"
  * callbacks always fire on ne***REMOVED***t turn of loop
