...
The middleware will parse the `Cookie` header on the request and e***REMOVED***pose the
...
A signed cookie is a cookie that has a value prefi***REMOVED***ed with `s:`. Signed cookies
...
the value is prefi***REMOVED***ed with `j:`. When these values are encountered, the value will
be e***REMOVED***posed as the result of `JSON.parse`. If parsing fails, the original value will
remain.
...
[ci-image]: https://badgen.net/github/checks/e***REMOVED***pressjs/cookie-parser/master?label=ci
[ci-url]: https://github.com/e***REMOVED***pressjs/cookie-parser/actions?query=workflow%3Aci
[coveralls-image]: https://badgen.net/coveralls/c/github/e***REMOVED***pressjs/cookie-parser/master
[coveralls-url]: https://coveralls.io/r/e***REMOVED***pressjs/cookie-parser?branch=master
