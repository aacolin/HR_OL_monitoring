...
Code Components e***REMOVED***tracted from this document must include MIT License te***REMOVED***t.
...
communication, as the key acquisition steps (generally) imply a fi***REMOVED***ed
...
signing algorithm.  However, it does e***REMOVED***plicitly assume that clients can send an
HTTP `Date` header.

## Authorization Header

The client is e***REMOVED***pected to send an Authorization header (as defined in RFC 2617)
with the following parameterization:

    credentials := "Signature" params
    params := 1#(keyId | algorithm | [headers] | [e***REMOVED***t] | signature)
    digitalSignature := plain-string

    keyId := "keyId" "=" <"> plain-string <">
    algorithm := "algorithm" "=" <"> plain-string <">
    headers := "headers" "=" <"> 1#headers-value <">
    e***REMOVED***t := "e***REMOVED***t" "=" <"> plain-string <">
    signature := "signature" "=" <"> plain-string <">

    headers-value := plain-string
    plain-string   = 1*( %***REMOVED***20-21 / %***REMOVED***23-5B / %***REMOVED***5D-7E )
...
OPTIONAL.  The `e***REMOVED***tensions` parameter is used to include additional information
which is covered by the request.  The content and format of the string is out of
scope for this document, and e***REMOVED***pected to be specified by implementors.
...
All requests refer to the following request (body omitted):
    ...
    Digest: SHA-256=X48E9qOokqqrvdts8nOJRJN3OWDUoyW***REMOVED***Bf7kbu9DBPE=
    Content-Length: 18
...
because of the infrastructure comple***REMOVED***ity.  Given the `header` parameterization,
a service provider is fully enabled to add nonce semantics into this scheme by
using something like an `***REMOVED***-request-nonce` header, and ensuring it is signed
...
* [RFC2616] Hyperte***REMOVED***t Transfer Protocol -- HTTP/1.1
...
to as `keyId=Test` in the following samples:
    ...
    6rPJj+CvfSC8+q28h***REMOVED***A161QFNUd13wuCTUcq0Qd2qsBe/2hFyc2DCJJg0h1L78+6
    Z4UMR7EOcpfdUE9Hf3m/hs+FUR45uBJeDK1HSFHD8bHKD6kv8FPGfJTotc+2***REMOVED***jJw
    oYi+1hqp1fIeka***REMOVED***syQIDAQAB
    -----END PUBLIC KEY-----

    -----BEGIN RSA PRIVATE KEY-----
    MIICXgIBAAKBgQDCFENGw33yGihy92pDjZQhl0C36rPJj+CvfSC8+q28h***REMOVED***A161QF
    NUd13wuCTUcq0Qd2qsBe/2hFyc2DCJJg0h1L78+6Z4UMR7EOcpfdUE9Hf3m/hs+F
    UR45uBJeDK1HSFHD8bHKD6kv8FPGfJTotc+2***REMOVED***jJwoYi+1hqp1fIeka***REMOVED***syQIDAQAB
    AoGBAJR8ZkCUv***REMOVED***5kzv+utdl7T5MnordT1TvoXXJGXK7ZZ+UuvMNUCdN2QPc4sBiA
    QWvLw1cSKt5DsKZ8UETpYPy8pPYnnDEz2dDYiaew9+***REMOVED***EpubyeW2oH4Z***REMOVED***71wqBtOK
    
    kpyUXRNvFsDE0czpJJBvL/aRFUJ***REMOVED***uRK91jhjC68sA7NsKMGg5OXb5I5Jj36***REMOVED***AkEA
    gIT7aFOYBFwGgQAQkWNKLvySgKbAZRTeLBacpHMuQdl1DfdntvAyqpAZ0lY0RKmW
    G6aFKaqQfOXKCyWoUiVknQJAXrlgySFci/2ueKlIE1QqIiLSZ8V8OlpFLRnb1pzI
    7U1yQXnTAEFYM560yJlzUpOb1V4cScGd365tiSMv***REMOVED***LOvTA==
    -----END RSA PRIVATE KEY-----

And all e***REMOVED***amples use this request:
...
<!-- authz -->
    ...
    Authorization: Signature keyId="Test",algorithm="rsa-sha256",headers="date",signature="jKyvPc***REMOVED***B4JbmYY4mByyBY7cZfNl4OW9HpFQlG7N4YcJPteKTu4MWCLyk+gIr0wDgqtLWf9NLpMAMimdfsH7FSWGfbMFSrsVTHNTk0rK3usrfFnti1d***REMOVED***sM4jl0kYJCKTGI/UWkqia***REMOVED***wNiKqGcdlEDrTcUhhsFsOIo8VhddmZTZ8w="
...
<!-- authz -->
    ...
    Authorization: Signature keyId="Test",algorithm="rsa-sha256",headers="(request-target) host date content-type digest content-length",signature="Ef7Ml***REMOVED***LXoBovhil3AlyjtBwAL9g4TN3tibLj7uuNB3CROat/9KaeQ4hW2NiJ+pZ6HQEO***REMOVED***9vYZAyi+7cmIkmJszJCut5kQLAwuX+Ms/mUFvpKlSo9StS2bMXDBNjOh4Auj774GFj4gwjS+3NhFeoqyr/MuN6HsEnkvn6zdgfE2i0="
...
Compose the signing string as usual, and pipe it into the the `openssl dgst` command, then into `openssl enc -base64`, as follows:
    ...
    $ printf 'date: Thu, 05 Jan 2014 21:31:40 GMT' | \
      ...
      openssl enc -base64
    jKyvPc***REMOVED***B4JbmYY4mByyBY7cZfNl4OW9Hp...
    $
...
To verify a signature, first save the signature data, Base64-decoded, into a file, then use `openssl dgst` again with the `-verify` option:
    ...
    $ echo 'jKyvPc***REMOVED***B4JbmYY4mByy...' | openssl enc -A -d -base64 > signature
    $ printf 'date: Thu, 05 Jan 2014 21:31:40 GMT' | \
...
You can also use `sshpk-verify` in a similar manner:
    ...
    $ printf 'date: Thu, 05 Jan 2014 21:31:40 GMT' | \
      sshpk-verify -i ./public.pem -s 'jKyvPc***REMOVED***B4JbmYY...'
    OK
    $
