...
test('inspect', function (t) {
    ...
    var obj = [{ inspect: function ***REMOVED***yzInspect() { return '!XYZ¡'; } }, []];
    var stringResult = '[ !XYZ¡, [] ]';
    var falseResult = '[ { inspect: [Function: ***REMOVED***yzInspect] }, [] ]';
...
test('ma***REMOVED***StringLength', function (t) {
    t['throws'](
        function () { inspect('', { ma***REMOVED***StringLength: -1 }); },
        TypeError,
        'ma***REMOVED***StringLength must be >= 0, or Infinity, not negative'
    );

    var str = repeat('a', 1e8);

    t.equal(
        inspect([str], { ma***REMOVED***StringLength: 10 }),
        '[ \'aaaaaaaaaa\'... 99999990 more characters ]',
        'ma***REMOVED***StringLength option limits output'
    );

    t.equal(
        inspect(['f'], { ma***REMOVED***StringLength: null }),
        '[ \'\'... 1 more character ]',
        'ma***REMOVED***StringLength option accepts `null`'
    );

    t.equal(
        inspect([str], { ma***REMOVED***StringLength: Infinity }),
        '[ \'' + str + '\' ]',
        'ma***REMOVED***StringLength option accepts ∞'
    );
...
test('inspect options', { skip: !utilInspect.custom }, function (t) {
    ...
    t.equal(
        ...
        '{ d1: [Object] }',
        'unlike nodejs inspect, customInspect will not be used once the depth is e***REMOVED***ceeded.'
    );
    t.end();
});
