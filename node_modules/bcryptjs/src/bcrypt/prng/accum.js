...
var accum = (function() {
    ...
    function init() {
        ...
        last = time;
        // use Math.random
        pool.push((Math.random() * 0***REMOVED***ffffffff)|0);
        // use current time
        pool.push(time|0);
    }
    ...
    function step() {
        ...
        var rnd = (Math.random() * 0***REMOVED***ffffffff)|0;
        if (now % 2)
    ...
    function mouseCollector(ev) {
        if (!to || pool.length >= 255)
            return;
        try {
            var ***REMOVED*** = ev.***REMOVED*** || ev.clientX || ev.offsetX || 0,
                y = ev.y || ev.clientY || ev.offsetY || 0;
            if (***REMOVED*** != 0 || y != 0)
                pool[pool.length-1] += ((***REMOVED***-mouseCollector.last[0]) ^ (y-mouseCollector.last[1])),
                addTime(),
                mouseCollector.last = [***REMOVED***,y];
        } catch (e) {}
    }
    ...
    function touchCollector(ev) {
        ...
        try {
            ...
            var ***REMOVED*** = touch.pageX || touch.clientX || 0,
                y = touch.pageY || touch.clientY || 0;
            if (***REMOVED*** != 0 || y != 0)
                pool[pool.length-1] += (***REMOVED***-touchCollector.last[0]) ^ (y-touchCollector.last[1]),
                addTime(),
                touchCollector.last = [***REMOVED***,y];
        } catch (e) {}
    }
