var path = require("path"),
    ...
    bcrypt = require(path.join(__dirname, '..', 'inde***REMOVED***.js'))/*,
    isaac = eval(
...
module.e***REMOVED***ports = {
    ...
    "encodeBase64": function(test) {
        var str = bcrypt.encodeBase64([0***REMOVED***00, 0***REMOVED***01, 0***REMOVED***02, 0***REMOVED***03, 0***REMOVED***04, 0***REMOVED***05, 0***REMOVED***06, 0***REMOVED***07, 0***REMOVED***08, 0***REMOVED***09, 0***REMOVED***0A, 0***REMOVED***0B, 0***REMOVED***0C, 0***REMOVED***0D, 0***REMOVED***0E, 0***REMOVED***0F, 0***REMOVED***10], 16);
    ...
    "decodeBase64": function(test) {
        ...
        test.deepEqual(bytes, [0***REMOVED***00, 0***REMOVED***01, 0***REMOVED***02, 0***REMOVED***03, 0***REMOVED***04, 0***REMOVED***05, 0***REMOVED***06, 0***REMOVED***07, 0***REMOVED***08, 0***REMOVED***09, 0***REMOVED***0A, 0***REMOVED***0B, 0***REMOVED***0C, 0***REMOVED***0D, 0***REMOVED***0E, 0***REMOVED***0F]);
        test.done();
    },
    ...
    "compat": {
        "quickbrown": function(test) {
            var pass = fs.readFileSync(path.join(__dirname, "quickbrown.t***REMOVED***t"))+"",
