...
test('nested', function (t) {
    ...
    t.equal(stringify(obj), '{"a":3,"b":[{"***REMOVED***":4,"y":5,"z":6},7],"c":8}');
});
...
test('cyclic (default)', function (t) {
    ...
    try {
        ...
        t.equal(e***REMOVED***.toString(), 'TypeError: Converting circular structure to JSON');
    }
});
...
test('repeated non-cyclic value', function(t) {
    ...
    var one = { ***REMOVED***: 1 };
    var two = { a: one, b: one };
    t.equal(stringify(two), '{"a":{"***REMOVED***":1},"b":{"***REMOVED***":1}}');
});

test('acyclic but with reused obj-property pointers', function (t) {
    t.plan(1);
    var ***REMOVED*** = { a: 1 };
    var y = { b: ***REMOVED***, c: ***REMOVED*** };
