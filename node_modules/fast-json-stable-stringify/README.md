...
var obj = { c: 8, b: [{z:6,y:5,***REMOVED***:4},7], a: 3 };
...
For e***REMOVED***ample, to sort on the object key names in reverse order you could write:
...
var obj = { d: 6, c: 5, b: [{z:3,y:2,***REMOVED***:1},9], a: 10 };
var s = stringify(obj, function (a, b) {
...
```
{"d":6,"c":5,"b":[{"z":3,"y":2,"***REMOVED***":1},9],"a":10}
```
...
Results:
```
fast-json-stable-stringify ***REMOVED*** 17,189 ops/sec ±1.43% (83 runs sampled)
json-stable-stringify ***REMOVED*** 13,634 ops/sec ±1.39% (85 runs sampled)
fast-stable-stringify ***REMOVED*** 20,212 ops/sec ±1.20% (84 runs sampled)
faster-stable-stringify ***REMOVED*** 15,549 ops/sec ±1.12% (84 runs sampled)
