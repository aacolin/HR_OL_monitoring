...
const rege***REMOVED***NonASCII = /[^\0-\***REMOVED***7F]/; // Note: U+007F DEL is e***REMOVED***cluded too.
...
function mapDomain(domain, callback) {
	...
	domain = domain.replace(rege***REMOVED***Separators, '\***REMOVED***2E');
...
const basicToDigit = function(codePoint) {
	if (codePoint >= 0***REMOVED***30 && codePoint < 0***REMOVED***3A) {
		return 26 + (codePoint - 0***REMOVED***30);
	}
	if (codePoint >= 0***REMOVED***41 && codePoint < 0***REMOVED***5B) {
		return codePoint - 0***REMOVED***41;
	}
	if (codePoint >= 0***REMOVED***61 && codePoint < 0***REMOVED***7B) {
...
const decode = function(input) {
	...
	for (let inde***REMOVED*** = basic > 0 ? basic + 1 : 0; inde***REMOVED*** < inputLength; /* no final e***REMOVED***pression */) {
		...
		for (let w = 1, k = base; /* no condition */; k += base) {
			...
			if (digit > floor((ma***REMOVED***Int - i) / w)) {
				error('overflow');
			}
...
e***REMOVED***port { ucs2decode, ucs2encode, decode, encode, toASCII, toUnicode };
