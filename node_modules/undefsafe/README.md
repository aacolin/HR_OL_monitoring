...
The function will only return a single result, either the 3rd argument validation value, or the first positive match. For e***REMOVED***ample, the following github data:
