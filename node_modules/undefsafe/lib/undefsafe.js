...
function undefsafe(obj, path, value, __res) {
  ...
  // it'll also be use in the browser and I wont *one* function e***REMOVED***posed
  function split(path) {
    var res = [];
    var level = 0;
    var key = '';
  ...
  for (; i < parts.length; i++) {
    ...
    if (Object.getOwnPropertyNames(obj).inde***REMOVED***Of(key) == -1) {
      return undefined;
    }
...
if (typeof module !== 'undefined') {
  module.e***REMOVED***ports = undefsafe;
}
