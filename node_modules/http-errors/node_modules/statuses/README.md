...
a few different projects:
  ...
  * The [IANA Status Code Registry](https://www.iana.org/assignments/http-status-codes/http-status-codes.***REMOVED***html)
  * The [Node.js project](https://nodejs.org/)
  * The [NGINX project](https://www.ngin***REMOVED***.com/)
...
<!-- eslint-disable no-undef, no-unused-e***REMOVED***pressions -->
...
Returns `true` if a status code e***REMOVED***pects an empty body.
