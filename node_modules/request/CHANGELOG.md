...
### v2.88.0 (2018/08/10)
- [#2996](https://github.com/request/request/pull/2996) fi***REMOVED***(uuid): import versioned uuid (@kwonoj)
- [#2994](https://github.com/request/request/pull/2994) Update to oauth-sign 0.9.0 (@dlecocq)
- [#2993](https://github.com/request/request/pull/2993) Fi***REMOVED*** header tests (@simov)
- [#2904](https://github.com/request/request/pull/2904) #515, #2894 Strip port suffi***REMOVED*** from Host header if the protocol is known. (#2904) (@paambaati)
...
### v2.84.0 (2018/03/12)
- [#2793](https://github.com/request/request/pull/2793) Fi***REMOVED***ed calculation of oauth_body_hash, issue #2792 (@dvishniakov)
- [#2880](https://github.com/request/request/pull/2880) Update hawk to 7.0.7 (#2880) (@kornel-kedzierski)

### v2.83.0 (2017/09/27)
- [#2776](https://github.com/request/request/pull/2776) Updating tough-cookie due to security fi***REMOVED***. (#2776) (@karlnorling)
...
- [#2658](https://github.com/request/request/pull/2658) Fi***REMOVED***ed some te***REMOVED***t in README.md (#2658) (@Marketionist)
...
- [#2589](https://github.com/request/request/pull/2589) fi***REMOVED*** tabulation on request e***REMOVED***ample README.MD (@odykyi)
- [#2594](https://github.com/request/request/pull/2594) chore(dependencies): har-validator to 5.***REMOVED*** [removes babel dep] (@ahmadnassri)
...
- [#2566](https://github.com/request/request/pull/2566) Timings: Tracks 'lookup', adds 'wait' time, fi***REMOVED***es connection re-use (#2566) (@nicjansma)
- [#2574](https://github.com/request/request/pull/2574) Migrating to safe-buffer for improved security. (@mikeal)
- [#2573](https://github.com/request/request/pull/2573) fi***REMOVED***es #2572 (@ahmadnassri)

### v2.80.0 (2017/03/04)
- [#2571](https://github.com/request/request/pull/2571) Correctly format the Host header for IPv6 addresses (@JamesMGreene)
- [#2558](https://github.com/request/request/pull/2558) Update README.md e***REMOVED***ample snippet (@FredKSchott)
...
- [#2460](https://github.com/request/request/pull/2460) Fi***REMOVED*** wrong MIME type in e***REMOVED***ample (@OwnageIsMagic)
- [#2514](https://github.com/request/request/pull/2514) Change tags to keywords in package.json (@humphd)
- [#2492](https://github.com/request/request/pull/2492) More lenient gzip decompression (@addalea***REMOVED***)

### v2.79.0 (2016/11/18)
- [#2368](https://github.com/request/request/pull/2368) Fi***REMOVED*** typeof check in test-pool.js (@forivall)
...
- [#2448](https://github.com/request/request/pull/2448) Make other connect timeout test more reliable too (@mscde***REMOVED***)

### v2.78.0 (2016/11/03)
- [#2447](https://github.com/request/request/pull/2447) Always set request timeout on keep-alive connections (@mscde***REMOVED***)

### v2.77.0 (2016/11/03)
- [#2439](https://github.com/request/request/pull/2439) Fi***REMOVED*** socket 'connect' listener handling (@mscde***REMOVED***)
...
- [#2414](https://github.com/request/request/pull/2414) Improve test-timeout reliability (@mscde***REMOVED***)

### v2.76.0 (2016/10/25)
- [#2424](https://github.com/request/request/pull/2424) Handle buffers directly instead of using "bl" (@zertosh)
- [#2415](https://github.com/request/request/pull/2415) Re-enable timeout tests on Travis + other fi***REMOVED***es (@mscde***REMOVED***)
- [#2431](https://github.com/request/request/pull/2431) Improve timeouts accuracy and node v6.8.0+ compatibility (@mscde***REMOVED***, @greenkeeperio-bot)
...
### v2.73.0 (2016/07/09)
- [#2240](https://github.com/request/request/pull/2240) Remove connectionErrorHandler to fi***REMOVED*** #1903 (@zarenner)
...
- [#2212](https://github.com/request/request/pull/2212) Fi***REMOVED*** link to http.IncomingMessage documentation (@nazieb)
...
- [#2165](https://github.com/request/request/pull/2165) Check for self.req e***REMOVED***istence inside the write method (@simov)
- [#2167](https://github.com/request/request/pull/2167) Fi***REMOVED*** TravisCI badge reference master branch (@a0viedo)
...
- [#2089](https://github.com/request/request/pull/2089) Fi***REMOVED*** badges (@simov)
...
- [#2058](https://github.com/request/request/pull/2058) Karma fi***REMOVED***es for latest versions (@eiriksm)
...
- [#2024](https://github.com/request/request/pull/2024) Update har-validator dependency for nsp advisory #76 (@TylerDi***REMOVED***on)
- [#2016](https://github.com/request/request/pull/2016) Update qs to version 6.0.2 🚀 (@greenkeeperio-bot)
- [#2007](https://github.com/request/request/pull/2007) Use the `e***REMOVED***tend` module instead of util._e***REMOVED***tend (@simov)
...
- [#1952](https://github.com/request/request/pull/1952) Adds e***REMOVED***ample for Tor pro***REMOVED***y (@prometheansacrifice)
...
- [#1915](https://github.com/request/request/pull/1915) Remove content-length and transfer-encoding headers from defaultPro***REMOVED***yHeaderWhiteList (@ya***REMOVED***ia)
...
- [#1894](https://github.com/request/request/pull/1894) Fi***REMOVED*** tunneling after redirection from https (Original: #1881) (@simov, @falms)
...
- [#1866](https://github.com/request/request/pull/1866) Add missing quotes on ***REMOVED***-token property in README (@miguelmota)
- [#1874](https://github.com/request/request/pull/1874) Fi***REMOVED*** typo in README.md (@gswalden)
...
- [#1857](https://github.com/request/request/pull/1857) Fi***REMOVED*** Referer header to point to the original host name (@simov)
...
- [#1836](https://github.com/request/request/pull/1836) Tunnel: fi***REMOVED*** wrong property name (@KoltesDigital)
...
- [#1818](https://github.com/request/request/pull/1818) E***REMOVED***tract `readResponseBody` method out of `onRequestResponse` (@pvoisin)
...
- [#1800](https://github.com/request/request/pull/1800) Add caret ranges for devDependencies, e***REMOVED***cept eslint (@simov)
...
### v2.64.0 (2015/09/25)
- [#1787](https://github.com/request/request/pull/1787) npm ignore e***REMOVED***amples, release.sh and disabled.appveyor.yml (@thisconnect)
- [#1775](https://github.com/request/request/pull/1775) Fi***REMOVED*** typo in README.md (@djchie)
...
- [#1767](https://github.com/request/request/pull/1767) Query strings now cooperate with uni***REMOVED*** sockets (@JoshWillik)
...
- [#1743](https://github.com/request/request/pull/1743) Fi***REMOVED*** options not being initialized in defaults method (@simov)

### v2.61.0 (2015/08/19)
- [#1721](https://github.com/request/request/pull/1721) Minor fi***REMOVED*** in README.md (@arbaaz)
...
- [#1715](https://github.com/request/request/pull/1715) Fi***REMOVED*** forever option in node > 0.10 #1709 (@calibr)
...
- [#1712](https://github.com/request/request/pull/1712) Set certificate e***REMOVED***piration to August 2, 2018 (@kevinburke)
- [#1700](https://github.com/request/request/pull/1700) debug() when JSON.parse() on a response body fails (@phillipj)

### v2.60.0 (2015/07/21)
- [#1687](https://github.com/request/request/pull/1687) Fi***REMOVED*** caseless bug - content-type not being set for multipart/form-data (@simov, @garymathews)
...
- [#1679](https://github.com/request/request/pull/1679) Fi***REMOVED*** - do not remove OAuth param when using OAuth realm (@simov, @jhalickman)
- [#1668](https://github.com/request/request/pull/1668) updated dependencies (@deamme)
- [#1656](https://github.com/request/request/pull/1656) Fi***REMOVED*** form method (@simov)
- [#1651](https://github.com/request/request/pull/1651) Preserve HEAD method when using followAllRedirects (@simov)
- [#1652](https://github.com/request/request/pull/1652) Update `encoding` option documentation in README.md (@daniel347***REMOVED***)
...
### v2.58.0 (2015/06/16)
- [#1638](https://github.com/request/request/pull/1638) Use the `e***REMOVED***tend` module to deep e***REMOVED***tend in the defaults method (@simov)
- [#1631](https://github.com/request/request/pull/1631) Move tunnel logic into separate module (@simov)
- [#1634](https://github.com/request/request/pull/1634) Fi***REMOVED*** OAuth query transport_method (@simov)
...
- [#1600](https://github.com/request/request/pull/1600) E***REMOVED***tract the querystring logic into separate module (@simov)
- [#1607](https://github.com/request/request/pull/1607) Re-generate certificates (@simov)
- [#1599](https://github.com/request/request/pull/1599) Move getPro***REMOVED***yFromURI logic below the check for Invaild URI (#1595) (@simov)
- [#1598](https://github.com/request/request/pull/1598) Fi***REMOVED*** the way http verbs are defined in order to please intellisense IDEs (@simov, @flannelJesus)
- [#1591](https://github.com/request/request/pull/1591) A few minor fi***REMOVED***es: (@simov)
- [#1584](https://github.com/request/request/pull/1584) Refactor test-default tests (according to comments in #1430) (@simov)
- [#1585](https://github.com/request/request/pull/1585) Fi***REMOVED***ing documentation regarding TLS options (#1583) (@mainakae)
...
- [#1569](https://github.com/request/request/pull/1569) Fi***REMOVED*** pause before response arrives (@kevinoid)
- [#1558](https://github.com/request/request/pull/1558) Emit error instead of throw (@simov)
- [#1568](https://github.com/request/request/pull/1568) Fi***REMOVED*** stall when piping gzipped response (@kevinoid)
...
- [#1541](https://github.com/request/request/pull/1541) Fi***REMOVED*** coveralls (@simov)
- [#1540](https://github.com/request/request/pull/1540) Fi***REMOVED*** recursive defaults for convenience methods (@simov)
...
- [#1518](https://github.com/request/request/pull/1518) Fi***REMOVED*** defaults (@simov)
- [#1515](https://github.com/request/request/pull/1515) Allow static invoking of convenience methods (@simov)
- [#1505](https://github.com/request/request/pull/1505) Fi***REMOVED*** multipart boundary e***REMOVED***traction rege***REMOVED***p (@simov)
- [#1510](https://github.com/request/request/pull/1510) Fi***REMOVED*** basic auth form data (@simov)
...
- [#1481](https://github.com/request/request/pull/1481) Fi***REMOVED*** baseUrl and redirections. (@burningtree)
...
- [#1442](https://github.com/request/request/pull/1442) Fi***REMOVED***ed the issue with strictSSL tests on  0.12 & io.js by e***REMOVED***plicitly setting a cipher that matches the cert. (@BBB, @nickmccurdy, @demohi, @simov, @0***REMOVED***4139)
- [#1460](https://github.com/request/request/pull/1460) localAddress or pro***REMOVED***y config is lost when redirecting (@simov, @0***REMOVED***4139)
- [#1453](https://github.com/request/request/pull/1453) Test on Node.js 0.12 and io.js with allowed failures (@nickmccurdy, @demohi)
- [#1426](https://github.com/request/request/pull/1426) Fi***REMOVED***ing tests to pass on io.js and node 0.12 (only test-https.js stiff failing) (@mikeal)
- [#1446](https://github.com/request/request/pull/1446) Missing HTTP referer header with redirects Fi***REMOVED***es #1038 (@simov, @guimon)
- [#1428](https://github.com/request/request/pull/1428) Deprecate Node v0.8.***REMOVED*** (@nylen)
...
- [#1430](https://github.com/request/request/pull/1430) Fi***REMOVED*** recursive requester (@tikotzky)
- [#1429](https://github.com/request/request/pull/1429) Throw error when making HEAD request with a body (@tikotzky)
- [#1419](https://github.com/request/request/pull/1419) Add note that the project is broken in 0.12.***REMOVED*** (@nylen)
- [#1413](https://github.com/request/request/pull/1413) Fi***REMOVED*** basic auth (@simov)
...
- [#1374](https://github.com/request/request/pull/1374) Allow e***REMOVED***plicitly disabling tunneling for pro***REMOVED***ied https destinations (@nylen)
...
- [#1346](https://github.com/request/request/pull/1346) getPro***REMOVED***yFromURI E***REMOVED***traction Refactor (@seanstrom)
...
- [#1335](https://github.com/request/request/pull/1335) Add support for OAuth plainte***REMOVED***t signature method (@simov)
- [#1332](https://github.com/request/request/pull/1332) Add clean script to remove test-browser.js after the tests run (@seanstrom)
- [#1327](https://github.com/request/request/pull/1327) Fi***REMOVED*** errors generating coverage reports. (@nylen)
...
- [#1315](https://github.com/request/request/pull/1315) Implement rfc3986 option (@simov, @nylen, @apoco, @DullReferenceE***REMOVED***ception, @mmalecki, @oliamb, @cliffcrosland, @LewisJEllis, @eiriksm, @poislagarde)
- [#1314](https://github.com/request/request/pull/1314) Detect urlencoded form data header via rege***REMOVED*** (@simov)
- [#1317](https://github.com/request/request/pull/1317) Improve OAuth1.0 server side flow e***REMOVED***ample (@simov)
...
- [#1307](https://github.com/request/request/pull/1307) Upgrade form-data, add back browserify compability. Fi***REMOVED***es #455. (@eiriksm)
- [#1305](https://github.com/request/request/pull/1305) Fi***REMOVED*** typo in README.md (@LewisJEllis)
- [#1288](https://github.com/request/request/pull/1288) Update README.md to e***REMOVED***plain custom file use case (@cliffcrosland)

### v2.49.0 (2014/11/28)
- [#1295](https://github.com/request/request/pull/1295) fi***REMOVED***(pro***REMOVED***y): no-pro***REMOVED***y false positive (@oliamb)
...
- [#1275](https://github.com/request/request/pull/1275) Fi***REMOVED*** multipart content-type headers detection (@simov)
- [#1269](https://github.com/request/request/pull/1269) adds streams e***REMOVED***ample for review (@tbuchok)
- [#1238](https://github.com/request/request/pull/1238) Add e***REMOVED***amples README.md (@simov)

### v2.48.0 (2014/11/12)
- [#1263](https://github.com/request/request/pull/1263) Fi***REMOVED***ed a synta***REMOVED*** error / typo in README.md (@***REMOVED***na2)
...
- [#1250](https://github.com/request/request/pull/1250) Improve documentation for pool and ma***REMOVED***Sockets options (@nylen)
...
- [#1241](https://github.com/request/request/pull/1241) Fi***REMOVED*** typo (@ale***REMOVED***anderGugel)
...
- [#1216](https://github.com/request/request/pull/1216) Made json and multipart options coe***REMOVED***ist (@nylen, @simov)
- [#1225](https://github.com/request/request/pull/1225) Allow header white/e***REMOVED***clusive lists in any case. (@RReverser)
...
- [#1215](https://github.com/request/request/pull/1215) Add pro***REMOVED***yHeaderE***REMOVED***clusiveList option for pro***REMOVED***y-only headers. (@RReverser)
...
- [#1199](https://github.com/request/request/pull/1199) Fi***REMOVED*** lint error: undeclared var i (@nylen)
- [#1191](https://github.com/request/request/pull/1191) Move self.pro***REMOVED***y decision logic out of init and into a helper (@FredKSchott)
- [#1190](https://github.com/request/request/pull/1190) Move _buildRequest() logic back into init (@FredKSchott)
- [#1186](https://github.com/request/request/pull/1186) Support Smarter Uni***REMOVED*** URL Scheme (@FredKSchott)
- [#1178](https://github.com/request/request/pull/1178) update form documentation for new usage (@FredKSchott)
- [#1180](https://github.com/request/request/pull/1180) Enable no-mi***REMOVED***ed-requires linting rule (@nylen)
...
- [#1174](https://github.com/request/request/pull/1174) update the request.cookie docs to have a valid cookie e***REMOVED***ample (@seanstrom)
- [#1168](https://github.com/request/request/pull/1168) create a detach helper and use detach helper in replace of ne***REMOVED***tTick (@seanstrom)
- [#1171](https://github.com/request/request/pull/1171) in post can send form data and use callback (@MiroRadenovic)
- [#1159](https://github.com/request/request/pull/1159) accept charset for ***REMOVED***-www-form-urlencoded content-type (@seanstrom)
...
- [#1161](https://github.com/request/request/pull/1161) fi***REMOVED*** no-use-before-define lint warnings (@emkay)
- [#1156](https://github.com/request/request/pull/1156) adding curly brackets to get rid of lint errors (@emkay)
- [#1151](https://github.com/request/request/pull/1151) Fi***REMOVED*** localAddress test on OS X (@nylen)
- [#1145](https://github.com/request/request/pull/1145) documentation: fi***REMOVED*** outdated reference to setCookieSync old name in README (@FredKSchott)
...
- [#1134](https://github.com/request/request/pull/1134) Fi***REMOVED*** multiple redirects and `self.followRedirect` (@blakeembrey)
- [#1130](https://github.com/request/request/pull/1130) documentation fi***REMOVED***: add note about npm test for contributing (@FredKSchott)
- [#1120](https://github.com/request/request/pull/1120) Support/refactor request setup tunnel (@seanstrom)
- [#1129](https://github.com/request/request/pull/1129) linting fi***REMOVED***: convert double quote strings to use single quotes (@FredKSchott)
- [#1124](https://github.com/request/request/pull/1124) linting fi***REMOVED***: remove unneccesary semi-colons (@FredKSchott)
...
- [#1121](https://github.com/request/request/pull/1121) Revert "E***REMOVED***plicitly use sync versions of cookie functions" (@nylen)
- [#1118](https://github.com/request/request/pull/1118) linting fi***REMOVED***: Restructure bad empty if statement (@FredKSchott)
- [#1117](https://github.com/request/request/pull/1117) Fi***REMOVED*** a bad check for valid URIs (@FredKSchott)
- [#1113](https://github.com/request/request/pull/1113) linting fi***REMOVED***: space out operators (@FredKSchott)
- [#1116](https://github.com/request/request/pull/1116) Fi***REMOVED*** typo in `noPro***REMOVED***yHost` definition (@FredKSchott)
- [#1114](https://github.com/request/request/pull/1114) linting fi***REMOVED***: Added a `new` operator that was missing when creating and throwing a new error (@FredKSchott)
- [#1096](https://github.com/request/request/pull/1096) No_pro***REMOVED***y support (@samcday)
- [#1107](https://github.com/request/request/pull/1107) linting-fi***REMOVED***: remove unused variables (@FredKSchott)
- [#1112](https://github.com/request/request/pull/1112) linting fi***REMOVED***: Make return values consistent and more straitforward (@FredKSchott)
- [#1111](https://github.com/request/request/pull/1111) linting fi***REMOVED***: authPieces was getting redeclared (@FredKSchott)
- [#1105](https://github.com/request/request/pull/1105) Use strict mode in request (@FredKSchott)
- [#1110](https://github.com/request/request/pull/1110) linting fi***REMOVED***: replace lazy '==' with more strict '===' (@FredKSchott)
- [#1109](https://github.com/request/request/pull/1109) linting fi***REMOVED***: remove function call from if-else conditional statement (@FredKSchott)
- [#1102](https://github.com/request/request/pull/1102) Fi***REMOVED*** to allow setting a `requester` on recursive calls to `request.defaults` (@tikotzky)
...
- [#1088](https://github.com/request/request/pull/1088) Fi***REMOVED*** cookie e***REMOVED***ample in README.md and make it more clear (@pipi32167)
...
- [#1031](https://github.com/request/request/pull/1031) E***REMOVED***plicitly use sync versions of cookie functions (@ZJONSSON)
- [#1056](https://github.com/request/request/pull/1056) Fi***REMOVED*** redirects when passing url.parse(***REMOVED***) as URL to convenience method (@nylen)

### v2.42.0 (2014/09/04)
- [#1053](https://github.com/request/request/pull/1053) Fi***REMOVED*** #1051 Parse auth properly when using non-tunneling pro***REMOVED***y (@isaacs)

### v2.41.0 (2014/09/04)
- [#1050](https://github.com/request/request/pull/1050) Pass whitelisted headers to tunneling pro***REMOVED***y.  Organize all tunneling logic. (@isaacs, @Feldhacker)
- [#1035](https://github.com/request/request/pull/1035) souped up nodei.co badge (@rvagg)
- [#1048](https://github.com/request/request/pull/1048) Aws is now possible over a pro***REMOVED***y (@steven-aerts)
- [#1039](https://github.com/request/request/pull/1039) e***REMOVED***tract out helper functions to a helper file (@seanstrom)
- [#1021](https://github.com/request/request/pull/1021) Support/refactor inde***REMOVED***js (@seanstrom)
- [#1033](https://github.com/request/request/pull/1033) Improve and document debug options (@nylen)
- [#1034](https://github.com/request/request/pull/1034) Fi***REMOVED*** readme headings (@nylen)
- [#1030](https://github.com/request/request/pull/1030) Allow recursive request.defaults (@tikotzky)
- [#1029](https://github.com/request/request/pull/1029) Fi***REMOVED*** a couple of typos (@nylen)
...
- [#1025](https://github.com/request/request/pull/1025) [fi***REMOVED***es #1023] Set self._ended to true once response has ended (@mridgway)
...
- [#1018](https://github.com/request/request/pull/1018) Remove pre-0.4.4 HTTPS fi***REMOVED*** (@mmalecki)
- [#1006](https://github.com/request/request/pull/1006) Migrate to caseless, fi***REMOVED***es #1001 (@mikeal)
- [#995](https://github.com/request/request/pull/995) Fi***REMOVED*** parsing array of objects (@sjonnet19)
- [#999](https://github.com/request/request/pull/999) Fi***REMOVED*** fallback for browserify for optional modules. (@eiriksm)
- [#996](https://github.com/request/request/pull/996) Wrong oauth signature when multiple same param keys e***REMOVED***ist [updated] (@bengl)

### v2.40.0 (2014/08/06)
- [#992](https://github.com/request/request/pull/992) Fi***REMOVED*** security vulnerability. Update qs (@poeticninja)
...
### v2.38.0 (2014/07/22)
- [#952](https://github.com/request/request/pull/952) Adding support to client certificate with pro***REMOVED***y use case (@ofirshaked)
- [#884](https://github.com/request/request/pull/884) Documented tough-cookie installation. (@wbyoung)
- [#935](https://github.com/request/request/pull/935) Correct repository url (@frit***REMOVED***)
...
- [#844](https://github.com/request/request/pull/844) Add support for HTTP[S]_PROXY environment variables.  Fi***REMOVED***es #595. (@jvmccarthy)
...
- [#955](https://github.com/request/request/pull/955) check for content-length header before setting it in ne***REMOVED***tTick (@camilleanne)
...
### v2.35.0 (2014/05/17)
- [#901](https://github.com/request/request/pull/901) Fi***REMOVED***es #555 (@pigulla)
- [#897](https://github.com/request/request/pull/897) merge with default options (@vohof)
- [#891](https://github.com/request/request/pull/891) fi***REMOVED***es 857 - options object is mutated by calling request (@lalitkapoor)
- [#869](https://github.com/request/request/pull/869) Pipefilter test (@tgohn)
- [#866](https://github.com/request/request/pull/866) Fi***REMOVED*** typo (@dandv)
- [#861](https://github.com/request/request/pull/861) Add support for RFC 6750 Bearer Tokens (@phedny)
- [#809](https://github.com/request/request/pull/809) upgrade tunnel-pro***REMOVED***y to 0.4.0 (@ksato9700)
- [#850](https://github.com/request/request/pull/850) Fi***REMOVED*** word consistency in readme (@0***REMOVED***Nobody)
- [#810](https://github.com/request/request/pull/810) add some e***REMOVED***position to mpu e***REMOVED***ample in README.md (@mikermcneil)
...
- [#745](https://github.com/request/request/pull/745) updating setCookie e***REMOVED***ample to make it clear that the callback is required (@emkay)
- [#742](https://github.com/request/request/pull/742) Add note about JSON output body type (@ianslt***REMOVED***)
- [#741](https://github.com/request/request/pull/741) README e***REMOVED***ample is using old cookie jar api (@emkay)
- [#736](https://github.com/request/request/pull/736) Fi***REMOVED*** callback arguments documentation (@mmalecki)
...
- [#728](https://github.com/request/request/pull/728) Fi***REMOVED*** TypeError when calling request.cookie (@scarletmeow)
- [#727](https://github.com/request/request/pull/727) fi***REMOVED*** requester bug (@jchris)
- [#724](https://github.com/request/request/pull/724) README.md: add custom HTTP Headers e***REMOVED***ample. (@tcort)
...
- [#710](https://github.com/request/request/pull/710) Fi***REMOVED***ing listing in callback part of docs. (@lukasz-zak)
...
- [#674](https://github.com/request/request/pull/674) change cookie module,to tough-cookie.please check it . (@s***REMOVED***yizhiren)
...
- [#662](https://github.com/request/request/pull/662) option.tunnel to e***REMOVED***plicitly disable tunneling (@seanmonstar)
- [#659](https://github.com/request/request/pull/659) fi***REMOVED*** failure when running with NODE_DEBUG=request, and a test for that (@jrgm)
...
- [#613](https://github.com/request/request/pull/613) Fi***REMOVED***es #583, moved initialization of self.uri.pathname (@le***REMOVED***ander)
- [#605](https://github.com/request/request/pull/605) Only include ":" + pass in Basic Auth if it's defined (fi***REMOVED***es #602) (@bendrucker)
...
- [#601](https://github.com/request/request/pull/601) Fi***REMOVED***ed a small typo (@michalstanko)
...
- [#581](https://github.com/request/request/pull/581) Fi***REMOVED*** spelling of "ignoring." (@bigeasy)
- [#568](https://github.com/request/request/pull/568) use agentOptions to create agent when specified in request (@SamPlacette)
- [#564](https://github.com/request/request/pull/564) Fi***REMOVED*** redirections (@criloz)
- [#541](https://github.com/request/request/pull/541) The e***REMOVED***ported request function doesn't have an auth method (@tschaub)
- [#542](https://github.com/request/request/pull/542) E***REMOVED***pose Request class (@regality)
- [#536](https://github.com/request/request/pull/536) Allow e***REMOVED***plicitly empty user field for basic authentication. (@mikeando)
- [#532](https://github.com/request/request/pull/532) fi***REMOVED*** typo (@fredericosilva)
- [#497](https://github.com/request/request/pull/497) Added redirect event (@Cauldrath)
- [#503](https://github.com/request/request/pull/503) Fi***REMOVED*** basic auth for passwords that contain colons (@tonistiigi)
...
- [#520](https://github.com/request/request/pull/520) Fi***REMOVED***ing test-tunnel.js (@noway)
...
- [#502](https://github.com/request/request/pull/502) Fi***REMOVED*** POST (and probably other) requests that are retried after 401 Unauthorized (@nylen)
- [#508](https://github.com/request/request/pull/508) Honor the .strictSSL option when using pro***REMOVED***ies (tunnel-agent) (@jhs)
...
- [#479](https://github.com/request/request/pull/479) Changing so if Accept header is e***REMOVED***plicitly set, sending json does not ov... (@RoryH)
...
- [#310](https://github.com/request/request/pull/310) Twitter Oauth Stuff Out of Date; Now Updated (@joemccann, @isaacs, @mscde***REMOVED***)
...
- [#415](https://github.com/request/request/pull/415) Fi***REMOVED***ed a typo. (@jerem)
...
- [#381](https://github.com/request/request/pull/381) Resolving "Invalid signature. E***REMOVED***pected signature base string: " (@landeiro)
- [#380](https://github.com/request/request/pull/380) Fi***REMOVED***es missing host header on retried request when using forever agent (@mac-)
- [#376](https://github.com/request/request/pull/376) Headers lost on redirect (@kapetan)
- [#375](https://github.com/request/request/pull/375) Fi***REMOVED*** for missing oauth_timestamp parameter (@jplock)
- [#374](https://github.com/request/request/pull/374) Correct Host header for pro***REMOVED***y tunnel CONNECT (@youurayy)
- [#370](https://github.com/request/request/pull/370) Twitter reverse auth uses ***REMOVED***_auth_mode not ***REMOVED***_auth_type (@drudge)
- [#369](https://github.com/request/request/pull/369) Don't remove ***REMOVED***_auth_mode for Twitter reverse auth (@drudge)
...
- [#332](https://github.com/request/request/pull/332) Fi***REMOVED*** #296 - Only set Content-Type if body e***REMOVED***ists (@Marsup)
...
- [#322](https://github.com/request/request/pull/322) Fi***REMOVED*** + test for piped into request bumped into redirect. #321 (@ale***REMOVED***indigo)
...
- [#293](https://github.com/request/request/pull/293) Allow parser errors to bubble up to request (@mscde***REMOVED***)
...
- [#207](https://github.com/request/request/pull/207) Fi***REMOVED*** #206 Change HTTP/HTTPS agent when redirecting between protocols (@isaacs)
...
- [#279](https://github.com/request/request/pull/279) fi***REMOVED*** tests with boundary by injecting boundry from header (@benatkin)
...
- [#265](https://github.com/request/request/pull/265) uncaughtE***REMOVED***ception when redirected to invalid URI (@naholyr)
...
- [#249](https://github.com/request/request/pull/249) Fi***REMOVED*** for the fi***REMOVED*** of your (closed) issue #89 where self.headers[content-length] is set to 0 for all methods (@sethbridges, @polotek, @zephra***REMOVED***, @jeromegn)
- [#255](https://github.com/request/request/pull/255) multipart allow body === '' ( the empty string ) (@Filirom1)
- [#260](https://github.com/request/request/pull/260) fi***REMOVED***ed just another leak of 'i' (@sreuter)
- [#246](https://github.com/request/request/pull/246) Fi***REMOVED***ing the set-cookie header (@jeromegn)
- [#243](https://github.com/request/request/pull/243) Dynamic boundary (@zephra***REMOVED***)
...
- [#203](https://github.com/request/request/pull/203) Fi***REMOVED*** cookie and redirect bugs and add auth support for HTTPS tunnel (@vpulim)
- [#199](https://github.com/request/request/pull/199) Tunnel (@isaacs)
- [#198](https://github.com/request/request/pull/198) Bugfi***REMOVED*** on forever usage of util.inherits (@isaacs)
- [#197](https://github.com/request/request/pull/197) Make ForeverAgent work with HTTPS (@isaacs)
- [#193](https://github.com/request/request/pull/193) Fi***REMOVED***es GH-119 (@goatslacker)
...
- [#182](https://github.com/request/request/pull/182) Fi***REMOVED*** request.defaults to support (uri, options, callback) api (@twilson63)
...
- [#179](https://github.com/request/request/pull/179) fi***REMOVED*** to add opts in .pipe(stream, opts) (@substack)
...
- [#168](https://github.com/request/request/pull/168) Picking off an EasyFi***REMOVED*** by adding some missing mimetypes. (@serby)
- [#161](https://github.com/request/request/pull/161) Fi***REMOVED*** cookie jar/headers.cookie collision (#125) (@papandreou)
- [#162](https://github.com/request/request/pull/162) Fi***REMOVED*** issue #159 (@dpetukhov)
...
- [#133](https://github.com/request/request/pull/133) Fi***REMOVED***ed cookies parsing (@afanasy)
...
- [#105](https://github.com/request/request/pull/105) added test for pro***REMOVED***y option. (@dominictarr)
- [#102](https://github.com/request/request/pull/102) Implemented cookies - closes issue 82: https://github.com/mikeal/request/issues/82 (@alessioale***REMOVED***)
...
- [#73](https://github.com/request/request/pull/73) Fi***REMOVED*** #71 Respect the strictSSL flag (@isaacs)
- [#69](https://github.com/request/request/pull/69) Flatten chunked requests properly (@isaacs)
- [#67](https://github.com/request/request/pull/67) fi***REMOVED***ed global variable leaks (@aheckmann)
...
- [#35](https://github.com/request/request/pull/35) The "end" event isn't emitted for some responses (@vo***REMOVED***pelli)
