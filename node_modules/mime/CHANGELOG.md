...
## v2.0.4 (24/11/2017)
- [**closed**] Switch to mime-score module for resolving e***REMOVED***tension contention issues. [#182](https://github.com/broofa/node-mime/issues/182)
- [**closed**] Update mime-db to 1.31.0 in v1.***REMOVED*** branch [#181](https://github.com/broofa/node-mime/issues/181)
...
- [**closed**] Vulnerable Regular E***REMOVED***pression [#167](https://github.com/broofa/node-mime/issues/167)
...
- [**closed**] The e***REMOVED***tension for video/quicktime should map to .mov, not .qt [#164](https://github.com/broofa/node-mime/issues/164)
- [**V2**] [v2 Feedback request] Mime class API [#163](https://github.com/broofa/node-mime/issues/163)
- [**V2**] [v2 Feedback request] Resolving conflicts over e***REMOVED***tensions [#162](https://github.com/broofa/node-mime/issues/162)
- [**V2**] Allow callers to load module with official, full, or no defined types.  [#161](https://github.com/broofa/node-mime/issues/161)
- [**V2**] Use "facets" to resolve e***REMOVED***tension conflicts [#160](https://github.com/broofa/node-mime/issues/160)
...
- [**V2**] E***REMOVED***tensionless paths should return null or false [#113](https://github.com/broofa/node-mime/issues/113)
...
- [**closed**] Help understanding change from application/***REMOVED***ml to te***REMOVED***t/***REMOVED***ml [#158](https://github.com/broofa/node-mime/issues/158)
...
- [**V2**] .wav files show up as "audio/***REMOVED***-wav" instead of "audio/***REMOVED***-wave" [#118](https://github.com/broofa/node-mime/issues/118)
...
- [**closed**] mime.e***REMOVED***tension() fails if the content-type is parameterized [#74](https://github.com/broofa/node-mime/issues/74)

---

## v1.3.6 (11/05/2017)
- [**closed**] .md should be te***REMOVED***t/markdown as of March 2016 [#154](https://github.com/broofa/node-mime/issues/154)
...
- [**closed**] Dynamic adaptive streaming over HTTP (DASH) file e***REMOVED***tension typo [#141](https://github.com/broofa/node-mime/issues/141)
...
- [**closed**] Feature: support for e***REMOVED***panding MIME patterns [#121](https://github.com/broofa/node-mime/issues/121)
...
- [**closed**] application/***REMOVED***-yaml [#104](https://github.com/broofa/node-mime/issues/104)
- [**closed**] Add mime type for WOFF file format 2.0 [#102](https://github.com/broofa/node-mime/issues/102)
- [**closed**] application/***REMOVED***-msi for .msi [#99](https://github.com/broofa/node-mime/issues/99)
- [**closed**] Add mimetype for gette***REMOVED***t translation files [#98](https://github.com/broofa/node-mime/issues/98)
...
- [**closed**] lookup with e***REMOVED***tension-less file on Windows returns wrong type [#68](https://github.com/broofa/node-mime/issues/68)
...
- [**closed**] README should state upfront that "application/octet-stream" is default for unknown e***REMOVED***tension [#55](https://github.com/broofa/node-mime/issues/55)
- [**closed**] Suggested improvement to the charset API [#52](https://github.com/broofa/node-mime/issues/52)

---

## v1.2.10 (25/07/2013)
- [**closed**] Mime type for woff files should be application/font-woff and not application/***REMOVED***-font-woff [#62](https://github.com/broofa/node-mime/issues/62)
...
- [**closed**] it's wrong to set charset to UTF-8 for te***REMOVED***t [#30](https://github.com/broofa/node-mime/issues/30)
...
- [**closed**] image/pjpeg + image/***REMOVED***-png [#10](https://github.com/broofa/node-mime/issues/10)
