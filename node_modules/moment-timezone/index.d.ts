...
//                 Agustin Carrasco <https://github.com/aserma***REMOVED***>
...
declare module 'moment' {
    ...
    interface MomentTimezone {
        ...
        names(): string[];
        zonesForCountry<T e***REMOVED***tends true>(country: string, with_offset: T): T e***REMOVED***tends true ? MomentZoneOffset[] : never;
        zonesForCountry<T e***REMOVED***tends false>(country: string, with_offset?: T): T e***REMOVED***tends false ? string[] : never;
