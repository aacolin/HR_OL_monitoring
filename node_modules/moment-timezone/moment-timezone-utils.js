...
(function (root, factory) {
	...
	if (typeof module === 'object' && module.e***REMOVED***ports) {
		module.e***REMOVED***ports = factory(require('./'));     // Node
	...
	************************************/
	...
	var BASE60 = '0123456789abcdefghijklmnopqrstuvw***REMOVED***yzABCDEFGHIJKLMNOPQRSTUVWX',
		EPSILON = 0.000001; // Used to fi***REMOVED*** floating point rounding errors
	...
	************************************/
	...
	function packAbbrsAndOffsets(source) {
		...
		for (i = 0; i < source.abbrs.length; i++) {
			...
			if (map[key] === undefined) {
				map[key] = inde***REMOVED***;
				abbrs[inde***REMOVED***] = source.abbrs[i];
				offsets[inde***REMOVED***] = packBase60(Math.round(source.offsets[i] * 60) / 60, 1);
				inde***REMOVED***++;
			}
	...
	function packPopulation (number) {
		...
		var e***REMOVED***ponent = String(number | 0).length - 2;
		var precision = Math.round(number / Math.pow(10, e***REMOVED***ponent));
		return precision + 'e' + e***REMOVED***ponent;
	}
	...
	************************************/
	...
	function findStartAndEndInde***REMOVED*** (untils, start, end) {
		var startI = 0,
	...
	function filterYears (source, start, end) {
		var slice     = Array.prototype.slice,
			indices   = findStartAndEndInde***REMOVED***(source.untils, start, end),
