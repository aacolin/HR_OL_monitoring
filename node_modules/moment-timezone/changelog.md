...
* Fi***REMOVED***ed `.valueOf()` to return `NaN` for invalid zoned objects (matching default `moment`) [#1082](https://github.com/moment/moment-timezone/pull/1082).
...
### `0.5.37` _2022-08-25_
* Re-publish npm package, because of e***REMOVED***tra folder present in 0.5.36, check
  https://github.com/moment/moment-timezone/issues/999

### `0.5.36` _2022-08-25_
* IANA TZDB 2022c
* improvements/fi***REMOVED***es to data pipeline

### `0.5.35` _2022-08-23_
* Fi***REMOVED*** command injection in data pipeline https://github.com/moment/moment-timezone/security/advisories/GHSA-56***REMOVED***4-j7p9-fcf9
* Fi***REMOVED*** clearte***REMOVED***t transmission of sensitive information https://github.com/moment/moment-timezone/security/advisories/GHSA-v78c-4p63-2j6c
...
### `0.5.31` _2020-05-16_
* Fi***REMOVED***ed Travis builds for Node.js 4 and 6

### `0.5.30` _2020-05-16_
* Updated data to IANA TZDB `2020a`
* Fi***REMOVED***ed typescript definitions
...
### `0.5.29` _2020-05-16_
* Merged fi***REMOVED*** of es6 module loading issue https://github.com/moment/moment-timezone/commit/1fd42349189b24e15c60f162dc8c40b42db79dfe
...
* Merged fi***REMOVED***es to changelog https://github.com/moment/moment-timezone/commit/adb7d7b43c7328d814311ac1355bfeef88eab6e8
...
* And as you know `moment.tz.zones()` already e***REMOVED***ists
...
* Fi***REMOVED***: stabilize Array.sort [#762](https://github.com/moment/moment-timezone/pull/762)

### `0.5.25` _2019-04-17_
* Fi***REMOVED*** `moment.tz.dataVersion` to return `2019a` [#742](https://github.com/moment/moment-timezone/issues/742)
...
* Fi***REMOVED***ed bug where `_z` time zone name was not cleared with `.local()` or `.utcOffset(offset)` [#738](https://github.com/moment/moment-timezone/issues/738)

### `0.5.23` _2018-10-28_
* Fi***REMOVED*** minor issue with tz guessing in Russia [#691](https://github.com/moment/moment-timezone/pull/691)

### `0.5.22` _2018-10-28_
* Updated data to IANA TZDB `2018g` [#689](https://github.com/moment/moment-timezone/pull/689)
* Fi***REMOVED*** issue with missing LMT entries for some zones, and fi***REMOVED*** data builds on Linu***REMOVED*** and Windows [#308](https://github.com/moment/moment-timezone/issues/308)

### `0.5.21` _2018-06-23_
* Bugfi***REMOVED***: revert breaking change introduced in 0.5.18

### `0.5.20` _2018-06-18_
* Bugfi***REMOVED***: accidentally commented code
...
### `0.5.16` _2018-04-18_
* Fi***REMOVED***ed Etc/UTC timezone recognition, updated tests. [#599](https://github.com/moment/moment-timezone/pull/599)
...
### `0.5.9` _2016-11-03_
* Fi***REMOVED***ed the output of `moment.tz.version`. [#413](https://github.com/moment/moment-timezone/issues/413)
...
* Fi***REMOVED***ed bug when `Date#toTimeString` did not return a known format. [#302](https://github.com/moment/moment-timezone/pull/302)  [#303](https://github.com/moment/moment-timezone/pull/303)
...
* Fi***REMOVED***ed UMD e***REMOVED***port issue when there was an html element with `id=e***REMOVED***ports`. [#275](https://github.com/moment/moment-timezone/pull/275)
...
* Fi***REMOVED***ed a bug when passing a moment with an offset to `moment.tz`. [#169](https://github.com/moment/moment-timezone/pull/169)
* Fi***REMOVED***ed a deprecation in moment core, changing `moment#zone` to `moment#utcOffset`. [#168](https://github.com/moment/moment-timezone/pull/168)
...
### `0.2.1` _2014-08-02_
* Fi***REMOVED***ed support for `moment@2.8.1+`.
...
* Fi***REMOVED***ed getting the name of a zone that was added as a linked zone. [#104](https://github.com/moment/moment-timezone/pull/104)
...
* *Breaking:* Removed `moment.tz.{addRule,addZone,zoneE***REMOVED***ists,zones}` as they are no longer relevant with the new data format.
* Made library 20***REMOVED*** faster. [JSPerf results](http://jsperf.com/moment-timezone-0-1-0/2)
...
* Fi***REMOVED***ed major memory leak. [#79](https://github.com/moment/moment-timezone/issues/79)
* Fi***REMOVED***ed global e***REMOVED***port to allow use in web workers. [#78](https://github.com/moment/moment-timezone/pull/78)
* Fi***REMOVED***ed global e***REMOVED***port in browser environments that define `window.module`. [#76](https://github.com/moment/moment-timezone/pull/76)

### `0.0.6` _2014-04-20_
* Fi***REMOVED***ed issue with preventing loading moment-timezone more than once. [#75](https://github.com/moment/moment-timezone/pull/75)
...
* Added `moment.tz.zoneE***REMOVED***ists` [#73](https://github.com/moment/moment-timezone/issues/73)
* Fi***REMOVED***ed cloning moments with a timezone. [#71](https://github.com/moment/moment-timezone/issues/71)
