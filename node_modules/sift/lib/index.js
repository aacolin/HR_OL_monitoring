(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var e***REMOVED***tendStatics = function(d, b) {
        e***REMOVED***tendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
        return e***REMOVED***tendStatics(d, b);
    };

    function __e***REMOVED***tends(d, b) {
        if (typeof b !== "function" && b !== null)
            throw new TypeError("Class e***REMOVED***tends value " + String(b) + " is not a constructor or null");
        e***REMOVED***tendStatics(d, b);
     ...
     */
    var walkKeyPathValues = function (item, keyPath, ne***REMOVED***t, depth, key, owner) {
        ...
        return walkKeyPathValues(item[currentKey], keyPath, ne***REMOVED***t, depth + 1, currentKey, item);
    };
    ...
    var GroupOperation = /** @class */ (function (_super) {
        __e***REMOVED***tends(GroupOperation, _super);
        ...
        /**
         */
        GroupOperation.prototype.childrenNe***REMOVED***t = function (item, key, owner, root, leaf) {
            var done = true;
            var keep = true;
    ...
    var NamedGroupOperation = /** @class */ (function (_super) {
        __e***REMOVED***tends(NamedGroupOperation, _super);
    ...
    var QueryOperation = /** @class */ (function (_super) {
        __e***REMOVED***tends(QueryOperation, _super);
        ...
        /**
         */
        QueryOperation.prototype.ne***REMOVED***t = function (item, key, parent, root) {
            this.childrenNe***REMOVED***t(item, key, parent, root);
        };
        return QueryOperation;
    }(GroupOperation));
    var NestedOperation = /** @class */ (function (_super) {
        __e***REMOVED***tends(NestedOperation, _super);
        function NestedOperation(keyPath, params, owneryQuery, options, children) {
            ...
            /**
             */
            _this._ne***REMOVED***tNestedValue = function (value, key, owner, root, leaf) {
                _this.childrenNe***REMOVED***t(value, key, owner, root, leaf);
                return !_this.done;
            };
            return _this;
        }
        /**
         */
        NestedOperation.prototype.ne***REMOVED***t = function (item, key, parent) {
            walkKeyPathValues(item, this.keyPath, this._ne***REMOVED***tNestedValue, 0, key, parent);
        };
    ...
    var EqualsOperation = /** @class */ (function (_super) {
        __e***REMOVED***tends(EqualsOperation, _super);
        ...
        EqualsOperation.prototype.ne***REMOVED***t = function (item, key, parent) {
    ...
    var createNestedOperation = function (keyPath, nestedQuery, parentKey, owneryQuery, options) {
        if (containsOperation(nestedQuery, options)) {
            ...
            if (nestedOperations.length) {
                throw new Error("Property queries must contain only operations, or e***REMOVED***act objects.");
            }
    ...
    var $Ne = /** @class */ (function (_super) {
        ...
        $Ne.prototype.ne***REMOVED***t = function (item) {
            if (this._test(item)) {
                this.done = true;
                this.keep = false;
            }
    ...
    var $ElemMatch = /** @class */ (function (_super) {
        __e***REMOVED***tends($ElemMatch, _super);
        function $ElemMatch() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.propop = true;
            return _this;
        ...
        $ElemMatch.prototype.ne***REMOVED***t = function (item) {
            if (isArray(item)) {
                for (var i = 0, length_1 = item.length; i < length_1; i++) {
    ...
    var $Not = /** @class */ (function (_super) {
        ...
        $Not.prototype.ne***REMOVED***t = function (item, key, owner, root) {
    ...
    var $Size = /** @class */ (function (_super) {
        ...
        $Size.prototype.ne***REMOVED***t = function (item) {
    ...
    var $Or = /** @class */ (function (_super) {
        ...
        $Or.prototype.ne***REMOVED***t = function (item, key, owner) {
            var done = false;
            var success = false;
    ...
    var $Nor = /** @class */ (function (_super) {
        __e***REMOVED***tends($Nor, _super);
        function $Nor() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.propop = false;
            return _this;
        }
        $Nor.prototype.ne***REMOVED***t = function (item, key, owner) {
            _super.prototype.ne***REMOVED***t.call(this, item, key, owner);
            this.keep = !this.keep;
        };
        return $Nor;
    }($Or));
    var $In = /** @class */ (function (_super) {
        __e***REMOVED***tends($In, _super);
        function $In() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.propop = true;
            return _this;
        ...
        $In.prototype.ne***REMOVED***t = function (item, key, owner) {
            var done = false;
            var success = false;
    ...
    var $Nin = /** @class */ (function (_super) {
        ...
        $Nin.prototype.ne***REMOVED***t = function (item, key, owner, root) {
    ...
    var $E***REMOVED***ists = /** @class */ (function (_super) {
        __e***REMOVED***tends($E***REMOVED***ists, _super);
        function $E***REMOVED***ists() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.propop = true;
            return _this;
        }
        $E***REMOVED***ists.prototype.ne***REMOVED***t = function (item, key, owner, root, leaf) {
            if (!leaf) {
                this.done = true;
        ...
        return $E***REMOVED***ists;
    }(BaseOperation));
    var $And = /** @class */ (function (_super) {
        __e***REMOVED***tends($And, _super);
        ...
        $And.prototype.ne***REMOVED***t = function (item, key, owner, root) {
            this.childrenNe***REMOVED***t(item, key, owner, root);
        };
        return $And;
    }(NamedGroupOperation));
    var $All = /** @class */ (function (_super) {
        __e***REMOVED***tends($All, _super);
        function $All(params, owneryQuery, options, name) {
            var _this = _super.call(this, params, owneryQuery, options, params.map(function (query) { return createQueryOperation(query, owneryQuery, options); }), name) || this;
            _this.propop = true;
            return _this;
        }
        $All.prototype.ne***REMOVED***t = function (item, key, owner, root) {
            this.childrenNe***REMOVED***t(item, key, owner, root);
        };
        return $All;
    }(NamedGroupOperation));
    ...
    var $e***REMOVED***ists = function (params, owneryQuery, options, name) { return new $E***REMOVED***ists(params, owneryQuery, options, name); };
    var $rege***REMOVED*** = function (pattern, owneryQuery, options) {
        return new EqualsOperation(new RegE***REMOVED***p(pattern, owneryQuery.$options), owneryQuery, options);
    };
    ...
    e***REMOVED***ports.$Size = $Size;
    e***REMOVED***ports.$all = $all;
    e***REMOVED***ports.$and = $and;
    e***REMOVED***ports.$elemMatch = $elemMatch;
    e***REMOVED***ports.$eq = $eq;
    e***REMOVED***ports.$e***REMOVED***ists = $e***REMOVED***ists;
    e***REMOVED***ports.$gt = $gt;
    e***REMOVED***ports.$gte = $gte;
    e***REMOVED***ports.$in = $in;
    e***REMOVED***ports.$lt = $lt;
    e***REMOVED***ports.$lte = $lte;
    e***REMOVED***ports.$mod = $mod;
    e***REMOVED***ports.$ne = $ne;
    e***REMOVED***ports.$nin = $nin;
    e***REMOVED***ports.$nor = $nor;
    e***REMOVED***ports.$not = $not;
    e***REMOVED***ports.$options = $options;
    e***REMOVED***ports.$or = $or;
    e***REMOVED***ports.$rege***REMOVED*** = $rege***REMOVED***;
    e***REMOVED***ports.$size = $size;
    e***REMOVED***ports.$type = $type;
    e***REMOVED***ports.$where = $where;
    e***REMOVED***ports.EqualsOperation = EqualsOperation;
    e***REMOVED***ports.createDefaultQueryOperation = createDefaultQueryOperation;
    e***REMOVED***ports.createEqualsOperation = createEqualsOperation;
    e***REMOVED***ports.createOperationTester = createOperationTester;
    e***REMOVED***ports.createQueryOperation = createQueryOperation;
    e***REMOVED***ports.createQueryTester = createQueryTester;
    e***REMOVED***ports.default = createDefaultQueryTester;
