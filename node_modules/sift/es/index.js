 ...
 */
const walkKeyPathValues = (item, keyPath, ne***REMOVED***t, depth, key, owner) => {
...
class GroupOperation e***REMOVED***tends BaseOperation {
    ...
    /**
     */
    childrenNe***REMOVED***t(item, key, owner, root, leaf) {
        let done = true;
        let keep = true;
        for (let i = 0, { length } = this.children; i < length; i++) {
...
class NamedGroupOperation e***REMOVED***tends GroupOperation {
    constructor(params, owneryQuery, options, children, name) {
        super(params, owneryQuery, options, children);
        this.name = name;
    }
}
class QueryOperation e***REMOVED***tends GroupOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
    /**
     */
    ne***REMOVED***t(item, key, parent, root) {
        this.childrenNe***REMOVED***t(item, key, parent, root);
    }
}
class NestedOperation e***REMOVED***tends GroupOperation {
    constructor(keyPath, params, owneryQuery, options, children) {
        ...
        /**
         */
        this._ne***REMOVED***tNestedValue = (value, key, owner, root, leaf) => {
...
class EqualsOperation e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
...
class $Ne e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
...
class $ElemMatch e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
...
class $Not e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
    ...
    ne***REMOVED***t(item, key, owner, root) {
        this._queryOperation.ne***REMOVED***t(item, key, owner, root);
        this.done = this._queryOperation.done;
        this.keep = !this._queryOperation.keep;
    }
}
class $Size e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
...
class $Or e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = false;
    }
...
class $In e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
...
class $Nin e***REMOVED***tends BaseOperation {
...
class $E***REMOVED***ists e***REMOVED***tends BaseOperation {
    constructor() {
        super(...arguments);
        this.propop = true;
    }
    ne***REMOVED***t(item, key, owner, root, leaf) {
        if (!leaf) {
            this.done = true;
...
const $e***REMOVED***ists = (params, owneryQuery, options, name) => new $E***REMOVED***ists(params, owneryQuery, options, name);
const $rege***REMOVED*** = (pattern, owneryQuery, options) => new EqualsOperation(new RegE***REMOVED***p(pattern, owneryQuery.$options), owneryQuery, options);
