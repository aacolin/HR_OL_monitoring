...
**For e***REMOVED***tended documentation, checkout http://docs.mongodb.org/manual/reference/operator/query/**

## Features:

- Supported operators: [\$in](#in), [\$nin](#nin), [\$e***REMOVED***ists](#e***REMOVED***ists), [\$gte](#gte), [\$gt](#gt), [\$lte](#lte), [\$lt](#lt), [\$eq](#eq), [\$ne](#ne), [\$mod](#mod), [\$all](#all), [\$and](#and), [\$or](#or), [\$nor](#nor), [\$not](#not), [\$size](#size), [\$type](#type), [\$rege***REMOVED***](#rege***REMOVED***), [\$where](#where), [\$elemMatch](#elemmatch)
- Rege***REMOVED***p searches
...
Here's another e***REMOVED***ample. This acts more like the \$or operator:
...
Checks if whether a value e***REMOVED***ists:

```javascript
// filtered: ['Craig','Tim']
sift({ $e***REMOVED***ists: true })(["Craig", null, "Tim"]);
```

You can also filter out values that don't e***REMOVED***ist

```javascript
// filtered: [{ name: "Tim" }]
[{ name: "Craig", city: "Minneapolis" }, { name: "Tim" }].filter(
  sift({ city: { $e***REMOVED***ists: false } }),
);
```
...
ability to use an array of e***REMOVED***pressions. All e***REMOVED***pressions must test true.
...
OR array of e***REMOVED***pressions.
...
Matches values based on the given regular e***REMOVED***pression

```javascript
["frank", "fred", "sam", "frost"].filter(
  sift({ $rege***REMOVED***: /^f/i, $nin: ["frank"] }),
); // ["fred", "frost"]
["frank", "fred", "sam", "frost"].filter(
  sift({ $rege***REMOVED***: "^f", $options: "i", $nin: ["frank"] }),
); // ["fred", "frost"]
```
...
Sift works like MongoDB out of the bo***REMOVED***, but you're also able to modify the behavior to suite your needs.

#### Custom operations

You can register your own custom operations. Here's an e***REMOVED***ample:
