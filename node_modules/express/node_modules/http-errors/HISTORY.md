...
==================
  ...
  * Remove `I'mateapot` e***REMOVED***port; use `ImATeapot` instead
...
==================
  ...
  * Add `isHttpError` e***REMOVED***port to determine if value is an HTTP error
...
==================
  ...
  * Fi***REMOVED*** error creating objects in some environments
