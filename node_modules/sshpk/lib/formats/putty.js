...
// https://tartarus.org/~simon/putty-prerel-snapshots/htmldoc/Appendi***REMOVED***C.html
...
function splitHeader(line) {
	var id***REMOVED*** = line.inde***REMOVED***Of(':');
	if (id***REMOVED*** === -1)
		return (null);
	var header = line.slice(0, id***REMOVED***);
	++id***REMOVED***;
	while (line[id***REMOVED***] === ' ')
		++id***REMOVED***;
	var rest = line.slice(id***REMOVED***);
	return ([header, rest]);
}
...
function wrap(t***REMOVED***t, len) {
	var lines = [];
	var pos = 0;
	while (pos < t***REMOVED***t.length) {
		lines.push(t***REMOVED***t.slice(pos, pos + 64));
		pos += 64;
	}
	return (lines);
}
