...
Comment: user@host
Fingerprint:
  SHA256:vCNX7eUkdvqqW0m4Po***REMOVED***QAZRv+CM4P4fS8+CbliAvS4k
...
zOt+kWJoijLnw3ZMYUKmA***REMOVED***+lD0I5XU***REMOVED***drPcs1vH5f3cn9TvRvO9L0z/hzg==
\-\-\-\-\-END PUBLIC KEY\-\-\-\-\-
.fi
.RE
.PP
...
e***REMOVED***tract only the public half of the key from it and work with that.
.TP
...
.TP
\fB\fCssh\fR
The SSH public key te***REMOVED***t format (the format of an \fB\fCid_rsa.pub\fR file). A single
