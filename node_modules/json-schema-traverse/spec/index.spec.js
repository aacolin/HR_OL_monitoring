...
var traverse = require('../inde***REMOVED***');
...
describe('json-schema-traverse', function() {
  ...
  it('should traverse all keywords containing schemas recursively', function() {
    var schema = require('./fi***REMOVED***tures/schema').schema;
    var e***REMOVED***pectedCalls = require('./fi***REMOVED***tures/schema').e***REMOVED***pectedCalls;

    traverse(schema, {cb: callback});
    assert.deepStrictEqual(calls, e***REMOVED***pectedCalls);
  });
