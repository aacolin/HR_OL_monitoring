...
module.e***REMOVED***ports = {
  ...
  // schema, jsonPtr, rootSchema, parentJsonPtr, parentKeyword, parentSchema, keyInde***REMOVED***
  e***REMOVED***pectedCalls: [[schema, '', schema, undefined, undefined, undefined, undefined]]
    .concat(e***REMOVED***pectedCalls('additionalItems'))
    .concat(e***REMOVED***pectedCalls('items'))
    .concat(e***REMOVED***pectedCalls('contains'))
    .concat(e***REMOVED***pectedCalls('additionalProperties'))
    .concat(e***REMOVED***pectedCalls('propertyNames'))
    .concat(e***REMOVED***pectedCalls('not'))
    .concat(e***REMOVED***pectedCallsChild('allOf', 0))
    .concat(e***REMOVED***pectedCallsChild('allOf', 1))
    .concat([
    ...
    .concat(e***REMOVED***pectedCallsChild('anyOf', 0))
    .concat(e***REMOVED***pectedCallsChild('anyOf', 1))
    .concat(e***REMOVED***pectedCallsChild('oneOf', 0))
    .concat(e***REMOVED***pectedCallsChild('oneOf', 1))
    .concat(e***REMOVED***pectedCallsChild('definitions', 'foo'))
    .concat(e***REMOVED***pectedCallsChild('definitions', 'bar'))
    .concat(e***REMOVED***pectedCallsChild('properties', 'foo'))
    .concat(e***REMOVED***pectedCallsChild('properties', 'bar'))
    .concat(e***REMOVED***pectedCallsChild('patternProperties', 'foo'))
    .concat(e***REMOVED***pectedCallsChild('patternProperties', 'bar'))
    .concat(e***REMOVED***pectedCallsChild('dependencies', 'foo'))
    .concat(e***REMOVED***pectedCallsChild('dependencies', 'bar'))
};


function e***REMOVED***pectedCalls(keyword) {
  return [
...
function e***REMOVED***pectedCallsChild(keyword, i) {
  return [
