...
- _parent schema_: not necessarily parent object/array; in the e***REMOVED***ample above the parent schema for `{type: 'string'}` is the root schema
- _inde***REMOVED***/property_: inde***REMOVED*** or property name in the array/object containing multiple schemas; in the e***REMOVED***ample above for `{type: 'string'}` the property name is `'foo'`
