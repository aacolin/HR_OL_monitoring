...
e***REMOVED***port declare function Yargs(processArgs?: string | string[], cwd?: string, parentRequire?: NodeRequire): YargsInstance;
e***REMOVED***port declare function rebase(base: string, dir: string): string;
/** Instance of the yargs module. */
e***REMOVED***port interface YargsInstance {
    $0: string;
    argv: Arguments;
    customScriptName: boolean;
    parsed: DetailedArguments | false;
    _copyDoubleDash<T e***REMOVED***tends Arguments | Promise<Arguments>>(argv: T): T;
    _getLoggerInstance(): LoggerInstance;
    _getParseConte***REMOVED***t(): Object;
    _hasOutput(): boolean;
    _hasParseCallback(): boolean;
    _parseArgs: {
        (args: null, shortCircuit: null, _calledFromCommand: boolean, commandInde***REMOVED***?: number): Arguments | Promise<Arguments>;
    ...
    default: {
        ...
        (keys: string[], value: E***REMOVED***clude<any, Function>): YargsInstance;
        (keys: Dictionary<any>): YargsInstance;
    };
    defaults: YargsInstance['default'];
    demand: {
        (min: number, ma***REMOVED***?: number | string, msg?: string): YargsInstance;
        (keys: string | string[], msg?: string | true): YargsInstance;
        (keys: string | string[], ma***REMOVED***: string[], msg?: string | true): YargsInstance;
        (keyMsgs: Dictionary<string | undefined>): YargsInstance;
        (keyMsgs: Dictionary<string | undefined>, ma***REMOVED***: string[], msg?: string): YargsInstance;
    };
    demandCommand(): YargsInstance;
    demandCommand(min: number, minMsg?: string): YargsInstance;
    demandCommand(min: number, ma***REMOVED***: number, minMsg?: string | null, ma***REMOVED***Msg?: string | null): YargsInstance;
    demandOption: {
    ...
    env(prefi***REMOVED***?: string | false): YargsInstance;
    epilog: YargsInstance['epilogue'];
    epilogue(msg: string): YargsInstance;
    e***REMOVED***ample(cmd: string | [string, string?][], description?: string): YargsInstance;
    e***REMOVED***it(code: number, err?: YError | string): void;
    e***REMOVED***itProcess(enabled: boolean): YargsInstance;
    ...
    getConte***REMOVED***t(): Conte***REMOVED***t;
    ...
    getE***REMOVED***itProcess(): boolean;
    ...
    parse: {
        ...
        (args: string | string[], conte***REMOVED***t: object, parseCallback?: ParseCallback): Arguments | Promise<Arguments>;
...
e***REMOVED***port declare function isYargsInstance(y: YargsInstance | void): y is YargsInstance;
/** Yargs' conte***REMOVED***t. */
e***REMOVED***port interface Conte***REMOVED***t {
    commands: string[];
    files: string[];
    fullCommands: string[];
}
declare type LoggerInstance = Pick<Console, 'error' | 'log'>;
e***REMOVED***port interface Options e***REMOVED***tends ParserOptions {
    __: Y18N['__'];
...
e***REMOVED***port interface Configuration e***REMOVED***tends Partial<ParserConfiguration> {
    /** Should a config object be deep-merged with the object config it e***REMOVED***tends? */
    'deep-merge-config'?: boolean;
    /** Should commands be sorted in help? */
    'sort-commands'?: boolean;
}
e***REMOVED***port interface OptionDefinition {
    alias?: string | string[];
    array?: boolean;
    boolean?: boolean;
...
interface PositionalDefinition e***REMOVED***tends Pick<OptionDefinition, 'alias' | 'array' | 'coerce' | 'choices' | 'conflicts' | 'default' | 'defaultDescription' | 'demand' | 'desc' | 'describe' | 'description' | 'implies' | 'normalize'> {
    type?: 'boolean' | 'number' | 'string';
}
interface ParseCallback {
    (err: YError | string | undefined | null, argv: Arguments | Promise<Arguments>, output: string): void;
}
e***REMOVED***port interface Arguments e***REMOVED***tends ParserArguments {
    /** The script name or node command */
    $0: string;
}
e***REMOVED***port interface DetailedArguments e***REMOVED***tends ParserDetailedArguments {
    argv: Arguments;
}
e***REMOVED***port {};
