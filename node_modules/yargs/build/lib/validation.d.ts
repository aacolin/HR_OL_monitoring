...
e***REMOVED***port declare function validation(yargs: YargsInstance, usage: UsageInstance, y18n: Y18N): ValidationInstance;
/** Instance of the validation module. */
e***REMOVED***port interface ValidationInstance {
...
e***REMOVED***port declare type KeyOrPos = string | number;
e***REMOVED***port {};
