...
module.e***REMOVED***ports = TokenStream;
...
TokenStream.prototype.lookahead = function (inde***REMOVED***) {
  if (this._tokens.length <= inde***REMOVED***) {
    throw new Error('Cannot read past the end of a stream');
  }
  return this._tokens[inde***REMOVED***];
};
