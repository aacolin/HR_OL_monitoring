...
describe('mpath', function() {
  ...
  function doc() {
    ...
    o.array = [
      ...
      { o: { array: [{ ***REMOVED***: { b: [1, 2, 3] } }, { ***REMOVED***: { z: 10 } }, { ***REMOVED***: { b: 'hi' } }] } },
  ...
  describe('get', function() {
    ...
    describe('without `special`', function() {
      ...
      it('handles array.prop.array', function(done) {
        assert.deepEqual(
          [[{ ***REMOVED***: { b: [4, 6, 8] } }, { y: 10 }],
            [{ ***REMOVED***: { b: [1, 2, 3] } }, { ***REMOVED***: { z: 10 } }, { ***REMOVED***: { b: 'hi' } }],
            [{ ***REMOVED***: { b: null } }, { ***REMOVED***: { b: [null, 1] } }],
            [{ ***REMOVED***: null }],
            [{ y: 3 }],
            [3, 0, null],
            undefined
      ...
      it('handles array.prop.array.inde***REMOVED***', function(done) {
        assert.deepEqual(
          [{ ***REMOVED***: { b: [4, 6, 8] } },
            { ***REMOVED***: { b: [1, 2, 3] } },
            { ***REMOVED***: { b: null } },
      ...
      it('handles array.prop.array.inde***REMOVED***.prop', function(done) {
        assert.deepEqual(
          [{ b: [4, 6, 8] },
            { b: [1, 2, 3] },
            { b: null },
          ...
          , mpath.get('array.o.array.0.***REMOVED***', o)
        );
        done();
      });
      ...
      it('handles array.prop.array.prop', function(done) {
        ...
        assert.deepEqual(
          ...
          , mpath.get('array.o.array.***REMOVED***', o)
        );
        done();
      });
      ...
      it('handles array.prop.array.prop.prop', function(done) {
        assert.deepEqual(
          ...
          , mpath.get('array.o.array.***REMOVED***.b', o)
        );
        done();
      });

      it('handles array.prop.array.prop.prop.inde***REMOVED***', function(done) {
        assert.deepEqual(
          [[6, undefined],
            [2, undefined, 'i'], // undocumented feature (string inde***REMOVED***ing)
            [null, 1],
            [null],
            [undefined],
            [undefined, undefined, undefined],
          ...
          , mpath.get('array.o.array.***REMOVED***.b.1', o)
        );
        assert.deepEqual(
          [[6, 0],
            [2, 0, 'i'], // undocumented feature (string inde***REMOVED***ing)
            [null, 1],
            [null],
            [0],
            [0, 0, 0],
          ...
          , mpath.get('array.o.array.***REMOVED***.b.1', o, function(v) {
      ...
      it('handles array.inde***REMOVED***.prop.prop', function(done) {
        assert.deepEqual(
          [{ ***REMOVED***: { b: [1, 2, 3] } }, { ***REMOVED***: { z: 10 } }, { ***REMOVED***: { b: 'hi' } }]
      ...
      it('handles array.array.inde***REMOVED***', function(done) {
        assert.deepEqual(
          [{ a: { c: 48 } }, undefined]
      ...
      it('handles array.array.inde***REMOVED***.prop', function(done) {
        assert.deepEqual(
          [{ c: 48 }, 'woot']
      ...
      it('handles array.array.inde***REMOVED***.prop.prop', function(done) {
        assert.deepEqual(
          [48, undefined]
    ...
    describe('with `special`', function() {
      describe('that is a string', function() {
        ...
        it('handles array.array.inde***REMOVED***.array', function(done) {
          assert.deepEqual(
        ...
        it('handles array.array.inde***REMOVED***.array.prop', function(done) {
          assert.deepEqual(
  ...
  describe('set', function() {
    it('prevents writing to __proto__', function() {
      const obj = {};
      mpath.set('__proto__.***REMOVED***', 'foobar', obj);
      assert.ok(!({}.***REMOVED***));

      mpath.set('constructor.prototype.***REMOVED***', 'foobar', obj);
      assert.ok(!({}.***REMOVED***));
    });
    ...
    describe('without `special`', function() {
      ...
      it('works', function(done) {
        ...
        mpath.set('first.second.third', [1, { name: '***REMOVED***' }, 9], o);
        assert.deepEqual([1, { name: '***REMOVED***' }, 9], o.first.second.third);
        ...
        mpath.set('comments.2.comments.1.comments.0.e***REMOVED***pand', 'added', o);
        assert.deepEqual(
          { val: 'twoo', e***REMOVED***pand: 'added' }
      ...
      describe('array.$.path', function() {
        describe('with single non-array value', function() {
          it('copies the value to each item in array', function(done) {
            mpath.set('arr.$.yep', { ***REMOVED***tra: 'double good' }, o, function(v) {
              return v && v.***REMOVED***tra ? 'hi' : v;
            });
            assert.deepEqual([
            ...
            mpath.set('arr.$.yep', { ***REMOVED***tra: 'double good' }, o);
            assert.deepEqual([
              { yep: { ***REMOVED***tra: 'double good' }, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }] },
              { yep: { ***REMOVED***tra: 'double good' } }
            ], o.arr);
      ...
      describe('array.inde***REMOVED***.path', function() {
        it('works', function(done) {
      ...
      describe('array.inde***REMOVED***.array.path', function() {
        ...
        it('with array', function(done) {
          mpath.set('arr.0.arr.e', ['a', 'b'], o, function(v) {
            return 'a' === v ? '***REMOVED***' : v;
          });
          assert.deepEqual([
            { yep: [15], arr: [{ a: { b: 47 }, e: '***REMOVED***' }, { a: { c: 48 }, e: 'b' }, { d: 'yep', e: 35 }] },
            { yep: 0 }
          ], o.arr);
      ...
      describe('array.inde***REMOVED***.array.path.path', function() {
        it('with single value', function(done) {
      ...
      describe('array.array.inde***REMOVED***.path', function() {
        it('with single value', function(done) {
      ...
      describe('array.array.path.inde***REMOVED***', function() {
        it('with single value', function(done) {
      ...
      describe('handles array.array.path', function() {
        it('with single', function(done) {
          ...
          assert.deepEqual([
            { yep: [15], arr: [
              { a: [4, 8, 15, 16, 23, 42, 108, null], e: '***REMOVED***mas' },
              { a: { c: 48, b: [1], 7: 46 }, e: '***REMOVED***mas' },
              { d: 'yep', e: '***REMOVED***mas' }
            ]
            },
            { yep: 0, arr: [{ e: '***REMOVED***mas' }, { e: '***REMOVED***mas' }] },
            { arr: 'something else' },
            { arr: ['something else'] },
            { arr: [weird] },
            { arr: [5] }
    ...
    describe('with `special`', function() {
      ...
      it('works', function(done) {
        ...
        mpath.set('comments.2.comments.1.comments.0.e***REMOVED***pander', 'adder', o, special, function(v) {
          return 'super';
        });
        assert.deepEqual(
          { val: 2, e***REMOVED***pander: 'super' }
          , o.comments[2]._doc.comments[1]._doc.comments[0]);

        mpath.set('comments.2.comments.1.comments.0.e***REMOVED***pander', 'adder', o, special);
        assert.deepEqual(
          { val: 2, e***REMOVED***pander: 'adder' }
          , o.comments[2]._doc.comments[1]._doc.comments[0]);
      ...
      describe('array.path', function() {
        ...
        describe('with array of values', function() {
          ...
          it('that is greater than length', function(done) {
            ...
            assert.deepEqual([
              { yep: 47, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }], _doc: { yep: '***REMOVED***', arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }] } },
              { yep: true, _doc: { special: true, yep: '***REMOVED***' } }
            ], o.arr);
      ...
      describe('array.$.path', function() {
        describe('with single non-array value', function() {
          it('copies the value to each item in array', function(done) {
            mpath.set('arr.$.yep', { ***REMOVED***tra: 'double good' }, o, special, function(v) {
              return 9;
            });
            assert.deepEqual([
              { yep: 47, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }],
            ...
            mpath.set('arr.$.yep', { ***REMOVED***tra: 'double good' }, o, special);
            assert.deepEqual([
              { yep: 47, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }],
                _doc: { yep: { ***REMOVED***tra: 'double good' }, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }] } },
              { yep: true, _doc: { special: true, yep: { ***REMOVED***tra: 'double good' } } }
            ], o.arr);
    ...
    describe('get/set integration', function() {
      ...
      it('works', function(done) {
        const vals = mpath.get('array.o.array.***REMOVED***.b', o);
        ...
        mpath.set('array.o.array.***REMOVED***.b', vals, o);

        const t = [
          { o: { array: [{ ***REMOVED***: { b: [4, 6, 10] } }, { y: 10 }] } },
          { o: { array: [{ ***REMOVED***: { b: [1, 0, 3] } }, { ***REMOVED***: { b: 'Rambaldi', z: 10 } }, { ***REMOVED***: { b: [12, 14] } }] } },
          { o: { array: [{ ***REMOVED***: { b: { changed: true } } }, { ***REMOVED***: { b: [null, ['changed', 'to', 'array']] } }] } },
          { o: { array: [{ ***REMOVED***: null }] } },
          { o: { array: [{ y: 3 }] } },
          { o: { array: [3, 0, null] } },
          { o: { name: 'ha' } }
    ...
    it('get() underneath subclassed array', function(done) {
      class MyArray e***REMOVED***tends Array {}
    ...
    it('ignores setting a nested path that doesnt e***REMOVED***ist', function(done) {
      const o = doc();
      assert.doesNotThrow(function() {
