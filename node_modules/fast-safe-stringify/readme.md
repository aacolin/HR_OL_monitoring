...
It could return an error string if the circular object is too comple***REMOVED*** to analyze,
e.g. in case there are pro***REMOVED***ies involved.

Provides a deterministic ("stable") version as well that will also gracefully
handle circular structures. See the e***REMOVED***ample below for further information.
...
[safe-stable-stringify][] module. However it is still considered e***REMOVED***perimental
due to a new and more comple***REMOVED*** implementation.
...
A few e***REMOVED***ceptions e***REMOVED***ist to [JSON.stringify][] while using [`toJSON`][] or
[`replacer`][]:
...
implementation. It is still considered e***REMOVED***perimental due to a new and more
comple***REMOVED*** implementation.
...
```md
fast-safe-stringify:   simple object ***REMOVED*** 1,121,497 ops/sec ±0.75% (97 runs sampled)
fast-safe-stringify:   circular      ***REMOVED*** 560,126 ops/sec ±0.64% (96 runs sampled)
fast-safe-stringify:   deep          ***REMOVED*** 32,472 ops/sec ±0.57% (95 runs sampled)
fast-safe-stringify:   deep circular ***REMOVED*** 32,513 ops/sec ±0.80% (92 runs sampled)

util.inspect:          simple object ***REMOVED*** 272,837 ops/sec ±1.48% (90 runs sampled)
util.inspect:          circular      ***REMOVED*** 116,896 ops/sec ±1.19% (95 runs sampled)
util.inspect:          deep          ***REMOVED*** 19,382 ops/sec ±0.66% (92 runs sampled)
util.inspect:          deep circular ***REMOVED*** 18,717 ops/sec ±0.63% (96 runs sampled)

json-stringify-safe:   simple object ***REMOVED*** 233,621 ops/sec ±0.97% (94 runs sampled)
json-stringify-safe:   circular      ***REMOVED*** 110,409 ops/sec ±1.85% (95 runs sampled)
json-stringify-safe:   deep          ***REMOVED*** 8,705 ops/sec ±0.87% (96 runs sampled)
json-stringify-safe:   deep circular ***REMOVED*** 8,336 ops/sec ±2.20% (93 runs sampled)
```
