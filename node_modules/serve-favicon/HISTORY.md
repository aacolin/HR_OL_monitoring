...
==================
  ...
  * deps: ms@0.7.1
    - Prevent e***REMOVED***traordinarily long inputs
...
==================
  ...
  * Fi***REMOVED*** content headers being sent in 304 response
  * deps: etag@~1.3.1
...
==================
  ...
  * Fi***REMOVED*** `ms` to be listed as a dependency
...
==================
  ...
  * Send valid ma***REMOVED***-age value
  * Support conditional requests
  * Support ma***REMOVED***-age=0
...
==================
  ...
  * Fi***REMOVED***ed content of default icon.

1.0.1 / 2014-03-11
==================

  * Fi***REMOVED***ed path to default icon.
