...
test('new SafeBuffer(value) works just like Buffer', function (t) {
  ...
  t.deepEqual(new SafeBuffer('686579', 'he***REMOVED***'), new Buffer('686579', 'he***REMOVED***'))
...
test('SafeBuffer.from(value) converts to a Buffer', function (t) {
  ...
  t.deepEqual(SafeBuffer.from('686579', 'he***REMOVED***'), new Buffer('686579', 'he***REMOVED***'))
...
test('SafeBuffer.alloc(number) returns zeroed-out memory', function (t) {
  for (var i = 0; i < 10; i++) {
    var e***REMOVED***pected1 = new Buffer(1000)
    e***REMOVED***pected1.fill(0)
    t.deepEqual(SafeBuffer.alloc(1000), e***REMOVED***pected1)

    var e***REMOVED***pected2 = new Buffer(1000 * 1000)
    e***REMOVED***pected2.fill(0)
    t.deepEqual(SafeBuffer.alloc(1000 * 1000), e***REMOVED***pected2)
  }
  t.end()
})
