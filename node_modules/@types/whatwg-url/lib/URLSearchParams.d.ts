import { URLSearchParams } from "../inde***REMOVED***";
 ...
 */
e***REMOVED***port function is(obj: unknown): obj is URLSearchParams;

/**
 * Checks whether `obj` is a `URLSearchParamsImpl` WebIDL2JS implementation object
 * provided by this package.
 */
e***REMOVED***port function isImpl(obj: unknown): obj is URLSearchParamsImpl;
 ...
 */
e***REMOVED***port function convert(globalObject: object, obj: unknown, { conte***REMOVED***t }?: { conte***REMOVED***t: string }): URLSearchParamsImpl;

e***REMOVED***port function createDefaultIterator<TIteratorKind e***REMOVED***tends "key" | "value" | "key+value">(
    globalObject: object,
    target: URLSearchParamsImpl,
    kind: TIteratorKind,
): IterableIterator<TIteratorKind e***REMOVED***tends "key" | "value" ? string : [name: string, value: string]>;
 ...
 */
e***REMOVED***port function create(
    globalObject: object,
 ...
 *         in the WebIDL2JS constructor registry.
 */
e***REMOVED***port function createImpl(
    globalObject: object,
    constructorArgs?: readonly [
        init: ReadonlyArray<[name: string, value: string]> | { readonly [name: string]: string } | string,
    ],
 ...
 */
e***REMOVED***port function setup<T e***REMOVED***tends URLSearchParams>(
    obj: T,
    globalObject: object,
    constructorArgs?: readonly [
        init: ReadonlyArray<[name: string, value: string]> | { readonly [name: string]: string } | string,
 ...
 */
e***REMOVED***port function install(globalObject: object, globalNames: readonly string[]): void;
