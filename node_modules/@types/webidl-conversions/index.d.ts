declare namespace WebIDLConversions {
    ...
    interface Options {
        conte***REMOVED***t?: string | undefined;
        globals?: Globals | undefined;
    }

    interface IntegerOptions e***REMOVED***tends Options {
        enforceRange?: boolean | undefined;
        clamp?: boolean | undefined;
    }

    interface StringOptions e***REMOVED***tends Options {
        treatNullAsEmptyString?: boolean | undefined;
    }

    interface BufferSourceOptions e***REMOVED***tends Options {
...
declare const WebIDLConversions: {
    ...
    object<V>(V: V, opts?: WebIDLConversions.Options): V e***REMOVED***tends object ? V : V & object;
    ArrayBuffer(
        V: unknown,
...
// This can't use ES6 style e***REMOVED***ports, as those can't have spaces in e***REMOVED***port names.
e***REMOVED***port = WebIDLConversions;
