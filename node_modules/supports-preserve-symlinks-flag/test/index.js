...
test('supportsPreserveSymlinks', function (t) {
	...
	var e***REMOVED***pected = semver.satisfies(process.version, '>= 6.2');
	t.equal(
		supportsPreserveSymlinks,
		e***REMOVED***pected,
		'is true in node v6.2+, false otherwise (actual: ' + supportsPreserveSymlinks + ', e***REMOVED***pected ' + e***REMOVED***pected + ')',
		{ skip: typeof window !== 'undefined' }
	);
