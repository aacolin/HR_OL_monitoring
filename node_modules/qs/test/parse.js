...
test('parse()', function (t) {
    t.test('parses a simple string', function (st) {
        ...
        st.deepEqual(qs.parse('foo=bar&baz'), { foo: 'bar', baz: '' });
        st.deepEqual(qs.parse('cht=p3&chd=t:60,40&chs=250***REMOVED***100&chl=Hello|World'), {
            cht: 'p3',
            chd: 't:60,40',
            chs: '250***REMOVED***100',
            chl: 'Hello|World'
    ...
    t.test('parses an e***REMOVED***plicit array', function (st) {
    ...
    t.test('parses a mi***REMOVED*** of simple and e***REMOVED***plicit arrays', function (st) {
        st.deepEqual(qs.parse('a=b&a[]=c'), { a: ['b', 'c'] });
        st.deepEqual(qs.parse('a[]=b&a=c'), { a: ['b', 'c'] });
    ...
    t.test('transforms arrays to objects', function (st) {
        ...
        st.deepEqual(qs.parse('a[]=b&a[hasOwnProperty]=c&a[***REMOVED***]=y', { allowPrototypes: false }), { a: { 0: 'b', ***REMOVED***: 'y' } });
        st.deepEqual(qs.parse('a[]=b&a[hasOwnProperty]=c&a[***REMOVED***]=y', { allowPrototypes: true }), { a: { 0: 'b', hasOwnProperty: 'c', ***REMOVED***: 'y' } });
        st.end();
    });
    ...
    t.test('parses jquery-param strings', function (st) {
        ...
        var e***REMOVED***pected = { filter: [['int1', '=', '77'], 'and', ['int2', '=', '8']] };
        st.deepEqual(qs.parse(encoded), e***REMOVED***pected);
        st.end();
    });
    ...
    t.test('parses a string with an alternative RegE***REMOVED***p delimiter', function (st) {
        st.deepEqual(qs.parse('a=b; c=d', { delimiter: /[;,] */ }), { a: 'b', c: 'd' });
        st.end();
    });
    ...
    t.test('allows for query string prefi***REMOVED***', function (st) {
        st.deepEqual(qs.parse('?foo=bar', { ignoreQueryPrefi***REMOVED***: true }), { foo: 'bar' });
        st.deepEqual(qs.parse('foo=bar', { ignoreQueryPrefi***REMOVED***: true }), { foo: 'bar' });
        st.deepEqual(qs.parse('?foo=bar', { ignoreQueryPrefi***REMOVED***: false }), { '?foo': 'bar' });
    ...
    t.test('parses an object', function (st) {
        ...
        st.deepEqual(result, e***REMOVED***pected);
        st.end();
    });
    ...
    t.test('parses comma delimited array while having percent-encoded comma treated as normal te***REMOVED***t', function (st) {
    ...
    t.test('parses regular e***REMOVED***pressions correctly', function (st) {
        var re = /^test$/;
    ...
    t.test('can return null objects', { skip: !Object.create }, function (st) {
        var e***REMOVED***pected = Object.create(null);
        e***REMOVED***pected.a = Object.create(null);
        e***REMOVED***pected.a.b = 'c';
        e***REMOVED***pected.a.hasOwnProperty = 'd';
        st.deepEqual(qs.parse('a[b]=c&a[hasOwnProperty]=d', { plainObjects: true }), e***REMOVED***pected);
        st.deepEqual(qs.parse(null, { plainObjects: true }), Object.create(null));
        var e***REMOVED***pectedArray = Object.create(null);
        e***REMOVED***pectedArray.a = Object.create(null);
        e***REMOVED***pectedArray.a[0] = 'b';
        e***REMOVED***pectedArray.a.c = 'd';
        st.deepEqual(qs.parse('a[]=b&a[c]=d', { plainObjects: true }), e***REMOVED***pectedArray);
        st.end();
    });
    ...
    t.test('can parse with custom encoding', function (st) {
        st.deepEqual(qs.parse('%8c%a7=%91%e5%8d%e3%95%7b', {
            decoder: function (str) {
                var reg = /%([0-9A-F]{2})/ig;
                var result = [];
                var parts = reg.e***REMOVED***ec(str);
                while (parts) {
                    result.push(parseInt(parts[1], 16));
                    parts = reg.e***REMOVED***ec(str);
                }
    ...
    t.test('does not interpret %uXXXX synta***REMOVED*** in iso-8859-1 mode', function (st) {
...
test('qs strictDepth option - throw cases', function (t) {
    t.test('throws an e***REMOVED***ception when depth e***REMOVED***ceeds the limit with strictDepth: true', function (st) {
        st['throws'](
            function () {
    ...
    t.test('throws an e***REMOVED***ception for multiple nested arrays with strictDepth: true', function (st) {
        st['throws'](
            function () {
    ...
    t.test('throws an e***REMOVED***ception for nested objects and arrays with strictDepth: true', function (st) {
        st['throws'](
            function () {
    ...
    t.test('throws an e***REMOVED***ception for different types of values with strictDepth: true', function (st) {
        st['throws'](
            function () {
...
test('qs strictDepth option - non-throw cases', function (t) {
    ...
    t.test('does not throw an e***REMOVED***ception when depth e***REMOVED***ceeds the limit with strictDepth: false', function (st) {
        st.doesNotThrow(
            function () {
    ...
    t.test('does not throw when depth is e***REMOVED***actly at the limit with strictDepth: true', function (st) {
        st.doesNotThrow(
            function () {
