    ...
    for (var j = 0; j < string.length; j += limit) {
        ...
        for (var i = 0; i < segment.length; ++i) {
            ...
            if (
                ...
                || (format === formats.RFC1738 && (c === 0***REMOVED***28 || c === 0***REMOVED***29)) // ( )
            ) {
            ...
            if (c < 0***REMOVED***80) {
                arr[arr.length] = he***REMOVED***Table[c];
                continue;
            }

            if (c < 0***REMOVED***800) {
                arr[arr.length] = he***REMOVED***Table[0***REMOVED***C0 | (c >> 6)]
                    + he***REMOVED***Table[0***REMOVED***80 | (c & 0***REMOVED***3F)];
                continue;
            }

            if (c < 0***REMOVED***D800 || c >= 0***REMOVED***E000) {
                arr[arr.length] = he***REMOVED***Table[0***REMOVED***E0 | (c >> 12)]
            ...
            i += 1;
            c = 0***REMOVED***10000 + (((c & 0***REMOVED***3FF) << 10) | (segment.charCodeAt(i) & 0***REMOVED***3FF));

            arr[arr.length] = he***REMOVED***Table[0***REMOVED***F0 | (c >> 18)]
