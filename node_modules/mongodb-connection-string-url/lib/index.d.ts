...
e***REMOVED***port { redactConnectionString, ConnectionStringRedactionOptions };
declare class CaseInsensitiveMap<K e***REMOVED***tends string = string> e***REMOVED***tends Map<K, string> {
...
declare abstract class URLWithoutHost e***REMOVED***tends URL {
...
e***REMOVED***port interface ConnectionStringParsingOptions {
    looseValidation?: boolean;
}
e***REMOVED***port declare class ConnectionString e***REMOVED***tends URLWithoutHost {
    _hosts: string[];
    ...
    typedSearchParams<T e***REMOVED***tends {}>(): {
...
e***REMOVED***port declare class CommaAndColonSeparatedRecord<K e***REMOVED***tends {} = Record<string, unknown>> e***REMOVED***tends CaseInsensitiveMap<keyof K & string> {
    constructor(from?: string | null);
    toString(): string;
}
e***REMOVED***port default ConnectionString;
