# simple-update-notifier [![GitHub stars](https://img.shields.io/github/stars/ale***REMOVED***brazier/simple-update-notifier?label=Star%20Project&style=social)](https://github.com/ale***REMOVED***brazier/simple-update-notifier/stargazers)

[![CI](https://github.com/ale***REMOVED***brazier/simple-update-notifier/workflows/Build%20and%20Deploy/badge.svg)](https://github.com/ale***REMOVED***brazier/simple-update-notifier/actions)
...
When set, logs e***REMOVED***plaining the decision will be output to `stderr` whenever the module opts to not print an update notification
