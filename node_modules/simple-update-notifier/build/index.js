...
function __awaiter(thisArg, _arguments, P, generator) {
    ...
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.ne***REMOVED***t(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }
        step((generator = generator.apply(thisArg, _arguments || [])).ne***REMOVED***t());
    });
}

function __generator(thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { ne***REMOVED***t: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
        if (f) throw new TypeError("Generator is already e***REMOVED***ecuting.");
        while (g && (g = 0, op[0] && (_ = 0)), _) try {
            if (f = 1, y && (t = op[0] & 2 ? y["return"] : op[0] ? y["throw"] || ((t = y["return"]) && t.call(y), 0) : y.ne***REMOVED***t) && !(t = t.call(y, op[1])).done) return t;
...
var createConfigDir = function () {
    if (!fs.e***REMOVED***istsSync(configDir)) {
...
var getLastUpdate = function (packageName) {
    ...
    try {
        if (!fs.e***REMOVED***istsSync(configFile)) {
            return undefined;
        }
...
var borderedTe***REMOVED***t = function (te***REMOVED***t) {
    var lines = te***REMOVED***t.split('\n');
    var width = Math.ma***REMOVED***.apply(Math, lines.map(function (l) { return l.length; }));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (latestVersion) {
                    console.error(borderedTe***REMOVED***t("New version of ".concat(args.pkg.name, " available!\nCurrent Version: ").concat(args.pkg.version, "\nLatest Version: ").concat(latestVersion)));
                }
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
                ...
                if (args.debug && err_1 instanceof Error) {
                    console.error('Une***REMOVED***pected error in simpleUpdateNotifier():', err_1);
                }
                return [3 /*break*/, 4];
...
module.e***REMOVED***ports = simpleUpdateNotifier;
