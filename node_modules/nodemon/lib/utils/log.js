...
function log(type, te***REMOVED***t) {
  var msg = '[nodemon] ' + (te***REMOVED***t || '');

  if (useColours) {
    msg = colour(coding[type], msg);
  }

  // always push the message through our bus, using ne***REMOVED***tTick
  // to help testing and get _out of_ promises.
  process.ne***REMOVED***tTick(() => {
    bus.emit('log', { type: type, message: te***REMOVED***t, colour: msg });
  });
