...
config.load = function (settings, ready) {
  ...
  load(settings, config.options, config, function (options) {
    ...
    config.command = {
      raw: cmd,
      string: utils.stringify(cmd.e***REMOVED***ecutable, cmd.args),
    };
    ...
    pinVersion().then(function () {
      ...
      // this doesn't help testing, but does give e***REMOVED***posure on synta***REMOVED*** errors
