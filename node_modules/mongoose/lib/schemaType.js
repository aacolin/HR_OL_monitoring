...
const $e***REMOVED***ists = require('./schema/operators/e***REMOVED***ists');
...
function SchemaType(path, options, instance) {
  ...
  for (const prop of keys) {
    ...
    if (utils.hasUserDefinedProperty(this.options, prop) && typeof this[prop] === 'function') {
      // { unique: true, inde***REMOVED***: true }
      if (prop === 'inde***REMOVED***' && this._inde***REMOVED***) {
        if (options.inde***REMOVED*** === false) {
          const inde***REMOVED*** = this._inde***REMOVED***;
          if (typeof inde***REMOVED*** === 'object' && inde***REMOVED*** != null) {
            if (inde***REMOVED***.unique) {
              throw new Error('Path "' + this.path + '" may not have `inde***REMOVED***` ' +
                'set to false and `unique` set to true');
            }
            if (inde***REMOVED***.sparse) {
              throw new Error('Path "' + this.path + '" may not have `inde***REMOVED***` ' +
                'set to false and `sparse` set to true');
            }
          }

          this._inde***REMOVED*** = false;
        }
        continue;
      }
  ...
  Object.defineProperty(this, '$$conte***REMOVED***t', {
    enumerable: false,
    configurable: false,
    writable: true,
    value: null
...
SchemaType.prototype.splitPath = function() {
  ...
  this._presplitPath = this.path.inde***REMOVED***Of('.') === -1 ? [this.path] : this.path.split('.');
  return this._presplitPath;
};
 ...
 *
 *     // default unique objects for Mi***REMOVED***ed types:
 *     const schema = new Schema({ mi***REMOVED***ed: Schema.Types.Mi***REMOVED***ed });
 *     schema.path('mi***REMOVED***ed').default(function () {
 *       return {};
 *     });
 *
 *     // if we don't use a function to return object literals for Mi***REMOVED***ed defaults,
 *     // each document will receive a reference to the same object literal creating
 *     // a "shared" object instance:
 *     const schema = new Schema({ mi***REMOVED***ed: Schema.Types.Mi***REMOVED***ed });
 *     schema.path('mi***REMOVED***ed').default({});
 *     const M = db.model('M', schema);
 *     const m1 = new M;
 *     m1.mi***REMOVED***ed.added = 1;
 *     console.log(m1.mi***REMOVED***ed); // { added: 1 }
 *     const m2 = new M;
 *     console.log(m2.mi***REMOVED***ed); // { added: 1 }
 *
...
/**
 * Declares the inde***REMOVED*** options for this schematype.
 *
 * #### E***REMOVED***ample:
 *
 *     const s = new Schema({ name: { type: String, inde***REMOVED***: true })
 *     const s = new Schema({ name: { type: String, inde***REMOVED***: -1 })
 *     const s = new Schema({ loc: { type: [Number], inde***REMOVED***: 'hashed' })
 *     const s = new Schema({ loc: { type: [Number], inde***REMOVED***: '2d', sparse: true })
 *     const s = new Schema({ loc: { type: [Number], inde***REMOVED***: { type: '2dsphere', sparse: true }})
 *     const s = new Schema({ date: { type: Date, inde***REMOVED***: { unique: true, e***REMOVED***pires: '1d' }})
 *     s.path('my.path').inde***REMOVED***(true);
 *     s.path('my.date').inde***REMOVED***({ e***REMOVED***pires: 60 });
 *     s.path('my.path').inde***REMOVED***({ unique: true, sparse: true });
 *
 * #### Note:
 *
 * _Inde***REMOVED***es are created [in the background](https://www.mongodb.com/docs/manual/core/inde***REMOVED***-creation/#inde***REMOVED***-creation-background)
 * by default. If `background` is set to `false`, MongoDB will not e***REMOVED***ecute any
 * read/write operations you send until the inde***REMOVED*** build.
...
SchemaType.prototype.inde***REMOVED*** = function(options) {
  this._inde***REMOVED*** = options;
  utils.e***REMOVED***pires(this._inde***REMOVED***);
  return this;
};

/**
 * Declares an unique inde***REMOVED***.
 *
 * #### E***REMOVED***ample:
 *
 *     const s = new Schema({ name: { type: String, unique: true } });
 *     s.path('name').inde***REMOVED***({ unique: true });
 *
...
SchemaType.prototype.unique = function(bool) {
  if (this._inde***REMOVED*** === false) {
    if (!bool) {
      return;
    }
    throw new Error('Path "' + this.path + '" may not have `inde***REMOVED***` set to ' +
      'false and `unique` set to true');
  }

  if (!this.options.hasOwnProperty('inde***REMOVED***') && bool === false) {
    return this;
  }

  if (this._inde***REMOVED*** == null || this._inde***REMOVED*** === true) {
    this._inde***REMOVED*** = {};
  } else if (typeof this._inde***REMOVED*** === 'string') {
    this._inde***REMOVED*** = { type: this._inde***REMOVED*** };
  }

  this._inde***REMOVED***.unique = bool;
  return this;
};

/**
 * Declares a full te***REMOVED***t inde***REMOVED***.
 *
 * ### E***REMOVED***ample:
 *
 *      const s = new Schema({ name : { type: String, te***REMOVED***t : true } })
 *      s.path('name').inde***REMOVED***({ te***REMOVED***t : true });
 *
 * @param {Boolean} bool
 * @return {SchemaType} this
 * @api public
...
SchemaType.prototype.te***REMOVED***t = function(bool) {
  if (this._inde***REMOVED*** === false) {
    if (!bool) {
      return this;
    }
    throw new Error('Path "' + this.path + '" may not have `inde***REMOVED***` set to ' +
      'false and `te***REMOVED***t` set to true');
  }
  ...
  if (this._inde***REMOVED*** === null || this._inde***REMOVED*** === undefined ||
    typeof this._inde***REMOVED*** === 'boolean') {
    this._inde***REMOVED*** = {};
  } else if (typeof this._inde***REMOVED*** === 'string') {
    this._inde***REMOVED*** = { type: this._inde***REMOVED*** };
  }

  this._inde***REMOVED***.te***REMOVED***t = bool;
  return this;
};

/**
 * Declares a sparse inde***REMOVED***.
 *
 * #### E***REMOVED***ample:
 *
 *     const s = new Schema({ name: { type: String, sparse: true } });
 *     s.path('name').inde***REMOVED***({ sparse: true });
 *
 * @param {Boolean} bool
 * @return {SchemaType} this
 * @api public
...
SchemaType.prototype.sparse = function(bool) {
  ...
  if (this._inde***REMOVED*** == null || typeof this._inde***REMOVED*** === 'boolean') {
    this._inde***REMOVED*** = {};
  } else if (typeof this._inde***REMOVED*** === 'string') {
    this._inde***REMOVED*** = { type: this._inde***REMOVED*** };
  }

  this._inde***REMOVED***.sparse = bool;
  return this;
};
 ...
 * stored in MongoDB, or before e***REMOVED***ecuting a query.
 *
 ...
 *       ta***REMOVED***onomy: { type: String, set: inspector }
 *     })
 *
 *     const Virus = db.model('Virus', VirusSchema);
 *     const v = new Virus({ name: 'Parvoviridae', ta***REMOVED***onomy: 'Parvovirinae' });
 *
 *     console.log(v.name);     // name is required
 *     console.log(v.ta***REMOVED***onomy); // Parvovirinae
 *
 ...
 *
 * Suppose you are storing credit card numbers and you want to hide everything e***REMOVED***cept the last 4 digits to the mongoose user. You can do so by defining a getter in the following way:
 *
 ...
 *       ta***REMOVED***onomy: { type: String, get: inspector }
 *     })
 *
 *     const Virus = db.model('Virus', VirusSchema);
 *
 ...
 *       console.log(virus.ta***REMOVED***onomy); // ta***REMOVED***onomy is not
 *     })
 *
 * @param {Function} fn
 * @return {SchemaType} this
 ...
 *
 * @param {Array<RegE***REMOVED***p|Function|Object>} validators
 * @returns this
 */
 ...
 *
 * Validation occurs `pre('save')` or whenever you manually e***REMOVED***ecute [document#validate](https://mongoosejs.com/docs/api/document.html#Document.prototype.validate()).
 *
 ...
 *
 * @param {RegE***REMOVED***p|Function|Object} obj validator function, or hash describing options
 * @param {Function} [obj.validator] validator function. If the validator function returns `undefined` or a truthy value, validation succeeds. If it returns [falsy](https://masteringjs.io/tutorials/fundamentals/falsy) (e***REMOVED***cept `undefined`) or throws an error, validation fails.
 * @param {String|Function} [obj.message] optional error message. If function, should return the error message as a string
 * @param {Boolean} [obj.propsParameter=false] If true, Mongoose will pass the validator properties object (with the `validator` function, `message`, etc.) as the 2nd arg to the validator function. This is disabled by default because many validators [rely on positional args](https://github.com/chriso/validator.js#validators), so turning this on may cause unpredictable behavior in e***REMOVED***ternal validators.
...
SchemaType.prototype.validate = function(obj, message, type) {
  if (typeof obj === 'function' || obj && utils.getFunctionName(obj.constructor) === 'RegE***REMOVED***p') {
    let properties;
 ...
 *
 * @param {Object} scope the scope which callback are e***REMOVED***ecuted
 * @param {Boolean} init
 ...
 *
 * Set to `true` if this path should always be included in the results, `false` if it should be e***REMOVED***cluded by default. This setting can be overridden at the query level.
 *
 * #### E***REMOVED***ample:
 *
 *     T = db.model('T', new Schema({ ***REMOVED***: { type: String, select: true }}));
 *     T.find(..); // field ***REMOVED*** will always be selected ..
 *     // .. unless overridden;
 *     T.find().select('-***REMOVED***').e***REMOVED***ec(callback);
 *
 * @param {Boolean} val
 * @return {SchemaType} this
 * @api public
...
SchemaType.prototype.doValidate = function(value, fn, scope, options) {
  ...
  for (let i = 0, len = validators.length; i < len; ++i) {
    ...
    if (validator instanceof RegE***REMOVED***p) {
...
SchemaType.prototype.doValidateSync = function(value, scope, options) {
  ...
  for (i = 0; i < len; ++i) {
    ...
    // Skip any e***REMOVED***plicit async validators. Validators that return a promise
...
function handleSingle(val, conte***REMOVED***t) {
  return this.castForQuery(null, val, conte***REMOVED***t);
}
...
function handleArray(val, conte***REMOVED***t) {
  const _this = this;
  if (!Array.isArray(val)) {
    return [this.castForQuery(null, val, conte***REMOVED***t)];
  }
  return val.map(function(m) {
    return _this.castForQuery(null, m, conte***REMOVED***t);
  });
}

/**
 * Just like handleArray, e***REMOVED***cept also allows `[]` because surprisingly
 * `$in: [1, []]` works fine
 * @api private
 */

function handle$in(val, conte***REMOVED***t) {
  const _this = this;
  if (!Array.isArray(val)) {
    return [this.castForQuery(null, val, conte***REMOVED***t)];
  }
 ...
 * @param {Any} val
 * @param {Query} conte***REMOVED***t
 * @return {Any}
 * @api private
 */

SchemaType.prototype.castForQuery = function($conditional, val, conte***REMOVED***t) {
  let handler;
  if ($conditional != null) {
    ...
    return handler.call(this, val, conte***REMOVED***t);
  }

  try {
    return this.applySetters(val, conte***REMOVED***t);
  } catch (err) {
...
SchemaType.prototype.clone = function() {
  ...
  if (this._inde***REMOVED*** !== undefined) schematype._inde***REMOVED*** = this._inde***REMOVED***;
...
module.e***REMOVED***ports = e***REMOVED***ports = SchemaType;

e***REMOVED***ports.CastError = CastError;

e***REMOVED***ports.ValidatorError = ValidatorError;
