...
class SchemaArrayOptions e***REMOVED***tends SchemaTypeOptions {}
 ...
 * #### E***REMOVED***ample:
 *
 *     const Model = db.model('Test', new Schema({ ***REMOVED***1: { castNonArrays: false, type: [String] } }));
 *     const doc = new Model({ ***REMOVED***1: "some non-array value" });
...
module.e***REMOVED***ports = SchemaArrayOptions;
