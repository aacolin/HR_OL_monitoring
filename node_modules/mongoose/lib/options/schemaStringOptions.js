...
class SchemaStringOptions e***REMOVED***tends SchemaTypeOptions {}
 ...
 * e***REMOVED***pression, and fails otherwise.
 *
 * @api public
 * @property match
 * @memberOf SchemaStringOptions
 ...
 *
 * Mongoose supports two different spellings for this option: `ma***REMOVED***Length` and `ma***REMOVED***length`.
 * `ma***REMOVED***Length` is the recommended way to specify this option, but Mongoose also supports
 * `ma***REMOVED***length` (lowercase "l").
 *
 * @api public
 * @property ma***REMOVED***Length
 * @memberOf SchemaStringOptions
 * @type {Number}
 * @instance
 */

Object.defineProperty(SchemaStringOptions.prototype, 'ma***REMOVED***Length', opts);
Object.defineProperty(SchemaStringOptions.prototype, 'ma***REMOVED***length', opts);
...
module.e***REMOVED***ports = SchemaStringOptions;
