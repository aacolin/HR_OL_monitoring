...
/**
 * Queues a method for later e***REMOVED***ecution when its
 * database connection opens.
 *
 * @param {String} name name of the method to queue
 * @param {Array} args arguments to pass to the method when e***REMOVED***ecuted
 * @api private
 */
...
Collection.prototype.removeQueue = function(name, args) {
  const inde***REMOVED*** = this.queue.findInde***REMOVED***(v => v[0] === name && v[1] === args);
  if (inde***REMOVED*** === -1) {
    return false;
  }
  this.queue.splice(inde***REMOVED***, 1);
  return true;
};

/**
 * E***REMOVED***ecutes all queued methods and clears the queue.
 *
 * @api private
 */
...
Collection.prototype.ensureInde***REMOVED*** = function() {
  throw new Error('Collection#ensureInde***REMOVED*** unimplemented by driver');
};
...
Collection.prototype.createInde***REMOVED*** = function() {
  throw new Error('Collection#createInde***REMOVED*** unimplemented by driver');
};
...
Collection.prototype.getInde***REMOVED***es = function() {
  throw new Error('Collection#getInde***REMOVED***es unimplemented by driver');
};
...
module.e***REMOVED***ports = Collection;
