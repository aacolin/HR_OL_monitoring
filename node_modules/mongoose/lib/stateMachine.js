...
const StateMachine = module.e***REMOVED***ports = e***REMOVED***ports = function StateMachine() {
};
...
StateMachine.prototype._changeState = function _changeState(path, ne***REMOVED***tState) {
  const prevState = this.paths[path];
  if (prevState === ne***REMOVED***tState) {
    return;
  }
  const prevBucket = this.states[prevState];
  if (prevBucket) delete prevBucket[path];

  this.paths[path] = ne***REMOVED***tState;
  this.states[ne***REMOVED***tState] = this.states[ne***REMOVED***tState] || {};
  this.states[ne***REMOVED***tState][path] = true;
};
