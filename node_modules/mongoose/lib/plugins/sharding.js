...
module.e***REMOVED***ports = function shardingPlugin(schema) {
  schema.post('init', function shardingPluginPostInit() {
    storeShard.call(this);
    return this;
  });
  schema.pre('save', function shardingPluginPreSave(ne***REMOVED***t) {
    applyWhere.call(this);
    ne***REMOVED***t();
  });
  schema.pre('remove', function shardingPluginPreRemove(ne***REMOVED***t) {
    applyWhere.call(this);
    ne***REMOVED***t();
  });
...
module.e***REMOVED***ports.storeShard = storeShard;
