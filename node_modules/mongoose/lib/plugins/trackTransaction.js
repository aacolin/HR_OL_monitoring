...
module.e***REMOVED***ports = function trackTransaction(schema) {
...
function _getAtomics(doc, previous) {
  ...
  for (const path of pathsToCheck) {
    ...
    if (val != null &&
      ...
      const e***REMOVED***isting = previous.get(path) || {};
      pathToAtomics.set(path, mergeAtomics(e***REMOVED***isting, val[arrayAtomicsSymbol]));
    }
  }
