 ...
 * - `ObjectE***REMOVED***pectedError`: Thrown when you set a nested path to a non-object value with [strict mode set](https://mongoosejs.com/docs/guide.html#strict).
 * - `ObjectParameterError`: Thrown when you pass a non-object value to a function which e***REMOVED***pects an object as a paramter
...
module.e***REMOVED***ports = e***REMOVED***ports = MongooseError;
 ...
 *
 * - `kind`: The validator's `type`, like `'required'` or `'rege***REMOVED***p'`
...
/**
 * An instance of this error class will be returned when mongoose failed to
 * populate with a path that is not e***REMOVED***isting.
 *
 * @api public
 * @memberOf Error
 * @static
