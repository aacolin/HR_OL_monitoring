...
class MongooseServerSelectionError e***REMOVED***tends MongooseError {
  /**
  ...
  assimilateError(err) {
    ...
    const isAtlasWhitelistError = isAtlas(reason) &&
      ...
      err.message.inde***REMOVED***Of('bad auth') === -1 &&
      err.message.inde***REMOVED***Of('Authentication failed') === -1;
...
module.e***REMOVED***ports = MongooseServerSelectionError;
