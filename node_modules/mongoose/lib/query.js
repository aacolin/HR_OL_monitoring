...
const { applyGlobalMa***REMOVED***TimeMS, applyGlobalDiskUse } = require('./helpers/query/applyGlobalOption');
...
const isE***REMOVED***clusive = require('./helpers/projection/isE***REMOVED***clusive');
 ...
 *     query.where('age').gte(21).e***REMOVED***ec(callback);
 *
...
function Query(conditions, options, model, collection) {
  ...
  this._e***REMOVED***ecutionStack = null;
 ...
 *     await Adventure().where({ name: /^Life/ }).e***REMOVED***ec();
 *
 *     // since Adventure is a stand-alone constructor we can also add our own
 *     // helper methods and getters without impacting global queries
 *     Adventure.prototype.startsWith = function (prefi***REMOVED***) {
 *       this.where({ name: new RegE***REMOVED***p('^' + prefi***REMOVED***) })
 *       return this;
 *     }
 ...
 *       }
 *     })
 *     await Adventure().highlyRated.startsWith('Life').e***REMOVED***ec();
 *
...
Query.prototype.toConstructor = function toConstructor() {
  ...
  // Need to handle `sort()` separately because entries-style `sort()` synta***REMOVED***
...
/**
 * Make a copy of this query so you can re-e***REMOVED***ecute it.
 *
 * #### E***REMOVED***ample:
 *
 *     const q = Book.findOne({ title: 'Casino Royale' });
 *     await q.e***REMOVED***ec();
 *     await q.e***REMOVED***ec(); // Throws an error because you can't e***REMOVED***ecute a query twice
 *
 *     await q.clone().e***REMOVED***ec(); // Works
 *
 * @method clone
 * @return {Query} copy
 * @memberOf Query
...
/**
 * Specifies a javascript function or e***REMOVED***pression to pass to MongoDBs query system.
 *
 * #### E***REMOVED***ample:
 *
 ...
 * #### E***REMOVED***ample:
 *
 *     const docs = await MyModel.where('tags').size(0).e***REMOVED***ec();
...
/**
 * Specifies a `$rege***REMOVED***` query condition.
 *
 * When called with one argument, the most recent path passed to `where()` is used.
 *
 * @see $rege***REMOVED*** https://www.mongodb.com/docs/manual/reference/operator/rege***REMOVED***/
 * @method rege***REMOVED***
 * @memberOf Query
 * @instance
 * @param {String} [path]
 * @param {String|RegE***REMOVED***p} val
 * @api public
 */

/**
 * Specifies a `ma***REMOVED***Distance` query condition.
 *
 * When called with one argument, the most recent path passed to `where()` is used.
 *
 * @see $ma***REMOVED***Distance https://www.mongodb.com/docs/manual/reference/operator/ma***REMOVED***Distance/
 * @method ma***REMOVED***Distance
 * @memberOf Query
 * @instance
 * @param {String} [path]
 * @param {Number} val
 ...
 *     // This synta***REMOVED*** is a little strange, but supported.
 *     Product.find().where('inventory').mod(2, 1);
 *
 * @method mod
 * @memberOf Query
...
/**
 * Specifies an `$e***REMOVED***ists` condition
 *
 * #### E***REMOVED***ample:
 *
 *     // { name: { $e***REMOVED***ists: true }}
 *     Thing.where('name').e***REMOVED***ists()
 *     Thing.where('name').e***REMOVED***ists(true)
 *     Thing.find().e***REMOVED***ists('name')
 *
 *     // { name: { $e***REMOVED***ists: false }}
 *     Thing.where('name').e***REMOVED***ists(false);
 *     Thing.find().e***REMOVED***ists('name', false);
 *
 * @method e***REMOVED***ists
 * @memberOf Query
 * @instance
 * @param {String} [path]
 * @param {Boolean} val
 * @return {Query} this
 * @see $e***REMOVED***ists https://www.mongodb.com/docs/manual/reference/operator/e***REMOVED***ists/
 * @api public
 */
 ...
 * #### E***REMOVED***ample:
 *
 *     query.where(path).within().bo***REMOVED***()
 *     query.where(path).within().circle()
 *     query.where(path).within().geometry()
 *
 *     query.where('loc').within({ center: [50,50], radius: 10, unique: true, spherical: true });
 *     query.where('loc').within({ bo***REMOVED***: [[40.73, -73.9], [40.7, -73.988]] });
 *     query.where('loc').within({ polygon: [[],[],[],[]] });
 *
 *     query.where('loc').within([], [], []) // polygon
 *     query.where('loc').within([], []) // bo***REMOVED***
 ...
 * #### Note:
 *
 * In Mongoose 3.7, `within` changed from a getter to a function. If you need the old synta***REMOVED***, use [this](https://github.com/ebensing/mongoose-within).
 *
 * @method within
 * @see $polygon https://www.mongodb.com/docs/manual/reference/operator/polygon/
 * @see $bo***REMOVED*** https://www.mongodb.com/docs/manual/reference/operator/bo***REMOVED***/
...
/**
 * Specifies the ma***REMOVED***imum number of documents the query will return.
 *
 * #### E***REMOVED***ample:
 *
 *     query.limit(20);
 ...
 * #### E***REMOVED***ample:
 *
 *     query.hint({ inde***REMOVED***A: 1, inde***REMOVED***B: -1 });
 *
 * #### Note:
 *
 * Cannot be used with `distinct()`
 ...
 * projection in place. This function overwrites the e***REMOVED***isting projection.
 *
 * #### E***REMOVED***ample:
 *
 *     const q = Model.find();
...
/**
 * Specifies which document fields to include or e***REMOVED***clude (also known as the query "projection")
 *
 * When using string synta***REMOVED***, prefi***REMOVED***ing a path with `-` will flag that path as e***REMOVED***cluded. When a path does not have the `-` prefi***REMOVED***, it is included. Lastly, if a path is prefi***REMOVED***ed with `+`, it forces inclusion of the path, which is useful for paths e***REMOVED***cluded at the [schema level](https://mongoosejs.com/docs/api/schematype.html#SchemaType.prototype.select()).
 *
 * A projection _must_ be either inclusive or e***REMOVED***clusive. In other words, you must
 * either list the fields to include (which e***REMOVED***cludes all others), or list the fields
 * to e***REMOVED***clude (which implies all other fields are included). The [`_id` field is the only e***REMOVED***ception because MongoDB includes it by default](https://www.mongodb.com/docs/manual/tutorial/project-fields-from-query-results/#suppress-id-field).
 *
 * #### E***REMOVED***ample:
 *
 *     // include a and b, e***REMOVED***clude other fields
 *     query.select('a b');
 *     // Equivalent synta***REMOVED***es:
 *     query.select(['a', 'b']);
 *     query.select({ a: 1, b: 1 });
 *
 *     // e***REMOVED***clude c and d, include other fields
 *     query.select('-c -d');
 *
 ...
 *     });
 *     // ...
 *     query.select('+foo'); // Override foo's `select: false` without e***REMOVED***cluding `bar`
 *
 *     // or you may use object notation, useful when
 *     // you have keys already prefi***REMOVED***ed with a "-"
 *     query.select({ a: 1, b: 1 });
...
Query.prototype.select = function select() {
  ...
  if (utils.isObject(arg)) {
    ...
    } else if (this.selectedE***REMOVED***clusively()) {
      Object.entries(arg).forEach(([key, value]) => {
        if (!value) {
          // Add the field to the projection
          if (fields['+' + key] != null) {
 ...
 * 2. Prevents using `+` synta***REMOVED*** to override properties that are deselected by default.
 *
 ...
 *     // in projections, which can lead to une***REMOVED***pected leaking of sensitive data.
 ...
 *     await mongoose.model('Person').findOne({ name: 'A***REMOVED***l Rose' }).session(s);
 *
 * @method session
 * @memberOf Query
 * @instance
 ...
 * - `wtimeout`: If [`w > 1`](https://mongoosejs.com/docs/api/query.html#Query.prototype.w()), the ma***REMOVED***imum amount of time to wait for this write to propagate through the replica set before this operation fails. The default is `0`, which means no timeout.
 *
...
/**
 * If [`w > 1`](https://mongoosejs.com/docs/api/query.html#Query.prototype.w()), the ma***REMOVED***imum amount of time to
 ...
 * linearizable  MongoDB 3.4+ The query returns data that reflects all successful majority-acknowledged writes that completed prior to the start of the read operation. The query may wait for concurrently e***REMOVED***ecuting writes to propagate to a majority of replica set members before returning results.
 ...
 *     query.limit(10);
 *     query.setOptions({ ma***REMOVED***TimeMS: 1000 });
 *     query.getOptions(); // { limit: 10, ma***REMOVED***TimeMS: 1000 }
 *
 ...
 * - useBigInt64
 *
 * The following options are only for all operations **e***REMOVED***cept** `updateOne()`, `updateMany()`, `deleteOne()`, and `deleteMany()`:
 *
 * - [ma***REMOVED***TimeMS](https://www.mongodb.com/docs/manual/reference/operator/meta/ma***REMOVED***TimeMS/)
 *
 ...
 * - [e***REMOVED***plain](https://www.mongodb.com/docs/manual/reference/method/cursor.e***REMOVED***plain/)
 *
 * @param {Object} options
 * @return {Query} this
 * @api public
...
/**
 * Sets the [`e***REMOVED***plain` option](https://www.mongodb.com/docs/manual/reference/method/cursor.e***REMOVED***plain/),
 * which makes this query return detailed e***REMOVED***ecution stats instead of the actual
 * query result. This method is useful for determining what inde***REMOVED*** your queries
 * use.
 *
 * Calling `query.e***REMOVED***plain(v)` is equivalent to `query.setOptions({ e***REMOVED***plain: v })`
 *
 * #### E***REMOVED***ample:
 *
 *     const query = new Query();
 *     const res = await query.find({ a: 1 }).e***REMOVED***plain('queryPlanner');
 *     console.log(res);
 *
 * @param {String} [verbose] The verbosity mode. Either 'queryPlanner', 'e***REMOVED***ecutionStats', or 'allPlansE***REMOVED***ecution'. The default is 'queryPlanner'
 * @return {Query} this
 * @api public
 */

Query.prototype.e***REMOVED***plain = function e***REMOVED***plain(verbose) {
  if (arguments.length === 0) {
    this.options.e***REMOVED***plain = true;
  } else if (verbose === false) {
    delete this.options.e***REMOVED***plain;
  } else {
    this.options.e***REMOVED***plain = verbose;
  }
  return this;
};
 ...
 * let you work around `QueryE***REMOVED***ceededMemoryLimitNoDiskUseAllowed` errors from the MongoDB server.
 *
...
/**
 * Sets the [ma***REMOVED***TimeMS](https://www.mongodb.com/docs/manual/reference/method/cursor.ma***REMOVED***TimeMS/)
 * option. This will tell the MongoDB server to abort if the query or write op
 * has been running for more than `ms` milliseconds.
 *
 * Calling `query.ma***REMOVED***TimeMS(v)` is equivalent to `query.setOptions({ ma***REMOVED***TimeMS: v })`
 *
 * #### E***REMOVED***ample:
 *
 *     const query = new Query();
 *     // Throws an error 'operation e***REMOVED***ceeded time limit' as long as there's
 *     // >= 1 doc in the queried collection
 *     const res = await query.find({ $where: 'sleep(1000) || true' }).ma***REMOVED***TimeMS(100);
 *
...
Query.prototype.ma***REMOVED***TimeMS = function(ms) {
  this.options.ma***REMOVED***TimeMS = ms;
  return this;
};
 ...
 *
 * @method _fieldsForE***REMOVED***ec
 * @return {Object}
 * @api private
 * @memberOf Query
 */

Query.prototype._fieldsForE***REMOVED***ec = function() {
 ...
 *
 * @method _updateForE***REMOVED***ec
 * @return {Object}
 * @api private
 * @memberOf Query
 */

Query.prototype._updateForE***REMOVED***ec = function() {
  ...
  while (i--) {
    ...
    if ('$' !== op[0]) {
      ...
      ops.splice(i, 1);
      if (!~ops.inde***REMOVED***Of('$set')) ops.push('$set');
    } else if ('$set' === op) {
      if (!ret.$set) {
        ret[op] = update[op];
      }
...
Query.prototype._optionsForE***REMOVED***ec = function(model) {
  ...
  if (this._fields != null) {
    ...
    const projection = this._fieldsForE***REMOVED***ec();
    if (projection != null) {
 ...
 * undefined, the `e***REMOVED***ec()` promise will reject without e***REMOVED***ecuting.
 *
 * #### E***REMOVED***ample:
 *
 *     Query().error(); // Get current error value
 *     Query().error(null); // Unset the current error
 *     Query().error(new Error('test')); // `e***REMOVED***ec()` will resolve with test
 ...
 *     TestModel.find({ num: 'not a number' }).error(new Error('woops')).e***REMOVED***ec(function(error) {
 *       // `error` will be a cast error because `num` failed to cast
 *     });
 *
 * @param {Error|null} err if set, `e***REMOVED***ec()` will fail fast before sending the query to MongoDB
 * @return {Query} this
 * @api public
 */
...
Query.prototype._find = async function _find() {
  ...
  applyGlobalMa***REMOVED***TimeMS(this.options, this.model.db.options, this.model.base.options);
...
/**
 * Internal helper to e***REMOVED***ecute a findOne() operation
 *
...
/**
 * Declares the query a findOne operation. When e***REMOVED***ecuted, the first found document is passed to the callback.
 *
...
/**
 * E***REMOVED***ecute a countDocuments query
 *
...
/**
 * E***REMOVED***ecute a estimatedDocumentCount() query
 *
 ...
 * e***REMOVED***cept it always does a full collection scan when passed an empty filter `{}`.
 *
 ...
 *
 *     query.countDocuments({ color: 'black' }).count().e***REMOVED***ec();
 *
 *     await query.countDocuments({ color: 'black' });
 *
 *     query.where('color', 'black').countDocuments().e***REMOVED***ec();
 *
...
/**
 * E***REMOVED***ecute a `distinct()` query
 *
...
/**
 * Declares or e***REMOVED***ecutes a distinct() operation.
 *
 ...
 * sort order of each path is ascending unless the path name is prefi***REMOVED***ed with `-`
 ...
 * @param {Object} [options]
 * @param {Boolean} [options.override=false] If true, replace e***REMOVED***isting sort options with `arg`
 * @return {Query} this
...
Query.prototype.sort = function(arg, options) {
  ...
  if (typeof arg === 'string') {
    const properties = arg.inde***REMOVED***Of(' ') === -1 ? [arg] : arg.split(' ');
...
/**
 * Declare and/or e***REMOVED***ecute this query as a `deleteOne()` operation. Works like
 * remove, e***REMOVED***cept it deletes at most one document regardless of the `single`
 * option.
 *
...
/**
 * Declare and/or e***REMOVED***ecute this query as a `deleteMany()` operation. Works like
 * remove, e***REMOVED***cept it deletes _every_ document that matches `filter` in the
...
/**
 * E***REMOVED***ecute a `deleteMany()` query
 *
 ...
 * - `upsert`: bool - creates the object if it doesn't e***REMOVED***ist. defaults to false.
 * - `fields`: {Object|String} - Field selection. Equivalent to `.select(fields).findOneAndUpdate()`
 * - `sort`: if multiple docs are found by the conditions, sets the sort order to choose which doc to update
 * - `ma***REMOVED***TimeMS`: puts a time limit on the query - requires mongodb >= 2.6.0
 ...
 * @param {Boolean} [options.overwriteImmutable=false] Mongoose removes updated immutable properties from `update` by default (e***REMOVED***cluding $setOnInsert). Set `overwriteImmutable` to `true` to allow updating immutable properties using other update operators.
...
/**
 * E***REMOVED***ecute a findOneAndUpdate operation
 *
...
Query.prototype._findOneAndUpdate = async function _findOneAndUpdate() {
  ...
  const options = this._optionsForE***REMOVED***ec(this.model);
...
/**
 * E***REMOVED***ecute a `findOneAndDelete()` query
 *
 * @return {Query} this
...
/**
 * E***REMOVED***ecute a findOneAndReplace() query
 *
 * @return {Query} this
...
function _getOption(query, option, def) {
  const opts = query._optionsForE***REMOVED***ec(query.model);
...
Query.prototype._mergeUpdate = function(doc) {
  ...
  if (doc instanceof Query) {
    if (Array.isArray(this._update)) {
      throw new Error('Cannot mi***REMOVED*** array and object updates');
    }
    if (doc._update) {
 ...
 * @param {Object} options the options from `_optionsForE***REMOVED***ec()`
...
Query.prototype.validate = async function validate(castedDoc, options, isOverwriting) {
  ...
  await _e***REMOVED***ecutePreHooks(this, 'validate');
  ...
  await _e***REMOVED***ecutePostHooks(this, null, null, 'validate');
};

/**
 * E***REMOVED***ecute an updateMany query
 *
...
/**
 * E***REMOVED***ecute an updateOne query
 *
 * @see Model.update https://mongoosejs.com/docs/api/model.html#Model.update()
 * @method _updateOne
 * @memberOf Query
...
/**
 * E***REMOVED***ecute a replaceOne query
 *
...
/**
 * Declare and/or e***REMOVED***ecute this query as an updateMany() operation.
...
/**
 * Declare and/or e***REMOVED***ecute this query as an updateOne() operation.
...
/**
 * Declare and/or e***REMOVED***ecute this query as a replaceOne() operation.
 * MongoDB will replace the e***REMOVED***isting document and will not accept any [atomic operators](https://www.mongodb.com/docs/manual/tutorial/model-data-for-atomic-operations/#pattern) (`$set`, etc.)
 *
 ...
 * an e***REMOVED***tra `if` statement to check if no document was found.
 *
 * #### E***REMOVED***ample:
 *
...
/**
 * E***REMOVED***ecutes the query
 *
 * #### E***REMOVED***ample:
 *
 *     const promise = query.e***REMOVED***ec();
 *     const promise = query.e***REMOVED***ec('update');
 *
...
Query.prototype.e***REMOVED***ec = async function e***REMOVED***ec(op) {
  if (typeof op === 'function' || (arguments.length >= 2 && typeof arguments[1] === 'function')) {
    throw new MongooseError('Query.prototype.e***REMOVED***ec() no longer accepts a callback');
  }
  ...
  if (this.op == null) {
    throw new MongooseError('Query must have `op` before e***REMOVED***ecuting');
  }
  if (this.model == null) {
    throw new MongooseError('Query must have an associated model before e***REMOVED***ecuting');
  }
  this._validateOp();
  ...
  if (this._e***REMOVED***ecutionStack != null) {
    let str = this.toString();
    if (str.length > 60) {
      str = str.slice(0, 60) + '...';
    }
    const err = new MongooseError('Query was already e***REMOVED***ecuted: ' + str);
    err.originalStack = this._e***REMOVED***ecutionStack.stack;
    throw err;
  } else {
    this._e***REMOVED***ecutionStack = new Error();
  }

  let skipWrappedFunction = null;
  try {
    await _e***REMOVED***ecutePreE***REMOVED***ecHooks(this);
  } catch (err) {
  ...
  let error = null;
  try {
    await _e***REMOVED***ecutePreHooks(this);
  ...
  res = await _e***REMOVED***ecutePostHooks(this, res, error);

  await _e***REMOVED***ecutePostE***REMOVED***ecHooks(this);
...
function _e***REMOVED***ecutePostE***REMOVED***ecHooks(query) {
  return new Promise((resolve, reject) => {
    query._hooks.e***REMOVED***ecPost('e***REMOVED***ec', query, [], {}, (error) => {
      if (error) {
        return reject(error);
      }
...
function _e***REMOVED***ecutePostHooks(query, res, error, op) {
  ...
  return new Promise((resolve, reject) => {
    ...
    query._queryMiddleware.e***REMOVED***ecPost(op || query.op, query, [res], opts, (error, res) => {
      if (error) {
        return reject(error);
      }
...
function _e***REMOVED***ecutePreE***REMOVED***ecHooks(query) {
  return new Promise((resolve, reject) => {
    query._hooks.e***REMOVED***ecPre('e***REMOVED***ec', query, [], (error) => {
      if (error != null) {
        return reject(error);
      }
      resolve();
...
function _e***REMOVED***ecutePreHooks(query, op) {
  if (query._queryMiddleware == null) {
    return;
  }

  return new Promise((resolve, reject) => {
    query._queryMiddleware.e***REMOVED***ecPre(op || query.op, query, [], (error) => {
      if (error != null) {
        return reject(error);
      }
      resolve();
...
/**
 * E***REMOVED***ecutes the query returning a `Promise` which will be
...
Query.prototype.then = function(resolve, reject) {
  return this.e***REMOVED***ec().then(resolve, reject);
};
...
Query.prototype.catch = function(reject) {
  return this.e***REMOVED***ec().then(null, reject);
};
...
Query.prototype.finally = function(onFinally) {
  return this.e***REMOVED***ec().finally(onFinally);
};
 ...
 *     });
 *     await q1.e***REMOVED***ec(); // Prints "{ answer: 42 }"
 *
...
Query.prototype.pre = function(fn) {
  this._hooks.pre('e***REMOVED***ec', fn);
  return this;
};
...
Query.prototype.post = function(fn) {
  this._hooks.post('e***REMOVED***ec', fn);
  return this;
};
 ...
 *       match: { name: new RegE***REMOVED***p('.*h.*', 'i') },
 *       sort: { name: -1 }
 *     });
 ...
 *     books[1].authors; // []
 *
 * Paths are populated after the query e***REMOVED***ecutes and a response is received. A
 * separate query is then e***REMOVED***ecuted for each path specified for population. After
...
function _getPopulatedPaths(list, arr, prefi***REMOVED***) {
  for (const pop of arr) {
    list.push(prefi***REMOVED*** + pop.path);
    if (!Array.isArray(pop.populate)) {
      continue;
    }
    _getPopulatedPaths(list, pop.populate, prefi***REMOVED*** + pop.path + '.');
  }
}
 ...
 *
 *     query.select({ ids: { $elemMatch: { $in: [he***REMOVED***String] }})
 *
 * @param {Object} fields
 ...
 * A QueryCursor e***REMOVED***poses a Streams3 interface, as well as a `.ne***REMOVED***t()` function.
 *
 ...
 *
 *     // Or you can use `.ne***REMOVED***t()` to manually get the ne***REMOVED***t doc in the stream.
 *     // `.ne***REMOVED***t()` returns a promise, so you can use promises or callbacks.
 *     const cursor = Thing.find({ name: /^hello/ }).cursor();
 *     cursor.ne***REMOVED***t(function(error, doc) {
 *       console.log(doc);
 *     });
 *
 *     // Because `.ne***REMOVED***t()` returns a promise, you can use co
 *     // to easily iterate through all documents without loading them
 *     // all into memory.
 *     const cursor = Thing.find({ name: /^hello/ }).cursor();
 *     for (let doc = await cursor.ne***REMOVED***t(); doc != null; doc = await cursor.ne***REMOVED***t()) {
 *       console.log(doc);
 *     }
 *
 * #### Valid options
 *
 *   - `transform`: optional function which accepts a mongoose document. The return value of the function will be emitted on `data` and returned by `.ne***REMOVED***t()`.
 *
 * @return {QueryCursor}
 * @param {Object} [options]
...
// the rest of these are basically to support older Mongoose synta***REMOVED*** with mquery
 ...
 * @param {Number} [opts.ma***REMOVED***AwaitTimeMS] the ma***REMOVED***imum amount of time for the server to wait on new documents to satisfy a tailable cursor query. Requires `tailable` and `awaitData` to be true
...
Query.prototype.tailable = function(val, opts) {
  ...
  // tailable(true, {awaitData :true}) synta***REMOVED*** that mquery does not support
 ...
 * #### Note:
 *
 * In Mongoose 3.7, `intersects` changed from a getter to a function. If you need the old synta***REMOVED***, use [this](https://github.com/ebensing/mongoose-within).
 *
 * @method intersects
 * @memberOf Query
 * @instance
 ...
 * @memberOf Query
 * @instance
 * @param {Object} object Must contain a `type` property which is a String and a `coordinates` property which is an Array. See the e***REMOVED***amples.
 * @return {Query} this
 * @see $geometry https://www.mongodb.com/docs/manual/reference/operator/geometry/
 * @see Geospatial Support Enhancements https://www.mongodb.com/docs/manual/release-notes/2.4/#geospatial-support-enhancements
 * @see MongoDB Geospatial Inde***REMOVED***ing https://www.mongodb.com/docs/manual/core/geospatial-inde***REMOVED***es/
 * @api public
 */
 ...
 *     query.where('loc').near({ center: [10, 10], ma***REMOVED***Distance: 5 });
 *     query.where('loc').near({ center: [10, 10], ma***REMOVED***Distance: 5, spherical: true });
 *     query.near('loc', { center: [10, 10], ma***REMOVED***Distance: 5 });
 *
 * @method near
 * @memberOf Query
 * @instance
 ...
 * #### E***REMOVED***ample:
 *
 *     query.where('loc').nearSphere({ center: [10, 10], ma***REMOVED***Distance: 5 });
 *
 ...
 * You do not need to call this function e***REMOVED***plicitly, the JavaScript runtime
 ...
 *     }
 *
 * Node.js 10.***REMOVED*** supports async iterators natively without any flags. You can
 * enable async iterators in Node.js 8.***REMOVED*** using the [`--harmony_async_iteration` flag](https://github.com/tc39/proposal-async-iteration/issues/117#issuecomment-346695187).
 *
...
/**
 * Specifies a `$bo***REMOVED***` condition
 *
 * #### E***REMOVED***ample:
 *
 ...
 *
 *     query.where('loc').within().bo***REMOVED***(lowerLeft, upperRight)
 *     query.bo***REMOVED***({ ll : lowerLeft, ur : upperRight })
 *
 * @method bo***REMOVED***
 * @memberOf Query
 * @instance
...
/**
 * this is needed to support the mongoose synta***REMOVED*** of:
 * bo***REMOVED***(field, { ll : [***REMOVED***,y], ur : [***REMOVED***2,y2] })
 * bo***REMOVED***({ ll : [***REMOVED***,y], ur : [***REMOVED***2,y2] })
 *
 * @method bo***REMOVED***
 * @memberOf Query
 * @instance
...
Query.prototype.bo***REMOVED*** = function(ll, ur) {
  if (!Array.isArray(ll) && utils.isObject(ll)) {
    ur = ll.ur;
    ll = ll.ll;
  }
  return Query.base.bo***REMOVED***.call(this, ll, ur);
};
...
/**
 * Determines if e***REMOVED***clusive field selection has been made.
 *
 *     query.selectedE***REMOVED***clusively(); // false
 *     query.select('-name');
 *     query.selectedE***REMOVED***clusively(); // true
 *     query.selectedInclusively(); // false
 *
 * @method selectedE***REMOVED***clusively
 * @memberOf Query
 * @instance
 * @return {Boolean}
 * @api public
...
Query.prototype.selectedE***REMOVED***clusively = function selectedE***REMOVED***clusively() {
  return isE***REMOVED***clusive(this._fields);
};
