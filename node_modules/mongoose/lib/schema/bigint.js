...
SchemaBigInt.prototype.castForQuery = function($conditional, val, conte***REMOVED***t) {
  let handler;
  if ($conditional != null) {
    ...
    return this.applySetters(null, val, conte***REMOVED***t);
  }
...
module.e***REMOVED***ports = SchemaBigInt;
