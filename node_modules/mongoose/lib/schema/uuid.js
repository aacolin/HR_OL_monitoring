...
/**
 * Helper function to convert the input he***REMOVED***-string to a buffer
 * @param {String} he***REMOVED*** The he***REMOVED*** string to convert
 * @returns {Buffer} The he***REMOVED*** as buffer
 * @api private
 */

function he***REMOVED***2buffer(he***REMOVED***) {
  // use buffer built-in function to convert from he***REMOVED***-string to buffer
  const buff = he***REMOVED*** != null && Buffer.from(he***REMOVED***, 'he***REMOVED***');
  return buff;
}
...
function stringToBinary(uuidStr) {
  ...
  const he***REMOVED*** = uuidStr.replace(/[{}-]/g, ''); // remove e***REMOVED***tra characters
  const bytes = he***REMOVED***2buffer(he***REMOVED***);
...
function binaryToString(uuidBin) {
  ...
  if (typeof uuidBin !== 'string' && uuidBin != null) {
    he***REMOVED*** = uuidBin.toString('he***REMOVED***');
    const uuidStr = he***REMOVED***.substring(0, 8) + '-' + he***REMOVED***.substring(8, 8 + 4) + '-' + he***REMOVED***.substring(12, 12 + 4) + '-' + he***REMOVED***.substring(16, 16 + 4) + '-' + he***REMOVED***.substring(20, 20 + 12);
    return uuidStr;
  }
  return uuidBin;
}
...
SchemaUUID.prototype.castForQuery = function($conditional, val, conte***REMOVED***t) {
  let handler;
  if ($conditional != null) {
...
module.e***REMOVED***ports = SchemaUUID;
