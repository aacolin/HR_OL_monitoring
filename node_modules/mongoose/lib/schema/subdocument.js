...
module.e***REMOVED***ports = SchemaSubdocument;
...
SchemaSubdocument.prototype.$conditionalHandlers.$geoWithin = function handle$geoWithin(val, conte***REMOVED***t) {
  return { $geometry: this.castForQuery(null, val.$geometry, conte***REMOVED***t) };
};
...
SchemaSubdocument.prototype.$conditionalHandlers.$ma***REMOVED***Distance = castToNumber;

SchemaSubdocument.prototype.$conditionalHandlers.$e***REMOVED***ists = $e***REMOVED***ists;
...
SchemaSubdocument.prototype.cast = function(val, doc, init, priorVal, options) {
  ...
  if (val != null && (typeof val !== 'object' || Array.isArray(val))) {
    throw new ObjectE***REMOVED***pectedError(this.path, val);
  }
  ...
  if (init) {
    ...
    subdoc.$init(val);
    const e***REMOVED***clude = isE***REMOVED***clusive(selected);
    applyDefaults(subdoc, selected, e***REMOVED***clude);
  } else {
...
SchemaSubdocument.prototype.castForQuery = function($conditional, val, conte***REMOVED***t, options) {
  let handler;
  if ($conditional != null) {
  ...
  if (this.options.runSetters) {
    val = this._applySetters(val, conte***REMOVED***t);
  }
...
SchemaSubdocument.prototype.discriminator = function(name, schema, options) {
  ...
  schema = discriminator(this.caster, name, schema, value, null, null, options.overwriteE***REMOVED***isting);
