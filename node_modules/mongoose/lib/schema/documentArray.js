...
SchemaDocumentArray.prototype.discriminator = function(name, schema, options) {
  ...
  schema = discriminator(this.casterConstructor, name, schema, tiedValue, null, null, options?.overwriteE***REMOVED***isting);
...
SchemaDocumentArray.prototype.doValidate = function(array, fn, scope, options) {
  ...
  function cb(err) {
    ...
    for (let i = 0, len = count; i < len; ++i) {
      ...
      // If you set the array inde***REMOVED*** directly, the doc might not yet be
...
SchemaDocumentArray.prototype.cast = function(value, doc, init, prev, options) {
  ...
  if (options.arrayPathInde***REMOVED*** != null) {
    value[arrayPathSymbol] = path + '.' + options.arrayPathInde***REMOVED***;
  }
  ...
  for (let i = 0; i < len; ++i) {
    ...
    if (rawArray[i] instanceof Subdocument) {
      ...
      // Might not have the correct inde***REMOVED*** yet, so ensure it does.
      if (rawArray[i].__inde***REMOVED*** == null) {
        rawArray[i].$setInde***REMOVED***(i);
      }
      ...
      if (init) {
        ...
        if (prev && subdoc && utils.deepEqual(subdoc.toObject(_toObjectOptions), rawArray[i])) {
          // handle resetting doc with e***REMOVED***isting id and same data
...
function cast$elemMatch(val, conte***REMOVED***t) {
  ...
  if (discriminatorKey != null &&
    ...
    return cast(discriminators[val[discriminatorKey]], val, null, this && this.$$conte***REMOVED***t);
  }

  const schema = this.casterConstructor.schema ?? conte***REMOVED***t.schema;
  return cast(schema, val, null, this && this.$$conte***REMOVED***t);
}
...
module.e***REMOVED***ports = SchemaDocumentArray;
