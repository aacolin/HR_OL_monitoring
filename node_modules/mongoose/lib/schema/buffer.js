 ...
 *     mongoose.Schema.Types.Buffer.get(v => v.toString('he***REMOVED***'));
 *
...
SchemaBuffer.prototype.castForQuery = function($conditional, val, conte***REMOVED***t) {
  let handler;
  if ($conditional != null) {
  ...
  let casted;
  try {
    casted = this.applySetters(val, conte***REMOVED***t);
  } catch (err) {
...
module.e***REMOVED***ports = SchemaBuffer;
