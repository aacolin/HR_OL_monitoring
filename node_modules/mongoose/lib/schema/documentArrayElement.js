...
SchemaDocumentArrayElement.prototype.doValidate = function(value, fn, scope, options) {
  ...
  if (value && !(value instanceof Constructor)) {
    value = new Constructor(value, scope, null, null, options && options.inde***REMOVED*** != null ? options.inde***REMOVED*** : null);
  }
...
module.e***REMOVED***ports = SchemaDocumentArrayElement;
