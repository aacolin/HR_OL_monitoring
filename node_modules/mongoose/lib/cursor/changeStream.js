...
class ChangeStream e***REMOVED***tends EventEmitter {
  ...
  hasNe***REMOVED***t(cb) {
    if (this.errored) {
      throw new MongooseError('Cannot call hasNe***REMOVED***t() on errored ChangeStream');
    }
    return this.driverChangeStream.hasNe***REMOVED***t(cb);
  }

  ne***REMOVED***t(cb) {
    if (this.errored) {
      throw new MongooseError('Cannot call ne***REMOVED***t() on errored ChangeStream');
    }
    if (this.options && this.options.hydrate) {
      ...
      let maybePromise = this.driverChangeStream.ne***REMOVED***t(cb);
    ...
    return this.driverChangeStream.ne***REMOVED***t(cb);
  }
...
module.e***REMOVED***ports = ChangeStream;
