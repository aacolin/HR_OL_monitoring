...
function NativeConnection() {
  ...
  // Tracks the last time (as uni***REMOVED*** timestamp) the connection received a
...
/**
 * E***REMOVED***pose the possible connection states.
 * @api public
 */
...
NativeConnection.prototype.createClient = async function createClient(uri, options) {
  ...
  if (options) {
    ...
    const autoInde***REMOVED*** = options.config && options.config.autoInde***REMOVED*** != null ?
      options.config.autoInde***REMOVED*** :
      options.autoInde***REMOVED***;
    if (autoInde***REMOVED*** != null) {
      this.config.autoInde***REMOVED*** = autoInde***REMOVED*** !== false;
      delete options.config;
      delete options.autoInde***REMOVED***;
    }
    ...
    if ('autoSearchInde***REMOVED***' in options) {
      this.config.autoSearchInde***REMOVED*** = options.autoSearchInde***REMOVED***;
      delete options.autoSearchInde***REMOVED***;
    }
  ...
  client.setMa***REMOVED***Listeners(0);
...
module.e***REMOVED***ports = NativeConnection;
