...
function MongooseDocumentArray(values, path, doc, schematype) {
  ...
  // Because doc comes from the conte***REMOVED***t of another function, doc === global
  // can happen if there was a null somewhere up the chain (see #3020 && #3034)
  // RB Jun 17, 2015 updated to check for presence of e***REMOVED***pected paths instead
  ...
  const pro***REMOVED***y = new Pro***REMOVED***y(__array, {
    get: function(target, prop) {
      if (prop === 'isMongooseArray' ||
          prop === 'isMongooseArrayPro***REMOVED***y' ||
          prop === 'isMongooseDocumentArray' ||
          prop === 'isMongooseDocumentArrayPro***REMOVED***y') {
        return true;
      }
    ...
    set: function(target, prop, value) {
      if (typeof prop === 'string' && numberRE.test(prop)) {
        DocumentArrayMethods.set.call(pro***REMOVED***y, prop, value, false);
...
module.e***REMOVED***ports = MongooseDocumentArray;
