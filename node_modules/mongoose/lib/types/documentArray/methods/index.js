...
const methods = {
  ...
  _cast(value, inde***REMOVED***, options) {
    ...
    if (isInstance ||
      ...
      value.$setInde***REMOVED***(inde***REMOVED***);
      return value;
    }
    ...
    if (Constructor.$isMongooseDocumentArray) {
      return Constructor.cast(value, this, undefined, undefined, inde***REMOVED***);
    }
    const ret = new Constructor(value, this, options, undefined, inde***REMOVED***);
    ret.isNew = true;
    return ret;
  },
    ...
    if (parent) {
      ...
      if (arguments.length) {
        if (embeddedPath != null) {
          ...
          const inde***REMOVED*** = elem.__inde***REMOVED***;
          dirtyPath = dirtyPath + '.' + inde***REMOVED*** + '.' + embeddedPath;
        } else {
          // directly set an inde***REMOVED***
