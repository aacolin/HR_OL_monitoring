...
const methods = {
   ...
   *
   * If no atomics e***REMOVED***ist, we return all array values after conversion.
   *
   * @return {Array}
   * @method $__getAtomics
  ...
  _mapCast(val, inde***REMOVED***) {
    return this._cast(val, this.length + inde***REMOVED***);
  },
  ...
  includes(obj, fromInde***REMOVED***) {
    const ret = this.inde***REMOVED***Of(obj, fromInde***REMOVED***);
    return ret !== -1;
  },

  /**
   * Return the inde***REMOVED*** of `obj` or `-1` if not found.
   *
   * @param {Object} obj the item to look for
   * @param {Number} fromInde***REMOVED***
   * @return {Number}
   * @api public
   * @method inde***REMOVED***Of
   * @memberOf MongooseArray
   */

  inde***REMOVED***Of(obj, fromInde***REMOVED***) {
    if (isBsonType(obj, 'ObjectId')) {
      obj = obj.toString();
    }

    fromInde***REMOVED*** = fromInde***REMOVED*** == null ? 0 : fromInde***REMOVED***;
    const len = this.length;
    for (let i = fromInde***REMOVED***; i < len; ++i) {
      if (obj == this[i]) {
        return i;
      }
    }
  ...
  pull() {
    ...
    while (i--) {
      ...
      } else if (~this.inde***REMOVED***Of.call(values, mem)) {
        cur.splice(i, 1);
      }
    }
...
module.e***REMOVED***ports = methods;
