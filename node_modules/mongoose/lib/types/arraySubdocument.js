...
function ArraySubdocument(obj, parentArr, skipId, fields, inde***REMOVED***) {
  ...
  this.$setInde***REMOVED***(inde***REMOVED***);
...
ArraySubdocument.prototype.$setInde***REMOVED*** = function(inde***REMOVED***) {
  this.__inde***REMOVED*** = inde***REMOVED***;
 ...
 *
 * @param {String} [path]
 * @param {Boolean} [skipInde***REMOVED***] Skip adding the array inde***REMOVED***. For e***REMOVED***ample `arr.foo` instead of `arr.0.foo`.
 * @return {String}
 * @api private
 * @method $__fullPath
...
ArraySubdocument.prototype.$__fullPath = function(path, skipInde***REMOVED***) {
  if (this.__inde***REMOVED*** == null) {
    return null;
  }
  if (!this.$__.fullPath) {
    this.ownerDocument();
  ...
  return path ?
    this.$__.fullPath + '.' + this.__inde***REMOVED*** + '.' + path :
    this.$__.fullPath + '.' + this.__inde***REMOVED***;
};
...
ArraySubdocument.prototype.$__pathRelativeToParent = function(path, skipInde***REMOVED***) {
  if (this.__inde***REMOVED*** == null || (!this.__parentArray || !this.__parentArray.$path)) {
    return null;
  }
  if (skipInde***REMOVED***) {
  ...
  if (path == null) {
    return this.__parentArray.$path() + '.' + this.__inde***REMOVED***;
  }
  return this.__parentArray.$path() + '.' + this.__inde***REMOVED*** + '.' + path;
};
...
module.e***REMOVED***ports = ArraySubdocument;
