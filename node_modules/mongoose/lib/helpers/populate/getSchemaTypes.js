...
module.e***REMOVED***ports = function getSchemaTypes(model, schema, doc, path) {
  ...
  function search(parts, schema, subdoc, nestedPath) {
    ...
    while (p--) {
      ...
      if (foundschema.caster) {
        ...
        if (foundschema.caster instanceof Mi***REMOVED***ed) {
        ...
        if (foundschema.schema != null && foundschema.schema.discriminators != null) {
          ...
          schemas = Object.keys(discriminators).
            reduce(function(cur, discriminator) {
              ...
              if (doc == null || keys.inde***REMOVED***Of(discriminator) !== -1 || keys.inde***REMOVED***Of(tiedValue) !== -1) {
      ...
      } else if (foundschema.$isSchemaMap && foundschema.$__schemaType instanceof Mi***REMOVED***ed) {
