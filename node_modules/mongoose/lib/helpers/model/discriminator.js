...
const Mi***REMOVED***ed = require('../../schema/mi***REMOVED***ed');
...
module.e***REMOVED***ports = function discriminator(model, name, schema, tiedValue, applyPlugins, mergeHooks, overwriteE***REMOVED***isting) {
  ...
  const e***REMOVED***istingPath = model.schema.path(key);
  if (e***REMOVED***istingPath != null) {
    if (!utils.hasUserDefinedProperty(e***REMOVED***istingPath.options, 'select')) {
      e***REMOVED***istingPath.options.select = true;
    }
    e***REMOVED***istingPath.options.$skipDiscriminatorCheck = true;
  } else {
  ...
  function merge(schema, baseSchema) {
    ...
    for (const path of baseSchemaPaths) {
      ...
      for (const piece of sp) {
        ...
        if (schema.paths[cur] instanceof Mi***REMOVED***ed ||
            schema.singleNestedPaths[cur] instanceof Mi***REMOVED***ed) {
          conflictingPaths.push(path);
        }
      }
    }
    ...
    obj[key][schema.options.typeKey] = e***REMOVED***istingPath ? e***REMOVED***istingPath.options[schema.options.typeKey] : String;
    schema.add(obj);
  ...
  if (model.discriminators[name] && !schema.options.overwriteModels && !overwriteE***REMOVED***isting) {
    throw new Error('Discriminator with name "' + name + '" already e***REMOVED***ists');
  }
