...
module.e***REMOVED***ports = function setupTimestamps(schema, timestamps) {
  ...
  schema.pre('save', function timestampsPreSave(ne***REMOVED***t) {
  ...
  function _setTimestampsOnUpdate(ne***REMOVED***t) {
