...
const isE***REMOVED***clusive = require('../projection/isE***REMOVED***clusive');
...
module.e***REMOVED***ports = function selectPopulatedFields(fields, userProvidedFields, populateOptions) {
  ...
  } else if (isE***REMOVED***clusive(fields)) {
    for (const path of paths) {
