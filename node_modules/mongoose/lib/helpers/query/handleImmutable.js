 ...
 * @param {Query} ct***REMOVED*** the query. Passed as `this` and first param to the `immutable` option, if `immutable` is a function
 * @returns true if field was removed, false otherwise
 */

module.e***REMOVED***ports = function handleImmutable(schematype, strict, obj, key, fullPath, options, ct***REMOVED***) {
  ...
  if (typeof immutable === 'function') {
    immutable = immutable.call(ct***REMOVED***, ct***REMOVED***);
  }
  if (!immutable) {
    return false;
  }
