...
e***REMOVED***ports.flatten = flatten;
e***REMOVED***ports.modifiedPaths = modifiedPaths;
...
function flatten(update, path, options, schema) {
  ...
  for (let i = 0; i < numKeys; ++i) {
    ...
    // Avoid going into mi***REMOVED***ed paths if schema is specified
    const keySchema = schema && schema.path && schema.path(path + key);
    const isNested = schema && schema.nested && schema.nested[path + key];
    if (keySchema && keySchema.instance === 'Mi***REMOVED***ed') continue;
