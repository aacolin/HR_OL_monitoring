...
module.e***REMOVED***ports = function castArrayFilters(query) {
...
function _castArrayFilters(arrayFilters, schema, strictQuery, updatedPathsByFilter, query) {
  ...
  for (const filter of arrayFilters) {
    ...
    const dot = firstKey.inde***REMOVED***Of('.');
    ...
    for (const key of keys) {
      ...
      if (schematype == null) {
        ...
        // quite work in this conte***REMOVED***t because we never want to silently strip out
