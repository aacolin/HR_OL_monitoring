...
module.e***REMOVED***ports = function applyDefaults(doc, fields, e***REMOVED***clude, hasIncludedChildren, isBeforeSetters, pathsToSkip, options) {
  ...
  for (let i = 0; i < plen; ++i) {
    ...
    for (let j = 0; j < len; ++j) {
      ...
      if (j === len - 1) {
        ...
        if (fields && e***REMOVED***clude !== null) {
          if (e***REMOVED***clude === true) {
            // apply defaults to all non-e***REMOVED***cluded fields
            if (p in fields) {
              continue;
            }
