declare module 'mongoose' {
  ...
  type SchemaValidator<T, EnforcedDocType> = RegE***REMOVED***p | [RegE***REMOVED***p, string] | Function | [Function, string] | ValidateOpts<T, EnforcedDocType> | ValidateOpts<T, EnforcedDocType>[];
