declare module 'mongoose' {
  ...
  type MiddlewareOptions = {
    ...
    query?: boolean,
    /**
      * E***REMOVED***plicitly set this function to be a Error handler instead of based on how many arguments are used
      * @default false
      */
  ...
  type PreMiddlewareFunction<ThisType = any> = (
    this: ThisType,
    ne***REMOVED***t: CallbackWithoutResultAndOptionalError,
  ...
  type PostMiddlewareFunction<ThisType = any, ResType = any> = (this: ThisType, res: ResType, ne***REMOVED***t: CallbackWithoutResultAndOptionalError) => void | Promise<void> | Kareem.OverwriteMiddlewareResult;
  type ErrorHandlingMiddlewareFunction<ThisType = any, ResType = any> = (this: ThisType, err: NativeError, res: ResType, ne***REMOVED***t: CallbackWithoutResultAndOptionalError) => void;
  type ErrorHandlingMiddlewareWithOption<ThisType = any, ResType = any> = (this: ThisType, err: NativeError, res: ResType | null, ne***REMOVED***t: CallbackWithoutResultAndOptionalError) => void | Promise<void> | Kareem.OverwriteMiddlewareResult;
}
