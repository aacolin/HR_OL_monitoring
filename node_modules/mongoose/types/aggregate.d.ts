declare module 'mongoose' {
  ...
  /** E***REMOVED***tract generic type from Aggregate class */
  type AggregateE***REMOVED***tract<P> = P e***REMOVED***tends Aggregate<infer T> ? T : never;

  interface AggregateOptions e***REMOVED***tends Omit<mongodb.AggregateOptions, 'session'>, SessionOption {
    [key: string]: any;
  }
  ...
  class Aggregate<ResultType> implements SessionOperation {
    ...
    e***REMOVED***ec(): Promise<ResultType>;

    /** E***REMOVED***ecute the aggregation with e***REMOVED***plain */
    e***REMOVED***plain(verbosity: mongodb.E***REMOVED***plainVerbosityLike): Promise<AnyObject>;
    e***REMOVED***plain(): Promise<AnyObject>;
     ...
     * @param num ma***REMOVED***imum number of records to pass to the ne***REMOVED***t stage
     */
    ...
    redact(e***REMOVED***pression: PipelineStage.Redact['$redact'], thenE***REMOVED***pr: '$$DESCEND' | '$$PRUNE' | '$$KEEP' | AnyObject, elseE***REMOVED***pr: '$$DESCEND' | '$$PRUNE' | '$$KEEP' | AnyObject): this;
     ...
     * @param num number of records to skip before ne***REMOVED***t stage
     */
