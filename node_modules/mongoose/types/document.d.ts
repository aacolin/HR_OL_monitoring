declare module 'mongoose' {
   ...
   * *  T - the type of _id
   * *  TQueryHelpers - Object with any helpers that should be mi***REMOVED***ed into the Query type
  ...
  class Document<T = unknown, TQueryHelpers = any, DocType = any> {
    ...
    get<T e***REMOVED***tends keyof DocType>(path: T, type?: any, options?: any): DocType[T];
    ...
    */
    ...
    invalidate<T e***REMOVED***tends keyof DocType>(path: T, errorMsg: string | NativeError, value?: any, kind?: string): NativeError | null;
    invalidate(path: string, errorMsg: string | NativeError, value?: any, kind?: string): NativeError | null;

    /** Returns true if `path` was directly set and modified, else false. */
    isDirectModified<T e***REMOVED***tends keyof DocType>(path: T | Array<T>): boolean;
    isDirectModified(path: string | Array<string>): boolean;

    /** Checks if `path` was e***REMOVED***plicitly selected. If no projection, always returns true. */
    isDirectSelected<T e***REMOVED***tends keyof DocType>(path: T): boolean;
    isDirectSelected(path: string): boolean;

    /** Checks if `path` is in the `init` state, that is, it was set by `Document#init()` and not modified since. */
    isInit<T e***REMOVED***tends keyof DocType>(path: T): boolean;
     ...
     */
    isModified<T e***REMOVED***tends keyof DocType>(path?: T | Array<T>, options?: { ignoreAtomics?: boolean } | null): boolean;
    ...
    isSelected<T e***REMOVED***tends keyof DocType>(path: T): boolean;
    isSelected(path: string): boolean;

    /** Marks the path as having pending changes to write to the db. */
    markModified<T e***REMOVED***tends keyof DocType>(path: T, scope?: any): void;
    ...
    set<T e***REMOVED***tends keyof DocType>(path: T, val: DocType[T], type: any, options?: DocumentSetOptions): this;
    set(path: string | Record<string, any>, val: any, type: any, options?: DocumentSetOptions): this;
    set(path: string | Record<string, any>, val: any, options?: DocumentSetOptions): this;
    set(value: string | Record<string, any>): this;
    ...
    unmarkModified<T e***REMOVED***tends keyof DocType>(path: T): void;
    ...
    validate<T e***REMOVED***tends keyof DocType>(pathsToValidate?: T | T[], options?: AnyObject): Promise<void>;
    ...
    validateSync<T e***REMOVED***tends keyof DocType>(pathsToValidate?: T | T[], options?: AnyObject): Error.ValidationError | null;
