declare module 'mongoose' {
  ...
  interface MongooseOptions {
     ...
     * creating inde***REMOVED***es. If readPreference is secondary or secondaryPreferred, Mongoose will
     * default to false for both autoCreate and autoInde***REMOVED*** because both createCollection() and
     * createInde***REMOVED***() will fail when connected to a secondary.
     */
    autoCreate?: boolean;

    /**
     * Set to `false` to disable automatic inde***REMOVED*** creation for all models associated with this Mongoose instance.
     *
     * @default true
     */
    ...
    /**
     * If bufferCommands is on, this option sets the ma***REMOVED***imum amount of time Mongoose
     ...
     * name, then all arguments passed to the method. For e***REMOVED***ample, if you wanted to
    ...
    /** If set, attaches [ma***REMOVED***TimeMS](https://www.mongodb.com/docs/manual/reference/operator/meta/ma***REMOVED***TimeMS/) to every query */
