declare module 'mongoose' {
   ...
   * of an ObjectId.
   */
  function isObjectIdOrHe***REMOVED***String(v: mongodb.ObjectId): true;
  function isObjectIdOrHe***REMOVED***String(v: mongodb.ObjectId | string): boolean;
  function isObjectIdOrHe***REMOVED***String(v: any): false;
