declare module 'mongoose' {
  ...
  interface ConnectOptions e***REMOVED***tends mongodb.MongoClientOptions {
    /** Set to false to [disable buffering](http://mongoosejs.com/docs/faq.html#callback_never_e***REMOVED***ecutes) on all models associated with this connection. */
    ...
    pass?: string;
    /** Set to false to disable automatic inde***REMOVED*** creation for all models associated with this connection. */
    autoInde***REMOVED***?: boolean;
  ...
  class Connection e***REMOVED***tends events.EventEmitter implements SessionStarter {
    ...
    collection<T e***REMOVED***tends AnyObject = AnyObject>(name: string, options?: mongodb.CreateCollectionOptions): Collection<T>;

    /** A hash of the collections associated with this connection */
    readonly collections: { [inde***REMOVED***: string]: Collection };
     ...
     */
    createCollection<T e***REMOVED***tends AnyObject = AnyObject>(name: string, options?: mongodb.CreateCollectionOptions): Promise<mongodb.Collection<T>>;
     ...
     */
    deleteModel(name: string | RegE***REMOVED***p): this;
     ...
     */
    readonly models: Readonly<{ [inde***REMOVED***: string]: Model<any> }>;

    /** Defines or retrieves a model. */
    model<TSchema e***REMOVED***tends Schema = any>(
      name: string,
      schema?: TSchema,
      collection?: string,
    ...
    plugin<S e***REMOVED***tends Schema = Schema, O = AnyObject>(fn: (schema: S, opts?: any) => void, opts?: O): Connection;
     ...
     */
    syncInde***REMOVED***es(options?: SyncInde***REMOVED***esOptions): Promise<ConnectionSyncInde***REMOVED***esResult>;
    ...
    watch<ResultType e***REMOVED***tends mongodb.Document = any>(pipeline?: Array<any>, options?: mongodb.ChangeStreamOptions): mongodb.ChangeStream<ResultType>;

    withSession<T = any>(e***REMOVED***ecutor: (session: ClientSession) => Promise<T>): Promise<T>;
  }
