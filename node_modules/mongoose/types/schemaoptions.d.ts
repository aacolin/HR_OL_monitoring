declare module 'mongoose' {
  ...
  > {
    /**
     * By default, Mongoose's init() function creates all the inde***REMOVED***es defined in your model's schema by
     * calling Model.createInde***REMOVED***es() after you successfully connect to MongoDB. If you want to disable
     * automatic inde***REMOVED*** builds, you can set autoInde***REMOVED*** to false.
     */
    autoInde***REMOVED***?: boolean;
    /**
     * Similar to autoInde***REMOVED***, e***REMOVED***cept for automatically creates any Atlas search inde***REMOVED***es defined in your
     * schema. Unlike autoInde***REMOVED***, this option defaults to false.
     */
    autoSearchInde***REMOVED***?: boolean;
    /**
    ...
    /**
     * If bufferCommands is on, this option sets the ma***REMOVED***imum amount of time Mongoose buffering will wait before
     ...
     * the capped option to the ma***REMOVED***imum size of the collection in bytes.
     */
    capped?: boolean | number | { size?: number; ma***REMOVED***?: number; autoInde***REMOVED***Id?: boolean; };
    ...
    /** The number of seconds after which a document in a timeseries collection e***REMOVED***pires. */
    e***REMOVED***pireAfterSeconds?: number;

    /** The time after which a document in a timeseries collection e***REMOVED***pires. */
     ...
     *
     * If true, skip building inde***REMOVED***es on this schema's path.
     *
     * @default false
     */
    e***REMOVED***cludeInde***REMOVED***es?: boolean;
    /**
     * Mongoose assigns each of your schemas an id virtual getter by default which returns the document's _id field
     * cast to a string, or in the case of ObjectIds, its he***REMOVED***String.
     */
    id?: boolean;
    /**
    ...
    /** E***REMOVED***actly the same as the toObject option but only applies when the document's toJSON method is called. */
    ...
    /**
     * By default, Mongoose will automatically select() any populated paths for you, unless you e***REMOVED***plicitly e***REMOVED***clude them.
     *
     * @default true
     */
    selectPopulatedPaths?: boolean;
    /**
     * skipVersioning allows e***REMOVED***cluding paths from versioning (i.e., the internal revision will not be
    ...
    QueryHelpers,
    {},
    Record<any, <T e***REMOVED***tends QueryWithHelpers<unknown, THydratedDocumentType, QueryHelpers, DocType>>(this: T, ...args: any) => T>,
    QueryHelpers
    >
