...
{{## def._errorMessages = {
  ...
  _e***REMOVED***clusiveLimit: "'{{=$e***REMOVED***clusiveKeyword}} should be boolean'",
  _limitItems:     "'should NOT have {{?$keyword=='ma***REMOVED***Items'}}more{{??}}fewer{{?}} than {{#def.concatSchema}} items'",
  _limitLength:    "'should NOT be {{?$keyword=='ma***REMOVED***Length'}}longer{{??}}shorter{{?}} than {{#def.concatSchema}} characters'",
  _limitProperties:"'should NOT have {{?$keyword=='ma***REMOVED***Properties'}}more{{??}}fewer{{?}} than {{#def.concatSchema}} properties'",
  multipleOf:      "'should be multiple of {{#def.appendSchema}}",
  not:             "'should NOT be valid'",
  oneOf:           "'should match e***REMOVED***actly one schema in oneOf'",
  ...
  _formatE***REMOVED***clusiveLimit: "'{{=$e***REMOVED***clusiveKeyword}} should be boolean'"
} #}}
...
{{## def._errorSchemas = {
  ...
  _e***REMOVED***clusiveLimit: "validate.schema{{=$schemaPath}}",
  ...
  _formatE***REMOVED***clusiveLimit: "validate.schema{{=$schemaPath}}"
} #}}
...
{{## def._errorParams = {
  ...
  _limit:          "{ comparison: {{=$opE***REMOVED***pr}}, limit: {{=$schemaValue}}, e***REMOVED***clusive: {{=$e***REMOVED***clusive}} }",
  _e***REMOVED***clusiveLimit: "{}",
  ...
  switch:          "{ caseInde***REMOVED***: {{=$caseInde***REMOVED***}} }",
  _formatLimit:    "{ comparison: {{=$opE***REMOVED***pr}}, limit: {{#def.schemaValueQS}}, e***REMOVED***clusive: {{=$e***REMOVED***clusive}} }",
  _formatE***REMOVED***clusiveLimit: "{}"
} #}}
