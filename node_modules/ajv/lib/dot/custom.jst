...
{{## def.callRuleValidate:
  {{=$validateCode}}.call(
    {{? it.opts.passConte***REMOVED***t }}this{{??}}self{{?}}
...
{{## def.e***REMOVED***tendErrors:_inline:
    ...
    {{??}}
      ...
      {{??}}
        if (Array.isArray({{=$ruleErrs}})) {
          ...
          {{# def.e***REMOVED***tendErrors:false }}
        } else {
          {{= def_customError }}
        }
      {{?}}
