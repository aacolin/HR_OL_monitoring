var tape             = require('tape')
  ...
  , isDuple***REMOVED***         = require('./').isDuple***REMOVED***
...
function testDuple***REMOVED*** (pass, type, stream) {
  tape('isDuple***REMOVED***('  + type + ')', function (t) {
    t.plan(1)
    t.ok(pass === isDuple***REMOVED***(stream), type)
  })
}
...
test(true, 'CoreStreams.Duple***REMOVED***', new (CoreStreams.Duple***REMOVED***)())
...
test(true, 'ReadableStream10.Duple***REMOVED***', new (ReadableStream10.Duple***REMOVED***)())
...
test(true, 'ReadableStream11.Duple***REMOVED***', new (ReadableStream11.Duple***REMOVED***)())
...
testReadable(true, 'CoreStreams.Duple***REMOVED***', new (CoreStreams.Duple***REMOVED***)())
...
testReadable(true, 'ReadableStream10.Duple***REMOVED***', new (ReadableStream10.Duple***REMOVED***)())
...
testReadable(true, 'ReadableStream11.Duple***REMOVED***', new (ReadableStream11.Duple***REMOVED***)())
...
testWritable(true, 'CoreStreams.Duple***REMOVED***', new (CoreStreams.Duple***REMOVED***)())
...
testWritable(true, 'ReadableStream10.Duple***REMOVED***', new (ReadableStream10.Duple***REMOVED***)())
...
testWritable(true, 'ReadableStream11.Duple***REMOVED***', new (ReadableStream11.Duple***REMOVED***)())
...
testDuple***REMOVED***(false, 'CoreStreams.Stream', new (CoreStreams.Stream)())
testDuple***REMOVED***(false, 'CoreStreams.Readable', new (CoreStreams.Readable)())
testDuple***REMOVED***(false, 'CoreStreams.Writable', new (CoreStreams.Writable)())
testDuple***REMOVED***(true, 'CoreStreams.Duple***REMOVED***', new (CoreStreams.Duple***REMOVED***)())
testDuple***REMOVED***(true, 'CoreStreams.Transform', new (CoreStreams.Transform)())
testDuple***REMOVED***(true, 'CoreStreams.PassThrough', new (CoreStreams.PassThrough)())

testDuple***REMOVED***(false, 'ReadableStream10.Readable', new (ReadableStream10.Readable)())
testDuple***REMOVED***(false, 'ReadableStream10.Writable', new (ReadableStream10.Writable)())
testDuple***REMOVED***(true, 'ReadableStream10.Duple***REMOVED***', new (ReadableStream10.Duple***REMOVED***)())
testDuple***REMOVED***(true, 'ReadableStream10.Transform', new (ReadableStream10.Transform)())
testDuple***REMOVED***(true, 'ReadableStream10.PassThrough', new (ReadableStream10.PassThrough)())

testDuple***REMOVED***(false, 'ReadableStream11.Readable', new (ReadableStream11.Readable)())
testDuple***REMOVED***(false, 'ReadableStream11.Writable', new (ReadableStream11.Writable)())
testDuple***REMOVED***(true, 'ReadableStream11.Duple***REMOVED***', new (ReadableStream11.Duple***REMOVED***)())
testDuple***REMOVED***(true, 'ReadableStream11.Transform', new (ReadableStream11.Transform)())
testDuple***REMOVED***(true, 'ReadableStream11.PassThrough', new (ReadableStream11.PassThrough)())


;[ CoreStreams, ReadableStream10, ReadableStream11 ].forEach(function (p) {
  [ 'Stream', 'Readable', 'Writable', 'Duple***REMOVED***', 'Transform', 'PassThrough' ].forEach(function (k) {
    if (!p[k])
      return
