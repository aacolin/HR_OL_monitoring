...
The pug parser (takes an array of tokens and converts it to an abstract synta***REMOVED*** tree)
...
Convert Pug tokens to an abstract synta***REMOVED*** tree (AST).
...
var tokens = le***REMOVED***(src, {filename});
