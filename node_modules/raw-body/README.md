...
Validates the stream's length against an e***REMOVED***pected length and ma***REMOVED***imum limit.
...
**Returns a promise if no callback specified and global `Promise` e***REMOVED***ists.**
...
- `limit` - The byte limit of the body.
  ...
  for e***REMOVED***ample `1000`, `'500kb'` or `'3mb'`.
...
otherwise an error created by this module, which has the following attributes:
  ...
  * `length` and `e***REMOVED***pected` - the e***REMOVED***pected length of the stream
...
a decoded stream. The stream should not have an encoding set and is e***REMOVED***pected to
emit `Buffer` objects.
...
### Simple E***REMOVED***press e***REMOVED***ample
...
app.use(function (req, res, ne***REMOVED***t) {
  getRawBody(req, {
    ...
    req.te***REMOVED***t = string
    ne***REMOVED***t()
  })
})

// now access req.te***REMOVED***t
```

### Simple Koa e***REMOVED***ample
...
app.use(function * (ne***REMOVED***t) {
  this.te***REMOVED***t = yield getRawBody(this.req, {
