...
- `Changed` for changes in e***REMOVED***isting functionality.
- `Deprecated` for soon-to-be removed features.
- `Removed` for now removed features.
- `Fi***REMOVED***ed` for any bug fi***REMOVED***es.
...
* Fi***REMOVED***es bug when a pattern containing an e***REMOVED***pression after the closing parenthesis (`/!(*.d).{ts,ts***REMOVED***}`) was incorrectly converted to rege***REMOVED***p ([9f241ef](https://github.com/micromatch/picomatch/commit/9f241ef)).
...
* Fi***REMOVED***es bug where file names with two dots were not being matched consistently with negation e***REMOVED***tglobs containing a star ([56083ef](https://github.com/micromatch/picomatch/commit/56083ef))
...
* Set negatedE***REMOVED***tGlob also if it does not span the whole pattern ([032e3f5](https://github.com/micromatch/picomatch/commit/032e3f5)).
...
* Fi***REMOVED***es [#49](https://github.com/micromatch/picomatch/issues/49), so that braces with no sets or ranges are now propertly treated as literals.
...
* Fi***REMOVED*** "E***REMOVED***tglobs" table in readme ([eb19da8](https://github.com/micromatch/picomatch/commit/eb19da8))
* fi***REMOVED***es https://github.com/micromatch/picomatch/issues/20 ([9caca07](https://github.com/micromatch/picomatch/commit/9caca07))
* fi***REMOVED***es https://github.com/micromatch/picomatch/issues/26 ([fa58f45](https://github.com/micromatch/picomatch/commit/fa58f45))
...
* Make scan work with noe***REMOVED***t ([6c02e03](https://github.com/micromatch/picomatch/commit/6c02e03))
...
* Run eslint during pretest, fi***REMOVED*** e***REMOVED***isting eslint findings ([0682367](https://github.com/micromatch/picomatch/commit/0682367))
...
* Use eslint-disable-ne***REMOVED***t-line instead of eslint-disable ([4e7c1fd](https://github.com/micromatch/picomatch/commit/4e7c1fd))
...
* fi***REMOVED***: typo in README ([0753e44](https://github.com/micromatch/picomatch/commit/0753e44))

## 2.0.4 (2019-04-10)

### Fi***REMOVED***ed

- Readme link [fi***REMOVED***ed](https://github.com/micromatch/picomatch/pull/13/commits/a96ab3aa2b11b6861c23289964613d85563b05df) by @danez.
- `options.capture` now works as e***REMOVED***pected when fastpaths are enabled. See https://github.com/micromatch/picomatch/pull/12/commits/26aefd71f1cfaf95c37f1c1fcab68a693b037304. Thanks to @DrPizza.
...
- The uni***REMOVED***ify option was renamed to `windows`
