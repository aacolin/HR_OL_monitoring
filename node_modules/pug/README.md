...
This project was formerly known as "Jade." However, it has been revealed to us that "Jade" is a registered trademark, and as a result a rename is needed. After some discussion among the maintainers, **"Pug"** has been chosen as the new name for this project. The ne***REMOVED***t major version will carry "pug" as the package name.
...
The website and documentation for Pug are still being updated, but if you are new to Pug, you should get started with the new synta***REMOVED*** and install the Pug package on npm.
...
Pug is a clean, whitespace sensitive synta***REMOVED*** for writing html.  Here is a simple e***REMOVED***ample:
...
### Options
 ...
 - `filename`  Used in e***REMOVED***ceptions, and required when using includes
...
Tutorials:
  ...
  - cssdeck interactive [Pug synta***REMOVED*** tutorial](http://cssdeck.com/labs/learning-the-jade-templating-engine-synta***REMOVED***)
...
Other:
  ...
  - [Vim Synta***REMOVED***](https://github.com/digitaltoad/vim-pug)
  - [Te***REMOVED***tMate Bundle](http://github.com/miksago/jade-tmbundle)
  - [Coda/SubEtha synta***REMOVED*** Mode](https://github.com/aaronmccall/jade.mode)
