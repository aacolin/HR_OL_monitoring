...
test('assert', function (t) {
	...
	t['throws'](
		...
		TypeError,
		'none***REMOVED***istent value throws'
	);

	var o = {};
	channel.set(o, 'data');
	t.doesNotThrow(function () { channel.assert(o); }, 'e***REMOVED***istent value noops');
...
test('has', function (t) {
	...
	t.equal(channel.has(o), false, 'none***REMOVED***istent value yields false');

	channel.set(o, 'foo');
	t.equal(channel.has(o), true, 'e***REMOVED***istent value yields true');

	t.equal(channel.has('abc'), false, 'non object value non e***REMOVED***istent yields false');

	channel.set('abc', 'foo');
	t.equal(channel.has('abc'), true, 'non object value that e***REMOVED***ists yields true');
...
test('get', function (t) {
	var channel = getSideChannel();
	var o = {};
	t.equal(channel.get(o), undefined, 'none***REMOVED***istent value yields undefined');
