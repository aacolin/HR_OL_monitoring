...
e***REMOVED***port { Node, Parser, Position, SourceLocation, TokConte***REMOVED***t, Token, TokenType, defaultOptions, getLineInfo, isIdentifierChar, isIdentifierStart, isNewLine, keywords$1 as keywordTypes, lineBreak, lineBreakG, nonASCIIwhitespace, parse, parseE***REMOVED***pressionAt, types$1 as tokConte***REMOVED***ts, types as tokTypes, tokenizer, version };
