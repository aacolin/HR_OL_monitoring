 ...
 */
e***REMOVED***port interface ResumeOptions {
 ...
 * @public
 */
e***REMOVED***port type ResumeToken = unknown;
 ...
 */
e***REMOVED***port type OperationTime = Timestamp;
 ...
 * @public
 */
e***REMOVED***port interface ChangeStreamOptions e***REMOVED***tends Omit<AggregateOptions, 'writeConcern'> {
  /**
...
/** @public */
e***REMOVED***port interface ChangeStreamNameSpace {
  db: string;
  coll: string;
}

/** @public */
e***REMOVED***port interface ChangeStreamDocumentKey<TSchema e***REMOVED***tends Document = Document> {
  /**
...
/** @public */
e***REMOVED***port interface ChangeStreamSplitEvent {
...
/** @public */
e***REMOVED***port interface ChangeStreamDocumentCommon {
  /**
...
/** @public */
e***REMOVED***port interface ChangeStreamDocumentCollectionUUID {
  /**
...
/** @public */
e***REMOVED***port interface ChangeStreamDocumentOperationDescription {
  /**
 ...
 */
e***REMOVED***port interface ChangeStreamInsertDocument<TSchema e***REMOVED***tends Document = Document>
  e***REMOVED***tends ChangeStreamDocumentCommon,
 ...
 */
e***REMOVED***port interface ChangeStreamUpdateDocument<TSchema e***REMOVED***tends Document = Document>
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentKey<TSchema>,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamReplaceDocument<TSchema e***REMOVED***tends Document = Document>
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentKey<TSchema> {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamDeleteDocument<TSchema e***REMOVED***tends Document = Document>
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentKey<TSchema>,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamDropDocument
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
  operationType: 'drop';
 ...
 */
e***REMOVED***port interface ChangeStreamRenameDocument
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamDropDatabaseDocument e***REMOVED***tends ChangeStreamDocumentCommon {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamInvalidateDocument e***REMOVED***tends ChangeStreamDocumentCommon {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamCreateInde***REMOVED***Document
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
 ...
 */
e***REMOVED***port interface ChangeStreamDropInde***REMOVED***Document
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamCollModDocument
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamCreateDocument
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamShardCollectionDocument
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamReshardCollectionDocument
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
 ...
 */
e***REMOVED***port interface ChangeStreamRefineCollectionShardKeyDocument
  e***REMOVED***tends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
...
/** @public */
e***REMOVED***port type ChangeStreamDocument<TSchema e***REMOVED***tends Document = Document> =
...
/** @public */
e***REMOVED***port interface UpdateDescription<TSchema e***REMOVED***tends Document = Document> {
  /**
...
/** @public */
e***REMOVED***port type ChangeStreamEvents<
  TSchema e***REMOVED***tends Document = Document,
  TChange e***REMOVED***tends Document = ChangeStreamDocument<TSchema>
> = {
 ...
 * @public
 */
e***REMOVED***port class ChangeStream<
    TSchema e***REMOVED***tends Document = Document,
    TChange e***REMOVED***tends Document = ChangeStreamDocument<TSchema>
  >
  e***REMOVED***tends TypedEventEmitter<ChangeStreamEvents<TSchema, TChange>>
  implements AsyncDisposable
{
  ...
  async hasNe***REMOVED***t(): Promise<boolean> {
    this._setIsIterator();
    ...
    while (true) {
      try {
        const hasNe***REMOVED***t = await this.cursor.hasNe***REMOVED***t();
        return hasNe***REMOVED***t;
      } catch (error) {
        try {
  ...
  async ne***REMOVED***t(): Promise<TChange> {
    this._setIsIterator();
    // Change streams must resume indefinitely while each resume event succeeds.
    // This loop continues until either a change event is received or until a resume attempt
    // fails.
    ...
    while (true) {
      try {
        const change = await this.cursor.ne***REMOVED***t();
   ...
   */
  async tryNe***REMOVED***t(): Promise<TChange | null> {
    this._setIsIterator();
    // Change streams must resume indefinitely while each resume event succeeds.
    // This loop continues until either a change event is received or until a resume attempt
    // fails.
    ...
    while (true) {
      try {
        const change = await this.cursor.tryNe***REMOVED***t();
        return change ?? null;
      } catch (error) {
        try {
          await this._processErrorIteratorMode(error);
  ...
  async *[Symbol.asyncIterator](): AsyncGenerator<TChange, void, void> {
    ...
    try {
      ...
      // So the only loop breaking condition is if `ne***REMOVED***t()` throws
      while (true) {
        yield await this.ne***REMOVED***t();
      }
    } finally {
      try {
        await this.close();
  ...
  private _processErrorStreamMode(changeStreamError: AnyError) {
    // If the change stream has been closed e***REMOVED***plicitly, do not process error.
    if (this[kClosed]) return;

    if (this.cursor.id != null && isResumableError(changeStreamError, this.cursor.ma***REMOVED***WireVersion)) {
      this._endStream();
  ...
  private async _processErrorIteratorMode(changeStreamError: AnyError) {
    ...
    if (
      this.cursor.id == null ||
      !isResumableError(changeStreamError, this.cursor.ma***REMOVED***WireVersion)
    ) {
      try {
        await this.close();
      } catch (error) {
