 ...
 * @category Event
 */
e***REMOVED***port abstract class ConnectionPoolMonitoringEvent {
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionPoolCreatedEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** The options used to create this connection pool */
  options: Pick<
    ConnectionPoolOptions,
    'ma***REMOVED***PoolSize' | 'minPoolSize' | 'ma***REMOVED***Connecting' | 'ma***REMOVED***IdleTimeMS' | 'waitQueueTimeoutMS'
  >;
  /** @internal */
  ...
  constructor(pool: ConnectionPool) {
    super(pool);
    const { ma***REMOVED***Connecting, ma***REMOVED***PoolSize, minPoolSize, ma***REMOVED***IdleTimeMS, waitQueueTimeoutMS } =
      pool.options;
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionPoolReadyEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionPoolClosedEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionCreatedEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionReadyEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionClosedEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** The id of the connection */
  connectionId: number | '<monitor>';
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionCheckOutStartedEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionCheckOutFailedEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionCheckedOutEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** The id of the connection */
  connectionId: number | '<monitor>';
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionCheckedInEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** The id of the connection */
  connectionId: number | '<monitor>';
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ConnectionPoolClearedEvent e***REMOVED***tends ConnectionPoolMonitoringEvent {
  /** @internal */
  serviceId?: ObjectId;
