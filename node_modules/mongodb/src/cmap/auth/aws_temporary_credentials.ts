 ...
 */
e***REMOVED***port interface AWSTempCredentials {
  AccessKeyId?: string;
  SecretAccessKey?: string;
  Token?: string;
  RoleArn?: string;
  E***REMOVED***piration?: Date;
}
 ...
 */
e***REMOVED***port abstract class AWSTemporaryCredentialProvider {
...
/** @internal */
e***REMOVED***port class AWSSDKCredentialProvider e***REMOVED***tends AWSTemporaryCredentialProvider {
  ...
  private get provider(): () => Promise<AWSCredentials> {
    ...
    const awsRegionSettingsE***REMOVED***ist =
 ...
 */
e***REMOVED***port class LegacyAWSTemporaryCredentialProvider e***REMOVED***tends AWSTemporaryCredentialProvider {
  override async getCredentials(): Promise<AWSTempCredentials> {
