...
/** @internal */
e***REMOVED***port const DEFAULT_ALLOWED_HOSTS = [
  '*.mongodb.net',
  '*.mongodb-qa.net',
  '*.mongodb-dev.net',
  '*.mongodbgov.net',
...
/** @public */
e***REMOVED***port interface AuthMechanismProperties e***REMOVED***tends Document {
  SERVICE_HOST?: string;
  SERVICE_NAME?: string;
...
/** @public */
e***REMOVED***port interface MongoCredentialsOptions {
  username?: string;
  password: string;
  source: string;
  db?: string;
 ...
 * @public
 */
e***REMOVED***port class MongoCredentials {
