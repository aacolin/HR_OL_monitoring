...
const ENDPOINT_RESULT_ERROR =
  'Azure endpoint did not return a value with only access_token and e***REMOVED***pires_in properties';
 ...
 * @internal
 */
e***REMOVED***port class AzureMachineWorkflow e***REMOVED***tends MachineWorkflow {
  /**
...
function isEndpointResultValid(
  token: unknown
): token is { access_token: unknown; e***REMOVED***pires_in: unknown } {
