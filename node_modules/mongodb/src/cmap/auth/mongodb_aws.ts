...
import { ByteUtils, ma***REMOVED***WireVersion, ns, randomBytes } from '../../utils';
...
e***REMOVED***port class MongoDBAWS e***REMOVED***tends AuthProvider {
  ...
  override async auth(authConte***REMOVED***t: AuthConte***REMOVED***t): Promise<void> {
    ...
    if (ma***REMOVED***WireVersion(connection) < 9) {
    ...
    if (!authConte***REMOVED***t.credentials.username) {
      authConte***REMOVED***t.credentials = await makeTempCredentials(
        authConte***REMOVED***t.credentials,
    ...
    if (serverNonce.length !== 64) {
      // TODO(NODE-3483)
      throw new MongoRuntimeError(`Invalid server nonce length ${serverNonce.length}, e***REMOVED***pected 64`);
    }
