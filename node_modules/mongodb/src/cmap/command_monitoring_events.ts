 ...
 * @category Event
 */
e***REMOVED***port class CommandStartedEvent {
  commandObj?: Document;
  requestId: number;
  databaseName: string;
  commandName: string;
 ...
 * @category Event
 */
e***REMOVED***port class CommandSucceededEvent {
  address: string;
  /** Driver generated connection id */
  connectionId?: string | number;
  /**
 ...
 * @category Event
 */
e***REMOVED***port class CommandFailedEvent {
  address: string;
  /** Driver generated connection id */
  connectionId?: string | number;
  /**
 ...
 * @internal
 */
e***REMOVED***port const SENSITIVE_COMMANDS = new Set([
  'authenticate',
  'saslStart',
  'saslContinue',
  'getnonce',
...
// helper methods
const e***REMOVED***tractCommandName = (commandDoc: Document) => Object.keys(commandDoc)[0];
...
function e***REMOVED***tractCommand(command: WriteProtocolMessageType): Document {
...
function e***REMOVED***tractReply(command: WriteProtocolMessageType, reply?: Document) {
  if (!reply) {
    return reply;
  }
...
function e***REMOVED***tractConnectionDetails(connection: Connection) {
  let connectionId;
  if ('id' in connection) {
