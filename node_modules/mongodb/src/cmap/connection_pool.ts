...
/** @public */
e***REMOVED***port interface ConnectionPoolOptions e***REMOVED***tends Omit<ConnectionOptions, 'id' | 'generation'> {
...
/** @internal */
e***REMOVED***port interface WaitQueueMember {
...
/** @internal */
e***REMOVED***port const PoolState = Object.freeze({
  paused: 'paused',
  ready: 'ready',
  closed: 'closed'
} as const);
 ...
 * in the driver
 */
e***REMOVED***port interface CloseOptions {
  force?: boolean;
}

/** @public */
e***REMOVED***port type ConnectionPoolEvents = {
 ...
 * @internal
 */
e***REMOVED***port class ConnectionPool e***REMOVED***tends TypedEventEmitter<ConnectionPoolEvents> {
  ...
  constructor(server: Server, options: ConnectionPoolOptions) {
    ...
    if (this.options.minPoolSize > this.options.ma***REMOVED***PoolSize) {
      throw new MongoInvalidArgumentError(
        'Connection pool minimum size must not be greater than ma***REMOVED***imum pool size'
      );
    }
  ...
  async checkOut(): Promise<Connection> {
    ...
    const timeout = Timeout.e***REMOVED***pires(waitQueueTimeoutMS);
  ...
  async reauthenticate(connection: Connection): Promise<void> {
    ...
    if (!authConte***REMOVED***t) {
      throw new MongoRuntimeError('No auth conte***REMOVED***t found on connection.');
    }
 ...
 * @internal
 *
 * @param error - An error instance representing the error during the e***REMOVED***ecution.
 ...
 */
e***REMOVED***port type WithConnectionCallback = (
