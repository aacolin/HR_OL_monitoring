...
e***REMOVED***port interface ReadPreferenceOption {
  readPreference?: ReadPreferenceLike;
}

e***REMOVED***port function getReadPreference(options?: ReadPreferenceOption): ReadPreference {
...
e***REMOVED***port function isSharded(topologyOrServer?: Topology | Server | Connection): boolean {
