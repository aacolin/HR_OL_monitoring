 ...
 */
e***REMOVED***port function isErrorResponse(bson: Uint8Array, elements: BSONElement[]): boolean {
    ...
    if (element[BSONElementOffset.nameLength] === 2) {
      ...
      if (bson[nameOffset] === 111 && bson[nameOffset + 1] === 107) {
        ...
        for (let i = valueOffset; i < valueOffset + valueLength; i++) {
          if (bson[i] !== 0***REMOVED***00) return false;
        }
...
/** @internal */
e***REMOVED***port type MongoDBResponseConstructor = {
  new (bson: Uint8Array, offset?: number, isArray?: boolean): MongoDBResponse;
  make(bson: Uint8Array): MongoDBResponse;
};

/** @internal */
e***REMOVED***port class MongoDBResponse e***REMOVED***tends OnDemandDocument {
  // Wrap error thrown from BSON
  public override get<const T e***REMOVED***tends keyof JSTypeOf>(
    name: string | number,
    as: T,
  ...
  public override get<const T e***REMOVED***tends keyof JSTypeOf>(
    ...
    try {
      ...
      throw new MongoUne***REMOVED***pectedServerResponseError(cause.message, { cause });
    }
  }
...
/** @internal */
e***REMOVED***port class CursorResponse e***REMOVED***tends MongoDBResponse {
  /**
  ...
  get encryptedBatch() {
    ...
    if (cursor?.has('firstBatch'))
      ...
      this._encryptedBatch = cursor.get('ne***REMOVED***tBatch', BSONType.array, true);
    else throw new MongoUne***REMOVED***pectedServerResponseError('Cursor document did not contain a batch');
  ...
  private get batch() {
    ...
    else if (cursor.has('ne***REMOVED***tBatch')) this._batch = cursor.get('ne***REMOVED***tBatch', BSONType.array, true);
    else throw new MongoUne***REMOVED***pectedServerResponseError('Cursor document did not contain a batch');
    return this._batch;
  }
 ...
 */
e***REMOVED***port class E***REMOVED***plainedCursorResponse e***REMOVED***tends CursorResponse {
  isE***REMOVED***plain = true;
 ...
 */
e***REMOVED***port class ClientBulkWriteCursorResponse e***REMOVED***tends CursorResponse {
  get insertedCount() {
