 ...
 */
e***REMOVED***port function onData(emitter: EventEmitter) {
  // Setup pending events and pending promise lists
  /**
   * When the caller has not yet called .ne***REMOVED***t(), we store the
   * value from the event in this list. Ne***REMOVED***t time they call .ne***REMOVED***t()
   ...
   * This error will turn into a rejection for the subsequent .ne***REMOVED***t() call
   */
