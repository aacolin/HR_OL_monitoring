...
/** @public */
e***REMOVED***port const Compressor = Object.freeze({
  none: 0,
  snappy: 1,
  zlib: 2,
  zstd: 3
...
/** @public */
e***REMOVED***port type Compressor = (typeof Compressor)[CompressorName];

/** @public */
e***REMOVED***port type CompressorName = keyof typeof Compressor;

e***REMOVED***port const uncompressibleCommands = new Set([
...
e***REMOVED***port async function compress(
...
e***REMOVED***port async function decompress(compressorID: number, compressedData: Buffer): Promise<Buffer> {
  if (
 ...
 */
e***REMOVED***port async function compressCommand(
 ...
 */
e***REMOVED***port async function decompressResponse(message: Buffer): Promise<OpMsgResponse | OpReply> {
