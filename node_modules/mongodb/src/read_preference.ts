...
/** @public */
e***REMOVED***port type ReadPreferenceLike = ReadPreference | ReadPreferenceMode;

/** @public */
e***REMOVED***port const ReadPreferenceMode = Object.freeze({
  primary: 'primary',
...
/** @public */
e***REMOVED***port type ReadPreferenceMode = (typeof ReadPreferenceMode)[keyof typeof ReadPreferenceMode];

/** @public */
e***REMOVED***port interface HedgeOptions {
  /** E***REMOVED***plicitly enable or disable hedged reads. */
  enabled?: boolean;
}

/** @public */
e***REMOVED***port interface ReadPreferenceOptions {
...
/** @public */
e***REMOVED***port interface ReadPreferenceLikeOptions e***REMOVED***tends ReadPreferenceOptions {
  readPreference?:
    | ReadPreferenceLike
    | {
...
/** @public */
e***REMOVED***port interface ReadPreferenceFromOptions e***REMOVED***tends ReadPreferenceLikeOptions {
 ...
 */
e***REMOVED***port class ReadPreference {
  mode: ReadPreferenceMode;
  tags?: TagSet[];
  hedge?: HedgeOptions;
  ma***REMOVED***StalenessSeconds?: number;
  ...
  constructor(mode: ReadPreferenceMode, tags?: TagSet[], options?: ReadPreferenceOptions) {
    ...
    this.ma***REMOVED***StalenessSeconds = undefined;
    this.minWireVersion = undefined;

    options = options ?? {};
    if (options.ma***REMOVED***StalenessSeconds != null) {
      if (options.ma***REMOVED***StalenessSeconds <= 0) {
        throw new MongoInvalidArgumentError('ma***REMOVED***StalenessSeconds must be a positive integer');
      }

      this.ma***REMOVED***StalenessSeconds = options.ma***REMOVED***StalenessSeconds;

      // NOTE: The minimum required wire version is 5 for this read preference. If the e***REMOVED***isting
    ...
    if (this.mode === ReadPreference.PRIMARY) {
      ...
      if (this.ma***REMOVED***StalenessSeconds) {
        throw new MongoInvalidArgumentError(
          'Primary read preference cannot be combined with ma***REMOVED***StalenessSeconds'
        );
      }
  ...
  static fromOptions(options?: ReadPreferenceFromOptions): ReadPreference | undefined {
    ...
    if (typeof readPreference === 'string') {
      return new ReadPreference(readPreference, readPreferenceTags, {
        ma***REMOVED***StalenessSeconds: options.ma***REMOVED***StalenessSeconds,
        hedge: options.hedge
      });
      ...
      if (mode && typeof mode === 'string') {
        return new ReadPreference(mode, readPreference.tags ?? readPreferenceTags, {
          ma***REMOVED***StalenessSeconds: readPreference.ma***REMOVED***StalenessSeconds,
          hedge: options.hedge
        });
      }
    }
    ...
    if (typeof r === 'string') {
      ...
      if (mode && typeof mode === 'string') {
        options.readPreference = new ReadPreference(mode, r.tags, {
          ma***REMOVED***StalenessSeconds: r.ma***REMOVED***StalenessSeconds
        });
      }
  ...
  toJSON(): Document {
    ...
    if (this.ma***REMOVED***StalenessSeconds) readPreference.ma***REMOVED***StalenessSeconds = this.ma***REMOVED***StalenessSeconds;
