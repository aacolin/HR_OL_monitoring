 ...
 * @public
 */
e***REMOVED***port interface AsyncDisposable {
  /**
   * @beta
...
/** @internal */
e***REMOVED***port function configureResourceManagement(target: AsyncDisposable) {
  Symbol.asyncDispose &&
 ...
 * ```
 */
e***REMOVED***port function configureE***REMOVED***plicitResourceManagement() {
