...
/** @public */
e***REMOVED***port type W = number | 'majority';

/** @public */
e***REMOVED***port interface WriteConcernOptions {
  /** Write Concern as an object */
  writeConcern?: WriteConcern | WriteConcernSettings;
}

/** @public */
e***REMOVED***port interface WriteConcernSettings {
  /** The write concern */
  w?: W;
...
e***REMOVED***port const WRITE_CONCERN_KEYS = ['w', 'wtimeout', 'j', 'journal', 'fsync'];
 ...
 */
e***REMOVED***port class WriteConcern {
  /**
...
e***REMOVED***port function throwIfWriteConcernError(response: unknown): void {
