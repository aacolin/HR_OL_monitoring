...
/** @internal */
e***REMOVED***port class TimeoutError e***REMOVED***tends Error {
...
type E***REMOVED***ecutor = ConstructorParameters<typeof Promise<never>>[0];
 ...
 * if interacted with e***REMOVED***clusively through its public API
 * */
e***REMOVED***port class Timeout e***REMOVED***tends Promise<never> {
  ...
  /** Create a new timeout that e***REMOVED***pires in `duration` ms */
  private constructor(e***REMOVED***ecutor: E***REMOVED***ecutor = () => null, duration: number, unref = false) {
    let reject!: Reject;
    ...
    super((_, promiseReject) => {
      ...
      e***REMOVED***ecutor(noop, promiseReject);
    });
    ...
    if (this.duration > 0) {
      this.id = setTimeout(() => {
        ...
        this.timedOut = true;
        reject(new TimeoutError(`E***REMOVED***pired after ${duration}ms`));
      }, this.duration);
  ...
  public static e***REMOVED***pires(durationMS: number, unref?: boolean): Timeout {
