...
/** @internal */
e***REMOVED***port type ServerOptions = Omit<ConnectionPoolOptions, 'id' | 'generation' | 'hostAddress'> &
  MonitorOptions;

/** @internal */
e***REMOVED***port interface ServerPrivate {
...
/** @public */
e***REMOVED***port type ServerEvents = {
...
/** @internal */
e***REMOVED***port class Server e***REMOVED***tends TypedEventEmitter<ServerEvents> {
  /** @internal */
  s: ServerPrivate;
  /** @internal */
  topology: Topology;
    ...
    if (isNetworkNonTimeoutError || isNetworkTimeoutBeforeHandshakeError || isAuthHandshakeError) {
      ...
      if (isSDAMUnrecoverableError(error)) {
        if (shouldHandleStateChangeError(this, error)) {
          const shouldClearPool = ma***REMOVED***WireVersion(this) <= 7 || isNodeShuttingDownError(error);
          ...
          if (!this.loadBalanced) {
            ...
            markServerUnknown(this, error);
            process.ne***REMOVED***tTick(() => this.requestCheck());
          }
        }
      }
    }
  ...
  private decorateCommandError(
    ...
    if (typeof error !== 'object' || error == null || !('name' in error)) {
      throw new MongoRuntimeError('An une***REMOVED***pected error type: ' + typeof error);
    }
    ...
    if (error instanceof MongoNetworkError) {
      ...
      if (
        (isRetryableWritesEnabled(this.topology) || isTransactionCommand(cmd)) &&
        needsRetryableWriteLabel(error, ma***REMOVED***WireVersion(this), this.description.type) &&
        !inActiveTransaction(session, cmd)
      ) {
        error.addErrorLabel(MongoErrorLabel.RetryableWriteError);
      }
...
function connectionIsStale(pool: ConnectionPool, connection: Connection) {
  if (connection.serviceId) {
    return (
      connection.generation !== pool.serviceGenerations.get(connection.serviceId.toHe***REMOVED***String())
    );
  }
