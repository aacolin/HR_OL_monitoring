 ...
 * @category Event
 */
e***REMOVED***port class ServerDescriptionChangedEvent {
 ...
 * @category Event
 */
e***REMOVED***port class ServerOpeningEvent {
  /** A unique identifier for the topology */
  topologyId: number;
  /** The address (host/port pair) of the server */
  address: string;
 ...
 * @category Event
 */
e***REMOVED***port class ServerClosedEvent {
  /** A unique identifier for the topology */
  topologyId: number;
  /** The address (host/port pair) of the server */
  address: string;
 ...
 * @category Event
 */
e***REMOVED***port class TopologyDescriptionChangedEvent {
  /** A unique identifier for the topology */
  topologyId: number;
 ...
 * @category Event
 */
e***REMOVED***port class TopologyOpeningEvent {
  /** A unique identifier for the topology */
  topologyId: number;
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class TopologyClosedEvent {
  /** A unique identifier for the topology */
  topologyId: number;
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ServerHeartbeatStartedEvent {
 ...
 * @category Event
 */
e***REMOVED***port class ServerHeartbeatSucceededEvent {
  /** The connection id for the command */
  connectionId: string;
 ...
 * @category Event
 */
e***REMOVED***port class ServerHeartbeatFailedEvent {
  /** The connection id for the command */
  connectionId: string;
  /** The e***REMOVED***ecution time of the event in ms */
  duration: number;
