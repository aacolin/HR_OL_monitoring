...
/** @internal */
e***REMOVED***port type ServerSelectionCallback = Callback<Server>;

/** @internal */
e***REMOVED***port interface ServerSelectionRequest {
...
/** @internal */
e***REMOVED***port interface TopologyPrivate {
...
/** @internal */
e***REMOVED***port interface TopologyOptions e***REMOVED***tends BSONSerializeOptions, ServerOptions {
...
/** @public */
e***REMOVED***port interface ConnectOptions {
  readPreference?: ReadPreference;
}

/** @public */
e***REMOVED***port interface SelectServerOptions {
...
/** @public */
e***REMOVED***port type TopologyEvents = {
 ...
 * @internal
 */
e***REMOVED***port class Topology e***REMOVED***tends TypedEventEmitter<TopologyEvents> {
  /** @internal */
  s: TopologyPrivate;
  /** @internal */
  ...
  constructor(
    ...
    const selectedHosts =
      options.srvMa***REMOVED***Hosts == null ||
      options.srvMa***REMOVED***Hosts === 0 ||
      options.srvMa***REMOVED***Hosts >= seedlist.length
        ? seedlist
        : shuffle(seedlist, options.srvMa***REMOVED***Hosts);
    ...
    if (options.srvHost && !options.loadBalanced) {
      this.s.srvPoller =
        ...
        new SrvPoller({
          ...
          srvMa***REMOVED***Hosts: options.srvMa***REMOVED***Hosts,
  ...
  private detectSrvRecords(ev: SrvPollingEvent) {
    ...
    this.s.description = this.s.description.updateFromSrvPollingEvent(
      ev,
      this.s.options.srvMa***REMOVED***Hosts
    );
  ...
  private async _connect(options?: ConnectOptions): Promise<Topology> {
    ...
    // emitted from the monitor, since the monitor doesn't e***REMOVED***ist.
  ...
  async selectServer(
    ...
    const timeout = Timeout.e***REMOVED***pires(options.serverSelectionTimeoutMS ?? 0);
  ...
  // NOTE: There are many places in code where we e***REMOVED***plicitly check the last hello
  ...
  lastHello(): Document {
    ...
    const result = sd || { ma***REMOVED***WireVersion: this.description.commonWireVersion };
    return result;
  }
...
function processWaitQueue(topology: Topology) {
  ...
  if (topology[kWaitQueue].length > 0) {
    ...
    for (const [, server] of topology.s.servers) {
      process.ne***REMOVED***tTick(function scheduleServerCheck() {
...
/** @public */
e***REMOVED***port class ServerCapabilities {
  ma***REMOVED***WireVersion: number;
  minWireVersion: number;

  constructor(hello: Document) {
    this.minWireVersion = hello.minWireVersion || 0;
    this.ma***REMOVED***WireVersion = hello.ma***REMOVED***WireVersion || 0;
  }

  get hasAggregationCursor(): boolean {
    return this.ma***REMOVED***WireVersion >= 1;
  }

  get hasWriteCommands(): boolean {
    return this.ma***REMOVED***WireVersion >= 2;
  }
  ...
  get hasListCollectionsCommand(): boolean {
    return this.ma***REMOVED***WireVersion >= 3;
  }
  ...
  get supportsSnapshotReads(): boolean {
    return this.ma***REMOVED***WireVersion >= 13;
  }

  get commandsTakeWriteConcern(): boolean {
    return this.ma***REMOVED***WireVersion >= 5;
  }
