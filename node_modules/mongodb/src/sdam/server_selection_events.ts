 ...
 * @category Log Type
 */
e***REMOVED***port abstract class ServerSelectionEvent {
 ...
 * @category Event
 */
e***REMOVED***port class ServerSelectionStartedEvent e***REMOVED***tends ServerSelectionEvent {
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ServerSelectionFailedEvent e***REMOVED***tends ServerSelectionEvent {
  /** @internal */
 ...
 * @category Event
 */
e***REMOVED***port class ServerSelectionSucceededEvent e***REMOVED***tends ServerSelectionEvent {
  /** @internal */
  name = SERVER_SELECTION_SUCCEEDED;
  message = 'Server selection succeeded';
  /** 	The hostname, IP address, or Uni***REMOVED*** domain socket path for the selected server. */
  serverHost: string;
  /** The port for the selected server. Optional; not present for Uni***REMOVED*** domain sockets. When the user does not specify a port and the default (27017) is used, the driver SHOULD include it here. */
 ...
 * @category Event
 */
e***REMOVED***port class WaitingForSuitableServerEvent e***REMOVED***tends ServerSelectionEvent {
  /** @internal */
