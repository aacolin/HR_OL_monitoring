...
/** @public */
e***REMOVED***port interface TopologyVersion {
  processId: ObjectId;
  counter: Long;
}

/** @public */
e***REMOVED***port type TagSet = { [key: string]: string };

/** @internal */
e***REMOVED***port interface ServerDescriptionOptions {
 ...
 * @public
 */
e***REMOVED***port class ServerDescription {
  address: string;
  type: ServerType;
  hosts: string[];
  passives: string[];
  ...
  constructor(
    ...
    this.ma***REMOVED***MessageSizeBytes = hello?.ma***REMOVED***MessageSizeBytes ?? null;
    this.ma***REMOVED***WriteBatchSize = hello?.ma***REMOVED***WriteBatchSize ?? null;
    this.ma***REMOVED***BsonObjectSize = hello?.ma***REMOVED***BsonObjectSize ?? null;
...
e***REMOVED***port function parseServerType(hello?: Document, options?: ServerDescriptionOptions): ServerType {
 ...
 * ```
 */
e***REMOVED***port function compareTopologyVersion(
