...
/** @internal */
e***REMOVED***port interface EncrypterOptions {
  autoEncryption: AutoEncryptionOptions;
  ma***REMOVED***PoolSize?: number;
}

/** @internal */
e***REMOVED***port class Encrypter {
  ...
  constructor(client: MongoClient, uri: string, options: MongoClientOptions) {
    ...
    if (options.ma***REMOVED***PoolSize === 0 && options.autoEncryption.keyVaultClient == null) {
    ...
    } else if (options.ma***REMOVED***PoolSize === 0) {
    ...
    if (options.pro***REMOVED***yHost) {
      options.autoEncryption.pro***REMOVED***yOptions = {
        pro***REMOVED***yHost: options.pro***REMOVED***yHost,
        pro***REMOVED***yPort: options.pro***REMOVED***yPort,
        pro***REMOVED***yUsername: options.pro***REMOVED***yUsername,
        pro***REMOVED***yPassword: options.pro***REMOVED***yPassword
      };
    }
