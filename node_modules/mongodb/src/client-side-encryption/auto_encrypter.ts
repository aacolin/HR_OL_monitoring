...
import { type CommandOptions, type Pro***REMOVED***yOptions } from '../cmap/connection';
...
/** @public */
e***REMOVED***port interface AutoEncryptionOptions {
 ...
 */
e***REMOVED***port type AutoEncryptionE***REMOVED***traOptions = NonNullable<AutoEncryptionOptions['e***REMOVED***traOptions']>;

/** @public */
e***REMOVED***port const AutoEncryptionLoggerLevel = Object.freeze({
  FatalError: 0,
  Error: 1,
  Warning: 2,
  Info: 3,
 ...
 * | 4 | Trace |
 */
e***REMOVED***port type AutoEncryptionLoggerLevel =
...
e***REMOVED***port class AutoEncrypter {
   ...
   * Other validation rules in the JSON schema will not be enforced by the driver and will result in an error.
   *
   * @e***REMOVED***ample <caption>Create an AutoEncrypter that makes use of mongocryptd</caption>
   * ```ts
   ...
   * @e***REMOVED***ample <caption>Create an AutoEncrypter that makes use of libmongocrypt's CSFLE shared library</caption>
   * ```ts
  ...
  constructor(client: MongoClient, options: AutoEncryptionOptions) {
    ...
    this._pro***REMOVED***yOptions = options.pro***REMOVED***yOptions || {};
    ...
    if (options.e***REMOVED***traOptions && options.e***REMOVED***traOptions.cryptSharedLibPath) {
      mongoCryptOptions.cryptSharedLibPath = options.e***REMOVED***traOptions.cryptSharedLibPath;
    }
    ...
    if (options.e***REMOVED***traOptions && options.e***REMOVED***traOptions.cryptSharedLibSearchPaths) {
      // Only for driver testing
      mongoCryptOptions.cryptSharedLibSearchPaths = options.e***REMOVED***traOptions.cryptSharedLibSearchPaths;
    ...
    this._conte***REMOVED***tCounter = 0;

    if (
      options.e***REMOVED***traOptions &&
      options.e***REMOVED***traOptions.cryptSharedLibRequired &&
    ...
    if (!this._bypassMongocryptdAndCryptShared && !this.cryptSharedLibVersionInfo) {
      this._mongocryptdManager = new MongocryptdManager(options.e***REMOVED***traOptions);
      const clientOptions: MongoClientOptions = {
        serverSelectionTimeoutMS: 10000
      };

      if (
        (options.e***REMOVED***traOptions == null || typeof options.e***REMOVED***traOptions.mongocryptdURI !== 'string') &&
      ...
      // eslint-disable-ne***REMOVED***t-line @typescript-eslint/ban-ts-comment
  ...
  async encrypt(
    ...
    const conte***REMOVED***t = this._mongocrypt.makeEncryptionConte***REMOVED***t(
      MongoDBCollectionNamespace.fromString(ns).db,
      commandBuffer
    );

    conte***REMOVED***t.id = this._conte***REMOVED***tCounter++;
    conte***REMOVED***t.ns = ns;
    conte***REMOVED***t.document = cmd;

    const stateMachine = new StateMachine({
      promoteValues: false,
      promoteLongs: false,
      pro***REMOVED***yOptions: this._pro***REMOVED***yOptions,
      tlsOptions: this._tlsOptions,
      socketOptions: autoSelectSocketOptions(this._client.options)
    });

    return deserialize(await stateMachine.e***REMOVED***ecute(this, conte***REMOVED***t), {
      promoteValues: false,
      promoteLongs: false
    });
  }
  ...
  async decrypt(response: Uint8Array, options: CommandOptions = {}): Promise<Uint8Array> {
    const conte***REMOVED***t = this._mongocrypt.makeDecryptionConte***REMOVED***t(response);
    ...
    return await stateMachine.e***REMOVED***ecute(this, conte***REMOVED***t);
  }
