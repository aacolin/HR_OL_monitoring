 ...
 */
e***REMOVED***port type ClientEncryptionDataKeyProvider = keyof KMSProviders;

/** @public */
e***REMOVED***port interface AWSKMSProviderConfiguration {
  /**
...
/** @public */
e***REMOVED***port interface LocalKMSProviderConfiguration {
  /**
...
/** @public */
e***REMOVED***port interface KMIPKMSProviderConfiguration {
  /**
...
/** @public */
e***REMOVED***port type AzureKMSProviderConfiguration =
  | {
      /**
...
/** @public */
e***REMOVED***port type GCPKMSProviderConfiguration =
  | {
      /**
 ...
 */
e***REMOVED***port interface KMSProviders {
  /**
 ...
 *
 * @internal - e***REMOVED***posed for testing purposes only
 */
e***REMOVED***port function isEmptyCredentials(
 ...
 * Credentials will only attempt to get loaded if they do not e***REMOVED***ist
 * and no e***REMOVED***isting credentials will get overwritten.
 *
 * @internal
 */
e***REMOVED***port async function refreshKMSCredentials(kmsProviders: KMSProviders): Promise<KMSProviders> {
