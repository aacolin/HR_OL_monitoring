...
/** @internal */
e***REMOVED***port interface AdminPrivate {
  db: Db;
}
...
e***REMOVED***port class Admin {
  ...
  async listDatabases(options?: ListDatabasesOptions): Promise<ListDatabasesResult> {
    return await e***REMOVED***ecuteOperation(this.s.db.client, new ListDatabasesOperation(this.s.db, options));
  }
