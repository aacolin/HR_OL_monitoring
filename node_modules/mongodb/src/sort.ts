...
/** @public */
e***REMOVED***port type SortDirection =
  | 1
  | -1
  | 'asc'
  | 'desc'
...
/** @public */
e***REMOVED***port type Sort =
  | string
  | E***REMOVED***clude<SortDirection, { $meta: string }>
  | string[]
...
/** @internal */
e***REMOVED***port type SortDirectionForCmd = 1 | -1 | { $meta: string };

/** @internal */
e***REMOVED***port type SortForCmd = Map<string, SortDirectionForCmd>;
...
e***REMOVED***port function formatSort(
  sort: Sort | undefined,
