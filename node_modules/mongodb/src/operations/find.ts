...
import { decorateWithE***REMOVED***plain, type MongoDBNamespace, normalizeHintField } from '../utils';
...
e***REMOVED***port interface FindOptions<TSchema e***REMOVED***tends Document = Document>
  e***REMOVED***tends Omit<CommandOperationOptions, 'writeConcern' | 'e***REMOVED***plain'> {
...
/** @internal */
e***REMOVED***port class FindOperation e***REMOVED***tends CommandOperation<CursorResponse> {
  /**
  ...
  override async e***REMOVED***ecute(
    ...
    if (this.e***REMOVED***plain) {
      findCommand = decorateWithE***REMOVED***plain(findCommand, this.e***REMOVED***plain);
    }
...
function makeFindCommand(ns: MongoDBNamespace, filter: Document, options: FindOptions): Document {
  ...
  if (typeof options.ma***REMOVED***TimeMS === 'number') {
    findCommand.ma***REMOVED***TimeMS = options.ma***REMOVED***TimeMS;
  }
  ...
  if (options.ma***REMOVED***) {
    findCommand.ma***REMOVED*** = options.ma***REMOVED***;
  }
