...
/** @public */
e***REMOVED***port interface ClientBulkWriteOptions e***REMOVED***tends CommandOperationOptions {
  /**
...
/** @public */
e***REMOVED***port interface ClientWriteModel {
  /**
...
/** @public */
e***REMOVED***port interface ClientInsertOneModel<TSchema> e***REMOVED***tends ClientWriteModel {
  name: 'insertOne';
...
/** @public */
e***REMOVED***port interface ClientDeleteOneModel<TSchema> e***REMOVED***tends ClientWriteModel {
  name: 'deleteOne';
  /**
...
/** @public */
e***REMOVED***port interface ClientDeleteManyModel<TSchema> e***REMOVED***tends ClientWriteModel {
  name: 'deleteMany';
  /**
   * The filter used to determine if a document should be deleted.
...
/** @public */
e***REMOVED***port interface ClientReplaceOneModel<TSchema> e***REMOVED***tends ClientWriteModel {
  name: 'replaceOne';
  /**
...
/** @public */
e***REMOVED***port interface ClientUpdateOneModel<TSchema> e***REMOVED***tends ClientWriteModel {
  name: 'updateOne';
  /**
...
/** @public */
e***REMOVED***port interface ClientUpdateManyModel<TSchema> e***REMOVED***tends ClientWriteModel {
  name: 'updateMany';
  /**
   * The filter used to determine if a document should be updated.
 ...
 * @public
 */
e***REMOVED***port type AnyClientBulkWriteModel<TSchema e***REMOVED***tends Document> =
 ...
 *
 */
e***REMOVED***port type ClientBulkWriteModel<
  SchemaMap e***REMOVED***tends Record<string, Document> = Record<string, Document>
> = {
...
/** @public */
e***REMOVED***port interface ClientBulkWriteResult {
  /**
...
/** @public */
e***REMOVED***port interface ClientBulkWriteError {
  code: number;
  message: string;
}

/** @public */
e***REMOVED***port interface ClientInsertOneResult {
  /**
...
/** @public */
e***REMOVED***port interface ClientUpdateResult {
  /**
...
/** @public */
e***REMOVED***port interface ClientDeleteResult {
  /**
