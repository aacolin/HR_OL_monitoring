...
/** @public */
e***REMOVED***port interface UpdateOptions e***REMOVED***tends CommandOperationOptions {
 ...
 */
e***REMOVED***port interface UpdateResult<TSchema e***REMOVED***tends Document = Document> {
...
/** @public */
e***REMOVED***port interface UpdateStatement {
 ...
 */
e***REMOVED***port class UpdateOperation e***REMOVED***tends CommandOperation<Document> {
  ...
  override async e***REMOVED***ecute(server: Server, session: ClientSession | undefined): Promise<Document> {
    ...
    if (unacknowledgedWrite) {
      if (this.statements.find((o: Document) => o.hint)) {
        // TODO(NODE-3541): fi***REMOVED*** error for hint with unacknowledged writes
        throw new MongoCompatibilityError(`hint is not supported with unacknowledged writes`);
      }
    }

    const res = await super.e***REMOVED***ecuteCommand(server, session, command);
    return res;
  }
}

/** @internal */
e***REMOVED***port class UpdateOneOperation e***REMOVED***tends UpdateOperation {
  ...
  override async e***REMOVED***ecute(
    ...
    const res: TODO_NODE_3286 = await super.e***REMOVED***ecute(server, session);
    if (this.e***REMOVED***plain != null) return res;
...
/** @internal */
e***REMOVED***port class UpdateManyOperation e***REMOVED***tends UpdateOperation {
  constructor(collection: Collection, filter: Document, update: Document, options: UpdateOptions) {
    super(
      collection.s.namespace,
...
/** @public */
e***REMOVED***port interface ReplaceOptions e***REMOVED***tends CommandOperationOptions {
  /** If true, allows the write to opt-out of document level validation */
  bypassDocumentValidation?: boolean;
  /** Specifies a collation */
  collation?: CollationOptions;
...
/** @internal */
e***REMOVED***port class ReplaceOneOperation e***REMOVED***tends UpdateOperation {
  constructor(
...
e***REMOVED***port function makeUpdateStatement(
  filter: Document,
