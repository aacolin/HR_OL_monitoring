...
import { decorateWithCollation, hasAtomicOperators, ma***REMOVED***WireVersion } from '../utils';
import { type WriteConcern, type WriteConcernSettings } from '../write_concern';
import { CommandOperation, type CommandOperationOptions } from './command';
import { Aspect, defineAspects } from './operation';

/** @public */
e***REMOVED***port const ReturnDocument = Object.freeze({
  BEFORE: 'before',
  AFTER: 'after'
} as const);

/** @public */
e***REMOVED***port type ReturnDocument = (typeof ReturnDocument)[keyof typeof ReturnDocument];

/** @public */
e***REMOVED***port interface FindOneAndDeleteOptions e***REMOVED***tends CommandOperationOptions {
...
/** @public */
e***REMOVED***port interface FindOneAndReplaceOptions e***REMOVED***tends CommandOperationOptions {
...
/** @public */
e***REMOVED***port interface FindOneAndUpdateOptions e***REMOVED***tends CommandOperationOptions {
...
/** @internal */
e***REMOVED***port class FindAndModifyOperation e***REMOVED***tends CommandOperation<Document> {
  ...
  override async e***REMOVED***ecute(server: Server, session: ClientSession | undefined): Promise<Document> {
    ...
    if (options.hint) {
      ...
      if (unacknowledgedWrite || ma***REMOVED***WireVersion(server) < 8) {
...
/** @internal */
e***REMOVED***port class FindOneAndDeleteOperation e***REMOVED***tends FindAndModifyOperation {
...
/** @internal */
e***REMOVED***port class FindOneAndReplaceOperation e***REMOVED***tends FindAndModifyOperation {
  constructor(
    collection: Collection,
    filter: Document,
...
/** @internal */
e***REMOVED***port class FindOneAndUpdateOperation e***REMOVED***tends FindAndModifyOperation {
  constructor(
    collection: Collection,
    filter: Document,
    update: Document,
