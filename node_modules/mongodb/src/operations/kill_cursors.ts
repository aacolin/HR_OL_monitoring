...
e***REMOVED***port class KillCursorsOperation e***REMOVED***tends AbstractOperation {
  cursorId: Long;
  ...
  override async e***REMOVED***ecute(server: Server, session: ClientSession | undefined): Promise<void> {
