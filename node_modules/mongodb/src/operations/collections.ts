...
e***REMOVED***port interface CollectionsOptions e***REMOVED***tends OperationOptions {
  nameOnly?: boolean;
}

/** @internal */
e***REMOVED***port class CollectionsOperation e***REMOVED***tends AbstractOperation<Collection[]> {
