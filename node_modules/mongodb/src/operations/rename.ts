...
/** @public */
e***REMOVED***port interface RenameOptions e***REMOVED***tends CommandOperationOptions {
...
/** @internal */
e***REMOVED***port class RenameOperation e***REMOVED***tends CommandOperation<Document> {
  constructor(
  ...
  override async e***REMOVED***ecute(server: Server, session: ClientSession | undefined): Promise<Collection> {
    ...
    await super.e***REMOVED***ecuteCommand(server, session, command);
