...
import type { E***REMOVED***plainCommandOptions, E***REMOVED***plainVerbosityLike } from '../e***REMOVED***plain';
...
/** @public */
e***REMOVED***port interface AggregationCursorOptions e***REMOVED***tends AbstractCursorOptions, AggregateOptions {}
 ...
 * @public
 */
e***REMOVED***port class AggregationCursor<TSchema = any> e***REMOVED***tends AbstractCursor<TSchema> {
  ...
  async _initialize(session: ClientSession): Promise<InitialCursorResponse> {
    ...
    const response = await e***REMOVED***ecuteOperation(this.client, aggregateOperation);
