...
import {
  ...
  type ListSearchInde***REMOVED***esOptions
...
import {
  ...
  type CreateInde***REMOVED***esOptions,
  type DropInde***REMOVED***esOptions,
  DropInde***REMOVED***Operation,
  type Inde***REMOVED***Description,
  type Inde***REMOVED***DescriptionCompact,
  type Inde***REMOVED***DescriptionInfo,
  type Inde***REMOVED***InformationOptions,
  type Inde***REMOVED***Specification,
  type ListInde***REMOVED***esOptions
...
import {
  CreateSearchInde***REMOVED***esOperation,
  type SearchInde***REMOVED***Description
} from './operations/search_inde***REMOVED***es/create';
import { DropSearchInde***REMOVED***Operation } from './operations/search_inde***REMOVED***es/drop';
import { UpdateSearchInde***REMOVED***Operation } from './operations/search_inde***REMOVED***es/update';
import {
  ReplaceOneOperation,
  type ReplaceOptions,
  UpdateManyOperation,
...
/** @public */
e***REMOVED***port interface ModifyResult<TSchema = Document> {
...
/** @public */
e***REMOVED***port interface CountDocumentsOptions e***REMOVED***tends AggregateOptions {
...
/** @public */
e***REMOVED***port interface CollectionOptions e***REMOVED***tends BSONSerializeOptions, WriteConcernOptions {
...
/** @internal */
e***REMOVED***port interface CollectionPrivate {
  pkFactory: PkFactory;
  db: Db;
  options: any;
 ...
 * ```
 */
e***REMOVED***port class Collection<TSchema e***REMOVED***tends Document = Document> {
  /** @internal */
  s: CollectionPrivate;
  ...
  async findOne(
    ...
    const res = await cursor.ne***REMOVED***t();
    await cursor.close();
    return res;
  }
   ...
   * ```
   */
  async createInde***REMOVED***(
    inde***REMOVED***Spec: Inde***REMOVED***Specification,
    options?: CreateInde***REMOVED***esOptions
  ): Promise<string> {
    const inde***REMOVED***es = await e***REMOVED***ecuteOperation(
      this.client,
      CreateInde***REMOVED***esOperation.fromInde***REMOVED***Specification(
        this,
        this.collectionName,
        inde***REMOVED***Spec,
        resolveOptions(this, options)
   ...
   * ```
   */
  async createInde***REMOVED***es(
    inde***REMOVED***Specs: Inde***REMOVED***Description[],
    options?: CreateInde***REMOVED***esOptions
  ): Promise<string[]> {
    return await e***REMOVED***ecuteOperation(
      this.client,
      CreateInde***REMOVED***esOperation.fromInde***REMOVED***DescriptionArray(
        this,
        this.collectionName,
        inde***REMOVED***Specs,
        resolveOptions(this, { ...options, ma***REMOVED***TimeMS: undefined })
      )
    );
  }
   ...
   * @param options - Optional settings for the command
   */
  async dropInde***REMOVED***(inde***REMOVED***Name: string, options?: DropInde***REMOVED***esOptions): Promise<Document> {
    return await e***REMOVED***ecuteOperation(
      this.client,
      new DropInde***REMOVED***Operation(this as TODO_NODE_3286, inde***REMOVED***Name, {
        ...resolveOptions(this, options),
        readPreference: ReadPreference.primary
      })
    );
   ...
   * @param options - Optional settings for the command
   */
  async dropInde***REMOVED***es(options?: DropInde***REMOVED***esOptions): Promise<boolean> {
    try {
      await e***REMOVED***ecuteOperation(
        this.client,
        new DropInde***REMOVED***Operation(this as TODO_NODE_3286, '*', resolveOptions(this, options))
      );
      return true;
    } catch {
      return false;
  ...
  listInde***REMOVED***es(options?: ListInde***REMOVED***esOptions): ListInde***REMOVED***esCursor {
    return new ListInde***REMOVED***esCursor(this as TODO_NODE_3286, resolveOptions(this, options));
  }
   ...
   * @param options - Optional settings for the command
   */
  async inde***REMOVED***E***REMOVED***ists(inde***REMOVED***es: string | string[], options?: ListInde***REMOVED***esOptions): Promise<boolean> {
    const inde***REMOVED***Names: string[] = Array.isArray(inde***REMOVED***es) ? inde***REMOVED***es : [inde***REMOVED***es];
    const allInde***REMOVED***es: Set<string> = new Set(
      await this.listInde***REMOVED***es(options)
        .map(({ name }) => name)
        .toArray()
    );
    return inde***REMOVED***Names.every(name => allInde***REMOVED***es.has(name));
  }
   ...
   * @param options - Optional settings for the command
   */
  inde***REMOVED***Information(
    options: Inde***REMOVED***InformationOptions & { full: true }
  ): Promise<Inde***REMOVED***DescriptionInfo[]>;
  inde***REMOVED***Information(
    options: Inde***REMOVED***InformationOptions & { full?: false }
  ): Promise<Inde***REMOVED***DescriptionCompact>;
  inde***REMOVED***Information(
    options: Inde***REMOVED***InformationOptions
  ): Promise<Inde***REMOVED***DescriptionCompact | Inde***REMOVED***DescriptionInfo[]>;
  inde***REMOVED***Information(): Promise<Inde***REMOVED***DescriptionCompact>;
  async inde***REMOVED***Information(
    options?: Inde***REMOVED***InformationOptions
  ): Promise<Inde***REMOVED***DescriptionCompact | Inde***REMOVED***DescriptionInfo[]> {
    return await this.inde***REMOVED***es({
      ...options,
  ...
  async countDocuments(
    ...
    const doc = await cursor.ne***REMOVED***t();
    await cursor.close();
    return doc?.n ?? 0;
  }
   ...
   * @param options - Optional settings for the command
   */
  distinct<Key e***REMOVED***tends keyof WithId<TSchema>>(
    key: Key
  ...
  async distinct<Key e***REMOVED***tends keyof WithId<TSchema>>(
    key: Key,
    filter: Filter<TSchema> = {},
    options: DistinctOptions = {}
  ): Promise<any[]> {
   ...
   * @param options - Optional settings for the command
   */
  inde***REMOVED***es(options: Inde***REMOVED***InformationOptions & { full?: true }): Promise<Inde***REMOVED***DescriptionInfo[]>;
  inde***REMOVED***es(options: Inde***REMOVED***InformationOptions & { full: false }): Promise<Inde***REMOVED***DescriptionCompact>;
  inde***REMOVED***es(
    options: Inde***REMOVED***InformationOptions
  ): Promise<Inde***REMOVED***DescriptionCompact | Inde***REMOVED***DescriptionInfo[]>;
  inde***REMOVED***es(options?: ListInde***REMOVED***esOptions): Promise<Inde***REMOVED***DescriptionInfo[]>;
  async inde***REMOVED***es(
    options?: Inde***REMOVED***InformationOptions
  ): Promise<Inde***REMOVED***DescriptionCompact | Inde***REMOVED***DescriptionInfo[]> {
    const inde***REMOVED***es: Inde***REMOVED***DescriptionInfo[] = await this.listInde***REMOVED***es(options).toArray();
    const full = options?.full ?? true;
    if (full) {
      return inde***REMOVED***es;
    }

    const object: Inde***REMOVED***DescriptionCompact = Object.fromEntries(
      inde***REMOVED***es.map(({ name, key }) => [name, Object.entries(key)])
    );
   ...
   * @param options - Optional settings for the command
   */
  aggregate<T e***REMOVED***tends Document = Document>(
    pipeline: Document[] = [],
   ...
   */
  watch<TLocal e***REMOVED***tends Document = TSchema, TChange e***REMOVED***tends Document = ChangeStreamDocument<TLocal>>(
    pipeline: Document[] = [],
  ...
  listSearchInde***REMOVED***es(
    inde***REMOVED***NameOrOptions?: string | ListSearchInde***REMOVED***esOptions,
    options?: ListSearchInde***REMOVED***esOptions
  ): ListSearchInde***REMOVED***esCursor {
    options =
      typeof inde***REMOVED***NameOrOptions === 'object' ? inde***REMOVED***NameOrOptions : options == null ? {} : options;

    const inde***REMOVED***Name =
      inde***REMOVED***NameOrOptions == null
        ? null
        : typeof inde***REMOVED***NameOrOptions === 'object'
          ? null
          : inde***REMOVED***NameOrOptions;

    return new ListSearchInde***REMOVED***esCursor(this as TODO_NODE_3286, inde***REMOVED***Name, options);
  }
   ...
   * @remarks Only available when used against a 7.0+ Atlas cluster.
   */
  async createSearchInde***REMOVED***(description: SearchInde***REMOVED***Description): Promise<string> {
    const [inde***REMOVED***] = await this.createSearchInde***REMOVED***es([description]);
    return inde***REMOVED***;
  }
   ...
   * @returns
   */
  async createSearchInde***REMOVED***es(descriptions: SearchInde***REMOVED***Description[]): Promise<string[]> {
    return await e***REMOVED***ecuteOperation(
      this.client,
      new CreateSearchInde***REMOVED***esOperation(this as TODO_NODE_3286, descriptions)
    );
  }
   ...
   * @remarks Only available when used against a 7.0+ Atlas cluster.
   */
  async dropSearchInde***REMOVED***(name: string): Promise<void> {
    return await e***REMOVED***ecuteOperation(
      this.client,
      new DropSearchInde***REMOVED***Operation(this as TODO_NODE_3286, name)
    );
  }
   ...
   * @remarks Only available when used against a 7.0+ Atlas cluster.
   */
  async updateSearchInde***REMOVED***(name: string, definition: Document): Promise<void> {
    return await e***REMOVED***ecuteOperation(
      this.client,
      new UpdateSearchInde***REMOVED***Operation(this as TODO_NODE_3286, name, definition)
    );
  }
}
