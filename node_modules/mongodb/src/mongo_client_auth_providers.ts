...
import { X509 } from './cmap/auth/***REMOVED***509';
 ...
 * @internal
 */
e***REMOVED***port class MongoClientAuthProviders {
  private e***REMOVED***istingProviders: Map<AuthMechanism | string, AuthProvider> = new Map();
