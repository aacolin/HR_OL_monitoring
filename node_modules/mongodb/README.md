...
For e***REMOVED***haustive server and runtime version compatibility matrices, please refer to the following links:
...
#### Component Support Matri***REMOVED***
...
| Component                                                                            | `mongodb@3.***REMOVED***`      | `mongodb@4.***REMOVED***`      | `mongodb@5.***REMOVED***`      | `mongodb@6.***REMOVED***` |
| ------------------------------------------------------------------------------------ | ------------------ | ------------------ | ------------------ | ------------- |
| [bson](https://www.npmjs.com/package/bson)                                           | ^1.0.0             | ^4.0.0             | ^5.0.0             | ^6.0.0        |
| [bson-e***REMOVED***t](https://www.npmjs.com/package/bson-e***REMOVED***t)                                   | ^1.0.0 \|\| ^2.0.0 | ^4.0.0             | N/A                | N/A           |
...
If you run into any une***REMOVED***pected compiler failures against our supported TypeScript versions, please let us know by filing an issue on our [JIRA](https://jira.mongodb.org/browse/NODE).

## Installation

The recommended way to get started using the Node.js 5.***REMOVED*** driver is by using the `npm` (Node Package Manager) to install the dependency in your project.
...
Some of these packages include native C++ e***REMOVED***tensions.
Consult the [trouble shooting guide here](https://github.com/mongodb/node-mongodb-native/blob/HEAD/etc/notes/native-e***REMOVED***tensions.md) if you run into compilation issues.
...
Ne***REMOVED***t, install the driver as a dependency.
...
async function main() {
  ...
  // the following code e***REMOVED***amples can be pasted here...
...
If you add this below the insertMany e***REMOVED***ample, you'll see the documents you've inserted.
...
### Inde***REMOVED*** a Collection

[Inde***REMOVED***es](https://www.mongodb.com/docs/manual/inde***REMOVED***es/) can improve your application's
performance. The following function creates an inde***REMOVED*** on the **a** field in the
**documents** collection.

```js
const inde***REMOVED***Name = await collection.createInde***REMOVED***({ a: 1 });
console.log('inde***REMOVED*** name =', inde***REMOVED***Name);
```

For more detailed information, see the [inde***REMOVED***ing strategies page](https://www.mongodb.com/docs/manual/applications/inde***REMOVED***es/).
