...
e***REMOVED***ports.MongoClientAuthProviders = void 0;
...
const ***REMOVED***509_1 = require("./cmap/auth/***REMOVED***509");
...
const AUTH_PROVIDERS = new Map([
    ...
    [providers_1.AuthMechanism.MONGODB_X509, () => new ***REMOVED***509_1.X509()]
]);
/**
...
class MongoClientAuthProviders {
    constructor() {
        this.e***REMOVED***istingProviders = new Map();
    }
    /**
    ...
    getOrCreateProvider(name, authMechanismProperties) {
        const authProvider = this.e***REMOVED***istingProviders.get(name);
        if (authProvider) {
            return authProvider;
        }
        ...
        this.e***REMOVED***istingProviders.set(name, provider);
        return provider;
    }
    /**
...
e***REMOVED***ports.MongoClientAuthProviders = MongoClientAuthProviders;
