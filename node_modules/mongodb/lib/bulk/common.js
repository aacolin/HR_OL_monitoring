...
e***REMOVED***ports.BulkOperationBase = e***REMOVED***ports.BulkWriteShimOperation = e***REMOVED***ports.FindOperators = e***REMOVED***ports.MongoBulkWriteError = e***REMOVED***ports.WriteError = e***REMOVED***ports.WriteConcernError = e***REMOVED***ports.BulkWriteResult = e***REMOVED***ports.Batch = e***REMOVED***ports.BatchType = void 0;
e***REMOVED***ports.mergeBatchResults = mergeBatchResults;
...
/** @public */
e***REMOVED***ports.BatchType = Object.freeze({
    INSERT: 1,
    UPDATE: 2,
    DELETE: 3
});
 ...
 */
class Batch {
    constructor(batchType, originalZeroInde***REMOVED***) {
...
class BulkWriteResult {
    ...
    getSuccessfullyInsertedIds(bulkResult, isOrdered) {
        ...
        return bulkResult.insertedIds.filter(({ inde***REMOVED*** }) => !bulkResult.writeErrors.some(writeError => inde***REMOVED*** === writeError.inde***REMOVED***));
    }
    /** Returns the upserted id at the given inde***REMOVED*** */
    getUpsertedIdAt(inde***REMOVED***) {
...
e***REMOVED***ports.BulkWriteResult = BulkWriteResult;
/**
...
e***REMOVED***ports.WriteConcernError = WriteConcernError;
/**
...
e***REMOVED***ports.WriteError = WriteError;
...
async function e***REMOVED***ecuteCommands(bulkOperation, options) {
    ...
    for (const batch of bulkOperation.s.batches) {
        ...
        let result;
        try {
            result = await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(bulkOperation.s.collection.client, operation);
        }
        catch (error) {
            thrownError = error;
        }
 ...
 * @category Error
 */
class MongoBulkWriteError e***REMOVED***tends error_1.MongoServerError {
    /**
...
e***REMOVED***ports.MongoBulkWriteError = MongoBulkWriteError;
/**
...
class FindOperators {
    ...
    update(updateDocument) {
        ...
        return this.bulkOperation.addToOperationsList(e***REMOVED***ports.BatchType.UPDATE, (0, update_1.makeUpdateStatement)(currentOp.selector, updateDocument, {
            ...currentOp,
            multi: true
        }));
    }
    ...
    updateOne(updateDocument) {
        ...
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(e***REMOVED***ports.BatchType.UPDATE, (0, update_1.makeUpdateStatement)(currentOp.selector, updateDocument, { ...currentOp, multi: false }));
    }
    ...
    replaceOne(replacement) {
        ...
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(e***REMOVED***ports.BatchType.UPDATE, (0, update_1.makeUpdateStatement)(currentOp.selector, replacement, { ...currentOp, multi: false }));
    }
    /** Add a delete one operation to the bulk operation */
    deleteOne() {
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(e***REMOVED***ports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(currentOp.selector, { ...currentOp, limit: 1 }));
    }
    /** Add a delete many operation to the bulk operation */
    delete() {
        const currentOp = buildCurrentOp(this.bulkOperation);
        return this.bulkOperation.addToOperationsList(e***REMOVED***ports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(currentOp.selector, { ...currentOp, limit: 0 }));
    }
...
e***REMOVED***ports.FindOperators = FindOperators;
/**
 * TODO(NODE-4063)
 ...
 * @internal
 */
class BulkWriteShimOperation e***REMOVED***tends operation_1.AbstractOperation {
    ...
    async e***REMOVED***ecute(_server, session) {
...
e***REMOVED***ports.BulkWriteShimOperation = BulkWriteShimOperation;
/** @public */
class BulkOperationBase {
    ...
    constructor(collection, options, isOrdered) {
        ...
        const ma***REMOVED***BsonObjectSize = hello && hello.ma***REMOVED***BsonObjectSize ? hello.ma***REMOVED***BsonObjectSize : 1024 * 1024 * 16;
    ...
    insert(document) {
        ...
        return this.addToOperationsList(e***REMOVED***ports.BatchType.INSERT, document);
    }
    /**
    ...
    raw(op) {
        ...
        if ('replaceOne' in op || 'updateOne' in op || 'updateMany' in op) {
            if ('replaceOne' in op) {
                ...
                return this.addToOperationsList(e***REMOVED***ports.BatchType.UPDATE, updateStatement);
            }
            if ('updateOne' in op) {
        ...
        if ('deleteOne' in op) {
            ...
            return this.addToOperationsList(e***REMOVED***ports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(op.deleteOne.filter, { ...op.deleteOne, limit: 1 }));
        }
        if ('deleteMany' in op) {
            if ('q' in op.deleteMany) {
                throw new error_1.MongoInvalidArgumentError('Raw operations are not allowed');
            }
            return this.addToOperationsList(e***REMOVED***ports.BatchType.DELETE, (0, delete_1.makeDeleteStatement)(op.deleteMany.filter, { ...op.deleteMany, limit: 0 }));
        }
    ...
    async e***REMOVED***ecute(options = {}) {
        if (this.s.e***REMOVED***ecuted) {
            throw new error_1.MongoBatchReE***REMOVED***ecutionError();
        }
        ...
        return await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(this.s.collection.client, operation);
    }
    /**
...
e***REMOVED***ports.BulkOperationBase = BulkOperationBase;
function isInsertBatch(batch) {
    return batch.batchType === e***REMOVED***ports.BatchType.INSERT;
}
function isUpdateBatch(batch) {
    return batch.batchType === e***REMOVED***ports.BatchType.UPDATE;
}
function isDeleteBatch(batch) {
    return batch.batchType === e***REMOVED***ports.BatchType.DELETE;
}
