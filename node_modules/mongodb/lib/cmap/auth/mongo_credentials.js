...
e***REMOVED***ports.MongoCredentials = e***REMOVED***ports.DEFAULT_ALLOWED_HOSTS = void 0;
...
/** @internal */
e***REMOVED***ports.DEFAULT_ALLOWED_HOSTS = [
    '*.mongodb.net',
    '*.mongodb-qa.net',
    '*.mongodb-dev.net',
    '*.mongodbgov.net',
...
class MongoCredentials {
    constructor(options) {
        ...
        if (this.mechanism === providers_1.AuthMechanism.MONGODB_OIDC && !this.mechanismProperties.ALLOWED_HOSTS) {
            this.mechanismProperties = {
                ...this.mechanismProperties,
                ALLOWED_HOSTS: e***REMOVED***ports.DEFAULT_ALLOWED_HOSTS
            };
        }
    ...
    validate() {
        ...
        if (providers_1.AUTH_MECHS_AUTH_SRC_EXTERNAL.has(this.mechanism)) {
            if (this.source != null && this.source !== '$e***REMOVED***ternal') {
...
e***REMOVED***ports.MongoCredentials = MongoCredentials;
