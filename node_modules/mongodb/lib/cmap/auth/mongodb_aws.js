...
e***REMOVED***ports.MongoDBAWS = void 0;
...
class MongoDBAWS e***REMOVED***tends auth_provider_1.AuthProvider {
    constructor() {
        super();
    ...
    async auth(authConte***REMOVED***t) {
        ...
        if (!authConte***REMOVED***t.credentials) {
        ...
        if ((0, utils_1.ma***REMOVED***WireVersion)(connection) < 9) {
            throw new error_1.MongoCompatibilityError('MONGODB-AWS authentication requires MongoDB version 4.4 or later');
        }
        if (!authConte***REMOVED***t.credentials.username) {
            authConte***REMOVED***t.credentials = await makeTempCredentials(authConte***REMOVED***t.credentials, this.credentialFetcher);
        }
        ...
        if (serverNonce.length !== 64) {
            // TODO(NODE-3483)
            throw new error_1.MongoRuntimeError(`Invalid server nonce length ${serverNonce.length}, e***REMOVED***pected 64`);
        }
        ...
        if (host.length < 1 || host.length > 255 || host.inde***REMOVED***Of('..') !== -1) {
            // TODO(NODE-3483)
        ...
        const options = sign({
            ...
            service: 'sts',
            headers: {
                'Content-Type': 'application/***REMOVED***-www-form-urlencoded',
...
e***REMOVED***ports.MongoDBAWS = MongoDBAWS;
