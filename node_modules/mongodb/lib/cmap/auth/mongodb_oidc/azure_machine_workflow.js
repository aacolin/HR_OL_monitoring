...
e***REMOVED***ports.AzureMachineWorkflow = void 0;
...
const ENDPOINT_RESULT_ERROR = 'Azure endpoint did not return a value with only access_token and e***REMOVED***pires_in properties';
 ...
 * @internal
 */
class AzureMachineWorkflow e***REMOVED***tends machine_workflow_1.MachineWorkflow {
    /**
...
e***REMOVED***ports.AzureMachineWorkflow = AzureMachineWorkflow;
/**
...
async function getAzureTokenData(tokenAudience, username) {
    ...
    return {
        ...
        e***REMOVED***pires_in: Number(result.e***REMOVED***pires_in)
    };
}
/**
 * Determines if a result returned from the endpoint is valid.
 * This means the result is not nullish, contains the access_token required field
 * and the e***REMOVED***pires_in required field.
 */
function isEndpointResultValid(token) {
    ...
    return ('access_token' in token &&
        ...
        'e***REMOVED***pires_in' in token &&
        typeof token.e***REMOVED***pires_in === 'number');
}
