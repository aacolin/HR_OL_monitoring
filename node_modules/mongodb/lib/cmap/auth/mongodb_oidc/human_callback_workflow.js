...
e***REMOVED***ports.HumanCallbackWorkflow = void 0;
 ...
 * @internal
 */
class HumanCallbackWorkflow e***REMOVED***tends callback_workflow_1.CallbackWorkflow {
    /**
    ...
    /**
     * E***REMOVED***ecute the OIDC human callback workflow.
     */
    async e***REMOVED***ecute(connection, credentials) {
        ...
        // and restart the authentication flow. Raise any other errors to the user. On success, e***REMOVED***it the algorithm.
        if (this.cache.hasAccessToken) {
            ...
            try {
                ...
                if (error instanceof error_1.MongoError &&
                    ...
                    return await this.e***REMOVED***ecute(connection, credentials);
                }
                else {
                    throw error;
                }
        ...
        // errors to the user. On success, e***REMOVED***it the algorithm.
    ...
    async fetchAccessToken(idpInfo, credentials, refreshToken) {
        ...
        const params = {
            timeoutConte***REMOVED***t: controller.signal,
        ...
        const timeout = timeout_1.Timeout.e***REMOVED***pires(callback_workflow_1.HUMAN_TIMEOUT_MS);
        try {
            return await Promise.race([this.e***REMOVED***ecuteAndValidateCallback(params), timeout]);
        }
        catch (error) {
...
e***REMOVED***ports.HumanCallbackWorkflow = HumanCallbackWorkflow;
