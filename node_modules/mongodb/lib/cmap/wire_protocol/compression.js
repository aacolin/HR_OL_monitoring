...
e***REMOVED***ports.uncompressibleCommands = e***REMOVED***ports.Compressor = void 0;
e***REMOVED***ports.compress = compress;
e***REMOVED***ports.decompress = decompress;
e***REMOVED***ports.compressCommand = compressCommand;
e***REMOVED***ports.decompressResponse = decompressResponse;
...
/** @public */
e***REMOVED***ports.Compressor = Object.freeze({
    none: 0,
    snappy: 1,
    zlib: 2,
    zstd: 3
});
e***REMOVED***ports.uncompressibleCommands = new Set([
...
async function decompress(compressorID, compressedData) {
    if (compressorID !== e***REMOVED***ports.Compressor.snappy &&
        compressorID !== e***REMOVED***ports.Compressor.zstd &&
        compressorID !== e***REMOVED***ports.Compressor.zlib &&
        compressorID !== e***REMOVED***ports.Compressor.none) {
        throw new error_1.MongoDecompressionError(`Server sent message compressed using an unsupported compressor. (Received compressor ID ${compressorID})`);
    }
    switch (compressorID) {
        case e***REMOVED***ports.Compressor.snappy: {
            Snappy ??= loadSnappy();
            return await Snappy.uncompress(compressedData, { asBuffer: true });
        }
        case e***REMOVED***ports.Compressor.zstd: {
            loadZstd();
            if ('kModuleError' in zstd) {
                throw zstd['kModuleError'];
            }
        ...
        case e***REMOVED***ports.Compressor.zlib: {
