...
e***REMOVED***ports.CryptoConnection = e***REMOVED***ports.SizedMessageTransform = e***REMOVED***ports.Connection = void 0;
e***REMOVED***ports.hasSessionSupport = hasSessionSupport;
...
function streamIdentifier(stream, options) {
    ...
    return (0, utils_1.uuidV4)().toString('he***REMOVED***');
}
/** @internal */
class Connection e***REMOVED***tends mongo_types_1.TypedEventEmitter {
    ...
    get supportsOpMsg() {
        return (this.description != null &&
            (0, utils_1.ma***REMOVED***WireVersion)(this) >= 6 &&
    ...
    async command(ns, command, options = {}, responseType) {
        ...
        throw new error_1.MongoUne***REMOVED***pectedServerResponseError('Unable to get response from server');
    }
    e***REMOVED***haustCommand(ns, command, options, replyListener) {
        const e***REMOVED***haustLoop = async () => {
            ...
            throw new error_1.MongoUne***REMOVED***pectedServerResponseError('Server ended moreToCome une***REMOVED***pectedly');
        };
...
e***REMOVED***ports.Connection = Connection;
/** @event */
...
/** @internal */
class SizedMessageTransform e***REMOVED***tends stream_1.Transform {
...
e***REMOVED***ports.SizedMessageTransform = SizedMessageTransform;
/** @internal */
class CryptoConnection e***REMOVED***tends Connection {
    constructor(stream, options) {
    ...
    async command(ns, cmd, options, responseType) {
        ...
        const serverWireVersion = (0, utils_1.ma***REMOVED***WireVersion)(this);
        ...
        const inde***REMOVED***Keys = cmd.createInde***REMOVED***es
            ? cmd.inde***REMOVED***es.map((inde***REMOVED***) => inde***REMOVED***.key)
            : null;
...
e***REMOVED***ports.CryptoConnection = CryptoConnection;
