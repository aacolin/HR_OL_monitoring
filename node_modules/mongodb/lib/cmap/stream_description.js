...
e***REMOVED***ports.StreamDescription = void 0;
...
class StreamDescription {
    constructor(address, options) {
        ...
        this.ma***REMOVED***WireVersion = undefined;
        this.ma***REMOVED***BsonObjectSize = 16777216;
        this.ma***REMOVED***MessageSizeBytes = 48000000;
        this.ma***REMOVED***WriteBatchSize = 100000;
    ...
    parseServerConnectionID(serverConnectionId) {
        ...
        return bson_1.Long.isLong(serverConnectionId)
            ...
            : // @ts-e***REMOVED***pect-error: Doubles are coercible to number
                BigInt(serverConnectionId);
    }
}
e***REMOVED***ports.StreamDescription = StreamDescription;
