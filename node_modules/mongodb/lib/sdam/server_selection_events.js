...
e***REMOVED***ports.WaitingForSuitableServerEvent = e***REMOVED***ports.ServerSelectionSucceededEvent = e***REMOVED***ports.ServerSelectionFailedEvent = e***REMOVED***ports.ServerSelectionStartedEvent = e***REMOVED***ports.ServerSelectionEvent = void 0;
const utils_1 = require(".././utils");
const constants_1 = require("../constants");
/**
 * The base e***REMOVED***port class for all logs published from server selection
 * @internal
 * @category Log Type
 */
...
e***REMOVED***ports.ServerSelectionEvent = ServerSelectionEvent;
/**
 * An event published when server selection starts
 * @internal
 * @category Event
 */
class ServerSelectionStartedEvent e***REMOVED***tends ServerSelectionEvent {
    /** @internal */
    constructor(selector, topologyDescription, operation) {
...
e***REMOVED***ports.ServerSelectionStartedEvent = ServerSelectionStartedEvent;
/**
 * An event published when a server selection fails
 * @internal
 * @category Event
 */
class ServerSelectionFailedEvent e***REMOVED***tends ServerSelectionEvent {
    /** @internal */
...
e***REMOVED***ports.ServerSelectionFailedEvent = ServerSelectionFailedEvent;
/**
 * An event published when server selection succeeds
 * @internal
 * @category Event
 */
class ServerSelectionSucceededEvent e***REMOVED***tends ServerSelectionEvent {
    /** @internal */
...
e***REMOVED***ports.ServerSelectionSucceededEvent = ServerSelectionSucceededEvent;
/**
 * An event published when server selection is waiting for a suitable server to become available
 * @internal
 * @category Event
 */
class WaitingForSuitableServerEvent e***REMOVED***tends ServerSelectionEvent {
    /** @internal */
...
e***REMOVED***ports.WaitingForSuitableServerEvent = WaitingForSuitableServerEvent;
