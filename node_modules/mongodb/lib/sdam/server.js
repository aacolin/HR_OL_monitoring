...
/** @internal */
class Server e***REMOVED***tends mongo_types_1.TypedEventEmitter {
    /**
     * Create a server
     */
        ...
        if (isNetworkNonTimeoutError || isNetworkTimeoutBeforeHandshakeError || isAuthHandshakeError) {
            ...
            if ((0, error_1.isSDAMUnrecoverableError)(error)) {
                if (shouldHandleStateChangeError(this, error)) {
                    const shouldClearPool = (0, utils_1.ma***REMOVED***WireVersion)(this) <= 7 || (0, error_1.isNodeShuttingDownError)(error);
    ...
    decorateCommandError(connection, cmd, options, error) {
        if (typeof error !== 'object' || error == null || !('name' in error)) {
            throw new error_1.MongoRuntimeError('An une***REMOVED***pected error type: ' + typeof error);
        }
        ...
        if (error instanceof error_1.MongoNetworkError) {
            ...
            if ((isRetryableWritesEnabled(this.topology) || (0, transactions_1.isTransactionCommand)(cmd)) &&
                (0, error_1.needsRetryableWriteLabel)(error, (0, utils_1.ma***REMOVED***WireVersion)(this), this.description.type) &&
                !inActiveTransaction(session, cmd)) {
                error.addErrorLabel(error_1.MongoErrorLabel.RetryableWriteError);
            }
        }
...
function connectionIsStale(pool, connection) {
    if (connection.serviceId) {
        return (connection.generation !== pool.serviceGenerations.get(connection.serviceId.toHe***REMOVED***String()));
    }
