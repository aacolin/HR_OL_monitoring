...
e***REMOVED***ports.ServerCapabilities = e***REMOVED***ports.Topology = void 0;
 ...
 * @internal
 */
class Topology e***REMOVED***tends mongo_types_1.TypedEventEmitter {
    /**
    ...
    constructor(client, seeds, options) {
        ...
        const selectedHosts = options.srvMa***REMOVED***Hosts == null ||
            options.srvMa***REMOVED***Hosts === 0 ||
            options.srvMa***REMOVED***Hosts >= seedlist.length
            ? seedlist
            : (0, utils_1.shuffle)(seedlist, options.srvMa***REMOVED***Hosts);
    ...
    detectSrvRecords(ev) {
        ...
        this.s.description = this.s.description.updateFromSrvPollingEvent(ev, this.s.options.srvMa***REMOVED***Hosts);
    ...
    async selectServer(selector, options) {
        ...
        const timeout = timeout_1.Timeout.e***REMOVED***pires(options.serverSelectionTimeoutMS ?? 0);
...
e***REMOVED***ports.Topology = Topology;
/** @event */
...
class ServerCapabilities {
    ...
    get hasListInde***REMOVED***esCommand() {
        return this.ma***REMOVED***WireVersion >= 3;
    }
...
e***REMOVED***ports.ServerCapabilities = ServerCapabilities;
