...
e***REMOVED***ports.RTTSampler = e***REMOVED***ports.MonitorInterval = e***REMOVED***ports.RTTPinger = e***REMOVED***ports.Monitor = e***REMOVED***ports.ServerMonitoringMode = void 0;
...
/** @public */
e***REMOVED***ports.ServerMonitoringMode = Object.freeze({
    auto: 'auto',
    poll: 'poll',
    stream: 'stream'
});
/** @internal */
class Monitor e***REMOVED***tends mongo_types_1.TypedEventEmitter {
...
e***REMOVED***ports.Monitor = Monitor;
...
function useStreamingProtocol(monitor, topologyVersion) {
    ...
    if (serverMonitoringMode === e***REMOVED***ports.ServerMonitoringMode.poll)
        return false;
    if (serverMonitoringMode === e***REMOVED***ports.ServerMonitoringMode.stream)
        return true;
...
function checkServer(monitor, callback) {
    ...
    if (connection && !connection.closed) {
        ...
        if (isAwaitable) {
            awaited = true;
            return connection.e***REMOVED***haustCommand((0, utils_1.ns)('admin.$cmd'), cmd, options, (error, hello) => {
                if (error)
...
e***REMOVED***ports.RTTPinger = RTTPinger;
/**
 * @internal
 */
class MonitorInterval {
    constructor(fn, options = {}) {
        ...
        this.hasE***REMOVED***ecutedOnce = false;
        this._e***REMOVED***ecuteAndReschedule = () => {
            ...
            this.fn(() => {
                this.lastE***REMOVED***ecutionEnded = (0, utils_1.now)();
                this.isE***REMOVED***ecutionInProgress = false;
    ...
    _reschedule(ms) {
        ...
        this.timerId = (0, timers_1.setTimeout)(this._e***REMOVED***ecuteAndReschedule, ms || this.heartbeatFrequencyMS);
    }
}
e***REMOVED***ports.MonitorInterval = MonitorInterval;
/** @internal
...
e***REMOVED***ports.RTTSampler = RTTSampler;
