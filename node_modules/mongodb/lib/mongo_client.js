...
e***REMOVED***ports.MongoClient = e***REMOVED***ports.ServerApiVersion = void 0;
...
const e***REMOVED***ecutor_1 = require("./operations/client_bulk_write/e***REMOVED***ecutor");
...
/** @public */
e***REMOVED***ports.ServerApiVersion = Object.freeze({
    v1: '1'
});
/** @internal */
 ...
 * ```
 */
class MongoClient e***REMOVED***tends mongo_types_1.TypedEventEmitter {
    ...
    async bulkWrite(models, options) {
        ...
        return await new e***REMOVED***ecutor_1.ClientBulkWriteE***REMOVED***ecutor(this, models, (0, utils_1.resolveOptions)(this, options)).e***REMOVED***ecute();
    }
    /**
    ...
    async close(force = false) {
        ...
        if (servers.length !== 0) {
            ...
            if (endSessions.length !== 0) {
                try {
                    await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(this, new run_command_1.RunAdminCommandOperation({ endSessions }, { readPreference: read_preference_1.ReadPreference.primaryPreferred, noResponse: true }));
                }
                catch (error) {
    ...
    startSession(options) {
        const session = new sessions_1.ClientSession(this, this.s.sessionPool, { e***REMOVED***plicit: true, ...options }, this[kOptions]);
    ...
    async withSession(optionsOrE***REMOVED***ecutor, e***REMOVED***ecutor) {
        const options = {
        ...
        const withSessionCallback = typeof optionsOrE***REMOVED***ecutor === 'function' ? optionsOrE***REMOVED***ecutor : e***REMOVED***ecutor;
...
e***REMOVED***ports.MongoClient = MongoClient;
