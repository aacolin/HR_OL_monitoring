...
e***REMOVED***ports.AggregationCursor = void 0;
 ...
 * @public
 */
class AggregationCursor e***REMOVED***tends abstract_cursor_1.AbstractCursor {
    /** @internal */
    ...
    async _initialize(session) {
        ...
        const response = await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(this.client, aggregateOperation);
        return { server: aggregateOperation.server, session, response };
    }
    /** E***REMOVED***ecute the e***REMOVED***plain for the cursor */
    async e***REMOVED***plain(verbosity) {
        return (await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(this.client, new aggregate_1.AggregateOperation(this.namespace, this.pipeline, {
...
e***REMOVED***ports.AggregationCursor = AggregationCursor;
