...
e***REMOVED***ports.FindCursor = e***REMOVED***ports.FLAGS = void 0;
...
/** @public */
class FindCursor e***REMOVED***tends abstract_cursor_1.AbstractCursor {
    /** @internal */
    ...
    async _initialize(session) {
        ...
        const response = await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(this.client, findOperation);
     ...
     */
    async count(options) {
        (0, utils_1.emitWarningOnce)('cursor.count is deprecated and will be removed in the ne***REMOVED***t major version, please use `collection.estimatedDocumentCount` or `collection.countDocuments` instead ');
        if (typeof options === 'boolean') {
            throw new error_1.MongoInvalidArgumentError('Invalid first parameter to count');
        }
        return await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(this.client, new count_1.CountOperation(this.namespace, this.cursorFilter, {
            ...this.findOptions, // NOTE: order matters here, we may need to refine this
            ...this.cursorOptions,
            ...options
        }));
    ...
    async e***REMOVED***plain(verbosity) {
        return (await (0, e***REMOVED***ecute_operation_1.e***REMOVED***ecuteOperation)(this.client, new find_1.FindOperation(this.namespace, this.cursorFilter, {
            ...this.findOptions, // NOTE: order matters here, we may need to refine this
            ...this.cursorOptions,
    ...
    addQueryModifier(name, value) {
        ...
        switch (field) {
            ...
            case 'e***REMOVED***plain':
                this.findOptions.e***REMOVED***plain = value;
                break;
            case 'hint':
                this.findOptions.hint = value;
                break;
            case 'ma***REMOVED***':
                this.findOptions.ma***REMOVED*** = value;
                break;
     ...
     */
    ma***REMOVED***AwaitTimeMS(value) {
        this.throwIfInitialized();
        if (typeof value !== 'number') {
            throw new error_1.MongoInvalidArgumentError('Argument for ma***REMOVED***AwaitTimeMS must be a number');
        }
...
e***REMOVED***ports.FindCursor = FindCursor;
