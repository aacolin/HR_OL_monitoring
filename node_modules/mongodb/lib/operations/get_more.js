...
e***REMOVED***ports.GetMoreOperation = void 0;
const responses_1 = require("../cmap/wire_protocol/responses");
const error_1 = require("../error");
const utils_1 = require("../utils");
const operation_1 = require("./operation");
/** @internal */
class GetMoreOperation e***REMOVED***tends operation_1.AbstractOperation {
     ...
     */
    async e***REMOVED***ecute(server, _session) {
        ...
        if (this.options.comment !== undefined && (0, utils_1.ma***REMOVED***WireVersion)(server) >= 9) {
...
e***REMOVED***ports.GetMoreOperation = GetMoreOperation;
