...
e***REMOVED***ports.ClientBulkWriteResultsMerger = void 0;
const __1 = require("../..");
...
class ClientBulkWriteResultsMerger {
    ...
    /**
     * Merge the results in the cursor to the e***REMOVED***isting result.
     * @param currentBatchOffset - The offset inde***REMOVED*** to the original models.
        ...
        try {
            for await (const document of cursor) {
                ...
                if (document.ok === 1) {
                    ...
                    // record the error in writeErrors and immediately throw the e***REMOVED***ception. Otherwise, drivers
                    // MUST continue to iterate the results cursor and e***REMOVED***ecute any further bulkWrite batches.
                    if (this.options.ordered) {
                        const error = new error_1.MongoClientBulkWriteError({
                            message: 'Mongo client ordered bulk write encountered a write error.'
                        });
                        error.writeErrors.set(document.id***REMOVED*** + this.currentBatchOffset, {
                            code: document.code,
                        ...
                        this.writeErrors.set(document.id***REMOVED*** + this.currentBatchOffset, {
                            code: document.code,
                            message: document.errmsg
                        });
                    }
    ...
    processDocument(cursor, document) {
        ...
        const operation = cursor.operations[document.id***REMOVED***];
        // Handle insert results.
        if ('insert' in operation) {
            this.result.insertResults?.set(document.id***REMOVED*** + this.currentBatchOffset, {
        ...
        if ('update' in operation) {
            ...
            this.result.updateResults?.set(document.id***REMOVED*** + this.currentBatchOffset, result);
        }
        // Handle delete results.
        if ('delete' in operation) {
            this.result.deleteResults?.set(document.id***REMOVED*** + this.currentBatchOffset, {
...
e***REMOVED***ports.ClientBulkWriteResultsMerger = ClientBulkWriteResultsMerger;
