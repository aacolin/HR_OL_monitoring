...
e***REMOVED***ports.aws4 = void 0;
e***REMOVED***ports.getKerberos = getKerberos;
e***REMOVED***ports.getZstdLibrary = getZstdLibrary;
e***REMOVED***ports.getAwsCredentialProvider = getAwsCredentialProvider;
e***REMOVED***ports.getGcpMetadata = getGcpMetadata;
e***REMOVED***ports.getSnappy = getSnappy;
e***REMOVED***ports.getSocks = getSocks;
e***REMOVED***ports.getMongoDBClientEncryption = getMongoDBClientEncryption;
const error_1 = require("./error");
function makeErrorModule(error) {
    const props = error ? { kModuleError: error } : {};
    return new Pro***REMOVED***y(props, {
        get: (_, key) => {
            if (key === 'kModuleError') {
                return error;
            }
...
function getSocks() {
    try {
        ...
        const kModuleError = new error_1.MongoMissingDependencyError('Optional module `socks` not found. Please install it to connections over a SOCKS5 pro***REMOVED***y', { cause: error, dependencyName: 'socks' });
        return { kModuleError };
    }
}
e***REMOVED***ports.aws4 = loadAws4();
function loadAws4() {
    let aws4;
    try {
        // eslint-disable-ne***REMOVED***t-line @typescript-eslint/no-require-imports
...
/** A utility function to get the instance of mongodb-client-encryption, if it e***REMOVED***ists. */
