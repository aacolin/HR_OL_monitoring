...
e***REMOVED***ports.ChangeStream = void 0;
 ...
 * @public
 */
class ChangeStream e***REMOVED***tends mongo_types_1.TypedEventEmitter {
    /** @internal */
    async asyncDispose() {
        await this.close();
    }
    ...
    _processErrorStreamMode(changeStreamError) {
        ...
        if (this[kClosed])
            return;
        if (this.cursor.id != null && (0, error_1.isResumableError)(changeStreamError, this.cursor.ma***REMOVED***WireVersion)) {
            this._endStream();
    ...
    async _processErrorIteratorMode(changeStreamError) {
        ...
        if (this.cursor.id == null ||
            !(0, error_1.isResumableError)(changeStreamError, this.cursor.ma***REMOVED***WireVersion)) {
            try {
                await this.close();
            }
            catch (error) {
...
e***REMOVED***ports.ChangeStream = ChangeStream;
/** @event */
