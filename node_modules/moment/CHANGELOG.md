...
* Release Jul 6, 2022
  * [#6015](https://github.com/moment/moment/pull/6015) [bugfi***REMOVED***] Fi***REMOVED*** ReDoS in preprocessRFC2822 rege***REMOVED***

### 2.29.3 [Full changelog](https://gist.github.com/ichernev/edebd440f49adcaec72e5e77b791d8be)

* Release Apr 17, 2022
  * [#5995](https://github.com/moment/moment/pull/5995) [bugfi***REMOVED***] Remove const usage
  * [#5990](https://github.com/moment/moment/pull/5990) misc: fi***REMOVED*** advisory link
...
Updated deprecation message, bugfi***REMOVED*** in hi locale

### 2.29.0 [See full changelog](https://gist.github.com/marwahaha/b0111718641a6461800066549957ec14)

* Release Sept 22, 2020

New locales (es-m***REMOVED***, bn-bd).
Minor bugfi***REMOVED***es and locale improvements.
More tests.
...
Fi***REMOVED*** bug where .format() modifies original instance, and locale updates

### 2.27.0 [See full changelog](https://gist.github.com/marwahaha/5100c9c2f42019067b1f6cefc333daa7)

* Release June 18, 2020

Added Turkmen locale, other locale improvements, slight TypeScript fi***REMOVED***es

### 2.26.0 [See full changelog](https://gist.github.com/marwahaha/0725c40740560854a849b096ea7b7590)

* Release May 19, 2020

TypeScript fi***REMOVED***es and many locale improvements
...
for modules loaded via module vs jsne***REMOVED***t:main.
...
* [226799e1](https://github.com/moment/moment/commit/226799e1) [locale] fil: Fi***REMOVED*** metadata comment
* [a83a521](https://github.com/moment/moment/commit/a83a521) [bugfi***REMOVED***] Fi***REMOVED*** typeoff usages
...
* [#4611](https://github.com/moment/moment/issues/4611) [022dc038](https://github.com/moment/moment/commit/022dc038) [feature] Support for strict string parsing, fi***REMOVED***es [#2469](https://github.com/moment/moment/issues/2469)
...
* [#4338](https://github.com/moment/moment/pull/4338) [bugfi***REMOVED***] Fi***REMOVED*** startOf/endOf DST issues while boosting performance
* [#4553](https://github.com/moment/moment/pull/4553) [feature] Add localeSort param to Locale weekday methods
* [#4887](https://github.com/moment/moment/pull/4887) [bugfi***REMOVED***] Make Duration#as work with quarters
...
* [#4417](https://github.com/moment/moment/pull/4417) [bugfi***REMOVED***] isBetween should return false for invalid dates
* [#4700](https://github.com/moment/moment/pull/4700) [bugfi***REMOVED***] Fi***REMOVED*** [#4698](https://github.com/moment/moment/pull/4698): Use ISO WeekYear for HTML5_FMT.WEEK
* [#4563](https://github.com/moment/moment/pull/4563) [feature] Fi***REMOVED*** [#4518](https://github.com/moment/moment/pull/4518): Add support to add/subtract ISO weeks
...
* [#4564](https://github.com/moment/moment/pull/4564) [bugfi***REMOVED***] Avoid using trim()
* [#4453](https://github.com/moment/moment/pull/4453) [bugfi***REMOVED***] Treat periods as periods, not rege***REMOVED***-anything period, for weekday parsing in strict mode.
...
* [#4495](https://github.com/moment/moment/pull/4495) [bugfi***REMOVED***] Added HTML5_FMT to moment.d.ts
...
* [#4391](https://github.com/moment/moment/pull/4391) [bugfi***REMOVED***] Fi***REMOVED*** [#4390](https://github.com/moment/moment/pull/4390): use offset properly in toISOString
* [#4310](https://github.com/moment/moment/pull/4310) [bugfi***REMOVED***] Fi***REMOVED*** [#3883](https://github.com/moment/moment/pull/3883) lazy load parentLocale in defineLocale, fallback to global if missing
* [#4085](https://github.com/moment/moment/pull/4085) [misc] Print console warning when setting non-e***REMOVED***istent locales
* [#4371](https://github.com/moment/moment/pull/4371) [misc] fi***REMOVED*** deprecated rollup options
...
* [#4359](https://github.com/moment/moment/pull/4359) [locale] Fi***REMOVED*** Arabic locale for months (again)
...
* [#4312](https://github.com/moment/moment/pull/4312) [bugfi***REMOVED***] Fi***REMOVED*** [#4251](https://github.com/moment/moment/pull/4251): Avoid RFC2822 in utc() test
* [#4240](https://github.com/moment/moment/pull/4240) [bugfi***REMOVED***] Fi***REMOVED*** incorrect strict parsing with full-width parentheses
...
* [#4332](https://github.com/moment/moment/pull/4332) [bugfi***REMOVED***] Fi***REMOVED*** weekday verification for UTC and offset days (fi***REMOVED***es [#4227](https://github.com/moment/moment/pull/4227))
* [#4336](https://github.com/moment/moment/pull/4336) [bugfi***REMOVED***] Fi***REMOVED*** [#4334](https://github.com/moment/moment/pull/4334): Remove unused function call argument
...
* [#4326](https://github.com/moment/moment/pull/4326) [bugfi***REMOVED***] Fi***REMOVED*** for ReDOS vulnerability (see [#4163](https://github.com/moment/moment/issues/4163))
* [#4289](https://github.com/moment/moment/pull/4289) [misc] Fi***REMOVED*** spelling and formatting for U.S. for es-us

### 2.19.2 [See changelog (it's the same >:D)](https://gist.github.com/ichernev/76b1a3f33d3a8ff9665ce434a45221d0)

* Release Nov 11, 2017

* [#4255](https://github.com/moment/moment/pull/4255) [bugfi***REMOVED***] Fi***REMOVED*** year setter for random days in a leap year, fi***REMOVED***es [#4238](https://github.com/moment/moment/issues/4238)
* [#4242](https://github.com/moment/moment/pull/4242) [bugfi***REMOVED***] updateLocale now tries to load parent, fi***REMOVED***es [#3626](https://github.com/moment/moment/issues/3626)
...
## Fi***REMOVED*** React Native 0.49+ crash
* [#4213](https://github.com/moment/moment/pull/4213) [critical] Rename dynamic
  require to avoid React Native crash
* [#4214](https://github.com/moment/moment/pull/4214) [fi***REMOVED***up] Move require
  rename inside try/catch, fi***REMOVED***es
...
* [#4106](https://github.com/moment/moment/pull/4106) [fi***REMOVED***up] Drop isNumeric utility fn, fi***REMOVED***es [#3735](https://github.com/moment/moment/issues/3735)
* [#4080](https://github.com/moment/moment/pull/4080) [feature] Implement a clone method for durations, fi***REMOVED***es [#4078](https://github.com/moment/moment/issues/4078)
...
* [#3904](https://github.com/moment/moment/pull/3904) [pkg] jsne***REMOVED***t:main -> module in package.json
* [#4060](https://github.com/moment/moment/pull/4060) [pkg] Account for new rollup interface

Bugfi***REMOVED***es, new locales, locale fi***REMOVED***es etc...

### 2.18.1

* Release Mar 22, 2017

* [#3853](https://github.com/moment/moment/pull/3853) [misc] Fi***REMOVED*** invalid whitespace character causing inability to parse
  moment.js
...
* [#3643](https://github.com/moment/moment/pull/3643) [bugfi***REMOVED***] Fi***REMOVED***es [#3520](https://github.com/moment/moment/issues/3520), parseZone incorrectly handled minutes under 16
* [#3710](https://github.com/moment/moment/pull/3710) [bugfi***REMOVED***] Fi***REMOVED***es [#3632](https://github.com/moment/moment/issues/3632), toISOString returns null for invalid date
* [#3787](https://github.com/moment/moment/pull/3787) [bugfi***REMOVED***] Fi***REMOVED***es [#3717](https://github.com/moment/moment/issues/3717), ensure day-of-year is non-zero
* [#3780](https://github.com/moment/moment/pull/3780) [bugfi***REMOVED***] Fi***REMOVED***es [#3765](https://github.com/moment/moment/issues/3765): Ensure year 0 is formatted with YYYY
* [#3806](https://github.com/moment/moment/pull/3806) [bugfi***REMOVED***] Fi***REMOVED***es [#3805](https://github.com/moment/moment/issues/3805), fi***REMOVED*** locale month getters for standalone/format cases
...
* [#3638](https://github.com/moment/moment/pull/3638) [misc] TS: Make typescript definitions work with 1.***REMOVED***
* [#3628](https://github.com/moment/moment/pull/3628) [misc] Adds "sign CLA" link to `CONTRIBUTING.md`
* [#3640](https://github.com/moment/moment/pull/3640) [misc] Fi***REMOVED*** locale issues
...
* [#3595](https://github.com/moment/moment/pull/3595) [bugfi***REMOVED***] Fi***REMOVED*** accidental reference to global "value" variable
* [#3506](https://github.com/moment/moment/pull/3506) [bugfi***REMOVED***] Fi***REMOVED*** invalid moments returning valid dates to method calls
* [#3563](https://github.com/moment/moment/pull/3563) [locale] ca: Change future relative time
* [#3504](https://github.com/moment/moment/pull/3504) [tests] Fi***REMOVED***es [#3463](https://github.com/moment/moment/issues/3463), parseZone not handling Z correctly (tests only)
* [#3591](https://github.com/moment/moment/pull/3591) [misc] typescript: update typescript to 2.0.8, add strictNullChecks=true
* [#3597](https://github.com/moment/moment/pull/3597) [misc] Fi***REMOVED***ed capitalization in nuget spec
...
* [#3515](https://github.com/moment/moment/pull/3515) [feature] Fi***REMOVED*** [#2300](https://github.com/moment/moment/issues/2300): Default to current week.

## Bugfi***REMOVED***es
* [#3546](https://github.com/moment/moment/pull/3546) [bugfi***REMOVED***] Implement lazy-loading of child locales with missing prents
* [#3523](https://github.com/moment/moment/pull/3523) [bugfi***REMOVED***] parseZone should handle UTC
* [#3502](https://github.com/moment/moment/pull/3502) [bugfi***REMOVED***] Fi***REMOVED*** [#3500](https://github.com/moment/moment/issues/3500): ISO 8601 parsing should match the full string, not the beginning of the string.
* [#3581](https://github.com/moment/moment/pull/3581) [bugfi***REMOVED***] Fi***REMOVED*** parseZone, redo [#3504](https://github.com/moment/moment/issues/3504), fi***REMOVED*** [#3463](https://github.com/moment/moment/issues/3463)
...
### 2.15.2
* Release Oct 23, 2016
* [#3525](https://github.com/moment/moment/pull/3525) Speedup month standalone/format rege***REMOVED***es **(IMPORTANT)**
* [#3466](https://github.com/moment/moment/pull/3466) Fi***REMOVED*** typo of Javanese

### 2.15.1
* Release Sept 20, 2016
* [#3438](https://github.com/moment/moment/pull/3438) Fi***REMOVED*** locale autoload, revert [#3344](https://github.com/moment/moment/pull/3344)
...
## Bugfi***REMOVED***es
* [#3276](https://github.com/moment/moment/pull/3276) [bugfi***REMOVED***] duration: parser: Support ms durations in .NET synta***REMOVED***
* [#3312](https://github.com/moment/moment/pull/3312) [bugfi***REMOVED***] locales: Enable locale-data getters without moment (fi***REMOVED***es [#3284](https://github.com/moment/moment/issues/3284))
* [#3381](https://github.com/moment/moment/pull/3381) [bugfi***REMOVED***] parsing: Fi***REMOVED*** parseZone without timezone in string, fi***REMOVED***es [#3083](https://github.com/moment/moment/issues/3083)
* [#3383](https://github.com/moment/moment/pull/3383) [bugfi***REMOVED***] toJSON: Fi***REMOVED*** isValid so that toJSON works after a moment is frozen
* [#3427](https://github.com/moment/moment/pull/3427) [bugfi***REMOVED***] ie8: Fi***REMOVED*** IE8 (regression in 2.14.***REMOVED***)
...
* [#3344](https://github.com/moment/moment/pull/3344) [pkg] e***REMOVED***ports: use module.require for nodejs

Also some locale and typescript improvements

### 2.14.1
- Release July 20, 2016
* [#3280](https://github.com/moment/moment/pull/3280) Fi***REMOVED*** typescript definitions
...
* [#3147](https://github.com/moment/moment/pull/3147) Call calendar format function with moment conte***REMOVED***t
* [#3160](https://github.com/moment/moment/pull/3160) deprecate isDSTShifted
* [#3175](https://github.com/moment/moment/pull/3175) make moment calendar e***REMOVED***tensible with ad-hoc options
...
## Bugfi***REMOVED***es
* [#3241](https://github.com/moment/moment/pull/3241) Escape all 24 mi***REMOVED***ed pieces, not only first 12 in computeMonthsParse
* [#3008](https://github.com/moment/moment/pull/3008) Object setter orders sets based on size of unit
* [#3177](https://github.com/moment/moment/pull/3177) Bug Fi***REMOVED*** [#2704](https://github.com/moment/moment/pull/2704) - isoWeekday(String) inconsistent with isoWeekday(Number)
* [#3230](https://github.com/moment/moment/pull/3230) fi***REMOVED*** passing date with format string to ignore format string
* [#3232](https://github.com/moment/moment/pull/3232) Fi***REMOVED*** negative 0 in certain diff cases
* [#3235](https://github.com/moment/moment/pull/3235) Use proper locale inheritance for the base locale, fi***REMOVED***es [#3137](https://github.com/moment/moment/pull/3137)

Plus es-do locale and locale bugfi***REMOVED***es
...
## Bugfi***REMOVED***es
* [#3109](https://github.com/moment/moment/pull/3109) Fi***REMOVED*** [#1756](https://github.com/moment/moment/issues/1756) Resolved thread-safe issue on server side.
* [#3078](https://github.com/moment/moment/pull/3078) Fi***REMOVED*** parsing for months/weekdays with weird characters
* [#3098](https://github.com/moment/moment/pull/3098) Use Z suffi***REMOVED*** when in UTC mode ([#3020](https://github.com/moment/moment/issues/3020))
* [#2995](https://github.com/moment/moment/pull/2995) Fi***REMOVED*** floating point rounding errors in durations
* [#3059](https://github.com/moment/moment/pull/3059) fi***REMOVED*** bug where diff returns -0 in month-related diffs
* [#3045](https://github.com/moment/moment/pull/3045) Fi***REMOVED*** mistaking any input for 'a' token
* [#2877](https://github.com/moment/moment/pull/2877) Use e***REMOVED***plicit .valueOf() calls instead of coercion
* [#3036](https://github.com/moment/moment/pull/3036) Year setter should keep time when DST changes

Plus 3 new locales and locale fi***REMOVED***es.
...
* [#2887](https://github.com/moment/moment/pull/2887) Fi***REMOVED*** toJSON casting of invalid moment
* [#2897](https://github.com/moment/moment/pull/2897) parse string arguments for month() correctly, closes #2884
* [#2946](https://github.com/moment/moment/pull/2946) Fi***REMOVED*** usage suggestions for min and ma***REMOVED***
...
### 2.11.2 (Fi***REMOVED*** ReDoS attack vector)

- Release February 7, 2016

* [#2939](https://github.com/moment/moment/pull/2939) use full-string match to speed up aspnet rege***REMOVED*** match
...
* [#2858](https://github.com/moment/moment/pull/2858) Fi***REMOVED*** Date mocking regression introduced in 2.11.0
...
* [#2869](https://github.com/moment/moment/pull/2869) Fi***REMOVED*** months parsing for some locales
...
* [#2634](https://github.com/moment/moment/pull/2634) Fi***REMOVED*** strict month parsing issue in cs,ru,sk
...
* [#2646](https://github.com/moment/moment/pull/2646) Fi***REMOVED*** [#2645](https://github.com/moment/moment/pull/2645) - invalid dates pre-1970
...
* [#2700](https://github.com/moment/moment/pull/2700) Add [Hh]mm and [Hh]mmss formatting tokens, so you can parse 123 with
  hmm for e***REMOVED***ample
* [#2565](https://github.com/moment/moment/pull/2565) [#2835](https://github.com/moment/moment/pull/2835) E***REMOVED***pose arguments used for moment creation with creationData
  (fi***REMOVED*** [#2443](https://github.com/moment/moment/pull/2443))
* [#2648](https://github.com/moment/moment/pull/2648) fi***REMOVED*** issue [#2640](https://github.com/moment/moment/pull/2640): support instanceof operator
* [#2709](https://github.com/moment/moment/pull/2709) Add isSameOrAfter and isSameOrBefore comparison methods
* [#2721](https://github.com/moment/moment/pull/2721) Fi***REMOVED*** moment creation from object with strings values
...
[#2515](https://github.com/moment/moment/pull/2515) Fi***REMOVED*** regression introduced
...
* [#2357](https://github.com/moment/moment/pull/2357) Improve unit bubbling for ISO dates
  this fi***REMOVED***es day to year conversions to work around end-of-year (~365 days). As
  a side effect 365 days is 11 months and 30 days, and 366 days is one year.
* [#2438](https://github.com/moment/moment/pull/2438) Fi***REMOVED*** inconsistent moment.min and moment.ma***REMOVED*** results
  Return invalid result if any of the inputs is invalid
* [#2494](https://github.com/moment/moment/pull/2494) Fi***REMOVED*** two digit year parsing with YYYY format
...
* fi***REMOVED***ed moment-with-locales in browser env caused by esperanto change
...
Some bugfi***REMOVED***es and language improvements -- [full changelog](https://gist.github.com/ichernev/0c9a9b49951111a27ce7)
...
* [#1960](https://github.com/moment/moment/issues/1960) added formatToken '***REMOVED***' for uni***REMOVED*** offset in milliseconds #1938
* [#1965](https://github.com/moment/moment/issues/1965) Support 24:00:00.000 to mean ne***REMOVED***t day, at midnight.
...
Some bugfi***REMOVED***es and language improvements -- [full changelog](https://gist.github.com/ichernev/a4fcb0a46d74e4b9b996)
...
* [#1871](https://github.com/moment/moment/issues/1871) fi***REMOVED*** zone bug caused by Firefo***REMOVED*** 24
* [#1882](https://github.com/moment/moment/issues/1882) Use hh:mm in Czech
* [#1883](https://github.com/moment/moment/issues/1883) Fi***REMOVED*** 2.8.0 regression in duration as conversions
...
* [#1848](https://github.com/moment/moment/issues/1848) Fi***REMOVED*** flaky month diffs
* [#1895](https://github.com/moment/moment/issues/1895) Fi***REMOVED*** 2.8.0 regression in moment.utc with format array
...
* bugfi***REMOVED*** [#1813](https://github.com/moment/moment/issues/1813): fi***REMOVED*** moment().lang([key]) incompatibility
...
* bugfi***REMOVED***es, locale bugfi***REMOVED***es, performance improvements, features
...
* features
  ...
  * [#1637](https://github.com/moment/moment/issues/1637) add moment.min and moment.ma***REMOVED*** and deprecate min/ma***REMOVED*** instance methods
...
* features
    ...
    * [#1545](https://github.com/moment/moment/issues/1545) e***REMOVED***tract two-digit year parsing in moment.parseTwoDigitYear, so it can be overwritten
...
* bugfi***REMOVED***es
  * [#1429](https://github.com/moment/moment/issues/1429) fi***REMOVED***es [#1423](https://github.com/moment/moment/issues/1423) weird chrome-32 bug with js object creation
  * [#1421](https://github.com/moment/moment/issues/1421) remove html entities from Welsh
  * [#1418](https://github.com/moment/moment/issues/1418) fi***REMOVED***es [#1401](https://github.com/moment/moment/issues/1401) improved non-padded tokens in strict matching
  * [#1417](https://github.com/moment/moment/issues/1417) fi***REMOVED***es [#1404](https://github.com/moment/moment/issues/1404) handle buggy moment object created by property cloning
  * [#1398](https://github.com/moment/moment/issues/1398) fi***REMOVED***es [#1397](https://github.com/moment/moment/issues/1397) fi***REMOVED*** Arabic-like week number parsing
...
* New languages
  * Lu***REMOVED***emburish (lb) [1247](https://github.com/moment/moment/issues/1247)
...
* Features
  ...
  * [1303](https://github.com/moment/moment/issues/1303) strict parsing now respects number of digits per token (fi***REMOVED*** [1196](https://github.com/moment/moment/issues/1196))
...
* **Deprecate** globally e***REMOVED***ported moment, will be removed in ne***REMOVED***t major
* New languages
  * Farose (fo) [#1206](https://github.com/moment/moment/issues/1206)
  * Tagalog/Filipino (tl-ph) [#1197](https://github.com/moment/moment/issues/1197)
  * Welsh (cy) [#1215](https://github.com/moment/moment/issues/1215)
* Bugfi***REMOVED***es
  * properly handle Z at the end of iso RegE***REMOVED***p [#1187](https://github.com/moment/moment/issues/1187)
  * chinese meridian time improvements [#1076](https://github.com/moment/moment/issues/1076)
  * fi***REMOVED*** language tests [#1177](https://github.com/moment/moment/issues/1177)
  * remove some failing tests (that should have never e***REMOVED***isted :))
...
Removed a trailing comma [1169] and fi***REMOVED***ed a bug with `months`, `weekdays` getters [#1171](https://github.com/moment/moment/issues/1171).
...
Fi***REMOVED***ed bug in string prototype test.
...
Added `moment#min` and `moment#ma***REMOVED***`
...
Fi***REMOVED***ed the logic for `moment#diff(Moment, 'months')` and `moment#diff(Moment, 'years')`
...
Bugfi***REMOVED***: Fi***REMOVED***ed parsing of first century dates

Bugfi***REMOVED***: Parsing 10Sep2001 should work as e***REMOVED***pected

Bugfi***REMOVED***: Fi***REMOVED***ed weirdness with `moment.utc()` parsing.
...
Made formatting method 3***REMOVED*** faster. http://jsperf.com/momentjs-cached-format-functions
...
Fi***REMOVED***ed [issue 31](https://github.com/timrwood/moment/pull/31).
...
Removed `window !== undefined` when checking if module e***REMOVED***ists to support browserify. [issue 25](https://github.com/timrwood/moment/pull/25)
...
Bugfi***REMOVED*** for [issue 8](https://github.com/timrwood/underscore.date/pull/8) and [issue 9](https://github.com/timrwood/underscore.date/pull/9).

### 0.5.1

- Release Jun 17, 2011

Bugfi***REMOVED*** for [issue 5](https://github.com/timrwood/underscore.date/pull/5).
...
E***REMOVED***posed customization options through the `_date.relativeTime`, `_date.weekdays`, `_date.weekdaysShort`, `_date.months`, `_date.monthsShort`, and `_date.ordinal` variables instead of the `_date.customize()` function.
