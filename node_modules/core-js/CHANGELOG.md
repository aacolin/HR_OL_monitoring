...
- Added code points / code units e***REMOVED***plicit feature detection in `String#at` for preventing breakage code which use obsolete `String#at` proposal polyfill
...
- Some fi***REMOVED***es and improvements of the `postinstall` script like support `npm` color config ([#556](https://github.com/zloirock/core-js/issues/556)) or adding support of `ADBLOCK` env variable

##### 2.6.8 [LEGACY] - 2019.05.22
- Added a workaround of a strange `np***REMOVED***` bug on `postinstall`, [#551](https://github.com/zloirock/core-js/issues/551)
...
- Fi***REMOVED***ed IE8- non-enumerable properties support in `Object.{ assign, entries, values }`, [#541](https://github.com/zloirock/core-js/issues/541)
- Fi***REMOVED***ed support of primitives in `Object.getOwnPropertySymbols` in Chrome 38 / 39, [#539](https://github.com/zloirock/core-js/issues/539)
- Show a message on `postinstall`

##### 2.6.5 - 2019.02.15
- Fi***REMOVED***ed buggy `String#padStart` and `String#padEnd` mobile Safari implementations, [#414](https://github.com/zloirock/core-js/issues/414).
...
##### 2.6.2 - 2019.01.10
- Fi***REMOVED***ed handling of `$` in `String#replace`, [#471](https://github.com/zloirock/core-js/issues/471)

##### 2.6.1 - 2018.12.18
- Fi***REMOVED***ed an issue with minified version, [#463](https://github.com/zloirock/core-js/issues/463)

##### 2.6.0 - 2018.12.05
- Add direct .e***REMOVED***ec calling to `RegE***REMOVED***p#{@@replace, @@split, @@match, @@search}`. Also, added fi***REMOVED***es for `RegE***REMOVED***p#e***REMOVED***ec` method. [#411](https://github.com/zloirock/core-js/issues/411), [#428](https://github.com/zloirock/core-js/issues/428), [#434](https://github.com/zloirock/core-js/issues/434), [#435](https://github.com/zloirock/core-js/issues/435), [#453](https://github.com/zloirock/core-js/issues/453), [#458](https://github.com/zloirock/core-js/issues/458), thanks [**@nicolo-ribaudo**](https://github.com/nicolo-ribaudo).
...
##### 2.5.5 - 2018.04.08
- Fi***REMOVED*** some edge cases of `Reflect.set`, [#392](https://github.com/zloirock/core-js/issues/392) and [#393](https://github.com/zloirock/core-js/issues/393)

##### 2.5.4 - 2018.03.27
- Fi***REMOVED***ed one case of deoptimization built-in iterators in V8, related [#377](https://github.com/zloirock/core-js/issues/377)
- Fi***REMOVED***ed some cases of iterators feature detection, [#368](https://github.com/zloirock/core-js/issues/368)
- Fi***REMOVED***ed manually entered NodeJS domains issue in `Promise`, [#367](https://github.com/zloirock/core-js/issues/367)
- Fi***REMOVED***ed `Number.{parseInt, parseFloat}` entry points
- Fi***REMOVED***ed `__(define|lookup)[GS]etter__` import in the `library` version

##### 2.5.3 - 2017.12.12
- Fi***REMOVED***ed calling `onunhandledrejectionhandler` multiple times for one `Promise` chain, [#318](https://github.com/zloirock/core-js/issues/318)
...
- Fi***REMOVED***ed `Array#@@iterator` in a very rare version of `WebKit`, [#236](https://github.com/zloirock/core-js/issues/236) and [#237](https://github.com/zloirock/core-js/issues/237)
- One more [#345](https://github.com/zloirock/core-js/issues/345)-related fi***REMOVED***
...
- Fi***REMOVED***ed `JSON.stringify(undefined, replacer)` case in the wrapper from the `Symbol` polyfill, [#345](https://github.com/zloirock/core-js/issues/345)
...
- Fi***REMOVED***ed some entry points for virtual methods
...
- Added `.of` and `.from` methods on collection constructors [stage 1 proposal](https://github.com/tc39/proposal-setmap-offrom):
  ...
  - `WeakSet.from`
  - `WeakMap.from`
- Added `Math` e***REMOVED***tensions [stage 1 proposal](https://github.com/rwaldron/proposal-math-e***REMOVED***tensions), [#226](https://github.com/zloirock/core-js/issues/226):
  - `Math.clamp`
  - `Math.DEG_PER_RAD`
  - `Math.degrees`
  - `Math.fscale`
...
- Updated the list of iterable DOM collections, [#249](https://github.com/zloirock/core-js/issues/249), added:
  ...
  - `Te***REMOVED***tTrackCueList#@@iterator`
  - `Te***REMOVED***tTrackList#@@iterator`
  - `TouchList#@@iterator`
...
- Fi***REMOVED***ed `%TypedArray%.from` Safari bug, [#285](https://github.com/zloirock/core-js/issues/285)
- Fi***REMOVED***ed compatibility with old version of Prototype.js, [#278](https://github.com/zloirock/core-js/issues/278), [#289](https://github.com/zloirock/core-js/issues/289)
...
- Added errors on incorrect conte***REMOVED***t of collection methods, [#272](https://github.com/zloirock/core-js/issues/272)
- Fi***REMOVED***ed conversion typed array constructors to string, fi***REMOVED*** [#300](https://github.com/zloirock/core-js/issues/300)
- Fi***REMOVED***ed `Set#size` with debugger ReactNative for Android, [#297](https://github.com/zloirock/core-js/issues/297)
- Fi***REMOVED***ed an issue with Electron-based debugger, [#230](https://github.com/zloirock/core-js/issues/230)
- Fi***REMOVED***ed compatibility with incomplete third-party `WeakMap` polyfills, [#252](https://github.com/zloirock/core-js/pull/252)
...
- Some other minor fi***REMOVED***es and optimizations

##### 2.4.1 - 2016.07.18
- Fi***REMOVED***ed `script` tag for some parsers, [#204](https://github.com/zloirock/core-js/issues/204), [#216](https://github.com/zloirock/core-js/issues/216)
...
- Fi***REMOVED***ed MS Edge `Reflect.construct` and `Reflect.apply` - they should not allow primitive as `argumentsList` argument

##### 1.2.7 [LEGACY] - 2016.07.18
- Some fi***REMOVED***es for issues like [#159](https://github.com/zloirock/core-js/issues/159), [#186](https://github.com/zloirock/core-js/issues/186), [#194](https://github.com/zloirock/core-js/issues/194), [#207](https://github.com/zloirock/core-js/issues/207)

##### 2.4.0 - 2016.05.08
- Added `Observable`, [stage 1 proposal](https://github.com/zenparsing/es-observable)
- Fi***REMOVED***ed behavior `Object.{getOwnPropertySymbols, getOwnPropertyDescriptor}` and `Object#propertyIsEnumerable` on `Object.prototype`
...
- `Map#toJSON` and `Set#toJSON` rejected and will be removed from the ne***REMOVED***t major release, [TC39 meeting notes](https://github.com/rwaldron/tc39-notes/blob/master/es7/2016-03/march-31.md#mapprototypetojsonsetprototypetojson)
- `Error.isError` withdrawn and will be removed from the ne***REMOVED***t major release, [TC39 meeting notes](https://github.com/rwaldron/tc39-notes/blob/master/es7/2016-03/march-29.md#erroriserror)
- Added fallback for `Function#name` on non-e***REMOVED***tensible functions and functions with broken `toString` conversion, [#193](https://github.com/zloirock/core-js/issues/193)

##### 2.2.2 - 2016.04.06
- Added conversion `-0` to `+0` to `Array#{inde***REMOVED***Of, lastInde***REMOVED***Of}`, [ES2016 fi***REMOVED***](https://github.com/tc39/ecma262/pull/316)
- Added fi***REMOVED***es for some `Math` methods in Tor Browser
...
##### 2.2.1 - 2016.03.19
- Fi***REMOVED***ed `Object.getOwnPropertyNames(window)` `2.1+` versions bug, [#181](https://github.com/zloirock/core-js/issues/181)

##### 2.2.0 - 2016.03.15
- Added `String#matchAll`, [proposal](https://github.com/tc39/String.prototype.matchAll)
- Added `Object#__(define|lookup)[GS]etter__`, [anne***REMOVED*** B ES2017](https://github.com/tc39/ecma262/pull/381)
- Added `@@toPrimitive` methods to `Date` and `Symbol`
- Fi***REMOVED***ed `%TypedArray%#slice` in Edge ~ 13 (throws with `@@species` and wrapped / inherited constructor)
- Some other minor fi***REMOVED***es
...
##### 2.1.2 - 2016.02.29
- Some minor `Promise` fi***REMOVED***es:
  ...
  - Fi***REMOVED***ed typo in feature detection
...
- Some `Promise` improvements:
  ...
  - `Promise.all` fi***REMOVED***ed for some very specific cases
...
- **API**:
  - ES5 polyfills are split and logic, used in other polyfills, moved to internal modules
    ...
    - Separated ES5 polyfills moved to the ES6 namespace. Why?
      - Mainly, for prevent duplication features in different namespaces - logic of most required ES5 polyfills changed in ES6+:
        - Already added changes for: `Object` statics - should accept primitives, new whitespaces lists in `String#trim`, `parse(Int|float)`, `RegE***REMOVED***p#toString` logic, `String#split`, etc
    ...
    - All old entry points should work fine, but in the ne***REMOVED***t major release API can be changed
  ...
  - Added `umd` option for [custom build process](https://github.com/zloirock/core-js#custom-build-from-e***REMOVED***ternal-scripts), [#169](https://github.com/zloirock/core-js/issues/169)
  - Returned entry points for `Array` statics, removed in `2.0`, for compatibility with `babel` `6` and for future fi***REMOVED***es
- **Deprecated**:
  - `Reflect.enumerate` deprecated and will be removed from the ne***REMOVED***t major release, [January TC39 meeting](https://github.com/rwaldron/tc39-notes/blob/master/es7/2016-01/2016-01-28.md#5***REMOVED***i***REMOVED***-revisit-pro***REMOVED***y-enumerate---revisit-decision-to-e***REMOVED***haust-iterator)
- **New Features**:
  - Added [`Reflect` metadata API](https://github.com/jonathandturner/decorators/blob/master/specs/metadata.md) as a pre-strawman feature, [#152](https://github.com/zloirock/core-js/issues/152):
    ...
    - `Reflect.metadata`
  - Implementation / fi***REMOVED***es `Date#toJSON`
  - Fi***REMOVED***es for `parseInt` and `Number.parseInt`
  - Fi***REMOVED***es for `parseFloat` and `Number.parseFloat`
  - Fi***REMOVED***es for `RegE***REMOVED***p#toString`
  - Fi***REMOVED***es for `Array#sort`
  - Fi***REMOVED***es for `Number#toFi***REMOVED***ed`
  - Fi***REMOVED***es for `Number#toPrecision`
  - Additional fi***REMOVED***es for `String#split` (`RegE***REMOVED***p#@@split`)
- **Improvements**:
  - Correct subclassing wrapped collections, `Number` and `RegE***REMOVED***p` constructors with native class synta***REMOVED***
...
- **Bug Fi***REMOVED***es**:
  - Fi***REMOVED***ed some cases `Array#lastInde***REMOVED***Of` with negative second argument
...
- Added fi***REMOVED*** for very specific environments with global `window === null`

##### 2.0.2 - 2016.01.04
- Temporarily removed `length` validation from `Uint8Array` constructor wrapper. Reason - [bug in `ws` module](https://github.com/websockets/ws/pull/645) (-> `socket.io`) which passes to `Buffer` constructor -> `Uint8Array` float and uses [the `V8` bug](https://code.google.com/p/v8/issues/detail?id=4552) for conversion to int (by the spec should be thrown an error). [It creates problems for many people.](https://github.com/karma-runner/karma/issues/1768) I hope, it will be returned after fi***REMOVED***ing this bug in `V8`.

##### 2.0.1 - 2015.12.31
- Forced usage `Promise.resolve` polyfill in the `library` version for correct work with wrapper
- `Object.assign` should be defined in the strict mode -> throw an error on e***REMOVED***tension non-e***REMOVED***tensible objects, [#154](https://github.com/zloirock/core-js/issues/154)

##### 2.0.0 - 2015.12.24
- Added implementations and fi***REMOVED***es [Typed Arrays](https://github.com/zloirock/core-js#ecmascript-6-typed-arrays)-related features
  ...
  - `%TypedArray%.{for, of}`, `%TypedArray%#{copyWithin, every, fill, filter, find, findInde***REMOVED***, forEach, inde***REMOVED***Of, includes, join, lastInde***REMOVED***Of, map, reduce, reduceRight, reverse, set, slice, some, sort, subarray, values, keys, entries, @@iterator, ...}`
...
- `RegE***REMOVED***p.escape` moved from the `es7` to the non-standard `core` namespace, [July TC39 meeting](https://github.com/rwaldron/tc39-notes/blob/master/es7/2015-07/july-28.md#62-rege***REMOVED***pescape) - too slow, but it's condition of stability, [#116](https://github.com/zloirock/core-js/issues/116)
...
- Added [anne***REMOVED*** B HTML methods](https://github.com/zloirock/core-js#ecmascript-6-string) - ugly, but also [the part of the spec](http://www.ecma-international.org/ecma-262/6.0/#sec-string.prototype.anchor)
- Added little fi***REMOVED*** for [`Date#toString`](https://github.com/zloirock/core-js#ecmascript-6-date) - `new Date(NaN).toString()` [should be `'Invalid Date'`](http://www.ecma-international.org/ecma-262/6.0/#sec-todatestring)
...
- [Custom build from e***REMOVED***ternal scripts](https://github.com/zloirock/core-js#custom-build-from-e***REMOVED***ternal-scripts) moved to the separate package for preventing problems with dependencies
- Changed `$` prefi***REMOVED*** for internal modules file names because Team Foundation Server does not support it, [#129](https://github.com/zloirock/core-js/issues/129)
- Additional fi***REMOVED*** for `SameValueZero` in V8 ~ Chromium 39-42 collections
- Additional fi***REMOVED*** for FF27 `Array` iterator
...
* Fi***REMOVED***ed V8 and FF `Array#{values, @@iterator}.name`
* Fi***REMOVED***ed IE7- `[1, 2].join(undefined) -> '1,2'`
* Some other fi***REMOVED***es / improvements / optimizations

##### 1.2.5 - 2015.11.02
* Some more `Number` constructor fi***REMOVED***es:
  * Fi***REMOVED***ed V8 ~ Node 0.8 bug: `Number('+0***REMOVED***1')` should be `NaN`
  * Fi***REMOVED***ed `Number(' 0b1\n')` case, should be `1`
  * Fi***REMOVED***ed `Number()` case, should be `0`

##### 1.2.4 - 2015.11.01
* Fi***REMOVED***ed `Number('0b12') -> NaN` case in the shim
* Fi***REMOVED***ed V8 ~ Chromium 40- bug - `Weak(Map|Set)#{delete, get, has}` should not throw errors [#124](https://github.com/zloirock/core-js/issues/124)
* Some other fi***REMOVED***es and optimizations

##### 1.2.3 - 2015.10.23
* Fi***REMOVED***ed some problems related old V8 bug `Object('a').propertyIsEnumerable(0) // => false`, for e***REMOVED***ample, `Object.assign({}, 'qwe')` from the last release
* Fi***REMOVED***ed `.name` property and `Function#toString` conversion some polyfilled methods
* Fi***REMOVED***ed `Math.imul` arity in Safari 8-

##### 1.2.2 - 2015.10.18
* Improved optimisations for V8
* Fi***REMOVED***ed build process from e***REMOVED***ternal packages, [#120](https://github.com/zloirock/core-js/pull/120)
* One more `Object.{assign, values, entries}` fi***REMOVED*** for [**very** specific case](https://github.com/ljharb/proposal-object-values-entries/issues/5)

##### 1.2.1 - 2015.10.02
* Replaced fi***REMOVED*** `JSON.stringify` + `Symbol` behavior from `.toJSON` method to wrapping `JSON.stringify` - little more correct, [compat-table/642](https://github.com/kanga***REMOVED***/compat-table/pull/642)
* Fi***REMOVED***ed typo which broke tasks scheduler in WebWorkers in old FF, [#114](https://github.com/zloirock/core-js/pull/114)

##### 1.2.0 - 2015.09.27
* Added browser [`Promise` rejection hook](#unhandled-rejection-tracking), [#106](https://github.com/zloirock/core-js/issues/106)
* Added correct [`IsRegE***REMOVED***p`](http://www.ecma-international.org/ecma-262/6.0/#sec-isrege***REMOVED***p) logic to [`String#{includes, startsWith, endsWith}`](https://github.com/zloirock/core-js/#ecmascript-6-string) and [`RegE***REMOVED***p` constructor](https://github.com/zloirock/core-js/#ecmascript-6-rege***REMOVED***p), `@@match` case, [e***REMOVED***ample](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/match#Disabling_the_isRegE***REMOVED***p_check)
...
* Fi***REMOVED***ed behavior with deleted in getters properties for `Object.{`[`assign`](https://github.com/zloirock/core-js/#ecmascript-6-object)`, `[`entries, values`](https://github.com/zloirock/core-js/#ecmascript-7-proposals)`}`, [e***REMOVED***ample](http://goo.gl/iQE01c)
* Fi***REMOVED***ed [`Math.sinh`](https://github.com/zloirock/core-js/#ecmascript-6-math) with very small numbers in V8 near Chromium 38
* Some other fi***REMOVED***es and optimizations

##### 1.1.4 - 2015.09.05
* Fi***REMOVED***ed support symbols in FF34-35 [`Object.assign`](https://github.com/zloirock/core-js/#ecmascript-6-object)
* Fi***REMOVED***ed [collections iterators](https://github.com/zloirock/core-js/#ecmascript-6-iterators) in FF25-26
* Fi***REMOVED***ed non-generic WebKit [`Array.of`](https://github.com/zloirock/core-js/#ecmascript-6-array)
* Some other fi***REMOVED***es and optimizations

##### 1.1.3 - 2015.08.29
* Fi***REMOVED***ed support Node.js domains in [`Promise`](https://github.com/zloirock/core-js/#ecmascript-6-promise), [#103](https://github.com/zloirock/core-js/issues/103)

##### 1.1.2 - 2015.08.28
* Added `toJSON` method to [`Symbol`](https://github.com/zloirock/core-js/#ecmascript-6-symbol) polyfill and to MS Edge implementation for e***REMOVED***pected `JSON.stringify` result w/o patching this method
...
* Fi***REMOVED***ed `global` detection with changed `document.domain` in ~IE8, [#100](https://github.com/zloirock/core-js/issues/100)
...
* Added [string trim functions](#ecmascript-7-proposals) - [proposal](https://github.com/sebmarkbage/ecmascript-string-left-right-trim), defacto standard - required only for IE11- and fi***REMOVED***ed for some old engines:
  * `String#trimLeft`
  * `String#trimRight`
* [`String#trim`](https://github.com/zloirock/core-js/#ecmascript-6-string) fi***REMOVED***ed for some engines by es6 spec and moved from `es5` to single `es6` module
...
* [`Reflect.construct`](https://github.com/zloirock/core-js/#ecmascript-6-reflect) optimized and fi***REMOVED***ed for some cases
...
* Fi***REMOVED***ed [`Math.imul`](https://github.com/zloirock/core-js/#ecmascript-6-math) for old WebKit
* Some fi***REMOVED***es in string / RegE***REMOVED***p [well-known symbols](https://github.com/zloirock/core-js/#ecmascript-6-rege***REMOVED***p) logic
* Some other fi***REMOVED***es and optimizations

##### 1.0.1 - 2015.07.31
* Some fi***REMOVED***es for final MS Edge, replaced broken native `Reflect.defineProperty`
* Some minor fi***REMOVED***es and optimizations
* Changed compression `client/*.min.js` options for safe `Function#name` and `Function#length`, should be fi***REMOVED***ed [#92](https://github.com/zloirock/core-js/issues/92)

##### 1.0.0 - 2015.07.22
* Added logic for [well-known symbols](https://github.com/zloirock/core-js/#ecmascript-6-rege***REMOVED***p):
  * `Symbol.match`
  * `Symbol.replace`
  * `Symbol.split`
  * `Symbol.search`
...
* Ma***REMOVED***imum modularity, reduced minimal custom build size, separated into submodules:
  * [`es6.reflect`](https://github.com/zloirock/core-js/#ecmascript-6-reflect)
  * [`es6.rege***REMOVED***p`](https://github.com/zloirock/core-js/#ecmascript-6-rege***REMOVED***p)
...
* Final cleaning non-standard features
  * Moved `$for` to [separate library](https://github.com/zloirock/forof). This work for synta***REMOVED*** - `for-of` loop and comprehensions
...
* Fi***REMOVED***ed [#85](https://github.com/zloirock/core-js/issues/85) - invalid `Promise` unhandled rejection message in nested `setTimeout`
* Fi***REMOVED***ed [#86](https://github.com/zloirock/core-js/issues/86) - support FF e***REMOVED***tensions
* Fi***REMOVED***ed [#89](https://github.com/zloirock/core-js/issues/89) - behavior `Number` constructor in strange case

##### 0.9.18 - 2015.06.17
* Removed `/` from [`RegE***REMOVED***p.escape`](https://github.com/zloirock/core-js/#ecmascript-7-proposals) escaped characters

##### 0.9.17 - 2015.06.14
* Updated [`RegE***REMOVED***p.escape`](https://github.com/zloirock/core-js/#ecmascript-7-proposals) to the [latest proposal](https://github.com/benjamingr/Re***REMOVED***E***REMOVED***p.escape)
* Fi***REMOVED***ed conflict with webpack dev server + IE buggy behavior
...
* Fi***REMOVED***ed collections prototype methods in `library` version
* Optimized [`Math.hypot`](https://github.com/zloirock/core-js/#ecmascript-6-math)

##### 0.9.14 - 2015.06.04
* Updated [`Promise.resolve` behavior](https://esdiscuss.org/topic/fi***REMOVED***ing-promise-resolve)
* Added fallback for IE11 buggy `Object.getOwnPropertyNames` + iframe
* Some other fi***REMOVED***es
...
* Added proto versions of methods to e***REMOVED***port object in `default` version for consistency with `library` version

##### 0.9.9 - 2015.05.14
* Wrapped `Object#propertyIsEnumerable` for [`Symbol` polyfill](https://github.com/zloirock/core-js/#ecmascript-6-symbol)
* [Added proto versions of methods to `library` for ES7 bind synta***REMOVED***](https://github.com/zloirock/core-js/issues/65)
* Some other fi***REMOVED***es

##### 0.9.8 - 2015.05.12
* Fi***REMOVED***ed [`Math.hypot`](https://github.com/zloirock/core-js/#ecmascript-6-math) with negative arguments
...
* Some fi***REMOVED***es and optimizations

##### 0.9.4 - 2015.04.27
* Fi***REMOVED***ed `RegE***REMOVED***p` constructor
...
##### 0.9.1 - 2015.04.25
* Fi***REMOVED***ed `__proto__`-based [`Promise`](https://github.com/zloirock/core-js/#ecmascript-6-promise) subclassing in some environments

##### 0.9.0 - 2015.04.24
* Added correct [symbols](https://github.com/zloirock/core-js/#ecmascript-6-symbol) descriptors
  * Fi***REMOVED***ed behavior `Object.{assign, create, defineProperty, defineProperties, getOwnPropertyDescriptor, getOwnPropertyDescriptors}` with symbols
...
* Removed non-standard methods `Object#[_]` and `Function#only` - they solves synta***REMOVED*** problems, but now in compilers available arrows and ~~in near future will be available~~ [available](http://babeljs.io/blog/2015/05/14/function-bind/) [bind synta***REMOVED***](https://github.com/zenparsing/es-function-bind)
* Removed non-standard undocumented methods `Symbol.{pure, set}`
* Some fi***REMOVED***es and internal changes

##### 0.8.4 - 2015.04.18
* Uses `webpack` instead of `browserify` for browser builds - more compression-friendly result

##### 0.8.3 - 2015.04.14
* Fi***REMOVED***ed `Array` statics with single entry points
...
* Some optimizations and fi***REMOVED***es

##### 0.8.1 - 2015.04.03
* Fi***REMOVED***ed `Symbol.keyFor`
...
* Fi***REMOVED***ed iterators support in v8 `Promise.all` and `Promise.race`
* Many other fi***REMOVED***es
...
##### 0.6.1 - 2015.02.24
* Fi***REMOVED***ed support [`Object.defineProperty`](https://github.com/zloirock/core-js/#ecmascript-5) with accessors on DOM elements on IE8

##### 0.6.0 - 2015.02.23
* Added support safe closing iteration - calling `iterator.return` on abort iteration, if it e***REMOVED***ists
...
##### 0.4.8 - 2015.01.25
* Some [collections](https://github.com/zloirock/core-js/#ecmascript-6-collections) fi***REMOVED***es
...
* `RegE***REMOVED***p` constructor can alter flags (IE9+)
...
* Added [`es6.reflect`](https://github.com/zloirock/core-js/#ecmascript-6-reflect) module:
  ...
  * Added `Reflect.has`
  * Added `Reflect.isE***REMOVED***tensible`
  * Added `Reflect.preventE***REMOVED***tensions`
  * Added `Reflect.set`
  * Added `Reflect.setPrototypeOf`
* `core-js` methods now can use e***REMOVED***ternal `Symbol.iterator` polyfill
* Some fi***REMOVED***es

##### 0.3.3 - 2014.12.28
* [Console cap](https://github.com/zloirock/core-js/#console) e***REMOVED***cluded from node.js default builds

##### 0.3.2 - 2014.12.25
* Added cap for [ES5](https://github.com/zloirock/core-js/#ecmascript-5) freeze-family methods
* Fi***REMOVED***ed `console` bug
...
##### 0.2.2 - 2014.12.13
* Added [`RegE***REMOVED***p#flags`](https://github.com/zloirock/core-js/#ecmascript-6-rege***REMOVED***p) ([December 2014 Draft Rev 29](http://wiki.ecmascript.org/doku.php?id=harmony:specification_drafts#december_6_2014_draft_rev_29))
