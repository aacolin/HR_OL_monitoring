...
module.e***REMOVED***ports = (grunt)->
  ...
  grunt.initConfig do
    ...
    uglify: build:
      ...
      options:
        ...
        output: {ma***REMOVED***_line_len: 32000}
        ie8: on
        sourceMap: on
    ...
    livescript: src: files:
      ...
      './tests/e***REMOVED***perimental.js': './tests/e***REMOVED***perimental/*'
      './build/inde***REMOVED***.js': './build/build.ls*'
    clean: <[./library]>
    copy: lib: files:
      * e***REMOVED***pand: on
        cwd: './'
        src: <[es5/** es6/** es7/** stage/** web/** core/** fn/** inde***REMOVED***.js shim.js]>
        dest: './library/'
      * e***REMOVED***pand: on
        cwd: './'
        src: <[modules/*]>
  ...
  grunt.registerTask \e ->
    grunt.option \library ''>
    grunt.option \path './client/core'
    grunt.task.run <[build:es5,es6,es7,js,web,core,e***REMOVED***p uglify]>
