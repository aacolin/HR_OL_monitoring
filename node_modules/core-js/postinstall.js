...
var SILENT = ['silent', 'error', 'warn'].inde***REMOVED***Of(env.npm_config_loglevel) !== -1;
...
function isBannerRequired() {
  ...
  try {
    ...
    if (DELTA >= 0 && DELTA < MINUTE * 3) {
      ...
      if (banners.inde***REMOVED***Of(BANNER) !== -1) return false;
    }
  } catch (error) {
    banners = [];
  }
...
function showBanner() {
  // eslint-disable-ne***REMOVED***t-line no-console,no-control-rege***REMOVED***
