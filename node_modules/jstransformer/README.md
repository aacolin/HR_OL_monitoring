<p align="center"><img src="https://cdn.rawgit.com/jstransformers/jstransformer/2bb6dc6c410e8683a17a4af5f1b73bcbee95aada/logo.svg" width="300p***REMOVED***" height="299p***REMOVED***" /></p>
...
Returns a string representing the default output format the transform would be e***REMOVED***pected to return when calling `.render()`.
