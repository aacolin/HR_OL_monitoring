 ...
 */
import { r as requestAnimFrame, a as resolve, e as effects, c as color, i as isObject, d as defaults, b as isArray, v as valueOrDefault, u as unlistenArrayEvents, l as listenArrayEvents, f as resolveObjectKey, g as isNumberFinite, h as defined, s as sign, j as createConte***REMOVED***t, k as isNullOrUndef, _ as _arrayUnique, t as toRadians, m as toPercentage, n as toDimension, T as TAU, o as formatNumber, p as _angleBetween, H as HALF_PI, P as PI, q as _getStartAndCountOfVisiblePoints, w as _scaleRangesChanged, ***REMOVED*** as isNumber, y as _parseObjectDataRadialScale, z as getRelativePosition, A as _rlookupByKey, B as _lookupByKey, C as _isPointInArea, D as getAngleFromPoint, E as toPadding, F as each, G as getMa***REMOVED***imumSize, I as _getParentNode, J as readUsedSize, K as supportsEventListenerOptions, L as throttled, M as _isDomSupported, N as _factorize, O as finiteOrDefault, Q as callback, R as _addGrace, S as _limitValue, U as toDegrees, V as _measureTe***REMOVED***t, W as _int16Range, X as _alignPi***REMOVED***el, Y as clipArea, Z as renderTe***REMOVED***t, $ as unclipArea, a0 as toFont, a1 as _toLeftRightCenter, a2 as _alignStartEnd, a3 as overrides, a4 as merge, a5 as _capitalize, a6 as descriptors, a7 as isFunction, a8 as _attachConte***REMOVED***t, a9 as _createResolver, aa as _descriptors, ab as mergeIf, ac as uid, ad as debounce, ae as retinaScale, af as clearCanvas, ag as setsEqual, ah as _elementsEqual, ai as _isClickEvent, aj as _isBetween, ak as _readValueToProps, al as _updateBezierControlPoints, am as _computeSegments, an as _boundSegments, ao as _steppedInterpolation, ap as _bezierInterpolation, aq as _pointInLine, ar as _steppedLineTo, as as _bezierCurveTo, at as drawPoint, au as addRoundedRectPath, av as toTRBL, aw as toTRBLCorners, a***REMOVED*** as _boundSegment, ay as _normalizeAngle, az as getRtlAdapter, aA as overrideTe***REMOVED***tDirection, aB as _te***REMOVED***tX, aC as restoreTe***REMOVED***tDirection, aD as drawPointLegend, aE as distanceBetweenPoints, aF as noop, aG as _setMinAndMa***REMOVED***ByKey, aH as niceNum, aI as almostWhole, aJ as almostEquals, aK as _decimalPlaces, aL as Ticks, aM as log10, aN as _longestTe***REMOVED***t, aO as _filterBetween, aP as _lookup } from './chunks/helpers.segment.js';
import '@kurkle/color';
...
function createDatasetConte***REMOVED***t(parent, inde***REMOVED***) {
    return createConte***REMOVED***t(parent, {
        active: false,
        dataset: undefined,
...
class DatasetController {
 ...
 constructor(chart, datasetInde***REMOVED***){
    ...
    linkScales() {
        ...
        const ***REMOVED***id = meta.***REMOVED***A***REMOVED***isID = valueOrDefault(dataset.***REMOVED***A***REMOVED***isID, getFirstScaleId(chart, '***REMOVED***'));
        const yid = meta.yA***REMOVED***isID = valueOrDefault(dataset.yA***REMOVED***isID, getFirstScaleId(chart, 'y'));
        const rid = meta.rA***REMOVED***isID = valueOrDefault(dataset.rA***REMOVED***isID, getFirstScaleId(chart, 'r'));
 ...
 parseObjectData(meta, data, start, count) {
        ...
        for(i = 0, ilen = count; i < ilen; ++i){
            ...
            item = data[inde***REMOVED***];
            parsed[i] = {
                ***REMOVED***: ***REMOVED***Scale.parse(resolveObjectKey(item, ***REMOVED***A***REMOVED***isKey), inde***REMOVED***),
                y: yScale.parse(resolveObjectKey(item, yA***REMOVED***isKey), inde***REMOVED***)
            };
        }
        return parsed;
    }
 ...
 getMinMa***REMOVED***(scale, canStack) {
        ...
        function _skip() {
            ...
            return !isNumberFinite(parsed[scale.a***REMOVED***is]) || otherMin > otherValue || otherMa***REMOVED*** < otherValue;
        }
        for(i = 0; i < ilen; ++i){
            if (_skip()) {
                continue;
 ...
 _update(mode) {
        ...
        meta._clip = toClip(valueOrDefault(this.options.clip, defaultClip(meta.***REMOVED***Scale, meta.yScale, this.getMa***REMOVED***Overflow())));
    }
 update(mode) {}
    draw() {
 ...
 _resolveElementOptions(elementType, mode = 'default', inde***REMOVED***) {
        ...
        const sharing = this.enableOptionSharing && defined(inde***REMOVED***);
        if (cached) {
...
class BarController e***REMOVED***tends DatasetController {
 ...
 parseObjectData(meta, data, start, count) {
        ...
        for(i = start, ilen = start + count; i < ilen; ++i){
            obj = data[i];
            item = {};
            item[iScale.a***REMOVED***is] = iScale.parse(resolveObjectKey(obj, iA***REMOVED***isKey), i);
            parsed.push(parseValue(resolveObjectKey(obj, vA***REMOVED***isKey), item, vScale, i));
        }
        return parsed;
    }
 updateRangeFromParsed(range, scale, parsed, stack) {
 ...
 getLabelAndValue(inde***REMOVED***) {
    ...
    updateElements(bars, start, count, mode) {
        ...
        for(let i = start; i < start + count; i++){
            ...
            const vpi***REMOVED***els = reset || isNullOrUndef(parsed[vScale.a***REMOVED***is]) ? {
                base,
                head: base
 ...
 _calculateBarInde***REMOVED***Pi***REMOVED***els(inde***REMOVED***, ruler) {
        ...
        const ma***REMOVED***BarThickness = valueOrDefault(options.ma***REMOVED***BarThickness, Infinity);
        let center, size;
        if (ruler.grouped) {
...
function getRatioAndOffset(rotation, circumference, cutout) {
    ...
    if (circumference < TAU) {
        ...
        const calcMa***REMOVED*** = (angle, a, b)=>_angleBetween(angle, startAngle, endAngle, true) ? 1 : Math.ma***REMOVED***(a, a * cutout, b, b * cutout);
        const calcMin = (angle, a, b)=>_angleBetween(angle, startAngle, endAngle, true) ? -1 : Math.min(a, a * cutout, b, b * cutout);
        const ma***REMOVED***X = calcMa***REMOVED***(0, startX, endX);
        const ma***REMOVED***Y = calcMa***REMOVED***(HALF_PI, startY, endY);
...
class DoughnutController e***REMOVED***tends DatasetController {
 ...
 update(mode) {
        ...
        const cutout = Math.min(toPercentage(this.options.cutout, ma***REMOVED***Size), 1);
        ...
        const outerRadius = toDimension(this.options.radius, ma***REMOVED***Radius);
 ...
 _circumference(i, reset) {
    ...
    getLabelAndValue(inde***REMOVED***) {
        ...
        const value = formatNumber(meta._parsed[inde***REMOVED***], chart.options.locale);
        return {
            label: labels[inde***REMOVED***] || '',
            value
        };
 ...
 _getRingWeight(datasetInde***REMOVED***) {
        return Math.ma***REMOVED***(valueOrDefault(this.chart.data.datasets[datasetInde***REMOVED***].weight, 1), 0);
    }
...
class LineController e***REMOVED***tends DatasetController {
 ...
 static overrides = {
    ...
    updateElements(points, start, count, mode) {
        ...
        const ma***REMOVED***GapLength = isNumber(spanGaps) ? spanGaps : Number.POSITIVE_INFINITY;
        ...
        for(let i = 0; i < pointsCount; ++i){
            ...
            const parsed = this.getParsed(i);
            const nullData = isNullOrUndef(parsed[vA***REMOVED***is]);
...
class PolarAreaController e***REMOVED***tends DatasetController {
 ...
 static overrides = {
    ...
    getLabelAndValue(inde***REMOVED***) {
        ...
        const chart = this.chart;
        const labels = chart.data.labels || [];
        const value = formatNumber(meta._parsed[inde***REMOVED***].r, chart.options.locale);
        return {
            label: labels[inde***REMOVED***] || '',
            value
        };
 ...
 _updateRadius() {
    ...
    updateElements(arcs, start, count, mode) {
        ...
        const datasetStartAngle = scale.getInde***REMOVED***Angle(0) - 0.5 * PI;
 ...
 _computeAngle(inde***REMOVED***, mode, defaultAngle) {
        return this.chart.getDataVisibility(inde***REMOVED***) ? toRadians(this.resolveDataElementOptions(inde***REMOVED***, mode).angle || defaultAngle) : 0;
    }
}
...
function binarySearch(metaset, a***REMOVED***is, value, intersect) {
    ...
    if (iScale && a***REMOVED***is === iScale.a***REMOVED***is && a***REMOVED***is !== 'r' && _sorted && data.length) {
        const lookupMethod = iScale._reversePi***REMOVED***els ? _rlookupByKey : _lookupByKey;
        if (!intersect) {
...
var layouts = {
 ...
 update (chart, width, height, minPadding) {
        ...
        each(chart.bo***REMOVED***es, (bo***REMOVED***)=>{
        ...
        updateMa***REMOVED***Padding(ma***REMOVED***Padding, toPadding(minPadding));
        ...
        each(bo***REMOVED***es.chartArea, (layout)=>{
            const bo***REMOVED*** = layout.bo***REMOVED***;
...
function fromNativeEvent(event, chart) {
    ...
    const { ***REMOVED*** , y  } = getRelativePosition(event, chart);
    return {
        type,
        chart,
        native: event,
...
function createPro***REMOVED***yAndListen(chart, type, listener) {
    const canvas = chart.canvas;
    const pro***REMOVED***y = throttled((event)=>{
 ...
 getMa***REMOVED***imumSize(canvas, width, height, aspectRatio) {
        return getMa***REMOVED***imumSize(canvas, width, height, aspectRatio);
    }
 isAttached(canvas) {
        const container = canvas && _getParentNode(canvas);
...
class Element {
    ...
    ***REMOVED***;
    ...
    hasValue() {
        return isNumber(this.***REMOVED***) && isNumber(this.y);
    }
...
const getTicksLimit = (ticksLength, ma***REMOVED***TicksLimit)=>Math.min(ma***REMOVED***TicksLimit || ticksLength, ticksLength);
 ...
 function getTitleHeight(options, fallback) {
    ...
    const lines = isArray(options.te***REMOVED***t) ? options.te***REMOVED***t.length : 1;
...
class Scale e***REMOVED***tends Element {
 ...
 getUserBounds() {
        ...
        _userMa***REMOVED*** = finiteOrDefault(_userMa***REMOVED***, Number.NEGATIVE_INFINITY);
        _suggestedMin = finiteOrDefault(_suggestedMin, Number.POSITIVE_INFINITY);
        _suggestedMa***REMOVED*** = finiteOrDefault(_suggestedMa***REMOVED***, Number.NEGATIVE_INFINITY);
        return {
            min: finiteOrDefault(_userMin, _suggestedMin),
            ma***REMOVED***: finiteOrDefault(_userMa***REMOVED***, _suggestedMa***REMOVED***),
            minDefined: isNumberFinite(_userMin),
            ma***REMOVED***Defined: isNumberFinite(_userMa***REMOVED***)
        };
    }
 getMinMa***REMOVED***(canStack) {
        ...
        return {
            min: finiteOrDefault(min, finiteOrDefault(ma***REMOVED***, min)),
            ma***REMOVED***: finiteOrDefault(ma***REMOVED***, finiteOrDefault(min, ma***REMOVED***))
        };
    }
 getPadding() {
        return {
 ...
 generateTickLabels(ticks) {
    ...
    calculateLabelRotation() {
        ...
        const ma***REMOVED***Width = _limitValue(this.chart.width - ma***REMOVED***LabelWidth, 0, this.ma***REMOVED***Width);
        ...
        if (ma***REMOVED***LabelWidth + 6 > tickWidth) {
            ...
            labelRotation = toDegrees(Math.min(Math.asin(_limitValue((labelSizes.highest.height + 6) / tickWidth, -1, 1)), Math.asin(_limitValue(ma***REMOVED***Height / ma***REMOVED***LabelDiagonal, -1, 1)) - Math.asin(_limitValue(ma***REMOVED***LabelHeight / ma***REMOVED***LabelDiagonal, -1, 1))));
 ...
 _computeLabelSizes(ticks, length, ma***REMOVED***TicksLimit) {
        ...
        for(i = 0; i < length; i += increment){
            ...
            if (!isNullOrUndef(label) && !isArray(label)) {
                width = _measureTe***REMOVED***t(ct***REMOVED***, cache.data, cache.gc, width, label);
                height = lineHeight;
            } else if (isArray(label)) {
                for(j = 0, jlen = label.length; j < jlen; ++j){
                    nestedLabel =  label[j];
                    if (!isNullOrUndef(nestedLabel) && !isArray(nestedLabel)) {
                        width = _measureTe***REMOVED***t(ct***REMOVED***, cache.data, cache.gc, width, nestedLabel);
                        height += lineHeight;
                    }
                }
            }
 ...
 getPi***REMOVED***elForDecimal(decimal) {
        ...
        return _int16Range(this._alignToPi***REMOVED***els ? _alignPi***REMOVED***el(this.chart, pi***REMOVED***el, 0) : pi***REMOVED***el);
    }
 ...
 _computeGridLineItems(chartArea) {
        ...
        const alignBorderValue = function(pi***REMOVED***el) {
            return _alignPi***REMOVED***el(chart, pi***REMOVED***el, a***REMOVED***isWidth);
        };
        ...
        const limit = valueOrDefault(options.ticks.ma***REMOVED***TicksLimit, ticksLength);
        ...
        for(i = 0; i < ticksLength; i += step){
            ...
            alignedLineValue = _alignPi***REMOVED***el(chart, lineValue, lineWidth);
            if (isHorizontal) {
 ...
 _computeLabelItems(chartArea) {
        ...
        for(i = 0, ilen = ticks.length; i < ilen; ++i){
            ...
            if (optsAtInde***REMOVED***.showLabelBackdrop) {
                const labelPadding = toPadding(optsAtInde***REMOVED***.backdropPadding);
 ...
 drawBorder() {
        ...
        if (this.isHorizontal()) {
            ***REMOVED***1 = _alignPi***REMOVED***el(chart, this.left, a***REMOVED***isWidth) - a***REMOVED***isWidth / 2;
            ***REMOVED***2 = _alignPi***REMOVED***el(chart, this.right, lastLineWidth) + lastLineWidth / 2;
            y1 = y2 = borderValue;
        } else {
            y1 = _alignPi***REMOVED***el(chart, this.top, a***REMOVED***isWidth) - a***REMOVED***isWidth / 2;
            y2 = _alignPi***REMOVED***el(chart, this.bottom, lastLineWidth) + lastLineWidth / 2;
 ...
 drawLabels(chartArea) {
        ...
        for (const item of items){
            ...
            renderTe***REMOVED***t(ct***REMOVED***, label, 0, y, tickFont, renderTe***REMOVED***tOptions);
        }
        if (area) {
            unclipArea(ct***REMOVED***);
        }
    }
 drawTitle() {
        ...
        renderTe***REMOVED***t(ct***REMOVED***, title.te***REMOVED***t, 0, 0, font, {
            color: title.color,
            ma***REMOVED***Width,
            rotation,
...
function mergeScaleConfig(config, options) {
    ...
    Object.keys(configScales).forEach((id)=>{
        ...
        const a***REMOVED***is = determineA***REMOVED***is(id, scaleConf, retrieveA***REMOVED***isFromDatasets(id, config), defaults.scales[scaleConf.type]);
...
class Config {
 ...
 resolveNamedOptions(scopes, names, conte***REMOVED***t, prefi***REMOVED***es = [
        ...
        if (needConte***REMOVED***t(resolver, names)) {
            result.$shared = false;
            conte***REMOVED***t = isFunction(conte***REMOVED***t) ? conte***REMOVED***t() : conte***REMOVED***t;
            const subResolver = this.createResolver(scopes, conte***REMOVED***t, subPrefi***REMOVED***es);
            options = _attachConte***REMOVED***t(resolver, conte***REMOVED***t, subResolver);
        }
 ...
 createResolver(scopes, conte***REMOVED***t, prefi***REMOVED***es = [
        ...
        return isObject(conte***REMOVED***t) ? _attachConte***REMOVED***t(resolver, conte***REMOVED***t, undefined, descriptorDefaults) : resolver;
    }
}
function getResolver(resolverCache, scopes, prefi***REMOVED***es) {
    ...
    if (!cached) {
        const resolver = _createResolver(scopes, prefi***REMOVED***es);
        cached = {
            resolver,
...
function needConte***REMOVED***t(pro***REMOVED***y, names) {
    const { isScriptable , isInde***REMOVED***able  } = _descriptors(pro***REMOVED***y);
    for (const prop of names){
        const scriptable = isScriptable(prop);
        const inde***REMOVED***able = isInde***REMOVED***able(prop);
        const value = (inde***REMOVED***able || scriptable) && pro***REMOVED***y[prop];
        if (scriptable && (isFunction(value) || hasFunction(value)) || inde***REMOVED***able && isArray(value)) {
            return true;
        }
    }
    return false;
...
class Chart {
 ...
 _initialize() {
        ...
        if (this.options.responsive) {
            ...
            retinaScale(this, this.options.devicePi***REMOVED***elRatio);
        }
        this.bindEvents();
    ...
    clear() {
        clearCanvas(this.canvas, this.ct***REMOVED***);
        return this;
    }
    stop() {
        animator.stop(this);
 ...
 resize(width, height) {
    ...
    ensureScalesHaveIDs() {
        ...
        each(scalesOptions, (a***REMOVED***isOptions, a***REMOVED***isID)=>{
 ...
 _resetElements() {
        each(this.data.datasets, (dataset, datasetInde***REMOVED***)=>{
 ...
 _checkEventBindings() {
        ...
        if (!setsEqual(e***REMOVED***istingEvents, newEvents) || !!this._responsiveListeners !== options.responsive) {
            this.unbindEvents();
            this.bindEvents();
        }
    }
 ...
 _updateLayout(minPadding) {
        ...
        this._layers = [];
        each(this.bo***REMOVED***es, (bo***REMOVED***)=>{
 ...
 isPointInArea(point) {
    ...
    getConte***REMOVED***t() {
        return this.$conte***REMOVED***t || (this.$conte***REMOVED***t = createConte***REMOVED***t(null, {
            chart: this,
            type: 'chart'
        }));
    }
...
function clipArc(ct***REMOVED***, element, endAngle) {
    ...
    if (innerRadius > pi***REMOVED***elMargin) {
        ...
        ct***REMOVED***.arc(***REMOVED***, y, pi***REMOVED***elMargin, endAngle + HALF_PI, startAngle - HALF_PI);
    }
 ...
 */ function pathArc(ct***REMOVED***, element, offset, spacing, end, circular) {
    ...
    const beta = Math.ma***REMOVED***(0.001, alpha * outerRadius - offset / PI) / outerRadius;
    ...
    if (circular) {
        ...
        if (outerEnd > 0) {
            ...
            ct***REMOVED***.arc(pCenter.***REMOVED***, pCenter.y, outerEnd, outerEndAdjustedAngle, endAngle + HALF_PI);
        }
        ...
        if (innerEnd > 0) {
            ...
            ct***REMOVED***.arc(pCenter.***REMOVED***, pCenter.y, innerEnd, endAngle + HALF_PI, innerEndAdjustedAngle + Math.PI);
        }
        ...
        if (innerStart > 0) {
            ...
            ct***REMOVED***.arc(pCenter.***REMOVED***, pCenter.y, innerStart, innerStartAdjustedAngle + Math.PI, startAngle - HALF_PI);
        }
        ...
        if (outerStart > 0) {
            ...
            ct***REMOVED***.arc(pCenter.***REMOVED***, pCenter.y, outerStart, startAngle - HALF_PI, outerStartAdjustedAngle);
        }
    } else {
...
class ArcElement e***REMOVED***tends Element {
    ...
    draw(ct***REMOVED***) {
        ...
        const fi***REMOVED*** = 1 - Math.sin(Math.min(PI, circumference || 0));
...
function setStyle(ct***REMOVED***, options, style = options) {
    ct***REMOVED***.lineCap = valueOrDefault(style.borderCapStyle, options.borderCapStyle);
    ct***REMOVED***.setLineDash(valueOrDefault(style.borderDash, options.borderDash));
    ct***REMOVED***.lineDashOffset = valueOrDefault(style.borderDashOffset, options.borderDashOffset);
    ct***REMOVED***.lineJoin = valueOrDefault(style.borderJoinStyle, options.borderJoinStyle);
    ct***REMOVED***.lineWidth = valueOrDefault(style.borderWidth, options.borderWidth);
    ct***REMOVED***.strokeStyle = valueOrDefault(style.borderColor, options.borderColor);
}
 ...
 static defaultRoutes = {
    ...
    updateControlPoints(chartArea, inde***REMOVED***A***REMOVED***is) {
        ...
        if ((options.tension || options.cubicInterpolationMode === 'monotone') && !options.stepped && !this._pointsUpdated) {
            ...
            _updateBezierControlPoints(this._points, options, chartArea, loop, inde***REMOVED***A***REMOVED***is);
...
class PointElement e***REMOVED***tends Element {
   ...
   */ static defaultRoutes = {
    ...
    draw(ct***REMOVED***, area) {
        ...
        ct***REMOVED***.fillStyle = options.backgroundColor;
        drawPoint(ct***REMOVED***, options, this.***REMOVED***, this.y);
    }
    getRange() {
        const options = this.options || {};
...
function skipOrLimit(skip, value, min, ma***REMOVED***) {
    return skip ? 0 : _limitValue(value, min, ma***REMOVED***);
}
...
function inRange(bar, ***REMOVED***, y, useFinalPosition) {
    ...
    return bounds && (skipX || _isBetween(***REMOVED***, bounds.left, bounds.right)) && (skipY || _isBetween(y, bounds.top, bounds.bottom));
}
    ...
    for(i = start; i < start + count; ++i){
        ...
        ***REMOVED*** = (point.***REMOVED*** - ***REMOVED***Min) / d***REMOVED*** * availableWidth;
        ...
        if (truncX === prevX) {
            ...
            if (!isNullOrUndef(minInde***REMOVED***) && !isNullOrUndef(ma***REMOVED***Inde***REMOVED***)) {
...
function getStartAndCountOfVisiblePointsSimplified(meta, points) {
    ...
    if (minDefined) {
        start = _limitValue(_lookupByKey(points, iScale.a***REMOVED***is, min).lo, 0, pointCount - 1);
    }
    if (ma***REMOVED***Defined) {
        count = _limitValue(_lookupByKey(points, iScale.a***REMOVED***is, ma***REMOVED***).hi + 1, start, pointCount) - start;
    } else {
...
function computeLinearBoundary(source) {
    ...
    if (isNumberFinite(pi***REMOVED***el)) {
...
class Legend e***REMOVED***tends Element {
 ...
 _draw() {
        ...
        const drawLegendBo***REMOVED*** = function(***REMOVED***, y, legendItem) {
            ...
            ct***REMOVED***.fillStyle = valueOrDefault(legendItem.fillStyle, defaultColor);
            ct***REMOVED***.lineCap = valueOrDefault(legendItem.lineCap, 'butt');
            ct***REMOVED***.lineDashOffset = valueOrDefault(legendItem.lineDashOffset, 0);
            ct***REMOVED***.lineJoin = valueOrDefault(legendItem.lineJoin, 'miter');
            ct***REMOVED***.lineWidth = lineWidth;
            ct***REMOVED***.strokeStyle = valueOrDefault(legendItem.strokeStyle, defaultColor);
            ct***REMOVED***.setLineDash(valueOrDefault(legendItem.lineDash, []));
            if (labelOpts.usePointStyle) {
                const drawOptions = {
                ...
                drawPointLegend(ct***REMOVED***, drawOptions, centerX, centerY, labelOpts.pointStyleWidth && bo***REMOVED***Width);
            } else {
        ...
        const fillTe***REMOVED***t = function(***REMOVED***, y, legendItem) {
            renderTe***REMOVED***t(ct***REMOVED***, legendItem.te***REMOVED***t, ***REMOVED***, y + itemHeight / 2, labelFont, {
        ...
        if (isHorizontal) {
            cursor = {
                ***REMOVED***: _alignStartEnd(align, this.left + padding, this.right - lineWidths[0]),
        ...
        overrideTe***REMOVED***tDirection(this.ct***REMOVED***, opts.te***REMOVED***tDirection);
        const lineHeight = itemHeight + padding;
        this.legendItems.forEach((legendItem, i)=>{
            ...
            if (isHorizontal) {
                if (i > 0 && ***REMOVED*** + width + padding > this.right) {
                    ...
                    cursor.line++;
                    ***REMOVED*** = cursor.***REMOVED*** = _alignStartEnd(align, this.left + padding, this.right - lineWidths[cursor.line]);
                }
            ...
            ***REMOVED*** = _te***REMOVED***tX(te***REMOVED***tAlign, ***REMOVED*** + bo***REMOVED***Width + halfFontSize, isHorizontal ? ***REMOVED*** + width : this.right, opts.rtl);
        ...
        restoreTe***REMOVED***tDirection(this.ct***REMOVED***, opts.te***REMOVED***tDirection);
    }
 drawTitle() {
        const opts = this.options;
        ...
        if (this.isHorizontal()) {
            ...
            left = _alignStartEnd(opts.align, left, this.right - ma***REMOVED***Width);
        } else {
            const ma***REMOVED***Height = this.columnSizes.reduce((acc, size)=>Math.ma***REMOVED***(acc, size.height), 0);
            y = topPaddingPlusHalfFontSize + _alignStartEnd(opts.align, this.top, this.bottom - ma***REMOVED***Height - opts.labels.padding - this._computeTitleHeight());
        }
        const ***REMOVED*** = _alignStartEnd(position, left, left + ma***REMOVED***Width);
        ct***REMOVED***.te***REMOVED***tAlign = rtlHelper.te***REMOVED***tAlign(_toLeftRightCenter(position));
        ct***REMOVED***.te***REMOVED***tBaseline = 'middle';
        ct***REMOVED***.strokeStyle = titleOpts.color;
        ct***REMOVED***.fillStyle = titleOpts.color;
        ct***REMOVED***.font = titleFont.string;
        renderTe***REMOVED***t(ct***REMOVED***, titleOpts.te***REMOVED***t, ***REMOVED***, y, titleFont);
    }
 _computeTitleHeight() {
 ...
 _getLegendItemAt(***REMOVED***, y) {
        ...
        if (_isBetween(***REMOVED***, this.left, this.right) && _isBetween(y, this.top, this.bottom)) {
            lh = this.legendHitBo***REMOVED***es;
            for(i = 0; i < lh.length; ++i){
                hitBo***REMOVED*** = lh[i];
                if (_isBetween(***REMOVED***, hitBo***REMOVED***.left, hitBo***REMOVED***.left + hitBo***REMOVED***.width) && _isBetween(y, hitBo***REMOVED***.top, hitBo***REMOVED***.top + hitBo***REMOVED***.height)) {
...
class Title e***REMOVED***tends Element {
 constructor(config){
    ...
    update(ma***REMOVED***Width, ma***REMOVED***Height) {
        ...
        const lineCount = isArray(opts.te***REMOVED***t) ? opts.te***REMOVED***t.length : 1;
        this._padding = toPadding(opts.padding);
        const te***REMOVED***tSize = lineCount * toFont(opts.font).lineHeight + this._padding.height;
        if (this.isHorizontal()) {
    ...
    draw() {
        ...
        renderTe***REMOVED***t(ct***REMOVED***, opts.te***REMOVED***t, 0, 0, fontOpts, {
            color: opts.color,
            ma***REMOVED***Width,
            rotation,
            te***REMOVED***tAlign: _toLeftRightCenter(opts.align),
            te***REMOVED***tBaseline: 'middle',
            translation: [
                titleX,
                titleY
...
function pushOrConcat(base, toPush) {
 ...
 function getTooltipSize(tooltip, options) {
    ...
    ct***REMOVED***.save();
    ct***REMOVED***.font = titleFont.string;
    each(tooltip.title, ma***REMOVED***LineWidth);
    ct***REMOVED***.font = bodyFont.string;
    each(tooltip.beforeBody.concat(tooltip.afterBody), ma***REMOVED***LineWidth);
    widthPadding = options.displayColors ? bo***REMOVED***Width + 2 + options.bo***REMOVED***Padding : 0;
    each(body, (bodyItem)=>{
        each(bodyItem.before, ma***REMOVED***LineWidth);
        each(bodyItem.lines, ma***REMOVED***LineWidth);
        each(bodyItem.after, ma***REMOVED***LineWidth);
    });
    widthPadding = 0;
    ct***REMOVED***.font = footerFont.string;
    each(tooltip.footer, ma***REMOVED***LineWidth);
    ct***REMOVED***.restore();
    width += padding.width;
    return {
        width,
...
function alignY(size, yAlign, paddingAndSize) {
 ...
 function getBackgroundPoint(options, size, alignment, chart) {
    ...
    return {
        ***REMOVED***: _limitValue(***REMOVED***, 0, chart.width - size.width),
...
class Tooltip e***REMOVED***tends Element {
 ...
 getConte***REMOVED***t() {
    ...
    getBody(tooltipItems, options) {
        const { callbacks  } = options;
        const bodyItems = [];
        each(tooltipItems, (conte***REMOVED***t)=>{
            const bodyItem = {
                before: [],
                lines: [],
                after: []
 ...
 _createItems(options) {
    ...
    drawTitle(pt, ct***REMOVED***, options) {
        ...
        if (length) {
            const rtlHelper = getRtlAdapter(options.rtl, this.***REMOVED***, this.width);
 ...
 _drawColorBo***REMOVED***(ct***REMOVED***, pt, i, rtlHelper, options) {
        ...
        if (options.usePointStyle) {
            ...
            drawPoint(ct***REMOVED***, drawOptions, centerX, centerY);
            ct***REMOVED***.strokeStyle = labelColor.borderColor;
            ct***REMOVED***.fillStyle = labelColor.backgroundColor;
            drawPoint(ct***REMOVED***, drawOptions, centerX, centerY);
        } else {
            ct***REMOVED***.lineWidth = isObject(labelColor.borderWidth) ? Math.ma***REMOVED***(...Object.values(labelColor.borderWidth)) : labelColor.borderWidth || 1;
            ct***REMOVED***.strokeStyle = labelColor.borderColor;
    ...
    drawBody(pt, ct***REMOVED***, options) {
        ...
        each(this.beforeBody, fillLineOfTe***REMOVED***t);
        ***REMOVED***LinePadding = displayColors && bodyAlignForCalculation !== 'right' ? bodyAlign === 'center' ? bo***REMOVED***Width / 2 + bo***REMOVED***Padding : bo***REMOVED***Width + 2 + bo***REMOVED***Padding : 0;
        for(i = 0, ilen = body.length; i < ilen; ++i){
            ...
            each(bodyItem.before, fillLineOfTe***REMOVED***t);
            ...
            each(bodyItem.after, fillLineOfTe***REMOVED***t);
        }
        ***REMOVED***LinePadding = 0;
        bodyLineHeight = bodyFont.lineHeight;
        each(this.afterBody, fillLineOfTe***REMOVED***t);
        pt.y -= bodySpacing;
    }
 ...
 _willRender() {
    ...
    draw(ct***REMOVED***) {
        ...
        if (options.enabled && hasTooltipContent) {
            ...
            overrideTe***REMOVED***tDirection(ct***REMOVED***, options.te***REMOVED***tDirection);
            pt.y += padding.top;
            this.drawTitle(pt, ct***REMOVED***, options);
            this.drawBody(pt, ct***REMOVED***, options);
            this.drawFooter(pt, ct***REMOVED***, options);
            restoreTe***REMOVED***tDirection(ct***REMOVED***, options.te***REMOVED***tDirection);
            ct***REMOVED***.restore();
        }
    }
 getActiveElements() {
...
const validInde***REMOVED*** = (inde***REMOVED***, ma***REMOVED***)=>inde***REMOVED*** === null ? null : _limitValue(Math.round(inde***REMOVED***), 0, ma***REMOVED***);
...
class CategoryScale e***REMOVED***tends Scale {
 ...
 static defaults = {
    ...
    parse(raw, inde***REMOVED***) {
        ...
        const labels = this.getLabels();
        inde***REMOVED*** = isFinite(inde***REMOVED***) && labels[inde***REMOVED***] === raw ? inde***REMOVED*** : findOrAddLabel(labels, raw, valueOrDefault(inde***REMOVED***, raw), this._addedLabels);
...
function generateTicks$1(generationOptions, dataRange) {
    ...
    const ma***REMOVED***Defined = !isNullOrUndef(ma***REMOVED***);
    const countDefined = !isNullOrUndef(count);
    const minSpacing = (rma***REMOVED*** - rmin) / (ma***REMOVED***Digits + 1);
    let spacing = niceNum((rma***REMOVED*** - rmin) / ma***REMOVED***Spaces / unit) * unit;
    ...
    if (numSpaces > ma***REMOVED***Spaces) {
        spacing = niceNum(numSpaces * spacing / ma***REMOVED***Spaces / unit) * unit;
    }
    ...
    if (minDefined && ma***REMOVED***Defined && step && almostWhole((ma***REMOVED*** - min) / step, spacing / 1000)) {
    ...
    const decimalPlaces = Math.ma***REMOVED***(_decimalPlaces(spacing), _decimalPlaces(niceMin));
    ...
    if (ma***REMOVED***Defined && includeBounds && niceMa***REMOVED*** !== ma***REMOVED***) {
        if (ticks.length && almostEquals(ticks[ticks.length - 1].value, ma***REMOVED***, relativeLabelSize(ma***REMOVED***, minSpacing, generationOptions))) {
...
class LinearScaleBase e***REMOVED***tends Scale {
    ...
    handleTickRangeOptions() {
        ...
        if (beginAtZero) {
            ...
            const ma***REMOVED***Sign = sign(ma***REMOVED***);
 ...
 computeTickLimit() {
    ...
    buildTicks() {
        ...
        if (opts.bounds === 'ticks') {
            _setMinAndMa***REMOVED***ByKey(ticks, this, 'value');
        }
        if (opts.reverse) {
            ticks.reverse();
...
class LinearScale e***REMOVED***tends LinearScaleBase {
 ...
 static defaults = {
    ...
    determineDataLimits() {
        ...
        this.ma***REMOVED*** = isNumberFinite(ma***REMOVED***) ? ma***REMOVED*** : 1;
...
function startE***REMOVED***p(min, ma***REMOVED***) {
 ...
 function generateTicks(generationOptions, { min , ma***REMOVED***  }) {
    ...
    let value = finiteOrDefault(generationOptions.min, Math.round((base + offset + significand * Math.pow(10, e***REMOVED***p)) * precision) / precision);
    ...
    const lastTick = finiteOrDefault(generationOptions.ma***REMOVED***, value);
    ticks.push({
        value: lastTick,
...
class LogarithmicScale e***REMOVED***tends Scale {
 ...
 static defaults = {
    ...
    determineDataLimits() {
        const { min , ma***REMOVED***  } = this.getMinMa***REMOVED***(true);
        this.min = isNumberFinite(min) ? Math.ma***REMOVED***(0, min) : null;
        this.ma***REMOVED*** = isNumberFinite(ma***REMOVED***) ? Math.ma***REMOVED***(0, ma***REMOVED***) : null;
 ...
 configure() {
        ...
        this._valueRange = log10(this.ma***REMOVED***) - log10(start);
    }
    getPi***REMOVED***elForValue(value) {
        ...
        return this.getPi***REMOVED***elForDecimal(value === this.min ? 0 : (log10(value) - this._startValue) / this._valueRange);
    }
    getValueForPi***REMOVED***el(pi***REMOVED***el) {
...
function measureLabelSize(ct***REMOVED***, font, label) {
    ...
    return {
        w: _longestTe***REMOVED***t(ct***REMOVED***, font.string, label),
...
function determineLimits(angle, pos, size, min, ma***REMOVED***) {
 ...
 function fitWithPointLabels(scale) {
    ...
    for(let i = 0; i < valueCount; i++){
        ...
        const angleRadians = _normalizeAngle(scale.getInde***REMOVED***Angle(i) + additionalAngle);
...
function isNotOverlapped(item, area) {
    ...
    const ape***REMOVED***esInArea = _isPointInArea({
        ***REMOVED***: left,
        y: top
    }, area) || _isPointInArea({
        ***REMOVED***: left,
...
function drawPointLabels(scale, labelCount) {
    ...
    for(let i = labelCount - 1; i >= 0; i--){
        ...
        const plFont = toFont(optsAtInde***REMOVED***.font);
        const { ***REMOVED*** , y , te***REMOVED***tAlign  } = item;
        renderTe***REMOVED***t(ct***REMOVED***, scale._pointLabels[i], ***REMOVED***, y + plFont.lineHeight / 2, plFont, {
...
function pathRadiusLine(scale, radius, circular, labelCount) {
    ...
    if (circular) {
        ct***REMOVED***.arc(scale.***REMOVED***Center, scale.yCenter, radius, 0, TAU);
    } else {
...
class RadialLinearScale e***REMOVED***tends LinearScaleBase {
 ...
 static defaults = {
    ...
    determineDataLimits() {
        ...
        this.ma***REMOVED*** = isNumberFinite(ma***REMOVED***) && !isNaN(ma***REMOVED***) ? ma***REMOVED*** : 0;
        this.handleTickRangeOptions();
    }
 computeTickLimit() {
    ...
    getInde***REMOVED***Angle(inde***REMOVED***) {
        ...
        return _normalizeAngle(inde***REMOVED*** * angleMultiplier + toRadians(startAngle));
    }
    ...
    getPointPosition(inde***REMOVED***, distanceFromCenter, additionalAngle = 0) {
        const angle = this.getInde***REMOVED***Angle(inde***REMOVED***) - HALF_PI + additionalAngle;
        return {
 ...
 drawLabels() {
        ...
        this.ticks.forEach((tick, inde***REMOVED***)=>{
            ...
            const tickFont = toFont(optsAtInde***REMOVED***.font);
            ...
            if (optsAtInde***REMOVED***.showLabelBackdrop) {
                ...
                const padding = toPadding(optsAtInde***REMOVED***.backdropPadding);
            ...
            renderTe***REMOVED***t(ct***REMOVED***, tick.label, 0, -offset, tickFont, {
                color: optsAtInde***REMOVED***.color,
...
class TimeScale e***REMOVED***tends Scale {
 ...
 function _applyBounds(bounds) {
        ...
        ma***REMOVED*** = isNumberFinite(ma***REMOVED***) && !isNaN(ma***REMOVED***) ? ma***REMOVED*** : +adapter.endOf(Date.now(), unit) + 1;
 ...
 buildTicks() {
        ...
        const min = this.min;
        const ma***REMOVED*** = this.ma***REMOVED***;
        const ticks = _filterBetween(timestamps, min, ma***REMOVED***);
 ...
 _getLabelSize(label) {
        ...
        const angle = toRadians(this.isHorizontal() ? ticksOpts.ma***REMOVED***Rotation : ticksOpts.minRotation);
...
e***REMOVED***port { Animation, Animations, ArcElement, BarController, BarElement, BasePlatform, BasicPlatform, BubbleController, CategoryScale, Chart, plugin_colors as Colors, DatasetController, plugin_decimation as Decimation, DomPlatform, DoughnutController, Element, inde***REMOVED*** as Filler, Interaction, plugin_legend as Legend, LineController, LineElement, LinearScale, LogarithmicScale, PieController, PointElement, PolarAreaController, RadarController, RadialLinearScale, Scale, ScatterController, plugin_subtitle as SubTitle, Ticks, TimeScale, TimeSeriesScale, plugin_title as Title, plugin_tooltip as Tooltip, adapters as _adapters, _detectPlatform, animator, controllers, defaults, elements, layouts, plugins, registerables, registry, scales };
